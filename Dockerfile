...
# =============================================================================
# EasySub2api Multi-Stage Dockerfile
# =============================================================================
...
RUN --mount=type=cache,id=easysub2api-pnpm-store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=easysub2api-gomod,target=/go/pkg/mod \
    go mod download
...
RUN --mount=type=cache,id=easysub2api-gomod,target=/go/pkg/mod \
    --mount=type=cache,id=easysub2api-gobuild,target=/root/.cache/go-build \
...
# Labels
LABEL maintainer="AsukaCC <https://github.com/AsukaCC>"
LABEL description="EasySub2api - AI API Gateway Platform"
LABEL org.opencontainers.image.source="https://github.com/AsukaCC/EasySub2api"
...
RUN addgroup -g 1000 easysub2api && \
    adduser -u 1000 -G easysub2api -s /bin/sh -D easysub2api
...
# Run the application (entrypoint fixes /app/data ownership then execs as easysub2api)
