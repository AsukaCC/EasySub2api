...
- 保持所有现有 OpenAI/Claude/媒体兼容入口的请求和响应 envelope。
...
Handler 使用自己已有的 OpenAI 或 Claude error helper。正文只包含通用中文消息、code 和 request ID。
...
| 协议 | chat / responses / messages / images-media / responses-ws |
