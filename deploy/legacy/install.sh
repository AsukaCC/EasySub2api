#!/bin/bash
#
# Legacy EasySub2api binary installer (compatibility release only)
# EasySub2api 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/AsukaCC/EasySub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="AsukaCC/EasySub2api"
...
declare -A MSG_ZH=(
    ...
    # Installation
    ["install_title"]="EasySub2api 安装脚本"
    ...
    # Completion
    ["install_complete"]="EasySub2api 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 EasySub2api 服务："
    ...
    ["not_installed"]="EasySub2api 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 EasySub2api。"
    ...
    ["uninstall_complete"]="EasySub2api 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 EasySub2api"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 EasySub2api"
    ...
    ["server_config_desc"]="配置 EasySub2api 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="EasySub2api Installation Script"
    ...
    # Completion
    ["install_complete"]="EasySub2api installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start EasySub2api service:"
    ...
    # Upgrade
    ["upgrading"]="Upgrading EasySub2api..."
    ...
    ["not_installed"]="EasySub2api is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove EasySub2api from your system."
    ...
    ["uninstall_complete"]="EasySub2api has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install EasySub2api"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove EasySub2api"
    ...
    ["server_config_desc"]="Configure EasySub2api server listen address"
...
[Unit]
Description=EasySub2api - AI API Gateway Platform
Documentation=https://github.com/AsukaCC/EasySub2api
...
# Upgrade function
upgrade() {
    # Check if EasySub2api is installed
    if [ ! -f "$INSTALL_DIR/sub2api" ]; then
...
# Requires: EasySub2api must already be installed
install_version() {
