/**
 * Vue Router configuration for EasySub2api frontend
...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/model-plaza/settings',
    name: 'AdminModelPlazaSettings',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Model Plaza Settings',
      titleKey: 'admin.settings.sections.feature-model-plaza',
      descriptionKey: 'admin.settings.sectionDescriptions.feature-model-plaza',
  ...
  },
  {
    ...
    meta: {
      ...
      userFeature: 'available-channels'
    }
  },
  {
    path: '/profile',
  ...
  {
    path: '/admin/ops/settings',
    name: 'AdminOpsSettings',
    component: () => import('@/views/admin/OpsFeatureSettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Operations Monitoring Settings',
      titleKey: 'admin.settings.featureManagement.modules.opsMonitoring',
      descriptionKey: 'admin.settings.featureManagement.moduleDescriptions.opsMonitoring',
    },
  },
  {
  ...
  },
  {
    ...
    component: () => import('@/views/admin/UserLevelsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'User Levels',
      titleKey: 'admin.users.levels.title',
      descriptionKey: 'admin.users.levels.description'
    }
  },
  {
    path: '/admin/groups',
  ...
  {
    path: '/admin/channels/monitor/settings',
    name: 'AdminChannelMonitorSettings',
    component: () => import('@/views/admin/ChannelMonitorFeatureSettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Channel Monitor Settings',
      titleKey: 'admin.settings.sections.feature-channel-monitor',
      descriptionKey: 'admin.settings.sectionDescriptions.feature-channel-monitor',
    },
  },
  {
    path: '/monitor',
  ...
  },
  {
    ...
    component: () => import('@/views/admin/FeatureManagementView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Feature Management',
      titleKey: 'admin.settings.featureManagement.title',
      descriptionKey: 'admin.settings.featureManagement.description',
    },
  },
  {
    path: '/admin/settings/updates',
    name: 'AdminSystemUpdates',
    component: () => import('@/views/admin/SystemUpdatesView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'System Updates',
      titleKey: 'admin.settings.systemUpdates.title',
      descriptionKey: 'admin.settings.systemUpdates.description',
    },
  },
  {
    path: '/admin/settings/features/channel-monitor',
    redirect: '/admin/channels/monitor/settings',
  },
  {
    path: '/admin/settings/features/available-channels',
    redirect: '/admin/channels/pricing',
  },
  {
    path: '/admin/settings/features/model-plaza',
  ...
  {
    path: '/admin/settings/features/risk-control',
    redirect: '/admin/risk-control',
  },
  {
    path: '/admin/settings/features/affiliate',
    redirect: '/admin/affiliates/settings',
  },
  {
    path: '/admin/settings/features/ops-monitoring',
    redirect: '/admin/ops/settings',
  },
  {
    path: '/admin/settings/platform',
    name: 'AdminSettingsPlatform',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
  ...
  },
  {
    ...
    name: 'AdminSettingsCompliance',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Login & Compliance Settings',
      titleKey: 'admin.settings.title',
      descriptionKey: 'admin.settings.description',
      settingsTabs: ['agreement'],
      settingsSection: 'compliance',
    },
  },
  {
    path: '/admin/settings/access',
    name: 'AdminSettingsAccess',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      ...
      titleKey: 'admin.settings.title',
      descriptionKey: 'admin.settings.description',
      settingsTabs: ['security', 'users'],
      settingsSection: 'access',
    },
  },
  {
    path: '/admin/settings/gateway',
    name: 'AdminSettingsGateway',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
  ...
  },
  {
    ...
    name: 'AdminSettingsOperations',
    component: () => import('@/views/admin/SettingsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Email & Operations Settings',
      titleKey: 'admin.settings.title',
      descriptionKey: 'admin.settings.description',
      settingsTabs: ['email', 'backup'],
  ...
  },
  {
    ...
    meta: {
      ...
      titleKey: 'admin.settings.sections.feature-affiliate',
      descriptionKey: 'admin.settings.sectionDescriptions.feature-affiliate',
      settingsTabs: ['features'],
      settingsSection: 'feature-affiliate',
    },
  },
  ...
  // ==================== 404 Not Found ====================
  {
    ...
    meta: {
      ...
      titleKey: 'featureUnavailable.title',
    },
  },
  {
    path: '/:pathMatch(.*)*',
...
type UserFeature = NonNullable<import('vue-router').RouteMeta['userFeature']>

function publicUserFeatureEnabled(settings: ReturnType<typeof useAppStore>['cachedPublicSettings'], feature: UserFeature): boolean | undefined {
  if (!settings) return undefined
  const values: Record<UserFeature, boolean | undefined> = {
...
router.beforeEach(async (to, _from, next) => {
  ...
  if (!requiresAuth) {
    ...
    if (to.path === '/model-plaza') {
      ...
      if (appStore.publicSettingsLoaded && plazaSettings?.model_plaza_enabled === false) {
        if (authStore.isAuthenticated && authStore.isAdmin) {
          ...
          if (!adminSettingsStore.modelPlazaEnabled) {
            next({ path: '/feature-unavailable', query: { feature: 'model-plaza' } })
            return
          }
        } else {
          next({ path: '/feature-unavailable', query: { feature: 'model-plaza' } })
    ...
    // Public feature pages still follow the published user-visibility switch.
    // This keeps /monitor reachable without JWT while avoiding a public bypass
    // when an administrator has withdrawn the feature from users.
    if (to.meta.userFeature) {
      ...
      const feature = to.meta.userFeature
      if (appStore.publicSettingsLoaded && publicUserFeatureEnabled(appStore.cachedPublicSettings, feature) === false) {
        next({ path: '/feature-unavailable', query: { feature } })
        return
      }
    }
  ...
  if (to.meta.userFeature && !authStore.isAdmin) {
    const feature = to.meta.userFeature
    if (appStore.publicSettingsLoaded && publicUserFeatureEnabled(appStore.cachedPublicSettings, feature) === false) {
      next({ path: '/feature-unavailable', query: { feature } })
      return
  ...
  if (
    to.meta.requiresPayment && !authStore.isAdmin &&
    appStore.publicSettingsLoaded &&
    appStore.cachedPublicSettings?.payment_enabled === false
  ) {
    next({ path: '/feature-unavailable', query: { feature: 'payment' } })
    return
  }

  if (to.meta.requiresPayment && authStore.isAdmin) {
    await adminSettingsStore.fetch()
    if (!adminSettingsStore.paymentEnabled) {
      next('/admin/settings/features')
      return
    }
  }
  ...
  if (
    ...
    next(authStore.isAdmin ? '/admin/settings/features' : '/dashboard')
    return
  }
