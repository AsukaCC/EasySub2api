<template>
  <BaseDialog
    ...
    @close="$emit('close')"
  >
    <form v-if="user" id="edit-user-form" @submit.prevent="handleUpdateUser" class="components-admin-user-user-edit-modal__form">
      <div>
      ...
      <div>
        ...
        <div class="components-admin-user-user-edit-modal__panel">
          <div class="components-admin-user-user-edit-modal__panel-2">
            <input v-model="form.password" type="text" class="components-admin-user-user-edit-modal__field input" :placeholder="t('admin.users.enterNewPassword')" />
            <button v-if="form.password" type="button" @click="copyPassword" class="components-admin-user-user-edit-modal__action" :class="passwordCopied ? 'components-admin-user-user-edit-modal__action-3' : 'components-admin-user-user-edit-modal__action-4'">
              <svg v-if="passwordCopied" class="components-admin-user-user-edit-modal__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
              <svg v-else class="components-admin-user-user-edit-modal__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184" /></svg>
            </button>
          </div>
          <button type="button" @click="generatePassword" class="components-admin-user-user-edit-modal__action-2 btn btn-secondary">
    ...
    <template #footer>
      <div class="components-admin-user-user-edit-modal__panel-3">
