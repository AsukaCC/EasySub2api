<template>
  <BaseDialog
    ...
    @close="handleClose"
  >
    <div class="components-admin-announcements-announcement-read-status-dialog__panel">
      <div class="components-admin-announcements-announcement-read-status-dialog__panel-2">
        <div class="components-admin-announcements-announcement-read-status-dialog__panel-3">
          <input
            v-model="search"
            type="text"
            class="input"
        ...
        <button @click="load" :disabled="loading" class="btn btn-secondary" :title="t('common.refresh')">
          <Icon name="refresh" size="md" :class="loading ? 'components-admin-announcements-announcement-read-status-dialog__icon' : ''" />
        </button>
      </div>
      ...
      >
        ...
        <template #cell-level="{ value }">
          <span class="badge badge-gray">L{{ value || 1 }}</span>
        </template>
        ...
        <template #cell-read_at="{ value }">
          <span class="components-admin-announcements-announcement-read-status-dialog__text-2">
    ...
    <template #footer>
      <div class="components-admin-announcements-announcement-read-status-dialog__panel-4">
...
const columns = computed<Column[]>(() => [
  ...
  { key: 'level', label: t('admin.announcements.level'), sortable: false },
