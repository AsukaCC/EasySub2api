...
const displaySnapshot = computed(() => snapshot.value || saved.value || null)
</script>

<style scoped>
.fingerprint-cell { display: block; width: 188px; padding: 4px; color: inherit; background: transparent; border: 0; cursor: pointer; border-radius: 4px; }
