...
describe('admin UsageTable tooltip', () => {
  ...
  it('shows service tier and billing breakdown in cost tooltip', async () => {
    ...
    const tooltipTriggers = wrapper.findAll('.components-admin-usage-usage-table__panel-16')
  ...
  it.each([
    ...
    await wrapper.find('.components-admin-usage-usage-table__panel-16').trigger('mouseenter')
    await nextTick()
