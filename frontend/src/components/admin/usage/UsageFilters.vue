<template>
  <div :class="flat ? 'components-admin-usage-usage-filters__panel-10 filter-toolbar' : 'components-admin-usage-usage-filters__panel-11 card-body card filter-toolbar'">
    ...
    <div class="components-admin-usage-usage-filters__panel">
      ...
      <div class="components-admin-usage-usage-filters__panel-2">
        <!-- User Search -->
        <div ref="userSearchRef" class="components-admin-usage-usage-filters__panel-3 usage-filter-dropdown">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="components-admin-usage-usage-filters__action"
        ...
        <!-- API Key Search -->
        <div ref="apiKeySearchRef" class="components-admin-usage-usage-filters__panel-3 usage-filter-dropdown">
        ...
        <!-- Account Filter -->
        <div ref="accountSearchRef" class="components-admin-usage-usage-filters__panel-6 usage-filter-dropdown">
      ...
      <!-- Right: actions -->
      <div v-if="showActions" class="components-admin-usage-usage-filters__panel-9">
...
const requestTypeOptions = ref<SelectOption[]>([
  ...
  { value: 'test', label: t('usage.testRequest') },
