...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    case 'anthropic': return 'components-admin-channel-types__state'
    case 'openai': return 'components-admin-channel-types__state-2'
    case 'grok': return 'components-admin-channel-types__state-5'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    case 'anthropic': return 'components-admin-channel-types__state-10'
    case 'openai': return 'components-admin-channel-types__state-11'
    case 'grok': return 'components-admin-channel-types__state-14'
