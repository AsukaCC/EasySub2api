<template>
  <div class="components-model-plaza-plaza-filter-bar__panel">
    <!-- 一级:平台 -->
    <div class="components-model-plaza-plaza-filter-bar__panel-2">
      <span class="components-model-plaza-plaza-filter-bar__text">
        {{ t('modelPlaza.filters.platformLabel') }}
      </span>
      <div class="components-model-plaza-plaza-filter-bar__panel-3">
        <button
          v-for="p in ['all', ...platforms]"
          :key="`platform-${p}`"
          type="button"
          class="components-model-plaza-plaza-filter-bar__action"
    ...
    <div class="components-model-plaza-plaza-filter-bar__panel-2">
      ...
      <div class="components-model-plaza-plaza-filter-bar__panel-3">
        <button
          type="button"
          class="components-model-plaza-plaza-filter-bar__action-2"
        ...
        <button
          ...
          :key="`group-${g.id}`"
          type="button"
          class="components-model-plaza-plaza-filter-bar__action-3"
    ...
    <div class="components-model-plaza-plaza-filter-bar__panel-2">
      ...
      <div class="components-model-plaza-plaza-filter-bar__panel-3">
        ...
        <button
          ...
          :key="`rate-${r}`"
          type="button"
          class="components-model-plaza-plaza-filter-bar__action-4"
    ...
    <!-- 四级:模型名搜索(纯前端过滤) -->
    <div class="components-model-plaza-plaza-filter-bar__panel-4">
      <span class="components-model-plaza-plaza-filter-bar__text">
        {{ t('modelPlaza.filters.modelLabel') }}
      </span>
      <div class="components-model-plaza-plaza-filter-bar__panel-5">
        <Icon
          name="search"
          size="sm"
          class="components-model-plaza-plaza-filter-bar__icon"
        />
        <input
          :value="search"
          type="text"
          :placeholder="t('modelPlaza.filters.searchPlaceholder')"
          class="components-model-plaza-plaza-filter-bar__field input"
          @input="$emit('update:search', ($event.target as HTMLInputElement).value)"
        />
        <button
          v-if="search"
          type="button"
          class="components-model-plaza-plaza-filter-bar__action-5"
          @click="$emit('update:search', '')"
        >
          <Icon name="x" size="xs" class="components-model-plaza-plaza-filter-bar__icon-2" />
        </button>
      </div>
    </div>
  </div>
...
const props = defineProps<{
  ...
  groups: Array<{ id: string; name: string; platform: string; rate: number }>
  /** 全量生效倍率去重升序。 */
  rates: number[]
  platform: string
  groupId: string | 'all'
...
defineEmits<{
  ...
  'update:groupId': [value: string | 'all']
...
function chipClass(active: boolean): string {
  return active
    ? 'components-model-plaza-plaza-filter-bar__state'
    : 'components-model-plaza-plaza-filter-bar__state-2'
}
</script>
