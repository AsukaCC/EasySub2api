<template>
  <div v-if="visible" class="components-account-cnprovider-balance-cell__panel">
    <div class="components-account-cnprovider-balance-cell__panel-2">
      <button
        type="button"
        :class="[
          'components-account-cnprovider-balance-cell__action',
      ...
      >
        <svg
          class="components-account-cnprovider-balance-cell__icon"
          :class="{ 'components-account-cnprovider-balance-cell__icon-2': loading }"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <span
        v-if="balanceLow"
        class="components-account-cnprovider-balance-cell__text"
      >
        {{ t('admin.accounts.cnProviders.balanceLow') }}
      </span>
    </div>

    <div v-if="error" class="components-account-cnprovider-balance-cell__panel-3" :title="error">
      {{ truncatedError }}
    </div>
  </div>
</template>
