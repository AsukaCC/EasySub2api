...
describe('AccountUsageCell', () => {
  ...
  expect(wrapper.text()).toContain('U 6.789 points')
  expect(wrapper.text()).not.toContain('U $6.789')
  ...
  it('Key 账号在 today stats loading 时显示骨架屏', async () => {
		...
		expect(wrapper.find('.components-account-account-usage-cell__panel-22').exists()).toBe(true)
  })
