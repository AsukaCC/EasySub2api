<template>
  <div v-if="visible" class="components-account-open-aiquota-reset-cell__panel">
    ...
    -->
    <div class="components-account-open-aiquota-reset-cell__panel-2">
      <slot name="pre-actions" />

      <button
        type="button"
        class="components-account-open-aiquota-reset-cell__action"
        :disabled="loading || resetting"
        :title="countButtonTitle"
        @click="handleQuery()"
      >
        <svg
          class="components-account-open-aiquota-reset-cell__icon"
          :class="{ 'components-account-open-aiquota-reset-cell__icon-2': loading }"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <button
        type="button"
        class="components-account-open-aiquota-reset-cell__action-2"
      ...
      >
        <svg
          class="components-account-open-aiquota-reset-cell__icon"
          :class="{ 'components-account-open-aiquota-reset-cell__icon-2': resetting }"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <div v-if="primaryResetCreditExpiry" class="components-account-open-aiquota-reset-cell__panel">
      <div class="components-account-open-aiquota-reset-cell__panel-3">
        <span
          class="components-account-open-aiquota-reset-cell__text"
        ...
        <button
          ...
          class="components-account-open-aiquota-reset-cell__action-3"
      ...
      <div
        ...
        class="components-account-open-aiquota-reset-cell__panel-4"
      >
        <span class="components-account-open-aiquota-reset-cell__text-2">{{ t('admin.accounts.openaiQuotaReset.expirationDetails') }}</span>
        <span
          v-for="(expiresAt, index) in resetCreditExpirations"
          :key="`${expiresAt}-${index}`"
          class="components-account-open-aiquota-reset-cell__text-3"
          :title="t('admin.accounts.openaiQuotaReset.expiresAtFull', { time: formatResetCreditExpiry(expiresAt, 'full') })"
        >
          <span class="components-account-open-aiquota-reset-cell__text-4" />
          <span class="components-account-open-aiquota-reset-cell__text-5">{{ formatResetCreditExpiry(expiresAt, 'short') }}</span>
        </span>
      </div>
    </div>
    ...
    <div
      v-if="error"
      class="components-account-open-aiquota-reset-cell__panel-5"
      :title="error"
    >
      {{ truncatedError }}
    </div>
    <div
      ...
      class="components-account-open-aiquota-reset-cell__panel-6"
    >
      {{ resetWarning }}
    </div>
    <div
      v-else-if="resetMessage"
      class="components-account-open-aiquota-reset-cell__panel-7"
    >
      {{ resetMessage }}
    </div>
