<template>
  <button
    type="button"
    class="components-account-header-override-json-tools__action"
  ...
  <button
    type="button"
    class="components-account-header-override-json-tools__action-2"
  ...
  <div v-if="showImportPanel" ref="importPanelRef" class="components-account-header-override-json-tools__panel">
    <textarea
      ref="importTextareaRef"
      v-model="importText"
      rows="5"
      class="components-account-header-override-json-tools__field input"
      :placeholder="IMPORT_JSON_PLACEHOLDER"
    ></textarea>
    <div class="components-account-header-override-json-tools__panel-2">
      <button
        type="button"
        class="components-account-header-override-json-tools__action-3"
        @click="applyImport"
      >
      ...
      <button
        type="button"
        class="components-account-header-override-json-tools__action-4"
        @click="closeImportPanel"
      >
        {{ t('admin.accounts.headerOverride.importJsonCancel') }}
      </button>
    </div>
    <p class="components-account-header-override-json-tools__description">
