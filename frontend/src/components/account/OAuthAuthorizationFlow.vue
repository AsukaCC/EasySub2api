        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="components-account-oauth-authorization-flow__panel-7">
          ...
          >
            ...
            >
              <svg
                v-if="loading"
                class="components-account-oauth-authorization-flow__icon-3"
                fill="none"
                viewBox="0 0 24 24"
              >
                <circle
                  class="components-account-oauth-authorization-flow__circle"
                  cx="12"
                  cy="12"
                  r="10"
                  stroke="currentColor"
                ...
                ></circle>
                <path
                  class="components-account-oauth-authorization-flow__path"
                  fill="currentColor"
                  d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
                ></path>
              </svg>
              <Icon v-else name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
              {{
                loading
            ...
            <div class="components-account-oauth-authorization-flow__panel-11">
              ...
              <div class="components-account-oauth-authorization-flow__panel-4">
                ...
                >
                  ...
                  <Icon v-else name="link" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
