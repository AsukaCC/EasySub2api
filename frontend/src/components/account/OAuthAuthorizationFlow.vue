<template>
  <div
    class="components-account-oauth-authorization-flow__panel"
  >
      <div class="components-account-oauth-authorization-flow__panel-2">
      <div class="components-account-oauth-authorization-flow__panel-3">
        <Icon name="link" size="md" class="components-account-oauth-authorization-flow__icon" />
      </div>
      <div class="components-account-oauth-authorization-flow__panel-4">
        <h4 class="components-account-oauth-authorization-flow__heading">{{ oauthTitle }}</h4>

        <!-- Auth Method Selection -->
        <div v-if="showMethodSelection" class="components-account-oauth-authorization-flow__panel-5">
          <label class="components-account-oauth-authorization-flow__label">
            {{ methodLabel }}
          </label>
          <div class="components-account-oauth-authorization-flow__panel-6">
            <label v-if="showManualOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="manual"
                class="components-account-oauth-authorization-flow__field"
              />
              <span class="components-account-oauth-authorization-flow__text">{{
                t('admin.accounts.oauth.manualAuth')
              }}</span>
            </label>
            <label v-if="showCookieOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="cookie"
            ...
            <label v-if="showRefreshTokenOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="refresh_token"
            ...
            <label v-if="showSsoOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="sso_cookie"
            ...
            <label v-if="emailPasswordOptionEnabled" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
            ...
            <label v-if="showMobileRefreshTokenOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
            ...
            <label v-if="showSessionTokenOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="session_token"
            ...
            <label v-if="showAccessTokenOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="access_token"
            ...
            <label v-if="showCodexSessionImportOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="codex_session"
            ...
            <label v-if="showAgentIdentityOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
            ...
            <label v-if="showCodexPatOption" class="components-account-oauth-authorization-flow__label-2">
              <input
                v-model="inputMethod"
                type="radio"
                value="codex_pat"
        ...
        <!-- Refresh Token Input -->
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
              {{ t(getOAuthKey('refreshTokenDesc')) }}
            </p>

            <!-- Refresh Token Input -->
            <div class="components-account-oauth-authorization-flow__panel-5">
              <label
                class="components-account-oauth-authorization-flow__label-3"
              >
                <Icon name="key" size="sm" class="components-account-oauth-authorization-flow__icon-2" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="components-account-oauth-authorization-flow__text-2"
                >
              ...
              <textarea
                ...
                rows="3"
                class="components-account-oauth-authorization-flow__field-2 input"
                :placeholder="t(getOAuthKey('refreshTokenPlaceholder'))"
              ></textarea>
              <p
                v-if="parsedRefreshTokenCount > 1"
                class="components-account-oauth-authorization-flow__description-2"
              >
            ...
            <div
              v-if="error"
              class="components-account-oauth-authorization-flow__panel-9"
            >
              <p class="components-account-oauth-authorization-flow__description-3">
                {{ error }}
              </p>
            </div>
            ...
            <button :aria-busy="loading"
              type="button"
              class="components-account-oauth-authorization-flow__action btn btn-primary"
              :disabled="loading || !refreshTokenInput.trim()"
              @click="handleValidateRefreshToken"
            >
<LoadingButtonContent :loading="loading" :loading-text="t(getOAuthKey('validating'))">
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
        ...
        <div v-if="inputMethod === 'sso_cookie'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
            ...
            <div class="components-account-oauth-authorization-flow__panel-5">
              ...
              <textarea
                ...
                spellcheck="false"
              ></textarea>
              <p class="components-account-oauth-authorization-flow__description-2">
            ...
            >
<LoadingButtonContent :loading="loading" :loading-text="t(getOAuthKey('convertingSSO'))">
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
              {{ t(getOAuthKey('convertSSOAndCreate')) }}
</LoadingButtonContent>
            </button>
          </div>
        </div>
        ...
        <div v-if="inputMethod === 'email_password'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
            ...
            <div class="components-account-oauth-authorization-flow__panel-5">
              <label
                class="components-account-oauth-authorization-flow__label-3"
              >
                <Icon name="user" size="sm" class="components-account-oauth-authorization-flow__icon-2" />
...
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
        ...
        <div v-if="inputMethod === 'codex_session' || inputMethod === 'agent_identity'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
            ...
            >
<LoadingButtonContent :loading="loading" :loading-text="t('admin.accounts.oauth.openai.validating')">
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
        ...
        <div v-if="inputMethod === 'codex_pat'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
...
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
        ...
        <div v-if="inputMethod === 'cookie'" class="components-account-oauth-authorization-flow__panel-7">
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <p class="components-account-oauth-authorization-flow__description">
            ...
            <div class="components-account-oauth-authorization-flow__panel-5">
              ...
              >
                ...
                <button
                  v-if="showHelp"
                  type="button"
                  class="components-account-oauth-authorization-flow__action-2"
                  @click="showHelpDialog = !showHelpDialog"
                >
                  <svg
                    class="components-account-oauth-authorization-flow__icon-5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="1.5"
            ...
            <div
              ...
              class="components-account-oauth-authorization-flow__panel-10"
            >
              <h5 class="components-account-oauth-authorization-flow__h5">
                {{ t('admin.accounts.oauth.howToGetSessionKey') }}
              </h5>
              <ol
                class="components-account-oauth-authorization-flow__list"
              >
              ...
              <p
                class="components-account-oauth-authorization-flow__description-4"
            ...
            >
<LoadingButtonContent :loading="loading" :loading-text="t('admin.accounts.oauth.authorizing')">
<Icon  name="sparkles" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
        ...
        <div v-if="inputMethod === 'manual'" class="components-account-oauth-authorization-flow__panel-7">
          <p class="components-account-oauth-authorization-flow__description-5">
            {{ oauthFollowSteps }}
          </p>
          ...
          <div
            class="components-account-oauth-authorization-flow__panel-8"
          >
            <div class="components-account-oauth-authorization-flow__panel-11">
              <div
                class="components-account-oauth-authorization-flow__panel-12"
              >
                1
              </div>
              <div class="components-account-oauth-authorization-flow__panel-4">
                <p class="components-account-oauth-authorization-flow__description-6">
                ...
                <button :aria-busy="loading"
                  ...
                  type="button"
                  :disabled="loading"
                  class="components-account-oauth-authorization-flow__action-3 btn btn-primary"
                  @click="handleGenerateUrl"
                >
<LoadingButtonContent :loading="loading" :loading-text="t('admin.accounts.oauth.generating')">
<Icon  name="link" size="sm" class="components-account-oauth-authorization-flow__icon-4" />
                  {{ oauthGenerateAuthUrl }}
</LoadingButtonContent>
                </button>
                <div v-else class="components-account-oauth-authorization-flow__panel-14">
                  <div class="components-account-oauth-authorization-flow__label-4">
                    <input
                      :value="authUrl"
                      readonly
                      type="text"
                      class="components-account-oauth-authorization-flow__field-4 input"
                    />
                    <button
                      type="button"
                      class="components-account-oauth-authorization-flow__action-4 btn btn-secondary"
                      title="Copy URL"
                      @click="handleCopyUrl"
                    >
                      <svg
                      ...
                      <Icon
                        ...
                        name="check"
                        size="sm"
                        class="components-account-oauth-authorization-flow__icon-7"
                        :stroke-width="2"
                      />
                    </button>
                  </div>
                  <button
                    type="button"
                    class="components-account-oauth-authorization-flow__action-5"
                    @click="handleRegenerate"
                  >
                    <Icon name="refresh" size="xs" class="components-account-oauth-authorization-flow__icon-8" />
          ...
          >
            <div class="components-account-oauth-authorization-flow__panel-11">
              ...
              <div class="components-account-oauth-authorization-flow__panel-4">
                ...
                <p class="components-account-oauth-authorization-flow__description-8">
                  {{ oauthOpenUrlDesc }}
                </p>
                <!-- Local callback notice -->
                <div
                  v-if="showLocalCallbackNotice"
                  class="components-account-oauth-authorization-flow__panel-15"
                >
                  <p
                    class="components-account-oauth-authorization-flow__description-9"
                ...
                <div
                  ...
                  class="components-account-oauth-authorization-flow__panel-16"
                >
                  <p
                    class="components-account-oauth-authorization-flow__description-10"
          ...
          >
            <div class="components-account-oauth-authorization-flow__panel-11">
              ...
              <div class="components-account-oauth-authorization-flow__panel-4">
                ...
                <p
                  class="components-account-oauth-authorization-flow__description"
                  v-text="oauthAuthCodeDesc"
                ></p>
                <div>
                  <label class="input-label">
                    <Icon name="key" size="sm" class="components-account-oauth-authorization-flow__icon-9" />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea
                    v-model="authCodeInput"
                    rows="3"
                    class="components-account-oauth-authorization-flow__field-5 input"
                    :placeholder="oauthAuthCodePlaceholder"
                  ></textarea>
                  <p class="components-account-oauth-authorization-flow__description-11">
                    <Icon name="infoCircle" size="xs" class="components-account-oauth-authorization-flow__icon-8" />
                    {{ oauthAuthCodeHint }}
                  </p>
                ...
                <div
                  v-if="error"
                  class="components-account-oauth-authorization-flow__panel-20"
                >
                  <p class="components-account-oauth-authorization-flow__description-3">
                    {{ error }}
                  </p>
