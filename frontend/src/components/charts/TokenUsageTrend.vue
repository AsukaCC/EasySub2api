<template>
  <div class="components-charts-token-usage-trend__panel card">
    ...
    <div
      v-else
      class="components-charts-token-usage-trend__panel-4"
    >
      ...
      callbacks: {
        ...
        footer: (tooltipItems: any) => {
          ...
          if (dataIndex !== undefined && props.trendData[dataIndex]) {
            ...
            return `Actual: ${formatPoints(data.actual_cost)} | Standard: $${formatCost(data.cost)}`
          }
          return ''
        }
      }
