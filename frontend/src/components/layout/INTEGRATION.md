...
The components use the shared semantic color tokens by default. To change:
...
- **Focus management**: Proper focus states with shared semantic focus styles
...
- Verify the shared SCSS entry point is being processed
