...
Vue 3 layout components for the EasySub2api frontend, built with Composition API, TypeScript, and semantic SCSS.
...
All components use semantic component classes and the shared SCSS entry point:
...
The sidebar uses SCSS media queries to adjust behavior responsively.
