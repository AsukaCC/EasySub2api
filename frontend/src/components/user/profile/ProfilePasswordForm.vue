<template>
  <div :class="props.embedded ? 'components-user-profile-profile-password-form__form' : 'card'">
    <div
      v-if="!props.embedded"
      class="components-user-profile-profile-password-form__panel"
    >
      <h2 class="components-user-profile-profile-password-form__heading">
        {{ t('profile.changePassword') }}
      </h2>
    </div>
    <div :class="props.embedded ? '' : 'px-6 py-6'">
      <form @submit.prevent="handleChangePassword" class="components-user-profile-profile-password-form__form">
        <div v-if="props.embedded">
          <p class="components-user-profile-profile-password-form__description">
            {{ t('profile.changePassword') }}
          </p>
        </div>
        <div>
        ...
        <div class="components-user-profile-profile-password-form__panel-2">
