<template>
  <div :class="props.embedded ? 'components-user-profile-profile-identity-bindings-section__panel-10' : 'components-user-profile-profile-identity-bindings-section__panel-11 card'">
    <div
      v-if="!props.embedded"
      class="components-user-profile-profile-identity-bindings-section__panel"
    >
      <h2 class="components-user-profile-profile-identity-bindings-section__heading">
        {{ t('profile.authBindings.title') }}
      </h2>
      <p class="components-user-profile-profile-identity-bindings-section__description">
        {{ t('profile.authBindings.description') }}
      </p>
    </div>

    <div :class="props.embedded ? 'components-user-profile-profile-identity-bindings-section__panel-10' : 'components-user-profile-profile-identity-bindings-section__panel-12'">
      <div v-if="props.embedded">
        <p class="components-user-profile-profile-identity-bindings-section__description-2">
          {{ t('profile.authBindings.title') }}
        </p>
        <p class="components-user-profile-profile-identity-bindings-section__description">
          {{ t('profile.authBindings.description') }}
      ...
      <div
        ...
        :class="rowClass"
      >
        <div class="components-user-profile-profile-identity-bindings-section__panel-2">
          <div class="components-user-profile-profile-identity-bindings-section__panel-3">
            <div
              :class="providerIconClass(item.provider)"
              class="components-user-profile-profile-identity-bindings-section__panel-4"
            >
              <Icon
                v-if="item.provider === 'email'"
                name="mail"
                size="sm"
                class="components-user-profile-profile-identity-bindings-section__icon"
              />
              <span v-else>{{ providerInitial(item.provider) }}</span>
            </div>

            <div class="components-user-profile-profile-identity-bindings-section__panel-5">
              <div class="components-user-profile-profile-identity-bindings-section__panel-6">
                <h3 class="components-user-profile-profile-identity-bindings-section__heading-2">
                  {{ item.label }}
                </h3>
                <span
              ...
              <p
                ...
                class="components-user-profile-profile-identity-bindings-section__description-3"
              >
              ...
              <div
                ...
                class="components-user-profile-profile-identity-bindings-section__panel-7"
              >
                <p
                  v-if="item.provider !== 'email' && item.details?.display_name"
                  class="components-user-profile-profile-identity-bindings-section__description-4"
                >
              ...
              <div
                ...
                class="components-user-profile-profile-identity-bindings-section__panel-8"
              >
                <input
                ...
                <button
                  ...
                  type="button"
                  class="components-user-profile-profile-identity-bindings-section__action btn btn-primary btn-sm"
                  :disabled="isBindingEmail"
                  @click="bindEmail"
                >
                  {{
          ...
          <div class="components-user-profile-profile-identity-bindings-section__panel-9">
            <button
...
const rowClass = computed(() =>
  props.embedded
    ? compact.value
      ? 'components-user-profile-profile-identity-bindings-section__state'
      : 'components-user-profile-profile-identity-bindings-section__state-2'
    : 'components-user-profile-profile-identity-bindings-section__state-3'
)
...
function providerIconClass(provider: UserAuthProvider): string {
  if (provider === 'dingtalk') {
    return 'components-user-profile-profile-identity-bindings-section__state-5'
  }
  if (provider === 'wechat') {
    return 'components-user-profile-profile-identity-bindings-section__state-6'
  }
  if (provider === 'oidc') {
    return 'components-user-profile-profile-identity-bindings-section__state-7'
  }
  return 'components-user-profile-profile-identity-bindings-section__state-8'
}
