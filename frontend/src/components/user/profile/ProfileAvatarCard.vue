<template>
  <div :class="props.embedded ? 'components-user-profile-profile-avatar-card__panel-4' : 'card'">
    <div
      v-if="!props.embedded"
      class="components-user-profile-profile-avatar-card__panel"
    >
      <h2 class="components-user-profile-profile-avatar-card__heading">
        {{ t('profile.avatar.title') }}
      </h2>
      <p class="components-user-profile-profile-avatar-card__description">
        {{ t('profile.avatar.description') }}
      </p>
    </div>

    <div :class="props.embedded ? 'components-user-profile-profile-avatar-card__panel-5' : 'components-user-profile-profile-avatar-card__panel-6'">
      <div
        :class="props.embedded
          ? 'components-user-profile-profile-avatar-card__panel-7'
          : 'components-user-profile-profile-avatar-card__panel-8'"
      >
        <img
          ...
          :alt="displayName"
          class="components-user-profile-profile-avatar-card__image"
        >
        <span v-else>{{ avatarInitial }}</span>
      </div>

      <div :class="props.embedded ? 'components-user-profile-profile-avatar-card__panel-5' : 'components-user-profile-profile-avatar-card__panel-9'">
        <div class="components-user-profile-profile-avatar-card__panel-2">
          <p v-if="props.embedded" class="components-user-profile-profile-avatar-card__description-2">
            {{ t('profile.avatar.title') }}
          </p>
          <p v-else class="components-user-profile-profile-avatar-card__description-3">
            {{ displayName }}
          </p>
          <p class="components-user-profile-profile-avatar-card__description-4">
            {{ t('profile.avatar.uploadHint') }}
          </p>
        </div>

        <div class="components-user-profile-profile-avatar-card__panel-3">
          <label class="components-user-profile-profile-avatar-card__label btn btn-secondary btn-sm">
            <input
              data-testid="profile-avatar-file-input"
              type="file"
              accept="image/*"
              class="components-user-profile-profile-avatar-card__field"
