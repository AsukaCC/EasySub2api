<template>
  <div class="components-channels-supported-model-chip__panel">
    <span
      ref="triggerEl"
      :class="[
        'components-channels-supported-model-chip__text-4',
        effectivePlatform
          ? platformBadgeClass(effectivePlatform)
          : 'components-channels-supported-model-chip__text-5',
      ]"
      @mouseenter="onEnter"
      @mouseleave="onLeave"
      @focusin="onEnter"
    ...
    >
      ...
      <span
        ...
        class="components-channels-supported-model-chip__text"
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="components-channels-supported-model-chip__panel-3"
          :class="[popoverHeaderClass, popoverBorderClass]"
        >
          <span class="components-channels-supported-model-chip__text-2">{{ model.name }}</span>
          <span
            v-if="model.platform"
            class="components-channels-supported-model-chip__text-3"
          >
            {{ model.platform }}
          </span>
        </div>

        <div class="components-channels-supported-model-chip__panel-4">
          <div v-if="!model.pricing" class="components-channels-supported-model-chip__panel-5">
            {{ noPricingLabel }}
          </div>

          <div v-else class="components-channels-supported-model-chip__panel-6">
            <div class="components-channels-supported-model-chip__panel-7">
              <span class="components-channels-supported-model-chip__panel-5">{{ t(prefixKey('billingMode')) }}</span>
            ...
            <div
              ...
              class="components-channels-supported-model-chip__panel-8"
              :class="[popoverBorderClass]"
            >
              <div class="components-channels-supported-model-chip__panel-9">
                {{ t(prefixKey('intervals')) }}
              </div>
              <div class="components-channels-supported-model-chip__panel-10">
                <div
                  v-for="(iv, idx) in model.pricing.intervals"
                  :key="idx"
                  class="components-channels-supported-model-chip__panel-11"
                >
                  <span class="components-channels-supported-model-chip__panel-5">
...
const popoverBorderClass = computed(() =>
  effectivePlatform.value
    ...
    : 'components-channels-supported-model-chip__state',
)
const popoverHeaderClass = computed(() =>
  effectivePlatform.value
    ? platformBadgeLightClass(effectivePlatform.value)
    : 'components-channels-supported-model-chip__state-2',
)
