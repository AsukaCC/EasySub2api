<template>
  <form class="components-auth-pending-oauth-create-account-form__form" @submit.prevent="handleSubmit">
    <input
      v-model="email"
      :data-testid="`${testIdPrefix}-create-account-email`"
      type="email"
      class="components-auth-pending-oauth-create-account-form__field input"
    ...
    />
    <div v-if="captchaEnabled" class="components-auth-pending-oauth-create-account-form__panel">
      <TurnstileWidget
        ref="turnstileRef"
    ...
    <div v-if="emailVerifyEnabled" class="components-auth-pending-oauth-create-account-form__panel-2">
      <input
        v-model="verifyCode"
        ...
        inputmode="numeric"
        maxlength="6"
        class="components-auth-pending-oauth-create-account-form__field-2 input"
        placeholder="123456"
        :disabled="isSubmitting"
      />
      <button
        ...
        type="button"
        class="components-auth-pending-oauth-create-account-form__action btn btn-secondary"
    ...
    <p v-if="emailVerifyEnabled && sendCodeSuccess" class="components-auth-pending-oauth-create-account-form__description">
      {{ t('auth.codeSentSuccess') }}
    </p>
    <p v-else-if="emailVerifyEnabled" class="components-auth-pending-oauth-create-account-form__description-2">
    ...
    <button
      ...
      type="button"
      class="components-auth-pending-oauth-create-account-form__field btn btn-primary"
    ...
    <button
      type="button"
      class="components-auth-pending-oauth-create-account-form__field btn btn-secondary"
      :disabled="isSubmitting"
