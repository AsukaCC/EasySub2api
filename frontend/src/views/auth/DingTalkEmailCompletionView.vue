<template>
  <AuthLayout>
    <div class="dingtalk-email-page">
      <div class="dingtalk-email-page__intro">
        <h2 class="dingtalk-email-page__title">
          {{ t('auth.dingtalk.createAccountTitle') }}
        </h2>
        <p class="dingtalk-email-page__description">
...
.dingtalk-email-page__intro {
  text-align: center;
}

.dingtalk-email-page__title {
...
.dingtalk-email-page__description {
  margin-top: 0.5rem;
