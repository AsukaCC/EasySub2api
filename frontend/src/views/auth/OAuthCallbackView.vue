  ...
  <div class="views-auth-oauth-callback-view__panel">
    <div class="views-auth-oauth-callback-view__panel-2">
      <div v-if="isProcessing" class="views-auth-oauth-callback-view__panel-3 card-body card">
        ...
        <p class="views-auth-oauth-callback-view__description">
      ...
      <div v-else-if="needsRegistrationCompletion" class="views-auth-oauth-callback-view__panel-5 card-body card">
        ...
        <div class="views-auth-oauth-callback-view__panel-6">
          <div>
            <label class="input-label">{{ t('auth.emailLabel') }}</label>
            <input
              class="views-auth-oauth-callback-view__field input"
              type="email"
          ...
          <p v-if="registrationError" class="views-auth-oauth-callback-view__description-2">
            {{ registrationError }}
          </p>
          <button
            class="views-auth-oauth-callback-view__field btn btn-primary"
            type="button"
      ...
      <div v-else-if="invalidCallback" class="views-auth-oauth-callback-view__panel-3 card-body card">
        ...
        <button class="views-auth-oauth-callback-view__action btn btn-primary" type="button" @click="router.replace('/login')">
          {{ t('auth.backToLogin') }}
        </button>
      </div>
      ...
      <div v-else class="views-auth-oauth-callback-view__panel-5 card-body card">
        ...
        <div class="views-auth-oauth-callback-view__panel-6">
          <div>
            ...
            <div class="views-auth-oauth-callback-view__panel-7">
              <input class="views-auth-oauth-callback-view__field-2 input" :value="code" readonly />
          ...
          <div>
            ...
            <div class="views-auth-oauth-callback-view__panel-7">
              <input class="views-auth-oauth-callback-view__field-2 input" :value="state" readonly />
              <button
          ...
          <div>
            ...
            <div class="views-auth-oauth-callback-view__panel-7">
              <input class="views-auth-oauth-callback-view__field-3 input" :value="fullUrl" readonly />
              <button
                class="btn btn-secondary"
                type="button"
                :disabled="!fullUrl"
