<template>
  <AuthLayout>
    <div class="views-auth-wechat-callback-view__panel">
      <div class="views-auth-wechat-callback-view__panel-2">
        <h2 class="views-auth-wechat-callback-view__heading">
          {{ t('auth.oidc.callbackTitle', { providerName }) }}
        </h2>
        <p class="views-auth-wechat-callback-view__description">
          {{
            isProcessing
      ...
      <transition name="fade">
        <div
          v-if="
            ...
            needsTotpChallenge
          "
          class="views-auth-wechat-callback-view__panel-3"
        >
          <div
            v-if="adoptionRequired && (suggestedDisplayName || suggestedAvatarUrl)"
            class="views-auth-wechat-callback-view__panel-4"
          >
            <div class="views-auth-wechat-callback-view__panel-5">
              <div class="views-auth-wechat-callback-view__panel-6">
                <p class="views-auth-wechat-callback-view__description-2">
                  {{ t('auth.oauthFlow.profileDetailsTitle', { providerName }) }}
                </p>
                <p class="views-auth-wechat-callback-view__description-3">
              ...
              <label
                ...
                class="views-auth-wechat-callback-view__label"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="views-auth-wechat-callback-view__field" />
                <span class="views-auth-wechat-callback-view__panel-6">
                  <span class="views-auth-wechat-callback-view__text">
                    {{ t('auth.oauthFlow.useDisplayName') }}
                  </span>
                  <span class="views-auth-wechat-callback-view__text-2">
              ...
              <label
                ...
                class="views-auth-wechat-callback-view__label"
              >
                <input v-model="adoptAvatar" type="checkbox" class="views-auth-wechat-callback-view__field" />
                <img
                  :src="suggestedAvatarUrl"
                  :alt="t('auth.oauthFlow.avatarAlt', { providerName })"
                  class="views-auth-wechat-callback-view__image"
                />
                <span class="views-auth-wechat-callback-view__panel-6">
                  <span class="views-auth-wechat-callback-view__text">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="views-auth-wechat-callback-view__text-3">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-if="needsInvitation">
            <p class="views-auth-wechat-callback-view__description-4">
            ...
            <div>
              <input
                ...
                type="text"
                class="views-auth-wechat-callback-view__field-2 input"
            ...
            <button
              class="views-auth-wechat-callback-view__field-2 btn btn-primary"
            ...
            >
              <div class="views-auth-wechat-callback-view__panel-5">
                ...
                <button
                  ...
                  type="button"
                  class="views-auth-wechat-callback-view__field-2 btn btn-secondary"
                  :disabled="isSubmitting"
          ...
          <template v-else-if="needsChooser">
            <div
              class="views-auth-wechat-callback-view__panel-4"
            >
              <div class="views-auth-wechat-callback-view__panel-3">
                <div class="views-auth-wechat-callback-view__panel-6">
                  <p class="views-auth-wechat-callback-view__description-2">
          ...
          <template v-else-if="needsAdoptionConfirmation">
            ...
            <button class="views-auth-wechat-callback-view__field-2 btn btn-primary" :disabled="isSubmitting" @click="handleContinueLogin">
          ...
          <template v-else-if="needsBindLogin">
            ...
            <div v-else class="views-auth-wechat-callback-view__panel-5">
              <input
