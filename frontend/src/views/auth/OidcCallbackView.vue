<template>
  <AuthLayout>
    <div class="views-auth-oidc-callback-view__panel">
      <div class="views-auth-oidc-callback-view__panel-2">
        <h2 class="views-auth-oidc-callback-view__heading">
          {{ t('auth.oidc.callbackTitle', { providerName }) }}
        </h2>
        <p class="views-auth-oidc-callback-view__description">
          {{
            isProcessing
      ...
      <transition name="fade">
        <div
          v-if="
            ...
            needsTotpChallenge
          "
          class="views-auth-oidc-callback-view__panel-3"
        >
          <div
            v-if="adoptionRequired && (suggestedDisplayName || suggestedAvatarUrl)"
            class="views-auth-oidc-callback-view__panel-4"
          >
            <div class="views-auth-oidc-callback-view__panel-5">
              <div class="views-auth-oidc-callback-view__panel-6">
                <p class="views-auth-oidc-callback-view__description-2">
                  {{ t('auth.oauthFlow.profileDetailsTitle', { providerName }) }}
                </p>
                <p class="views-auth-oidc-callback-view__description-3">
              ...
              <label
                ...
                class="views-auth-oidc-callback-view__label"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="views-auth-oidc-callback-view__field" />
                <span class="views-auth-oidc-callback-view__panel-6">
                  <span class="views-auth-oidc-callback-view__text">
                    {{ t('auth.oauthFlow.useDisplayName') }}
                  </span>
                  <span class="views-auth-oidc-callback-view__text-2">
              ...
              <label
                ...
                class="views-auth-oidc-callback-view__label"
              >
                <input v-model="adoptAvatar" type="checkbox" class="views-auth-oidc-callback-view__field" />
                <img
                  :src="suggestedAvatarUrl"
                  :alt="t('auth.oauthFlow.avatarAlt', { providerName })"
                  class="views-auth-oidc-callback-view__image"
                />
                <span class="views-auth-oidc-callback-view__panel-6">
                  <span class="views-auth-oidc-callback-view__text">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="views-auth-oidc-callback-view__text-3">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-if="needsInvitation">
            <p class="views-auth-oidc-callback-view__description-4">
            ...
            <div>
              <input
                ...
                type="text"
                class="views-auth-oidc-callback-view__field-2 input"
            ...
            <button
              class="views-auth-oidc-callback-view__field-2 btn btn-primary"
          ...
          <template v-else-if="needsAdoptionConfirmation">
            ...
            <button class="views-auth-oidc-callback-view__field-2 btn btn-primary" :disabled="isSubmitting" @click="handleContinueLogin">
              {{ isSubmitting ? t('common.processing') : t('auth.continue') }}
            </button>
          </template>

          <template v-else-if="needsChooser">
            <div class="views-auth-oidc-callback-view__panel-4">
              <div class="views-auth-oidc-callback-view__panel-3">
                <div class="views-auth-oidc-callback-view__panel-6">
                  <p class="views-auth-oidc-callback-view__description-2">
                ...
                <div class="views-auth-oidc-callback-view__panel-7">
                  <button
                    class="views-auth-oidc-callback-view__field-2 btn btn-secondary"
                    :disabled="isSubmitting"
