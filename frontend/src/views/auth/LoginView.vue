<template>
  <AuthLayout>
    <div class="views-auth-login-view__panel">
      <!-- Title -->
      <div class="views-auth-login-view__panel-2">
        <h2 class="views-auth-login-view__heading">
          {{ t('auth.welcomeBack') }}
        </h2>
        <p class="views-auth-login-view__description">
          {{ t('auth.signInToAccount') }}
        </p>
      </div>
      <!-- Login Form -->
      <form @submit.prevent="handleLogin" class="views-auth-login-view__form">
        <!-- Email Input -->
        <div>
          <label for="email" class="input-label">
            {{ t('auth.emailLabel') }}
          </label>
          <div class="views-auth-login-view__panel-3">
            <div class="views-auth-login-view__panel-4">
              <Icon name="mail" size="md" class="views-auth-login-view__icon" />
            </div>
            <input
              id="email"
              ...
              class="views-auth-login-view__field input"
        ...
        <div>
          ...
          <div class="views-auth-login-view__panel-3">
            <div class="views-auth-login-view__panel-4">
              <Icon name="lock" size="md" class="views-auth-login-view__icon" />
            </div>
            <input
              id="password"
              ...
              :disabled="authActionDisabled"
              class="views-auth-login-view__field-2 input"
            ...
            <button
              ...
              :disabled="authActionDisabled"
              class="views-auth-login-view__action"
            >
              <Icon v-if="showPassword" name="eyeOff" size="md" />
              <Icon v-else name="eye" size="md" />
            </button>
          </div>
          <div class="views-auth-login-view__panel-5">
            <span></span>
            <router-link
              v-if="passwordResetEnabled && !backendModeEnabled"
              to="/forgot-password"
              class="views-auth-login-view__router-link"
            >
        ...
        <button
          ...
          class="views-auth-login-view__action-2 btn btn-primary"
        >
          <svg
            v-if="isLoading"
            class="views-auth-login-view__icon-2"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
              class="views-auth-login-view__circle"
              cx="12"
              cy="12"
              r="10"
              stroke="currentColor"
            ...
            ></circle>
            <path
              class="views-auth-login-view__path"
              fill="currentColor"
              d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
            ></path>
          </svg>
          <Icon v-else name="login" size="md" class="views-auth-login-view__icon-3" />
        ...
        <div v-if="showPasskeyLogin || showOAuthLogin" class="views-auth-login-view__panel-6">
          <div class="views-auth-login-view__panel-7">
            <div class="views-auth-login-view__panel-8"></div>
            <span class="views-auth-login-view__text">
          ...
          <button
            ...
            type="button"
            class="views-auth-login-view__action-2 btn btn-secondary"
            :disabled="authActionDisabled"
            @click="handlePasskeyLogin"
          >
            <Icon name="key" size="md" class="views-auth-login-view__icon-3" />
    ...
    <template v-if="!backendModeEnabled" #footer>
      <p class="views-auth-login-view__description-2">
        {{ t('auth.dontHaveAccount') }}
        <router-link
          to="/register"
          class="views-auth-login-view__router-link-2"
        >
          {{ t('auth.signUp') }}
        </router-link>
      </p>
