<template>
  <AuthLayout>
    <div class="views-auth-register-view__panel">
      <!-- Title -->
      <div class="views-auth-register-view__panel-2">
        <h2 class="views-auth-register-view__heading">
          {{ t('auth.createAccount') }}
        </h2>
        <p class="views-auth-register-view__description">
      ...
      <div
        ...
        class="views-auth-register-view__panel-3"
      >
        <div class="views-auth-register-view__panel-4">
          <div class="views-auth-register-view__panel-5">
            <Icon name="exclamationCircle" size="md" class="views-auth-register-view__icon" />
          </div>
          <p class="views-auth-register-view__description-2">
      ...
      <!-- Registration Form -->
      <form v-else @submit.prevent="handleRegister" class="views-auth-register-view__form">
        <!-- Email Input -->
        <div>
          ...
          <div class="views-auth-register-view__panel-6">
            <div class="views-auth-register-view__panel-7">
              <Icon name="mail" size="md" class="views-auth-register-view__icon-2" />
            </div>
            <input
              id="email"
        ...
        <div>
          ...
          <div class="views-auth-register-view__panel-6">
            <div class="views-auth-register-view__panel-7">
              <Icon name="lock" size="md" class="views-auth-register-view__icon-2" />
            </div>
            <input
              id="password"
              ...
              :disabled="registrationActionDisabled"
              class="views-auth-register-view__field-2 input"
            ...
            <button
              ...
              class="views-auth-register-view__action"
            >
        ...
        <div v-if="promoCodeEnabled">
          ...
          <div class="views-auth-register-view__panel-6">
            <div class="views-auth-register-view__panel-7">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'views-auth-register-view__icon-4' : 'views-auth-register-view__icon-2'" />
            </div>
            <input
              id="promo_code"
              ...
              :class="{
                'views-auth-register-view__field-4': promoValidation.valid,
                'views-auth-register-view__field-5': promoValidation.invalid
              }"
            ...
            <div v-else-if="promoValidation.invalid" class="views-auth-register-view__panel-8">
              <Icon name="exclamationCircle" size="md" class="views-auth-register-view__icon-5" />
            </div>
          </div>
          <!-- Promo code validation result -->
          <transition name="fade">
            <div v-if="promoValidation.valid" class="views-auth-register-view__panel-9">
              <Icon name="gift" size="sm" class="views-auth-register-view__icon-6" />
              <span class="views-auth-register-view__text">
                {{ t('auth.promoCodeValid', { amount: formatPoints(promoValidation.bonusAmount) }) }}
              </span>
            </div>
          </transition>
        </div>
      ...
      <div v-if="showOAuthLogin" class="views-auth-register-view__panel-10">
        <div class="views-auth-register-view__panel-11">
          <div class="views-auth-register-view__panel-12"></div>
          <span class="views-auth-register-view__text-3">
    ...
    <!-- Footer -->
    <template #footer>
      <p class="views-auth-register-view__description-3">
        {{ t('auth.alreadyHaveAccount') }}
        <router-link
          to="/login"
          class="views-auth-register-view__router-link"
        >
          {{ t('auth.signIn') }}
        </router-link>
      </p>
...
const LOGIN_AGREEMENT_STORAGE_KEY = 'easysub2api_login_agreement_consent'
