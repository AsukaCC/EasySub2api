  ...
  <div class="views-auth-wechat-payment-callback-view__panel">
    <div class="views-auth-wechat-payment-callback-view__panel-2">
      <div class="views-auth-wechat-payment-callback-view__panel-3 card">
        ...
        <p class="views-auth-wechat-payment-callback-view__description">
          {{ errorMessage || callbackProcessingText }}
        </p>

        <div
          v-if="!errorMessage"
          class="views-auth-wechat-payment-callback-view__panel-4"
        >
          <div
            class="views-auth-wechat-payment-callback-view__panel-5"
          ></div>
        </div>

        <div
          v-else
          class="views-auth-wechat-payment-callback-view__panel-6"
        >
          <p class="views-auth-wechat-payment-callback-view__description-2">
            {{ errorMessage }}
          </p>
          <button
            class="views-auth-wechat-payment-callback-view__action btn btn-primary"
            type="button"
