...
export function getSeverityClass(severity: OpsSeverity): string {
  const classes: Record<string, string> = {
    P0: 'views-admin-ops-utils-ops-formatters__state',
    P1: 'views-admin-ops-utils-ops-formatters__state-2',
    P2: 'views-admin-ops-utils-ops-formatters__state-3',
    P3: 'views-admin-ops-utils-ops-formatters__state-4'
  }
