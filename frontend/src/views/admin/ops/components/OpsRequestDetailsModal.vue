      ...
      <div class="views-admin-ops-components-ops-request-details-modal__panel">
        ...
        <div v-if="loading" class="views-admin-ops-components-ops-request-details-modal__panel-4">
          <div class="views-admin-ops-components-ops-request-details-modal__panel-5">
            <svg class="views-admin-ops-components-ops-request-details-modal__icon" fill="none" viewBox="0 0 24 24">
              <circle class="views-admin-ops-components-ops-request-details-modal__circle" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path
                class="views-admin-ops-components-ops-request-details-modal__path"
                fill="currentColor"
