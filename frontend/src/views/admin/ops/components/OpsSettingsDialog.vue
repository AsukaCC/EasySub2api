...
<template>
  <BaseDialog :show="show" :title="t('admin.ops.settings.title')" width="extra-wide" @close="emit('close')">
    <div v-if="loading" class="views-admin-ops-components-ops-settings-dialog__panel">
      {{ t('common.loading') }}
    </div>

    <div v-else-if="runtimeSettings && emailConfig && advancedSettings" class="views-admin-ops-components-ops-settings-dialog__panel-2">
      <!-- 验证错误 -->
      <div v-if="!validation.valid" class="views-admin-ops-components-ops-settings-dialog__panel-3">
        <div class="views-admin-ops-components-ops-settings-dialog__panel-4">{{ t('admin.ops.settings.validation.title') }}</div>
        <ul class="views-admin-ops-components-ops-settings-dialog__list">
          <li v-for="msg in validation.errors" :key="msg">{{ msg }}</li>
        </ul>
      </div>

      <!-- 数据采集频率 -->
      <div class="views-admin-ops-components-ops-settings-dialog__panel-5">
        <h4 class="views-admin-ops-components-ops-settings-dialog__heading">{{ t('admin.ops.settings.dataCollection') }}</h4>
        <div>
          ...
          <input
            ...
            class="input"
          />
          <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.evaluationIntervalHint') }}</p>
        </div>
      </div>

      <!-- 预警配置 -->
      <div class="views-admin-ops-components-ops-settings-dialog__panel-5">
        <h4 class="views-admin-ops-components-ops-settings-dialog__heading">{{ t('admin.ops.settings.alertConfig') }}</h4>

        <div class="views-admin-ops-components-ops-settings-dialog__panel-6">
          <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
            <div>
              <label class="views-admin-ops-components-ops-settings-dialog__label">{{ t('admin.ops.settings.enableAlert') }}</label>
            </div>
          ...
          <div v-if="emailConfig.alert.enabled">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-8">
              <input
              ...
              />
              <button class="views-admin-ops-components-ops-settings-dialog__action btn btn-secondary" type="button" @click="addRecipient('alert')">
                {{ t('common.add') }}
              </button>
            </div>
            <div class="views-admin-ops-components-ops-settings-dialog__panel-9">
              <span
                v-for="email in emailConfig.alert.recipients"
                :key="email"
                class="views-admin-ops-components-ops-settings-dialog__text"
              >
                {{ email }}
                <button type="button" class="views-admin-ops-components-ops-settings-dialog__action-2" @click="removeRecipient('alert', email)">×</button>
              </span>
            </div>
            <p class="views-admin-ops-components-ops-settings-dialog__description-2">
      ...
      <!-- 评估报告配置 -->
      <div class="views-admin-ops-components-ops-settings-dialog__panel-5">
        <h4 class="views-admin-ops-components-ops-settings-dialog__heading">{{ t('admin.ops.settings.reportConfig') }}</h4>

        <div class="views-admin-ops-components-ops-settings-dialog__panel-6">
          <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
            <div>
              <label class="views-admin-ops-components-ops-settings-dialog__label">{{ t('admin.ops.settings.enableReport') }}</label>
            </div>
          ...
          <div v-if="emailConfig.report.enabled">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-8">
              ...
              />
              <button class="views-admin-ops-components-ops-settings-dialog__action btn btn-secondary" type="button" @click="addRecipient('report')">
                {{ t('common.add') }}
              </button>
            </div>
            <div class="views-admin-ops-components-ops-settings-dialog__panel-9">
              ...
              >
                {{ email }}
                <button type="button" class="views-admin-ops-components-ops-settings-dialog__action-2" @click="removeRecipient('report', email)">×</button>
              </span>
            </div>
            <p class="views-admin-ops-components-ops-settings-dialog__description-2">
              {{ t('admin.ops.settings.recipientsHint') }}
          ...
          <div v-if="emailConfig.report.enabled" class="views-admin-ops-components-ops-settings-dialog__panel-10">
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.dailySummary') }}</label>
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.weeklySummary') }}</label>
      ...
      <!-- 指标阈值配置 -->
      <div class="views-admin-ops-components-ops-settings-dialog__panel-5">
        <h4 class="views-admin-ops-components-ops-settings-dialog__heading">{{ t('admin.ops.settings.metricThresholds') }}</h4>
        <p class="views-admin-ops-components-ops-settings-dialog__description-3">{{ t('admin.ops.settings.metricThresholdsHint') }}</p>
        ...
        <div class="views-admin-ops-components-ops-settings-dialog__panel-6">
          <div>
            ...
            <input
              ...
              class="input"
            />
            <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.slaMinPercentHint') }}</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              class="input"
            />
            <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.ttftP99MaxMsHint') }}</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              class="input"
            />
            <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.requestErrorRateMaxPercentHint') }}</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              class="input"
            />
            <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.upstreamErrorRateMaxPercentHint') }}</p>
          </div>
        </div>
      </div>

      <!-- 高级设置 -->
      <details class="views-admin-ops-components-ops-settings-dialog__details">
        <summary class="views-admin-ops-components-ops-settings-dialog__summary">
          {{ t('admin.ops.settings.advancedSettings') }}
        </summary>
        <div class="views-admin-ops-components-ops-settings-dialog__panel-11">
          <!-- 数据保留策略 -->
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.dataRetention') }}</h5>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.enableCleanup') }}</label>
            ...
            <div v-if="advancedSettings.data_retention.cleanup_enabled">
              ...
              <input
                ...
                placeholder="0 2 * * *"
              />
              <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.cleanupScheduleHint') }}</p>
            </div>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-13">
              <div>
            ...
            <p class="views-admin-ops-components-ops-settings-dialog__description-4">{{ t('admin.ops.settings.retentionDaysHint') }}</p>
          </div>

          <!-- 预聚合任务 -->
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.aggregation') }}</h5>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.enableAggregation') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">{{ t('admin.ops.settings.aggregationHint') }}</p>
              </div>
          ...
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.openaiQuotaAutoPause') }}</h5>
            <p class="views-admin-ops-components-ops-settings-dialog__description-4">{{ t('admin.ops.settings.openaiQuotaAutoPauseHint') }}</p>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-10">
              <div>
            ...
            <p class="views-admin-ops-components-ops-settings-dialog__description-4">{{ t('admin.ops.settings.openaiQuotaAutoPauseThresholdHint') }}</p>
          </div>

          <!-- Error Filtering -->
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.errorFiltering') }}</h5>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.ignoreCountTokensErrors') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.ignoreContextCanceled') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.ignoreNoAvailableAccounts') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.ignoreInsufficientBalanceErrors') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
          ...
          <!-- Auto Refresh -->
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.autoRefresh') }}</h5>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.enableAutoRefresh') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
          ...
          <!-- Dashboard Cards -->
          <div class="views-admin-ops-components-ops-settings-dialog__panel-12">
            <h5 class="views-admin-ops-components-ops-settings-dialog__h5">{{ t('admin.ops.settings.dashboardCards') }}</h5>

            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.displayAlertEvents') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
            ...
            <div class="views-admin-ops-components-ops-settings-dialog__panel-7">
              <div>
                <label class="views-admin-ops-components-ops-settings-dialog__label-2">{{ t('admin.ops.settings.displayOpenAITokenStats') }}</label>
                <p class="views-admin-ops-components-ops-settings-dialog__description">
    ...
    <template #footer>
      <div class="views-admin-ops-components-ops-settings-dialog__panel-14">
