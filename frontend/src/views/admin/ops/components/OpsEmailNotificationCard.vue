...
<template>
  <div class="views-admin-ops-components-ops-email-notification-card__panel card-body">
    <div class="views-admin-ops-components-ops-email-notification-card__panel-2">
      <div>
        ...
        <p class="views-admin-ops-components-ops-email-notification-card__description">{{ t('admin.ops.email.description') }}</p>
      </div>
      <div class="views-admin-ops-components-ops-email-notification-card__panel-3">
        <button
          class="views-admin-ops-components-ops-email-notification-card__action"
          :disabled="loading"
          @click="loadConfig"
        >
          <svg class="views-admin-ops-components-ops-email-notification-card__icon" :class="{ 'views-admin-ops-components-ops-email-notification-card__icon-2': loading }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div v-if="!config" class="views-admin-ops-components-ops-email-notification-card__panel-4">
      <span v-if="loading">{{ t('admin.ops.email.loading') }}</span>
      <span v-else>{{ t('admin.ops.email.noData') }}</span>
    </div>

    <div v-else class="views-admin-ops-components-ops-email-notification-card__panel-5">
      <div class="views-admin-ops-components-ops-email-notification-card__panel-6">
        <h4 class="views-admin-ops-components-ops-email-notification-card__heading-2">{{ t('admin.ops.email.alertTitle') }}</h4>
        <div class="views-admin-ops-components-ops-email-notification-card__panel-7">
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
            {{ t('common.enabled') }}:
            <span class="views-admin-ops-components-ops-email-notification-card__text">
              {{ config.alert.enabled ? t('common.enabled') : t('common.disabled') }}
            </span>
          </div>
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
            {{ t('admin.ops.email.recipients') }}:
            <span class="views-admin-ops-components-ops-email-notification-card__text">{{ config.alert.recipients.length }}</span>
          </div>
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
          ...
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
            ...
            <span class="views-admin-ops-components-ops-email-notification-card__text">{{ config.alert.rate_limit_per_hour }}</span>
          </div>
        </div>
      </div>

      <div class="views-admin-ops-components-ops-email-notification-card__panel-6">
        <h4 class="views-admin-ops-components-ops-email-notification-card__heading-2">{{ t('admin.ops.email.reportTitle') }}</h4>
        <div class="views-admin-ops-components-ops-email-notification-card__panel-7">
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
            {{ t('common.enabled') }}:
            <span class="views-admin-ops-components-ops-email-notification-card__text">
          ...
          <div class="views-admin-ops-components-ops-email-notification-card__panel-8">
            {{ t('admin.ops.email.recipients') }}:
            <span class="views-admin-ops-components-ops-email-notification-card__text">{{ config.report.recipients.length }}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <BaseDialog :show="showEditor" :title="t('admin.ops.email.title')" width="extra-wide" @close="showEditor = false">
    <div v-if="draft" class="views-admin-ops-components-ops-email-notification-card__panel-5">
      <div
        v-if="!editorValidation.valid"
        class="views-admin-ops-components-ops-email-notification-card__panel-9"
      >
        <div class="views-admin-ops-components-ops-email-notification-card__panel-10">{{ t('admin.ops.email.validation.title') }}</div>
        <ul class="views-admin-ops-components-ops-email-notification-card__list">
          <li v-for="msg in editorValidation.errors" :key="msg">{{ msg }}</li>
        </ul>
      </div>
      <div class="views-admin-ops-components-ops-email-notification-card__panel-6">
        <h4 class="views-admin-ops-components-ops-email-notification-card__heading-3">{{ t('admin.ops.email.alertTitle') }}</h4>
        <div class="views-admin-ops-components-ops-email-notification-card__panel-11">
          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('common.enabled') }}</div>
            <label class="views-admin-ops-components-ops-email-notification-card__label">
              <input v-model="draft.alert.enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
              <span>{{ draft.alert.enabled ? t('common.enabled') : t('common.disabled') }}</span>
            </label>
          </div>

          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.minSeverity') }}</div>
            <Select v-model="draft.alert.min_severity" :options="severityOptions" />
          </div>

          <div class="views-admin-ops-components-ops-email-notification-card__panel-13">
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.recipients') }}</div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-14">
              <input
              ...
              />
              <button class="views-admin-ops-components-ops-email-notification-card__action-2 btn btn-secondary" type="button" @click="addRecipient('alert')">
                {{ t('common.add') }}
              </button>
            </div>
            <p v-if="alertRecipientError" class="views-admin-ops-components-ops-email-notification-card__description-2">{{ alertRecipientError }}</p>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-15">
              <span
                v-for="email in draft.alert.recipients"
                :key="email"
                class="views-admin-ops-components-ops-email-notification-card__text-2"
              >
                {{ email }}
                <button
                  type="button"
                  class="views-admin-ops-components-ops-email-notification-card__action-3"
            ...
            <div class="views-admin-ops-components-ops-email-notification-card__description">{{ t('admin.ops.email.recipientsHint') }}</div>
          </div>

          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.rateLimitPerHour') }}</div>
            <input v-model.number="draft.alert.rate_limit_per_hour" type="number" min="0" max="100000" class="input" />
          </div>

          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.batchWindowSeconds') }}</div>
            <input v-model.number="draft.alert.batching_window_seconds" type="number" min="0" max="86400" class="input" />
          </div>

          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.includeResolved') }}</div>
            <label class="views-admin-ops-components-ops-email-notification-card__label">
              <input v-model="draft.alert.include_resolved_alerts" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
      ...
      <div class="views-admin-ops-components-ops-email-notification-card__panel-6">
        <h4 class="views-admin-ops-components-ops-email-notification-card__heading-3">{{ t('admin.ops.email.reportTitle') }}</h4>
        <div class="views-admin-ops-components-ops-email-notification-card__panel-11">
          <div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('common.enabled') }}</div>
            <label class="views-admin-ops-components-ops-email-notification-card__label">
              <input v-model="draft.report.enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
          ...
          <div class="views-admin-ops-components-ops-email-notification-card__panel-13">
            ...
            <div class="views-admin-ops-components-ops-email-notification-card__panel-14">
              ...
              />
              <button class="views-admin-ops-components-ops-email-notification-card__action-2 btn btn-secondary" type="button" @click="addRecipient('report')">
                {{ t('common.add') }}
              </button>
            </div>
            <p v-if="reportRecipientError" class="views-admin-ops-components-ops-email-notification-card__description-2">{{ reportRecipientError }}</p>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-15">
              <span
          ...
          <div class="views-admin-ops-components-ops-email-notification-card__panel-13">
            <div class="views-admin-ops-components-ops-email-notification-card__panel-11">
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.dailySummary') }}</div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-3">
                  <label class="views-admin-ops-components-ops-email-notification-card__label">
                    <input v-model="draft.report.daily_summary_enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
                  </label>
                  <input v-model="draft.report.daily_summary_schedule" type="text" class="input" :placeholder="t('admin.ops.email.cronPlaceholder')" />
                </div>
              </div>
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.weeklySummary') }}</div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-3">
                  <label class="views-admin-ops-components-ops-email-notification-card__label">
                    <input v-model="draft.report.weekly_summary_enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
                  </label>
                  <input v-model="draft.report.weekly_summary_schedule" type="text" class="input" :placeholder="t('admin.ops.email.cronPlaceholder')" />
                </div>
              </div>
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.errorDigest') }}</div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-3">
                  <label class="views-admin-ops-components-ops-email-notification-card__label">
                    <input v-model="draft.report.error_digest_enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
                  </label>
                  <input v-model="draft.report.error_digest_schedule" type="text" class="input" :placeholder="t('admin.ops.email.cronPlaceholder')" />
                </div>
              </div>
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.errorDigestMinCount') }}</div>
                <input v-model.number="draft.report.error_digest_min_count" type="number" min="0" max="1000000" class="input" />
              </div>
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.accountHealth') }}</div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-3">
                  <label class="views-admin-ops-components-ops-email-notification-card__label">
                    <input v-model="draft.report.account_health_enabled" type="checkbox" class="views-admin-ops-components-ops-email-notification-card__field" />
                  </label>
                  <input v-model="draft.report.account_health_schedule" type="text" class="input" :placeholder="t('admin.ops.email.cronPlaceholder')" />
                </div>
              </div>
              <div>
                <div class="views-admin-ops-components-ops-email-notification-card__panel-12">{{ t('admin.ops.email.accountHealthThreshold') }}</div>
                <input v-model.number="draft.report.account_health_error_rate_threshold" type="number" min="0" max="100" step="0.1" class="input" />
              </div>
            </div>
            <div class="views-admin-ops-components-ops-email-notification-card__panel-16">{{ t('admin.ops.email.reportHint') }}</div>
          </div>
        </div>
      </div>
    </div>
    <template #footer>
      <div class="views-admin-ops-components-ops-email-notification-card__panel-17">
