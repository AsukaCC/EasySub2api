...
interface Emits {
  ...
  (e: 'update:group', value: string | null): void
...
function getThresholdColorClass(level: ThresholdLevel): string {
  switch (level) {
    case 'critical':
      return 'views-admin-ops-components-ops-dashboard-header__state'
    case 'warning':
      return 'views-admin-ops-components-ops-dashboard-header__state-2'
    default:
      return 'views-admin-ops-components-ops-dashboard-header__state-3'
  }
}
...
const healthScoreClass = computed(() => {
  if (isSystemIdle.value) return 'status-text--neutral'
  const score = healthScoreValue.value
  if (score == null) return 'status-text--neutral'
  if (score >= 90) return 'status-text--success'
  if (score >= 60) return 'status-text--warning'
...
const cpuPercentClass = computed(() => {
  ...
  if (v == null) return 'views-admin-ops-components-ops-dashboard-header__state-4'
  if (v >= 95) return 'views-admin-ops-components-ops-dashboard-header__state-5'
  if (v >= 80) return 'views-admin-ops-components-ops-dashboard-header__state-2'
  return 'views-admin-ops-components-ops-dashboard-header__state-6'
})
...
const memPercentClass = computed(() => {
  ...
  if (v == null) return 'views-admin-ops-components-ops-dashboard-header__state-4'
  if (v >= 95) return 'views-admin-ops-components-ops-dashboard-header__state-5'
  if (v >= 85) return 'views-admin-ops-components-ops-dashboard-header__state-2'
  return 'views-admin-ops-components-ops-dashboard-header__state-6'
})
...
const dbMiddleClass = computed(() => {
  if (systemMetrics.value?.db_ok === false) return 'views-admin-ops-components-ops-dashboard-header__state-5'
  if (dbUsagePercent.value != null) {
    if (dbUsagePercent.value >= 90) return 'views-admin-ops-components-ops-dashboard-header__state-5'
    if (dbUsagePercent.value >= 70) return 'views-admin-ops-components-ops-dashboard-header__state-2'
    return 'views-admin-ops-components-ops-dashboard-header__state-6'
  }
  if (systemMetrics.value?.db_ok === true) return 'views-admin-ops-components-ops-dashboard-header__state-6'
  return 'views-admin-ops-components-ops-dashboard-header__state-4'
})
...
const redisMiddleClass = computed(() => {
  if (systemMetrics.value?.redis_ok === false) return 'views-admin-ops-components-ops-dashboard-header__state-5'
  if (redisUsagePercent.value != null) {
    if (redisUsagePercent.value >= 90) return 'views-admin-ops-components-ops-dashboard-header__state-5'
    if (redisUsagePercent.value >= 70) return 'views-admin-ops-components-ops-dashboard-header__state-2'
    return 'views-admin-ops-components-ops-dashboard-header__state-6'
  }
  if (systemMetrics.value?.redis_ok === true) return 'views-admin-ops-components-ops-dashboard-header__state-6'
  return 'views-admin-ops-components-ops-dashboard-header__state-4'
})
...
const goroutineStatusClass = computed(() => {
  switch (goroutineStatus.value) {
    ...
    case 'warning':
      return 'views-admin-ops-components-ops-dashboard-header__state-2'
    case 'critical':
      return 'views-admin-ops-components-ops-dashboard-header__state-5'
    default:
      return 'views-admin-ops-components-ops-dashboard-header__state-4'
  }
})
  ...
  <div :class="['views-admin-ops-components-ops-dashboard-header__panel-64', props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__panel-65' : 'views-admin-ops-components-ops-dashboard-header__panel-66 card-body']">
    ...
    <div class="views-admin-ops-components-ops-dashboard-header__panel">
      <div>
        ...
        <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-2">
          <span class="views-admin-ops-components-ops-dashboard-header__text" :title="props.loading ? t('admin.ops.loadingText') : t('admin.ops.ready')">
            <span class="views-admin-ops-components-ops-dashboard-header__text-2">
              <span class="views-admin-ops-components-ops-dashboard-header__text-3" :class="props.loading ? 'views-admin-ops-components-ops-dashboard-header__text-17' : 'views-admin-ops-components-ops-dashboard-header__text-18'"></span>
            </span>
      ...
      <div class="views-admin-ops-components-ops-dashboard-header__panel-3">
        <template v-if="!props.fullscreen">
          <Select
            :model-value="platform"
            :options="platformOptions"
            class="views-admin-ops-components-ops-dashboard-header__field"
          ...
          <Select
            ...
            class="views-admin-ops-components-ops-dashboard-header__field-2"
            @update:model-value="handleGroupChange"
          />

          <div class="views-admin-ops-components-ops-dashboard-header__panel-4"></div>

          <Select
            :model-value="timeRange"
            :options="timeRangeOptions"
            class="views-admin-ops-components-ops-dashboard-header__field-3"
        ...
        <Select
          ...
          class="views-admin-ops-components-ops-dashboard-header__field-4"
        ...
        <button
          ...
          type="button"
          class="views-admin-ops-components-ops-dashboard-header__action"
          :disabled="loading"
          :title="t('common.refresh')"
          @click="handleToolbarRefresh"
        >
          <svg class="views-admin-ops-components-ops-dashboard-header__icon-2" :class="{ 'views-admin-ops-components-ops-dashboard-header__icon-9': loading }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"
        ...
        <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-4"></div>

        <!-- Alert Rules Button (hidden in fullscreen) -->
        <button
          v-if="!props.fullscreen"
          type="button"
          class="views-admin-ops-components-ops-dashboard-header__action-2"
          :title="t('admin.ops.alertRules.title')"
          @click="emit('openAlertRules')"
        >
          <svg class="views-admin-ops-components-ops-dashboard-header__icon-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
          </svg>
          <span class="views-admin-ops-components-ops-dashboard-header__text-4">{{ t('admin.ops.alertRules.manage') }}</span>
        </button>
        ...
        <button
          v-if="!props.fullscreen"
          type="button"
          class="views-admin-ops-components-ops-dashboard-header__action-3"
        ...
        >
          ...
          <span class="views-admin-ops-components-ops-dashboard-header__text-4">{{ t('common.settings') }}</span>
        </button>
        ...
        <button
          v-if="!props.fullscreen"
          type="button"
          class="views-admin-ops-components-ops-dashboard-header__action-4"
    ...
    <div v-if="overview && !props.compact" class="views-admin-ops-components-ops-dashboard-header__panel-5">
      ...
      <div :class="['views-admin-ops-components-ops-dashboard-header__panel-67', props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__panel-66 card-body' : 'views-admin-ops-components-ops-dashboard-header__panel-68']">
        <div class="views-admin-ops-components-ops-dashboard-header__panel-6">
          <!-- 1) Health Score -->
          <div
            class="views-admin-ops-components-ops-dashboard-header__panel-7"
          >
            <!-- Diagnosis Popover (hover) -->
            <div
              class="views-admin-ops-components-ops-dashboard-header__panel-8"
            >
              <div class="views-admin-ops-components-ops-dashboard-header__panel-9">
                <h4 class="views-admin-ops-components-ops-dashboard-header__heading-2">
                  <Icon name="brain" size="sm" class="views-admin-ops-components-ops-dashboard-header__icon-3" />
                  {{ t('admin.ops.diagnosis.title') }}
                </h4>

                <div class="views-admin-ops-components-ops-dashboard-header__panel-10">
                  <div v-for="(item, idx) in diagnosisReport" :key="idx" class="views-admin-ops-components-ops-dashboard-header__panel-11">
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-12">
                      <svg v-if="item.type === 'critical'" class="views-admin-ops-components-ops-dashboard-header__icon-4" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          fill-rule="evenodd"
                      ...
                      <svg v-else-if="item.type === 'warning'" class="views-admin-ops-components-ops-dashboard-header__icon-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          fill-rule="evenodd"
                      ...
                      <svg v-else class="views-admin-ops-components-ops-dashboard-header__icon-6" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          fill-rule="evenodd"
                    ...
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-13">
                      <div class="views-admin-ops-components-ops-dashboard-header__panel-14">{{ item.message }}</div>
                      <div class="views-admin-ops-components-ops-dashboard-header__panel-15">{{ item.impact }}</div>
                      <div v-if="item.action" class="views-admin-ops-components-ops-dashboard-header__panel-16">
                ...
                <div class="views-admin-ops-components-ops-dashboard-header__panel-17">
                  {{ t('admin.ops.diagnosis.footer') }}
                </div>
              </div>
            </div>

            <div class="views-admin-ops-components-ops-dashboard-header__panel-18">
              <svg :width="circleSize" :height="circleSize" class="views-admin-ops-components-ops-dashboard-header__icon-7">
                <circle
                  :cx="circleSize / 2"
                  :cy="circleSize / 2"
                  :r="radius"
                  ...
                  fill="transparent"
                  class="views-admin-ops-components-ops-dashboard-header__circle"
                  stroke="currentColor"
                />
                <circle
                  :cx="circleSize / 2"
                  ...
                  class="views-admin-ops-components-ops-dashboard-header__circle-2"
                />
              </svg>

              <div class="views-admin-ops-components-ops-dashboard-header__panel-19">
                <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-19' : 'views-admin-ops-components-ops-dashboard-header__text-20', 'views-admin-ops-components-ops-dashboard-header__text-21', healthScoreClass]">
                  {{ isSystemIdle ? t('admin.ops.idleStatus') : (overview.health_score ?? '--') }}
                </span>
                <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-8' : 'views-admin-ops-components-ops-dashboard-header__text-22', 'views-admin-ops-components-ops-dashboard-header__text-23']">{{ t('admin.ops.health') }}</span>
              </div>
            </div>

            <div class="views-admin-ops-components-ops-dashboard-header__panel-20" v-if="!props.fullscreen">
              <div class="views-admin-ops-components-ops-dashboard-header__panel-21">
                {{ t('admin.ops.healthCondition') }}
                <HelpTooltip :content="t('admin.ops.healthHelp')" />
              </div>
              <div class="views-admin-ops-components-ops-dashboard-header__panel-22" :class="healthScoreClass">
                {{
                  isSystemIdle
          ...
          <!-- 2) Realtime Traffic -->
          <div class="views-admin-ops-components-ops-dashboard-header__panel-23">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-24">
              <div class="views-admin-ops-components-ops-dashboard-header__panel-25">
                <div class="views-admin-ops-components-ops-dashboard-header__panel-26">
                  <span class="views-admin-ops-components-ops-dashboard-header__text-5"></span>
                  <span class="views-admin-ops-components-ops-dashboard-header__text-6"></span>
                </div>
                <h3 class="views-admin-ops-components-ops-dashboard-header__heading-3">{{ t('admin.ops.realtime.title') }}</h3>
                <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.qps')" />
              </div>

              <!-- Time Window Selector -->
              <div class="views-admin-ops-components-ops-dashboard-header__panel-27">
                <button
                  v-for="window in availableRealtimeWindows"
                  :key="window"
                  type="button"
                  class="views-admin-ops-components-ops-dashboard-header__action-5"
                  :class="realtimeWindow === window
                    ? 'views-admin-ops-components-ops-dashboard-header__action-9'
                    : 'views-admin-ops-components-ops-dashboard-header__action-10'"
            ...
            <div :class="props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__panel-62' : 'views-admin-ops-components-ops-dashboard-header__panel-10'">
              <!-- Row 1: Current -->
              <div>
                <div :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-8' : 'views-admin-ops-components-ops-dashboard-header__text-22', 'views-admin-ops-components-ops-dashboard-header__panel-69']">{{ t('admin.ops.current') }}</div>
                <div class="views-admin-ops-components-ops-dashboard-header__panel-28">
                  <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                    <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-24' : 'views-admin-ops-components-ops-dashboard-header__text-25', 'views-admin-ops-components-ops-dashboard-header__text-7']">{{ displayRealTimeQps.toFixed(1) }}</span>
                    <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-26' : 'views-admin-ops-components-ops-dashboard-header__text-8', 'views-admin-ops-components-ops-dashboard-header__text-27']">QPS</span>
                  </div>
                  <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                    <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-24' : 'views-admin-ops-components-ops-dashboard-header__text-25', 'views-admin-ops-components-ops-dashboard-header__text-7']">{{ displayRealTimeTps.toFixed(1) }}</span>
                    <span :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-26' : 'views-admin-ops-components-ops-dashboard-header__text-8', 'views-admin-ops-components-ops-dashboard-header__text-27']">{{ t('admin.ops.tps') }}</span>
                  </div>
                </div>
              </div>

              <!-- Row 2: Peak + Average -->
              <div class="views-admin-ops-components-ops-dashboard-header__panel-30">
                <!-- Peak -->
                <div>
                  <div :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-8' : 'views-admin-ops-components-ops-dashboard-header__text-22', 'views-admin-ops-components-ops-dashboard-header__panel-69']">{{ t('admin.ops.peak') }}</div>
                  <div :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__panel-70' : 'views-admin-ops-components-ops-dashboard-header__text-26', 'views-admin-ops-components-ops-dashboard-header__panel-71']">
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                      <span class="views-admin-ops-components-ops-dashboard-header__text-7">{{ realtimeQpsPeakLabel }}</span>
                      <span class="views-admin-ops-components-ops-dashboard-header__text-8">QPS</span>
                    </div>
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                      <span class="views-admin-ops-components-ops-dashboard-header__text-7">{{ realtimeTpsPeakLabel }}</span>
                      <span class="views-admin-ops-components-ops-dashboard-header__text-8">{{ t('admin.ops.tps') }}</span>
                    </div>
                  </div>
                </div>
                ...
                <!-- Average -->
                <div>
                  <div :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__text-8' : 'views-admin-ops-components-ops-dashboard-header__text-22', 'views-admin-ops-components-ops-dashboard-header__panel-69']">{{ t('admin.ops.average') }}</div>
                  <div :class="[props.fullscreen ? 'views-admin-ops-components-ops-dashboard-header__panel-70' : 'views-admin-ops-components-ops-dashboard-header__text-26', 'views-admin-ops-components-ops-dashboard-header__panel-71']">
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                      <span class="views-admin-ops-components-ops-dashboard-header__text-7">{{ realtimeQpsAvgLabel }}</span>
                      <span class="views-admin-ops-components-ops-dashboard-header__text-8">QPS</span>
                    </div>
                    <div class="views-admin-ops-components-ops-dashboard-header__panel-29">
                      <span class="views-admin-ops-components-ops-dashboard-header__text-7">{{ realtimeTpsAvgLabel }}</span>
                      <span class="views-admin-ops-components-ops-dashboard-header__text-8">{{ t('admin.ops.tps') }}</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="views-admin-ops-components-ops-dashboard-header__panel-31">
                <svg class="views-admin-ops-components-ops-dashboard-header__icon-8" viewBox="0 0 280 32" preserveAspectRatio="none">
                  <path
      ...
      <div class="views-admin-ops-components-ops-dashboard-header__panel-32">
        <!-- Card 1: Requests -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 1;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">{{ t('admin.ops.requestsTitle') }}</span>
              <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.totalRequests')" />
            </div>
            <button
              v-if="!props.fullscreen"
              class="views-admin-ops-components-ops-dashboard-header__action-6"
              type="button"
          ...
          <div class="views-admin-ops-components-ops-dashboard-header__panel-36">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.requests') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ totalRequestsLabel }}</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.tokens') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ totalTokensLabel }}</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.avgQps') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ qpsAvgLabel }}</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.avgTps') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ tpsAvgLabel }}</span>
            </div>
          </div>
        </div>

        <!-- Card 2: SLA -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 2;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-25">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">{{ t('admin.ops.sla') }}</span>
              <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.sla')" />
              <span class="views-admin-ops-components-ops-dashboard-header__text-12" :class="getSLAThresholdLevel(slaPercent) === 'critical' ? 'views-admin-ops-components-ops-dashboard-header__text-28' : getSLAThresholdLevel(slaPercent) === 'warning' ? 'views-admin-ops-components-ops-dashboard-header__text-29' : 'views-admin-ops-components-ops-dashboard-header__text-18'"></span>
            </div>
            <button
              v-if="!props.fullscreen"
              class="views-admin-ops-components-ops-dashboard-header__action-6"
          ...
          <div class="views-admin-ops-components-ops-dashboard-header__panel-38" :class="getThresholdColorClass(getSLAThresholdLevel(slaPercent))">
            {{ slaPercent == null ? '-' : `${slaPercent.toFixed(3)}%` }}
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-39">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-40" :class="getSLAThresholdLevel(slaPercent) === 'critical' ? 'views-admin-ops-components-ops-dashboard-header__text-28' : getSLAThresholdLevel(slaPercent) === 'warning' ? 'views-admin-ops-components-ops-dashboard-header__text-29' : 'views-admin-ops-components-ops-dashboard-header__text-18'" :style="{ width: `${Math.max((slaPercent ?? 0) - 90, 0) * 10}%` }"></div>
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-41">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.exceptions') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ formatNumber((overview.request_count_sla ?? 0) - (overview.success_count ?? 0)) }}</span>
            </div>
          </div>
        </div>

        <!-- Card 4: Request Duration -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 4;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">{{ t('admin.ops.latencyDuration') }}</span>
          ...
          <div class="views-admin-ops-components-ops-dashboard-header__panel-42">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-43">
              {{ durationP99Ms ?? '-' }}
            </div>
            <span class="views-admin-ops-components-ops-dashboard-header__text-13">ms (P99)</span>
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-44">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P95:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ durationP95Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P90:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ durationP90Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P50:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ durationP50Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">Avg:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ durationAvgMs ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">Max:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ durationMaxMs ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
          </div>
        </div>
        ...
        <!-- Card 5: TTFT -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 5;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">TTFT</span>
          ...
          <div class="views-admin-ops-components-ops-dashboard-header__panel-42">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-46" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftP99Ms))">
              {{ ttftP99Ms ?? '-' }}
            </div>
            <span class="views-admin-ops-components-ops-dashboard-header__text-13">ms (P99)</span>
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-44">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P95:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-15" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftP95Ms))">{{ ttftP95Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P90:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-15" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftP90Ms))">{{ ttftP90Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">P50:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-15" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftP50Ms))">{{ ttftP50Ms ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">Avg:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-15" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftAvgMs))">{{ ttftAvgMs ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-45">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">Max:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-15" :class="getThresholdColorClass(getTTFTThresholdLevel(ttftMaxMs))">{{ ttftMaxMs ?? '-' }}</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-14">ms</span>
            </div>
          </div>
        </div>
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 3;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">{{ t('admin.ops.requestErrors') }}</span>
              <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.errors')" />
            </div>
            <button v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__action-6" type="button" @click="openErrorDetails('request')">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-38" :class="getThresholdColorClass(getRequestErrorRateThresholdLevel(errorRatePercent))">
            {{ errorRatePercent == null ? '-' : `${errorRatePercent.toFixed(2)}%` }}
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-47">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.errorCount') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ formatNumber(overview.error_count_sla ?? 0) }}</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.businessLimited') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ formatNumber(overview.business_limited_count ?? 0) }}</span>
            </div>
          </div>
        </div>

        <!-- Card 6: Upstream Errors -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-33" style="order: 6;">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-34">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <span class="views-admin-ops-components-ops-dashboard-header__text-9">{{ t('admin.ops.upstreamErrors') }}</span>
              <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.upstreamErrors')" />
            </div>
            <button v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__action-6" type="button" @click="openErrorDetails('upstream')">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-38" :class="getThresholdColorClass(getUpstreamErrorRateThresholdLevel(upstreamErrorRatePercent))">
            {{ upstreamErrorRatePercent == null ? '-' : `${upstreamErrorRatePercent.toFixed(2)}%` }}
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-47">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">{{ t('admin.ops.errorCountExcl429529') }}:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ formatNumber(overview.upstream_error_count_excl_429_529 ?? 0) }}</span>
            </div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-37">
              <span class="views-admin-ops-components-ops-dashboard-header__text-10">429/529:</span>
              <span class="views-admin-ops-components-ops-dashboard-header__text-11">{{ formatNumber((overview.upstream_429_count ?? 0) + (overview.upstream_529_count ?? 0)) }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="overview && !props.compact" class="views-admin-ops-components-ops-dashboard-header__panel-48">
      <div class="views-admin-ops-components-ops-dashboard-header__panel-49">
        <!-- CPU -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-51">CPU</div>
            <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.cpu')" />
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="cpuPercentClass">
            {{ cpuPercentValue == null ? '-' : `${cpuPercentValue.toFixed(1)}%` }}
          </div>
          <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-53">
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-51">{{ t('admin.ops.memory') }}</div>
            <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.memory')" />
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="memPercentClass">
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-51">{{ t('admin.ops.db') }}</div>
            <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.db')" />
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="dbMiddleClass">
            {{ dbMiddleLabel }}
          </div>
          <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-53">
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-51">Redis</div>
            <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.redis')" />
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="redisMiddleClass">
            {{ redisMiddleLabel }}
          </div>
          <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-53">
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-51">{{ t('admin.ops.goroutines') }}</div>
            <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.goroutines')" />
          </div>
          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="goroutineStatusClass">
            {{ goroutineStatusLabel }}
          </div>
          <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-53">
            {{ t('admin.ops.current') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ goroutineCountValue ?? '-' }}</span>
            · {{ t('common.warning') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ goroutinesWarnThreshold }}</span>
            · {{ t('common.critical') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ goroutinesCriticalThreshold }}</span>
            <span v-if="systemMetrics?.concurrency_queue_depth != null">
              · {{ t('admin.ops.queue') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ systemMetrics.concurrency_queue_depth }}</span>
            </span>
          </div>
        </div>
        ...
        <!-- Jobs -->
        <div class="views-admin-ops-components-ops-dashboard-header__panel-50">
          <div class="views-admin-ops-components-ops-dashboard-header__panel-54">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-35">
              <div class="views-admin-ops-components-ops-dashboard-header__panel-51">{{ t('admin.ops.jobs') }}</div>
              <HelpTooltip v-if="!props.fullscreen" :content="t('admin.ops.tooltips.jobs')" />
            </div>
            <button v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__action-6" type="button" @click="openJobsDetails">
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>

          <div class="views-admin-ops-components-ops-dashboard-header__panel-52" :class="jobsStatusClass">
            {{ jobsStatusLabel }}
          </div>

          <div v-if="!props.fullscreen" class="views-admin-ops-components-ops-dashboard-header__panel-53">
            {{ t('common.total') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ jobHeartbeats.length }}</span>
            · {{ t('common.warning') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ jobsWarnCount }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <BaseDialog :show="showJobsDetails" :title="t('admin.ops.jobs')" width="wide" @close="showJobsDetails = false">
      <div v-if="!jobHeartbeats.length" class="views-admin-ops-components-ops-dashboard-header__panel-55">
        {{ t('admin.ops.noData') }}
      </div>
      <div v-else class="views-admin-ops-components-ops-dashboard-header__panel-10">
        <div
          v-for="hb in jobHeartbeats"
          :key="hb.job_name"
          class="views-admin-ops-components-ops-dashboard-header__panel-56"
        >
          <div class="views-admin-ops-components-ops-dashboard-header__panel-57">
            <div class="views-admin-ops-components-ops-dashboard-header__panel-58">{{ hb.job_name }}</div>
            <div class="views-admin-ops-components-ops-dashboard-header__panel-59">
              <span v-if="hb.last_duration_ms != null" class="views-admin-ops-components-ops-dashboard-header__text-16">{{ hb.last_duration_ms }}ms</span>
              <span>{{ formatTimeShort(hb.updated_at) }}</span>
            </div>
          </div>

          <div class="views-admin-ops-components-ops-dashboard-header__panel-60">
            <div>
              {{ t('admin.ops.lastSuccess') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ formatTimeShort(hb.last_success_at) }}</span>
            </div>
            <div>
              {{ t('admin.ops.lastError') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ formatTimeShort(hb.last_error_at) }}</span>
            </div>
            <div>
              {{ t('admin.ops.result') }} <span class="views-admin-ops-components-ops-dashboard-header__text-16">{{ hb.last_result || '-' }}</span>
            </div>
          </div>

          <div
            v-if="hb.last_error"
            class="views-admin-ops-components-ops-dashboard-header__panel-61"
          >
            {{ hb.last_error }}
          </div>
        </div>
    ...
    <BaseDialog :show="showCustomTimeRangeDialog" :title="t('admin.ops.timeRange.custom')" width="narrow" @close="handleCustomTimeRangeCancel">
      <div class="views-admin-ops-components-ops-dashboard-header__panel-62">
        <div>
        ...
        <div class="views-admin-ops-components-ops-dashboard-header__panel-63">
          <button
            type="button"
            class="views-admin-ops-components-ops-dashboard-header__action-7"
          ...
          <button
            type="button"
            class="views-admin-ops-components-ops-dashboard-header__action-8"
