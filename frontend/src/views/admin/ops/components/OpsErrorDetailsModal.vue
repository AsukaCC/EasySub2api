...
<template>
  <BaseDialog :show="show" :title="modalTitle" width="full" @close="close">
    <div class="views-admin-ops-components-ops-error-details-modal__panel">
      <!-- Filters -->
      <div class="views-admin-ops-components-ops-error-details-modal__panel-2">
        <div class="views-admin-ops-components-ops-error-details-modal__panel-3">
          <div class="views-admin-ops-components-ops-error-details-modal__panel-4 compact-select">
            <div class="views-admin-ops-components-ops-error-details-modal__panel-5">
              <div class="views-admin-ops-components-ops-error-details-modal__panel-6">
                <svg
                  class="views-admin-ops-components-ops-error-details-modal__icon"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <input
                v-model="q"
                type="text"
                class="views-admin-ops-components-ops-error-details-modal__field"
          ...
          <div class="views-admin-ops-components-ops-error-details-modal__panel-7">
            <button type="button" class="views-admin-ops-components-ops-error-details-modal__action" @click="resetFilters">
              {{ t('common.reset') }}
            </button>
          </div>
        </div>
      ...
      <!-- Body -->
      <div class="views-admin-ops-components-ops-error-details-modal__panel-8">
        <div class="views-admin-ops-components-ops-error-details-modal__panel-9">
          {{ t('admin.ops.errorDetails.total') }} {{ total }}
        </div>

          <OpsErrorLogTable
            class="views-admin-ops-components-ops-error-details-modal__ops-error-log-table"
            :rows="rows"
            :total="total"
            :loading="loading"
            :page="page"
