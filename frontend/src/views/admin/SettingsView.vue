    ...
    <div class="views-admin-settings-view__panel">
      ...
      <form v-else @submit.prevent="saveSection" class="views-admin-settings-view__form settings-page-form" novalidate>
        <div class="views-admin-settings-view__panel-152">
          ...
          <p v-if="saving" class="views-admin-settings-view__description-17">
            {{ t("common.saving") }}
          </p>
          <p
            v-else-if="lastSavedSection === settingsSection"
            class="views-admin-settings-view__description-17"
          >
            {{ t("common.saved") }}
          </p>
        </div>
        ...
        <div v-if="isTabVisible('security')" class="views-admin-settings-view__form">
          <!-- Admin API Key Settings -->
          <div class="card">
            <div
              class="views-admin-settings-view__panel-4"
            >
            ...
            <div class="views-admin-settings-view__panel-5">
              ...
              >
                <div class="views-admin-settings-view__panel-7">
                  <Icon
                    name="exclamationTriangle"
                    size="md"
                    class="views-admin-settings-view__icon"
                  />
                  <p class="views-admin-settings-view__description-2">
              ...
              <!-- Key Exists -->
              <div v-else class="views-admin-settings-view__panel-11">
                <div class="views-admin-settings-view__panel-10">
                  <div>
                    <label
                      class="views-admin-settings-view__label"
                    >
                      {{ t("admin.settings.adminApiKey.currentKey") }}
                    </label>
                    <code
                      class="views-admin-settings-view__code"
                    >
                      {{ adminApiKeyMasked }}
                    </code>
                  </div>
                  <div class="views-admin-settings-view__panel-12">
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      :disabled="adminApiKeyOperating"
                      class="views-admin-settings-view__action btn btn-secondary btn-sm"
                    >
                ...
                <div
                  v-if="newAdminApiKey"
                  class="views-admin-settings-view__panel-13"
                >
                  <p
                    class="views-admin-settings-view__description-3"
                  >
                    {{ t("admin.settings.adminApiKey.keyWarning") }}
                  </p>
                  <div class="views-admin-settings-view__panel-14">
                    <code
                      class="views-admin-settings-view__code-2"
                    >
                      {{ newAdminApiKey }}
                    </code>
                    <button
                      type="button"
                      @click="copyNewKey"
                      class="views-admin-settings-view__action-2 btn btn-primary btn-sm"
                    >
                      {{ t("admin.settings.adminApiKey.copyKey") }}
                    </button>
                  </div>
                  <p class="views-admin-settings-view__description-4">
        ...
        <!-- Tab: Gateway -->
        <div v-if="isTabVisible('gateway')" class="views-admin-settings-view__form">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <template v-else>
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-16"
                >
                  <div>
                    <label
              ...
              <template v-else>
                ...
                >
                  ...
                  <div>
                    ...
                    <Select v-model="streamTimeoutForm.action" class="views-admin-settings-view__field-2" :options="[
                ...
                >
                  ...
                  <div class="views-admin-settings-view__panel-10">
                    <div>
                      ...
                      >
                      <p class="views-admin-settings-view__description-7">
                        {{
                  ...
                  <div
                    ...
                    class="views-admin-settings-view__panel-18"
                  >
                    <div>
                      <label
                        class="views-admin-settings-view__label-4"
                    ...
                    <div
                      ...
                      :key="index"
                      class="views-admin-settings-view__panel-14"
                    >
                      <input
                        v-model="rectifierForm.apikey_signature_patterns[index]"
                        type="text"
                        class="views-admin-settings-view__field-3 input input-sm"
                        :placeholder="
                      ...
                      <button
                        ...
                        "
                        class="views-admin-settings-view__action-3 btn btn-ghost btn-xs"
                      >
                        <svg
                          class="views-admin-settings-view__icon-3"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    <button
                      ...
                      class="views-admin-settings-view__action-4 btn btn-ghost btn-xs"
                    >
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <template v-else>
                ...
                <div
                  ...
                  :key="rule.beta_token"
                  class="views-admin-settings-view__panel-19"
                >
                  <div class="views-admin-settings-view__panel-20">
                    <span
                      class="views-admin-settings-view__text-2"
                    >
                      {{ getBetaDisplayName(rule.beta_token) }}
                    </span>
                    <span
                      class="views-admin-settings-view__text-3"
                    >
                      {{ rule.beta_token }}
                    </span>
                  </div>

                  <div class="views-admin-settings-view__panel-21">
                    <!-- Action -->
                    <div>
                      <label
                        class="views-admin-settings-view__label-5"
                      >
                  ...
                  <div v-if="rule.action === 'block'" class="views-admin-settings-view__panel-22">
                    <label
                      class="views-admin-settings-view__label-5"
                    >
                    ...
                    <input
                      ...
                      "
                    />
                    <p class="views-admin-settings-view__description-8">
                      {{ t("admin.settings.betaPolicy.errorMessageHint") }}
                    </p>
                  </div>

                  <!-- Quick Presets (only for tokens with presets) -->
                  <div v-if="betaPresets[rule.beta_token]?.length" class="views-admin-settings-view__panel-22">
                    <label
                      class="views-admin-settings-view__label-5"
                    >
                      {{ t("admin.settings.betaPolicy.quickPresets") }}
                    </label>
                    <div class="views-admin-settings-view__panel-23">
                      <button
                        v-for="preset in betaPresets[rule.beta_token]"
                        :key="preset.label"
                        type="button"
                        class="views-admin-settings-view__action-5"
                  ...
                  <!-- Model Whitelist -->
                  <div class="views-admin-settings-view__panel-22">
                    <label
                      class="views-admin-settings-view__label-5"
                    >
                      {{ t("admin.settings.betaPolicy.modelWhitelist") }}
                    </label>
                    <p class="views-admin-settings-view__description-9">
                    ...
                    <div
                      ...
                      :key="index"
                      class="views-admin-settings-view__panel-24"
                    >
                      <input
                      ...
                      <button
                        ...
                        class="views-admin-settings-view__action-6"
                      >
                        <svg
                          class="views-admin-settings-view__icon-3"
                          fill="none"
                    ...
                    <button
                      ...
                      "
                      class="views-admin-settings-view__action-7"
                    >
                      <svg
                        class="views-admin-settings-view__icon-4"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
                    ...
                    <div class="views-admin-settings-view__panel-25">
                      <span class="views-admin-settings-view__text-4"
                        >{{
                      ...
                      <button
                        ...
                        :key="pattern"
                        type="button"
                        class="views-admin-settings-view__action-8"
                  ...
                  <div
                    ...
                    "
                    class="views-admin-settings-view__panel-22"
                  >
                    <label
                      class="views-admin-settings-view__label-5"
                    >
                    ...
                    <div v-if="rule.fallback_action === 'block'" class="views-admin-settings-view__panel-26">
                      <input
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              >
                <div class="views-admin-settings-view__panel-28">
                  ...
                  <button
                    ...
                    class="views-admin-settings-view__action-9"
                ...
                <div
                  class="views-admin-settings-view__panel-29"
                  :data-testid="`openai-fast-policy-summary-${ruleIndex}`"
                >
                  <span class="views-admin-settings-view__text-5">
                    {{
                      t(
                  ...
                  <span
                    class="views-admin-settings-view__text-6"
                  >
                  ...
                  <template v-if="hasOpenAIFastPolicyTargetModels(rule)">
                    ...
                    <span aria-hidden="true">→</span>
                    <span
                      class="views-admin-settings-view__text-7"
                    >
                      {{
                ...
                <div class="views-admin-settings-view__panel-30">
                  <!-- Service Tier -->
                  <div>
                    <label
                      class="views-admin-settings-view__label-5"
                ...
                >
                  ...
                  <p
                    ...
                    class="views-admin-settings-view__description-9"
                  >
                    {{
              ...
              <div>
                <button
                  ...
                  class="views-admin-settings-view__action-10 btn btn-secondary btn-sm"
                >
                  <svg
                    class="views-admin-settings-view__icon-3"
                    fill="none"
                ...
                <p class="views-admin-settings-view__description-10">
        ...
        <div v-if="isTabVisible('security')" class="views-admin-settings-view__form">
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <div class="views-admin-settings-view__panel-32">
                ...
                <div
                  class="views-admin-settings-view__panel-33"
                >
                  <div class="views-admin-settings-view__panel-34">
                    <span
                      v-for="suffix in registrationEmailSuffixWhitelistTags"
                      :key="suffix"
                      class="views-admin-settings-view__text-8"
                    >
                      <span>{{ suffix }}</span>
                      <button
                        type="button"
                        class="views-admin-settings-view__action-11"
                        @click="
                    ...
                    <div
                      class="views-admin-settings-view__panel-35"
                    >
                      <input
                        v-model="registrationEmailSuffixWhitelistDraft"
                        type="text"
                        class="views-admin-settings-view__field-4"
                        :placeholder="
                          t(
                ...
                <p class="views-admin-settings-view__description-11">
                  {{
                    t(
              ...
              <div
                ...
                class="views-admin-settings-view__panel-32"
              >
                <label
                  class="views-admin-settings-view__label-3"
                >
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    class="views-admin-settings-view__description-12"
                  >
              ...
              >
                ...
                <div
                  class="views-admin-settings-view__panel-37"
                  :class="
                    form.passkey_configured
                      ? 'views-admin-settings-view__panel-152'
                      : 'views-admin-settings-view__panel-153'
                  "
                  data-testid="passkey-config-status"
                >
                  <p class="views-admin-settings-view__description-13">
                    {{
                      form.passkey_configured
                  ...
                  <p class="views-admin-settings-view__description-14">
                  ...
                  <p v-if="!form.passkey_configured" class="views-admin-settings-view__panel-26">
              ...
              >
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  class="views-admin-settings-view__field-5 input"
                />
              </div>
            </div>
          </div>
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              >
                <label
                  ...
                  class="views-admin-settings-view__label-2"
                >
          ...
          <div class="card">
            ...
            >
              <div class="views-admin-settings-view__panel-14">
                <Icon
                  name="shield"
                  size="md"
                  class="views-admin-settings-view__icon-5"
                />
                <h2 class="views-admin-settings-view__heading">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <template v-else>
                ...
                <div
                  class="views-admin-settings-view__panel-39"
                >
                  <div class="views-admin-settings-view__panel-7">
                    <Icon
                      name="infoCircle"
                      size="md"
                      class="views-admin-settings-view__icon-6"
                    />
                    <p class="views-admin-settings-view__description-15">
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-40"
                >
                  <div class="views-admin-settings-view__panel-41">
                    <div>
                      <label
                        class="views-admin-settings-view__label-3"
                      >
                      ...
                      <div class="views-admin-settings-view__panel-14">
                        <input
                          ...
                          class="views-admin-settings-view__field input"
                        />
                        <span class="views-admin-settings-view__description-5">
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              >
                <!-- Provider Selector -->
                <div class="views-admin-settings-view__panel-42">
                  <label
                    class="views-admin-settings-view__label-3"
                  >
                  ...
                  <div
                    class="views-admin-settings-view__panel-43"
                  >
                    <button
                      type="button"
                      data-testid="captcha-provider-turnstile"
                      class="views-admin-settings-view__action-12"
                      :class="
                        captchaProviderSelection === 'turnstile'
                          ? 'views-admin-settings-view__action-34'
                          : 'views-admin-settings-view__action-35'
                      "
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-44"
                >
                  <div>
                    <label
                      class="views-admin-settings-view__label-3"
                    ...
                    <input
                      ...
                      type="text"
                      class="views-admin-settings-view__field-6 input"
                    ...
                    <p class="views-admin-settings-view__description-6">
                      ...
                      <a
                        ...
                        target="_blank"
                        class="views-admin-settings-view__link"
                        >{{
                ...
                <div v-else-if="captchaProviderSelection === 'tencent'">
                  <div class="views-admin-settings-view__panel-45">
                    <label class="views-admin-settings-view__label-3">
                      {{ t("admin.settings.tencentCaptcha.region") }}
                    </label>
                    <div class="views-admin-settings-view__panel-46">
                      <button
                        type="button"
                        data-testid="tencent-captcha-region-cn"
                        class="views-admin-settings-view__action-13"
                        :class="
                  ...
                  <div class="views-admin-settings-view__panel-47">
                    ...
                    <div class="views-admin-settings-view__panel-49">
                      <h3 class="views-admin-settings-view__heading-2">
                  ...
                  <div class="views-admin-settings-view__panel-50">
                    <a
                ...
                <div v-else class="views-admin-settings-view__panel-44">
                  <div class="views-admin-settings-view__panel-41">
                    <div>
                      <label
                        class="views-admin-settings-view__label-3"
                      ...
                      <div
                        class="views-admin-settings-view__panel-46"
                      >
                        <button
                          type="button"
                          class="views-admin-settings-view__action-13"
            ...
            <div class="views-admin-settings-view__panel-52">
              <div class="views-admin-settings-view__panel-53">
                <div class="views-admin-settings-view__panel-54">
                  <div class="views-admin-settings-view__panel-36">
                    <div>
                      <h3 class="views-admin-settings-view__label-2">
                        GitHub
                      </h3>
                      <p class="views-admin-settings-view__description">
                        {{
                  ...
                  <div v-if="form.github_oauth_enabled" class="views-admin-settings-view__panel-55">
                    <div class="views-admin-settings-view__panel-56">
                      <template v-if="isZhLocale">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          class="views-admin-settings-view__link-2"
                        >OAuth Apps</a>
                    ...
                    <div class="views-admin-settings-view__panel-57">
                      <div>
                        <label class="views-admin-settings-view__label-3">Client ID</label>
                        <input
                      ...
                      <div>
                        <label class="views-admin-settings-view__label-3">Client Secret</label>
                        <input
                    ...
                    <div>
                      ...
                      />
                      <div class="views-admin-settings-view__panel-51">
                        <button
                          type="button"
                          class="views-admin-settings-view__action-14 btn btn-secondary btn-sm"
                        ...
                        <code
                          ...
                          class="views-admin-settings-view__code-3"
                        >
                ...
                <div class="views-admin-settings-view__panel-54">
                  ...
                  <div v-if="form.google_oauth_enabled" class="views-admin-settings-view__panel-55">
                    <div class="views-admin-settings-view__panel-56">
                      {{
                        localText(
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <div
                ...
                class="views-admin-settings-view__panel-58"
              >
                <div class="views-admin-settings-view__panel-11">
                  <div
                    class="views-admin-settings-view__panel-54"
                  >
                    <div class="views-admin-settings-view__panel-36">
                      <div>
                        <h3 class="views-admin-settings-view__label-2">
                    ...
                    <div
                      ...
                      class="views-admin-settings-view__panel-59"
                    >
                      <div>
                        <label
                          class="views-admin-settings-view__label-3"
                ...
                <div
                  ...
                  "
                  class="views-admin-settings-view__panel-60"
                >
                  {{
                    localText(
                ...
                <div class="views-admin-settings-view__panel-61">
                  <div>
                    <label
                      class="views-admin-settings-view__label-3"
                    >
                    ...
                    <div
                      class="views-admin-settings-view__panel-51"
                    >
                      <button
                        type="button"
                        class="views-admin-settings-view__action-14 btn btn-secondary btn-sm"
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <div
                ...
                class="views-admin-settings-view__panel-32"
              >
                <div class="views-admin-settings-view__panel-44">
                  <div>
                    <label
                      class="views-admin-settings-view__label-3"
                    >
                  ...
                  <div class="views-admin-settings-view__panel-32">
                    ...
                    <p class="views-admin-settings-view__description-18">
                      {{ t("admin.settings.dingtalk.corpPolicy.hint") }}
                    </p>
                    <div class="views-admin-settings-view__panel-62">
                      <label class="views-admin-settings-view__label-6">
                        <input
                          v-model="form.dingtalk_connect_corp_restriction_policy"
                          type="radio"
                          value="none"
                          class="views-admin-settings-view__field-7"
                        />
                        <span class="views-admin-settings-view__text-9">
                  ...
                  <div
                    ...
                    class="views-admin-settings-view__panel-63"
                  >
                    <div>
                      <label class="views-admin-settings-view__label-2">{{
                  ...
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                    class="views-admin-settings-view__panel-64"
                  >
                    <div class="views-admin-settings-view__panel-10">
                      <div>
                        <label class="views-admin-settings-view__label-2">{{
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="views-admin-settings-view__panel-62">
                      <div class="views-admin-settings-view__panel-14">
                        <label class="views-admin-settings-view__label-7">
                        ...
                        <input
                          ...
                          class="views-admin-settings-view__field-8 input"
                        />
                      </div>
                      <div class="views-admin-settings-view__panel-14">
                        <label class="views-admin-settings-view__label-7">
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="views-admin-settings-view__text-4">
                  ...
                  >
                    <div class="views-admin-settings-view__panel-10">
                      <div>
                        ...
                        <p class="views-admin-settings-view__description-19">
                          {{ t("admin.settings.dingtalk.syncCorpEmailPermissionHint") }}
                        </p>
                      </div>
                      <Toggle v-model="form.dingtalk_connect_sync_corp_email" />
                    </div>
                    <div v-if="form.dingtalk_connect_sync_corp_email" class="views-admin-settings-view__panel-62">
                      <div class="views-admin-settings-view__panel-14">
                        <label class="views-admin-settings-view__label-7">
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="views-admin-settings-view__text-4">
                  ...
                  >
                    ...
                    <div v-if="form.dingtalk_connect_sync_dept" class="views-admin-settings-view__panel-62">
                      <div class="views-admin-settings-view__panel-14">
                        <label class="views-admin-settings-view__label-7">
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="views-admin-settings-view__text-4">
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <div
                ...
                class="views-admin-settings-view__panel-58"
              >
                <div class="views-admin-settings-view__panel-65">
                  <div>
                    <label
                      class="views-admin-settings-view__label-3"
                    >
                ...
                <div class="views-admin-settings-view__panel-61">
                  ...
                  <div class="views-admin-settings-view__panel-66">
                    <label
                      class="views-admin-settings-view__label-3"
                    >
                ...
                <div class="views-admin-settings-view__panel-65">
                  <div>
                    ...
                    <Select v-model="form.oidc_connect_token_auth_method" class="views-admin-settings-view__field-6" :options="[
        ...
        <!-- Tab: Users -->
        <div v-if="isTabVisible('users')" class="views-admin-settings-view__form">
          <!-- Default Settings -->
          <div class="card">
            <div
              class="views-admin-settings-view__panel-4"
            ...
            <div class="views-admin-settings-view__panel-52">
              ...
              <div class="views-admin-settings-view__panel-32">
                ...
                <div v-else class="views-admin-settings-view__panel-69">
                  <div
                    v-for="(item, index) in form.default_subscriptions"
                    :key="`default-sub-${index}`"
                    class="views-admin-settings-view__panel-70"
                  >
                    <div>
                      <label
                        class="views-admin-settings-view__label-5"
                      ...
                      >
                        <template #selected="{ option }">
                          <GroupBadge
                            ...
                            "
                          />
                          <span v-else class="views-admin-settings-view__text-10">
                            {{ t("admin.settings.defaults.subscriptionGroup") }}
                          </span>
                        </template>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="1"
                        max="36500"
                        class="views-admin-settings-view__field-9 input"
                      />
                    </div>
                    <div class="views-admin-settings-view__panel-71">
                      <button
                        type="button"
                        class="views-admin-settings-view__action-15 btn btn-secondary default-sub-delete-btn"
              ...
              <!-- ★ 新增：系统全局默认平台限额矩阵 -->
              <div class="views-admin-settings-view__panel-32">
                <div class="views-admin-settings-view__panel-72">
                  <label class="views-admin-settings-view__label-2">
                  ...
                  <p class="views-admin-settings-view__description-20">
                    {{ t("admin.settings.defaults.platformQuotaNotice") }}
                  </p>
                </div>
                <div class="views-admin-settings-view__panel-73">
                  <table class="views-admin-settings-view__table">
                    <thead>
                      <tr class="views-admin-settings-view__row">
                        <th class="views-admin-settings-view__heading-3">{{ t("admin.settings.platformQuota.platform") }}</th>
                        <th class="views-admin-settings-view__heading-3">{{ t("admin.settings.platformQuota.daily") }}</th>
                        <th class="views-admin-settings-view__heading-3">{{ t("admin.settings.platformQuota.weekly") }}</th>
                        <th class="views-admin-settings-view__heading-4">{{ t("admin.settings.platformQuota.monthly") }}</th>
                      </tr>
                    </thead>
                    <tbody class="views-admin-settings-view__panel-62">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="p" class="views-admin-settings-view__row-2">
                        <td class="views-admin-settings-view__cell">
                          <span class="views-admin-settings-view__text-11">{{ p }}</span>
                        </td>
                        <td class="views-admin-settings-view__cell">
                          <input
                            ...
                            step="0.01"
                            min="0"
                            class="views-admin-settings-view__field-10 input"
                        ...
                        <td class="views-admin-settings-view__cell-2">
                          <input
            ...
            <div class="views-admin-settings-view__panel-52">
              ...
              <div class="views-admin-settings-view__panel-11">
                <div
                  ...
                  class="views-admin-settings-view__panel-74"
                >
                  <div class="views-admin-settings-view__panel-38">
                    <div>
                      <div class="views-admin-settings-view__label-2">
                        {{ authSource.title }}
                      </div>
                      <p class="views-admin-settings-view__description">
                  ...
                  <div
                    ...
                    class="views-admin-settings-view__panel-75"
                  >
                    <p class="views-admin-settings-view__description-5">
                      {{ t("admin.settings.authSourceDefaults.enabledHint") }}
                    </p>

                    <div class="views-admin-settings-view__panel-76">
                      <div>
                        <label
                          class="views-admin-settings-view__label-3"
                        >
                    ...
                    <div v-else class="views-admin-settings-view__panel-69">
                      ...
                      >
                        ...
                        <div class="views-admin-settings-view__panel-71">
                          <button
                            type="button"
                            class="views-admin-settings-view__action-15 btn btn-secondary"
                            @click="
                    ...
                    <div class="views-admin-settings-view__panel-32">
                      ...
                      <div class="views-admin-settings-view__panel-73">
                        <table class="views-admin-settings-view__table">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="`${authSource.source}-pq-${p}`" class="views-admin-settings-view__row-2">
                              <td class="views-admin-settings-view__cell">
                                <span class="views-admin-settings-view__text-11">{{ p }}</span>
                              </td>
                              <td class="views-admin-settings-view__cell">
        ...
        <div v-if="isTabVisible('gateway')" class="views-admin-settings-view__form">
            ...
            <div class="views-admin-settings-view__panel-77">
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="views-admin-settings-view__field-11 input"
                  :placeholder="
              ...
              <div class="views-admin-settings-view__panel-78">
                <label
                  class="views-admin-settings-view__label-3"
                >
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-79">
                ...
                <div class="views-admin-settings-view__panel-80">
                  <div>
                    <label
                      class="views-admin-settings-view__label-3"
                    >
                    ...
                    <input
                      ...
                      type="text"
                      class="views-admin-settings-view__field-12 input"
                      :placeholder="
                        t(
                ...
                <div>
                  <label class="views-admin-settings-view__label-8">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignals") }}
                  </label>
                  <p class="views-admin-settings-view__description-22">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignalsDesc") }}
                  </p>
                  <div
                    v-for="(row, i) in codexFingerprintRows"
                    :key="`codex-fp-${i}`"
                    class="views-admin-settings-view__panel-81"
                  >
                    <Select v-model="row.type" class="views-admin-settings-view__field-13" :options="[
                    ...
                    <input
                      v-model="row.match"
                      type="text"
                      class="views-admin-settings-view__field-14 input"
                      :placeholder="t('admin.settings.gatewayForwarding.codexFpMatchPlaceholder')"
                    />
                    <label class="views-admin-settings-view__label-9">
                      <input v-model="row.required" type="checkbox" />
                      {{ t("admin.settings.gatewayForwarding.codexFpRequired") }}
                    </label>
                    <button
                      type="button"
                      class="views-admin-settings-view__action-16 btn btn-secondary btn-sm"
                  ...
                  <p
                    ...
                    class="views-admin-settings-view__description-23"
                  >
                ...
                <div class="views-admin-settings-view__panel-10">
                  <div class="views-admin-settings-view__panel-82">
                    <label
                      class="views-admin-settings-view__label-8"
                    >
                      {{
                ...
                <div>
                  ...
                  <div
                    ...
                    :key="`codex-bl-${i}`"
                    class="views-admin-settings-view__panel-83"
                  >
                    <input
                      v-model="row.originator"
                      type="text"
                      class="views-admin-settings-view__field-15 input"
                      :placeholder="
                        t(
                ...
                <div>
                  ...
                  >
                    ...
                    />
                    <label
                      class="views-admin-settings-view__label-9"
                      :title="
                        t(
          ...
          <div class="card" data-testid="ollama-cloud-usage-global-settings">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <template v-else>
                ...
                <div v-if="ollamaCloudUsageForm.enabled" class="views-admin-settings-view__panel-16">
                  <div>
                    <label class="views-admin-settings-view__label-3" for="ollama-cloud-usage-debounce">
                  ...
                  <div>
                    <label class="views-admin-settings-view__label-3" for="ollama-cloud-usage-interval">
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <div class="views-admin-settings-view__panel-32">
                ...
                <div class="views-admin-settings-view__panel-84">
                  <div
                    v-for="platform in schedulingThresholdPlatforms"
                    :key="platform"
                    class="views-admin-settings-view__panel-54"
                  >
                    <div class="views-admin-settings-view__panel-85">
                      <div>
                        <label
                          class="views-admin-settings-view__label-10"
                        >
                          {{ platform }}
                        </label>
                        <p class="views-admin-settings-view__description-21">
                      ...
                      <span
                        class="views-admin-settings-view__text-12"
                      >
                        %
                      </span>
                    </div>
                    <input
                      ...
                      max="100"
                      step="1"
                      class="views-admin-settings-view__panel-22 input"
              ...
              <div
                ...
                class="views-admin-settings-view__panel-86"
              >
                <div>
                  <label
                    class="views-admin-settings-view__label-4"
              ...
              <div
                ...
                class="views-admin-settings-view__panel-87"
              >
                ...
                <div class="views-admin-settings-view__panel-89">
                  <input
                  ...
                  />
                  <span
                    class="views-admin-settings-view__text-13"
                  >x</span>
                </div>
              </div>

              <div class="views-admin-settings-view__panel-86">
                <div>
                  <label
                    class="views-admin-settings-view__label-4"
                  >
              ...
              <div
                v-if="form.openai_advanced_scheduler_enabled"
                class="views-admin-settings-view__panel-90"
              >
                <div>
                  <label
                    class="views-admin-settings-view__label-4"
                ...
                <div class="views-admin-settings-view__panel-91">
                  <label
                    v-for="field in openAIAdvancedSchedulerWeightFields"
                    :key="field.key"
                    class="views-admin-settings-view__label-11"
                  >
                    <span class="views-admin-settings-view__text-14">
                      {{ field.label }}
                    </span>
                    <input
                      v-model="form[field.key]"
                      class="views-admin-settings-view__field-17 input"
                      inputmode="decimal"
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              <div class="views-admin-settings-view__panel-92">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    class="views-admin-settings-view__field-18 input"
              ...
              <div>
                ...
                <div class="views-admin-settings-view__panel-69">
                  <div
                    v-for="(block, index) in claudeOAuthSystemPromptBlocks"
                    :key="block.id"
                    class="views-admin-settings-view__panel-94"
                  >
                    <div
                      :class="[
                        'views-admin-settings-view__panel-154',
                        block.expanded && 'views-admin-settings-view__panel-72',
                      ]"
                    >
                      <div class="views-admin-settings-view__panel-88">
                        <div
                      ...
                      <div class="views-admin-settings-view__panel-14">
                        <button
                          type="button"
                          class="views-admin-settings-view__action-17 btn btn-secondary btn-sm"
                          :title="
                            block.expanded
                              ? t(
                        ...
                        <button
                          type="button"
                          class="views-admin-settings-view__action-18 btn btn-secondary btn-sm"
                    ...
                    <div v-show="block.expanded">
                      <div class="views-admin-settings-view__panel-95">
                        <div>
                          <label
                            class="views-admin-settings-view__label-12"
                          >
                            {{
                              t(
                      ...
                      <div class="views-admin-settings-view__panel-22">
                        ...
                        <textarea
                          v-model="block.text"
                          rows="6"
                          class="views-admin-settings-view__field-19 input"
                          @input="markClaudeOAuthSystemPromptBlockCustom(block)"
                        />
                      </div>

                      <div
                        class="views-admin-settings-view__panel-96"
                      >
                        <div class="views-admin-settings-view__panel-38">
                          <div>
                            <label
                              class="views-admin-settings-view__label-13"
                            >
                              {{
                                t(
                ...
                <div class="views-admin-settings-view__panel-97">
                  <button
                    type="button"
                    class="btn btn-secondary btn-sm"
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-15">
              ...
              <!-- Providers -->
              <div v-if="webSearchConfig.enabled" class="views-admin-settings-view__panel-11">
                <div class="views-admin-settings-view__panel-10">
                  <label
                    class="views-admin-settings-view__label-4"
                  >
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-98"
                >
                ...
                <div
                  ...
                  :key="pIdx"
                  class="views-admin-settings-view__panel-99"
                >
                  <!-- Collapsible header -->
                  <div
                    class="views-admin-settings-view__panel-100"
                    @click="toggleProviderExpand(pIdx)"
                  >
                    <div class="views-admin-settings-view__panel-101">
                      <svg
                        class="views-admin-settings-view__icon-7"
                      ...
                      <Select
                        ...
                        class="views-admin-settings-view__field-20"
                        @click.stop
                      />
                      <!-- Quota summary (always visible) -->
                      <span class="views-admin-settings-view__text-15">
                      ...
                      <span
                        ...
                        "
                        class="views-admin-settings-view__text-16"
                      >
                        {{
                          t(
                    ...
                    <button
                      type="button"
                      class="views-admin-settings-view__action-19"
                  ...
                  <div
                    ...
                    class="views-admin-settings-view__panel-102"
                  >
                    ...
                    <div>
                      ...
                      <div class="views-admin-settings-view__panel-103">
                        <input
                          ...
                          class="views-admin-settings-view__field-21 input"
                          :class="
                        ...
                        <div
                          ...
                          class="views-admin-settings-view__panel-104"
                        >
                          <button
                            type="button"
                            class="views-admin-settings-view__action-20"
                            :title="
                              apiKeyVisible[pIdx]
                                ? t(
                          ...
                          <button
                            ...
                            class="views-admin-settings-view__action-20"
                            :class="{
                              'views-admin-settings-view__action-36':
                                !provider.api_key,
                            }"
                            :title="
                    ...
                    <div class="views-admin-settings-view__panel-105">
                      <div>
                        <label class="views-admin-settings-view__label-14">{{
                    ...
                    <!-- Usage display -->
                    <div class="views-admin-settings-view__panel-14">
                      <span class="views-admin-settings-view__label-14"
                        >{{
                      ...
                      <div
                        v-if="
                          ...
                          provider.quota_limit > 0
                        "
                        class="views-admin-settings-view__panel-106"
                        style="height: 6px"
                      >
                        <div
                          class="views-admin-settings-view__panel-107"
                          :class="
                            quotaPercentage(provider) > 90
                              ? 'views-admin-settings-view__panel-155'
                              : quotaPercentage(provider) > 70
                                ? 'views-admin-settings-view__panel-156'
                                : 'views-admin-settings-view__panel-157'
                          "
                          :style="{
                            width:
                      ...
                      <div v-else class="views-admin-settings-view__field-3" />
                      <span class="views-admin-settings-view__label-14"
                        >{{ provider.quota_used ?? 0 }} /
                        {{
                          provider.quota_limit != null &&
                      ...
                      <button
                        ...
                        type="button"
                        class="views-admin-settings-view__action-21"
                    ...
                    <div class="views-admin-settings-view__panel-108">
                      ...
                      <button
                        type="button"
                        class="views-admin-settings-view__action-22 btn btn-secondary btn-sm"
          ...
          <div
            ...
            class="views-admin-settings-view__panel-109"
            ...
            >
              ...
              <div class="views-admin-settings-view__panel-14">
                <input
                  v-model="wsTestQuery"
                  type="text"
                  class="views-admin-settings-view__field-23 input"
                  :placeholder="
              ...
              <div
                v-if="wsTestResult"
                class="views-admin-settings-view__panel-111"
              >
                <p
                  class="views-admin-settings-view__description-26"
                >
                  {{
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-112"
                >
                ...
                <div
                  ...
                  :key="rIdx"
                  class="views-admin-settings-view__panel-113"
                >
                  <a
                    :href="r.url"
                    target="_blank"
                    class="views-admin-settings-view__link-3"
                    >{{ r.title }}</a
                  >
                  <p class="views-admin-settings-view__description-21">
                    {{ r.snippet }}
              ...
              <div class="views-admin-settings-view__panel-114">
                <button
                  type="button"
                  class="btn btn-secondary btn-sm"
        ...
        <!-- Tab: General -->
        <div v-if="isTabVisible('general')" class="views-admin-settings-view__form">
          <div class="settings-platform-cards">
            <!-- Runtime Mode -->
            <div class="card settings-platform-card">
              <div class="settings-platform-card__header">
                <span class="settings-platform-card__index">01</span>
                <div>
                  <h2 class="views-admin-settings-view__heading">
                    {{ t("admin.settings.site.sections.runtime.title") }}
                  </h2>
                  <p class="views-admin-settings-view__description">
                    {{ t("admin.settings.site.sections.runtime.description") }}
                  </p>
                </div>
              </div>
              <div class="views-admin-settings-view__panel-52">
            ...
            <div class="card settings-platform-card">
              <div class="settings-platform-card__header">
                <span class="settings-platform-card__index">02</span>
                <div>
                  <h2 class="views-admin-settings-view__heading">
                    {{ t("admin.settings.site.sections.branding.title") }}
                  </h2>
                  <p class="views-admin-settings-view__description">
                    {{ t("admin.settings.site.sections.branding.description") }}
                  </p>
                </div>
              </div>
              <div class="views-admin-settings-view__panel-52">
            ...
            <div class="card settings-platform-card">
              <div class="settings-platform-card__header">
                <span class="settings-platform-card__index">03</span>
                <div>
                  <h2 class="views-admin-settings-view__heading">
                    {{ t("admin.settings.site.sections.links.title") }}
                  </h2>
                  <p class="views-admin-settings-view__description">
                    {{ t("admin.settings.site.sections.links.description") }}
                  </p>
                </div>
              </div>
              <div class="views-admin-settings-view__panel-52">
            ...
            <div class="card settings-platform-card">
              <div class="settings-platform-card__header">
                <span class="settings-platform-card__index">04</span>
                <div>
                  <h2 class="views-admin-settings-view__heading">
                    {{ t("admin.settings.site.sections.home.title") }}
                  </h2>
                  <p class="views-admin-settings-view__description">
                    {{ t("admin.settings.site.sections.home.description") }}
                  </p>
                </div>
              </div>
              <div class="views-admin-settings-view__panel-52">
                <div>
                  ...
                  <p class="views-admin-settings-view__description-27">
                    {{ t("admin.settings.site.homeContentIframeWarning") }}
                  </p>
                </div>
                <div class="views-admin-settings-view__panel-31">
                  <div>
                    <label class="views-admin-settings-view__label-2">
            ...
            <!-- Tables & Custom Endpoints -->
            <div class="card settings-platform-card">
              <div class="settings-platform-card__header">
                <span class="settings-platform-card__index">05</span>
                <div>
                  <h2 class="views-admin-settings-view__heading">
                    {{ t("admin.settings.site.sections.tables.title") }}
                  </h2>
                  <p class="views-admin-settings-view__description">
                    {{ t("admin.settings.site.sections.tables.description") }}
                  </p>
                </div>
              </div>
              <div class="views-admin-settings-view__panel-52">
                <div class="views-admin-settings-view__panel-32">
                  ...
                  <div class="views-admin-settings-view__panel-116">
                    <div>
                      <label class="views-admin-settings-view__label-3">
                      ...
                      <input
                        ...
                        max="1000"
                        step="1"
                        class="views-admin-settings-view__field-24 input"
                      />
                      <p class="views-admin-settings-view__description-6">
                ...
                <div>
                  ...
                  <div class="views-admin-settings-view__panel-69">
                    ...
                    >
                      <div class="views-admin-settings-view__panel-28">
                        <span class="views-admin-settings-view__label-4">
                          {{ t("admin.settings.site.customEndpoints.itemLabel", { n: index + 1 }) }}
                        </span>
                        <button
                          type="button"
                          class="views-admin-settings-view__action-23"
                      ...
                      <div class="views-admin-settings-view__panel-117">
                        <div>
                          <label class="views-admin-settings-view__label-5">
                        ...
                        <div class="views-admin-settings-view__panel-118">
                          <label class="views-admin-settings-view__label-5">
                  ...
                  <button
                    type="button"
                    class="views-admin-settings-view__action-24"
                    @click="addEndpoint"
                  >
                    <svg
                      class="views-admin-settings-view__icon-3"
          ...
          <div class="card settings-platform-card">
            <div
              class="settings-platform-card__header"
            >
              <span class="settings-platform-card__index">06</span>
              <div>
              <h2 class="views-admin-settings-view__heading">
                {{ t("admin.settings.site.sections.menu.title") }}
              </h2>
              <p class="views-admin-settings-view__description">
                {{ t("admin.settings.site.sections.menu.description") }}
              </p>
              </div>
            </div>
            <div class="views-admin-settings-view__panel-5">
              ...
              >
                <div class="views-admin-settings-view__panel-28">
                  ...
                  <div class="views-admin-settings-view__panel-14">
                    ...
                    <button
                      v-if="index > 0"
                      type="button"
                      class="views-admin-settings-view__action-25"
                ...
                <div class="views-admin-settings-view__panel-117">
                  ...
                  <div>
                    ...
                    <Select v-model="item.visibility" class="views-admin-settings-view__field-22" :options="[
              ...
              <button
                type="button"
                class="views-admin-settings-view__action-26"
                @click="addMenuItem"
              >
                <svg
                  class="views-admin-settings-view__icon-3"
	        ...
	        <!-- Tab: Login Agreement -->
        <div v-if="isTabVisible('agreement')" class="views-admin-settings-view__form">
	          <div class="card">
	            <div class="views-admin-settings-view__panel-4">
	              <div class="views-admin-settings-view__panel-119">
	                <div>
	                  <h2 class="views-admin-settings-view__heading">
	                ...
	                <div class="views-admin-settings-view__panel-101">
	                  <span class="views-admin-settings-view__text-17">
              ...
              <div>
                <div class="views-admin-settings-view__panel-121">
                  <div>
                    <h3 class="views-admin-settings-view__text-2">
                  ...
                  <button
                    type="button"
                    class="views-admin-settings-view__action-27 btn btn-primary btn-sm"
                ...
                <div class="views-admin-settings-view__panel-122">
                  <div
                    v-for="(doc, index) in form.login_agreement_documents"
                    :key="doc.id || index"
                    class="views-admin-settings-view__panel-123"
                  >
                    <div class="views-admin-settings-view__panel-124">
                      <div class="views-admin-settings-view__panel-125">
                        <span class="views-admin-settings-view__text-18">
                          <Icon
                            :name="
                              index === 1
                                ? 'shield'
                        ...
                        <div class="views-admin-settings-view__panel-88">
                          <p class="views-admin-settings-view__description-28">
                            {{ doc.title || localText("未命名文档", "Untitled document") }}
                          </p>
                          <p class="views-admin-settings-view__description-29">
                      ...
                      <button
                        type="button"
                        class="views-admin-settings-view__action-28"
                        :disabled="
                    ...
                    <div class="views-admin-settings-view__panel-126">
                      <div>
                        <label class="views-admin-settings-view__label-5">
                      ...
                      <div>
                        ...
                        <div class="views-admin-settings-view__panel-127">
                          <span class="views-admin-settings-view__text-19">
                            /legal/
                          </span>
                          <input
                            v-model="doc.id"
                            type="text"
                            class="views-admin-settings-view__field-25"
        ...
        <!-- /Tab: Login Agreement -->
	        ...
	        <!-- Tab: Feature Details -->
        <div v-if="isTabVisible('features')" class="views-admin-settings-view__form">

        <div v-if="isFeatureSettingsCard('channel-monitor')" class="card">
          <div class="views-admin-settings-view__panel-4">
            <h2 class="views-admin-settings-view__heading">
            ...
            <p class="views-admin-settings-view__description-30">
              <router-link
                to="/admin/channels/monitor"
                class="views-admin-settings-view__router-link"
              >
        ...
        <div v-if="isFeatureSettingsCard('available-channels')" class="card">
          <div class="views-admin-settings-view__panel-4">
            <h2 class="views-admin-settings-view__heading">
        ...
        <div v-if="isFeatureSettingsCard('model-plaza')" class="card">
          <div class="views-admin-settings-view__panel-4">
            <h2 class="views-admin-settings-view__heading">
          ...
          <div class="views-admin-settings-view__panel-15">
            ...
            <div>
              ...
              <p class="views-admin-settings-view__description-32">
        ...
        <div v-if="isFeatureSettingsCard('risk-control')" class="card">
          <div class="views-admin-settings-view__panel-4">
            <h2 class="views-admin-settings-view__heading">
          ...
          <div class="views-admin-settings-view__panel-15">
            ...
            <div v-if="form.cyber_session_block_enabled">
              <label class="input-label">
                ...
                <span class="views-admin-settings-view__text-20">*</span>
              </label>
              <input
        ...
        <div v-if="isFeatureSettingsCard('affiliate')" class="card">
          <div class="views-admin-settings-view__panel-4">
            <h2 class="views-admin-settings-view__heading">
          ...
          <div class="views-admin-settings-view__panel-15">
            <div class="views-admin-settings-view__form">
              <div>
                ...
                <div class="views-admin-settings-view__panel-103">
                  <input
                    ...
                    placeholder="20"
                  />
                  <span class="views-admin-settings-view__text-21">%</span>
                </div>
              ...
              <div>
                ...
                <div class="payment-fixed-contract" data-testid="affiliate-freeze-hours-fixed">
                  <strong>168</strong>
                  <span>{{ t('admin.settings.features.affiliate.hoursUnit') }}</span>
                </div>
                <p class="views-admin-settings-view__description-31">
              ...
              <div class="views-admin-settings-view__panel-130">
                ...
                <div class="views-admin-settings-view__panel-20">
                  <input
                    ...
                    type="text"
                    class="views-admin-settings-view__field-3 input"
                ...
                <div class="views-admin-settings-view__panel-131">
                  <table class="views-admin-settings-view__table-2">
                    <thead class="views-admin-settings-view__header">
                      <tr>
                        <th class="views-admin-settings-view__heading-7">
                          <input
                            type="checkbox"
                        ...
                        <th class="views-admin-settings-view__heading-8">{{ t('admin.settings.features.affiliate.customUsers.col.email') }}</th>
                        <th class="views-admin-settings-view__heading-8">{{ t('admin.settings.features.affiliate.customUsers.col.username') }}</th>
                        <th class="views-admin-settings-view__heading-8">{{ t('admin.settings.features.affiliate.customUsers.col.code') }}</th>
                        <th class="views-admin-settings-view__heading-8">{{ t('admin.settings.features.affiliate.customUsers.col.rate') }}</th>
                        <th class="views-admin-settings-view__heading-8">{{ t('admin.settings.features.affiliate.customUsers.col.actions') }}</th>
                      </tr>
                    </thead>
                    <tbody class="views-admin-settings-view__body">
                      <tr v-if="affiliateState.loading">
                        <td colspan="6" class="views-admin-settings-view__cell-3">
                          {{ t('common.loading') }}
                        </td>
                      </tr>
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        <td class="views-admin-settings-view__cell-4">
                          <input
                            type="checkbox"
                        ...
                        <td class="views-admin-settings-view__cell-5">{{ entry.email }}</td>
                        <td class="views-admin-settings-view__cell-6">{{ entry.username }}</td>
                        <td class="views-admin-settings-view__cell-7">
                          {{ entry.aff_code }}
                          <span
                            v-if="entry.aff_code_custom"
                            class="views-admin-settings-view__text-22"
                          >{{ t('admin.settings.features.affiliate.customUsers.customBadge') }}</span>
                        </td>
                        <td class="views-admin-settings-view__cell-8">
                          <span v-if="entry.aff_rebate_rate_percent != null">{{ entry.aff_rebate_rate_percent }}%</span>
                          <span v-else class="views-admin-settings-view__text-10">{{ t('admin.settings.features.affiliate.customUsers.useGlobal') }}</span>
                        </td>
                        <td class="views-admin-settings-view__cell-8">
                          <div class="views-admin-settings-view__panel-14">
                            <button type="button" class="views-admin-settings-view__action-30" @click="openAffiliateModal(entry)">
                              {{ t('common.edit') }}
                            </button>
                            <button
                              type="button"
                              class="views-admin-settings-view__action-31"
                ...
                <div v-if="affiliateState.total > affiliateState.pageSize" class="views-admin-settings-view__panel-132">
                  <span class="views-admin-settings-view__text-23">
                  ...
                  <div class="views-admin-settings-view__panel-14">
                    ...
                    <span class="views-admin-settings-view__text-23">{{ affiliateState.page }} / {{ Math.max(1, Math.ceil(affiliateState.total / affiliateState.pageSize)) }}</span>
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm"
        ...
        <div
          v-if="isFeatureSettingsCard('affiliate') && affiliateModal.open"
        ...
        >
          <div class="views-admin-settings-view__panel-134">
            ...
            <div class="views-admin-settings-view__panel-11">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                <div
                  ...
                  class="views-admin-settings-view__panel-135"
                >
                  <div class="views-admin-settings-view__field-22">
                    <span class="views-admin-settings-view__label-2">{{ affiliateModal.selectedUser.email }}</span>
                    <span class="views-admin-settings-view__text-24">({{ affiliateModal.selectedUser.username }})</span>
                  </div>
                  <button
                    type="button"
                    class="views-admin-settings-view__action-32"
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="views-admin-settings-view__field-26 input"
            ...
            <div class="views-admin-settings-view__panel-137">
              <p
                v-if="!affiliateModalCanSubmit"
                class="views-admin-settings-view__description-7"
              >
        ...
        >
          <div class="views-admin-settings-view__panel-134">
            ...
            <p class="views-admin-settings-view__description-33">
            ...
            <p class="views-admin-settings-view__description-34">
              {{ t('admin.settings.features.affiliate.batchModal.clearHint') }}
            </p>
            <div class="views-admin-settings-view__panel-138">
        ...
        <!-- Tab: Email -->
        <!-- Tab: Payment -->
        <div v-if="isTabVisible('payment')" class="views-admin-settings-view__form">
            ...
            >
              ...
              <p class="views-admin-settings-view__description">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="views-admin-settings-view__link-4"
                >
                  <svg
                    class="views-admin-settings-view__icon-8"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <!-- Row 1: Product name -->
                <div class="views-admin-settings-view__panel-139">
                  ...
                  <div>
                    ...
                    <div
                      class="views-admin-settings-view__panel-140"
                    >
                      {{
                        (form.payment_product_name_prefix || "EasySub2api") +
                        " 100 " +
                ...
                <div class="views-admin-settings-view__panel-141">
                  <div>
                    <label class="input-label">{{
                  ...
                  <div>
                    <label class="input-label">{{ t("admin.settings.payment.pointsConversion") }}</label>
                    <div class="payment-fixed-contract" data-testid="payment-points-conversion">
                      <strong>1 RMB</strong>
                      <Icon name="arrowRight" size="sm" />
                      <strong>{{ t("admin.settings.payment.onePlatformPoint") }}</strong>
                    </div>
                    <p class="views-admin-settings-view__description-25">
                      {{ t("admin.settings.payment.pointsConversionHint") }}
                    </p>
                  </div>
                  <div class="payment-bonus-tiers" data-testid="payment-recharge-bonus-tiers">
                    <div class="payment-bonus-tiers__header">
                      <div>
                        <label class="input-label">{{ t("admin.settings.payment.bonusTiers") }}</label>
                        <p class="views-admin-settings-view__description-25">{{ t("admin.settings.payment.bonusTiersHint") }}</p>
                      </div>
                      <button type="button" class="btn btn-secondary" data-testid="add-recharge-bonus-tier" @click="addRechargeBonusTier">
                        <Icon name="plus" size="sm" />
                        {{ t("admin.settings.payment.addBonusTier") }}
                      </button>
                    </div>
                    <p v-if="form.payment_recharge_bonus_tiers.length === 0" class="payment-bonus-tiers__empty">
                      {{ t("admin.settings.payment.noBonusTiers") }}
                    </p>
                    <div v-else class="payment-bonus-tiers__rows">
                      <div v-for="(tier, index) in form.payment_recharge_bonus_tiers" :key="index" class="payment-bonus-tiers__row">
                        <label>
                          <span>{{ t("admin.settings.payment.bonusThreshold") }}</span>
                          <input
                            :value="tier.threshold_cny"
                            :data-testid="`recharge-bonus-threshold-${index}`"
                            type="number"
                            inputmode="decimal"
                            min="0"
                            step="0.01"
                            class="input"
                            @input="tier.threshold_cny = ($event.target as HTMLInputElement).value"
                          />
                        </label>
                        <label>
                    ...
                    <p v-if="invalidRechargeBonusTierRow != null" class="payment-bonus-tiers__error">
                      {{ t("admin.settings.payment.invalidBonusTier", { row: invalidRechargeBonusTierRow }) }}
                    </p>
                    <p v-else-if="duplicateRechargeBonusTierThreshold != null" class="payment-bonus-tiers__error">
                      {{ t("admin.settings.payment.duplicateBonusThreshold", { amount: duplicateRechargeBonusTierThreshold }) }}
                    </p>
                  </div>
                  <div>
                    <label class="input-label">{{
                    ...
                    <div class="views-admin-settings-view__panel-103">
                      ...
                      />
                      <span
                        class="views-admin-settings-view__text-25"
                        >%</span
                      >
                    </div>
                    <p class="views-admin-settings-view__description-25">
                  ...
                  <div>
                    <label class="input-label"
                      ...
                      <span class="views-admin-settings-view__text-20">*</span></label
                    ><input
                ...
                <div class="views-admin-settings-view__panel-142">
                  <div class="views-admin-settings-view__panel-143">
                    <label class="input-label">{{
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      class="views-admin-settings-view__field-24"
                    />
                  </div>
                  <div>
                    <label class="input-label">{{
                    ...
                    <div class="views-admin-settings-view__panel-14">
                      <button
                        type="button"
                        :class="[
                          'views-admin-settings-view__action-37',
                          form.payment_cancel_rate_limit_enabled
                            ? 'views-admin-settings-view__action-38'
                            : 'views-admin-settings-view__action-39',
                        ]"
                        @click="
                          form.payment_cancel_rate_limit_enabled =
                            !form.payment_cancel_rate_limit_enabled
                      ...
                      >
                        <span
                          :class="[
                            'views-admin-settings-view__text-27',
                            form.payment_cancel_rate_limit_enabled
                              ? 'toggle-thumb--on'
                              : 'views-admin-settings-view__text-28',
                          ]"
                        />
                      </button>
                      <Select
                        ...
                        class="views-admin-settings-view__field-27"
                        :disabled="!form.payment_cancel_rate_limit_enabled"
                      />
                      <span
                        :class="[
                          'views-admin-settings-view__text-29',
                          form.payment_cancel_rate_limit_enabled
                            ? 'views-admin-settings-view__text-30'
                            : 'views-admin-settings-view__text-31',
                        ]"
                        >{{
                      ...
                      <input
                        ...
                        min="1"
                        required
                        class="views-admin-settings-view__field-28 input"
                        :disabled="!form.payment_cancel_rate_limit_enabled"
                      />
                      <Select
                        v-model="form.payment_cancel_rate_limit_unit"
                        :options="cancelRateLimitUnitOptions"
                        class="views-admin-settings-view__panel-143"
                        :disabled="!form.payment_cancel_rate_limit_enabled"
                      />
                      <span
                        :class="[
                ...
                <div>
                  ...
                  <div class="views-admin-settings-view__panel-144">
                    <button
                      ...
                      :class="[
                        'views-admin-settings-view__action-40',
                        isPaymentTypeEnabled(pt.value)
                          ? 'views-admin-settings-view__action-41'
                          : 'views-admin-settings-view__action-42',
                      ]"
                    >
                      {{ pt.label }}
                    </button>
                  ...
                  <p class="views-admin-settings-view__description-10">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="views-admin-settings-view__link-5"
                    >
                      {{ t("admin.settings.payment.findProvider") }}
                      <svg
                        class="views-admin-settings-view__icon-9"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        <div v-if="isTabVisible('email')" class="views-admin-settings-view__form">
            ...
            <div class="views-admin-settings-view__panel-77">
              <div class="views-admin-settings-view__panel-145">
                <Icon
                  name="mail"
                  size="md"
                  class="views-admin-settings-view__icon-10"
                />
                <div>
                  <h3 class="views-admin-settings-view__label-2">
          ...
          <div v-if="form.email_verify_enabled" class="card">
            <div
              class="views-admin-settings-view__panel-146"
            >
              <div>
                <h2 class="views-admin-settings-view__heading">
          ...
          <div class="card">
            <div
              class="views-admin-settings-view__panel-4"
            >
              <h3 class="views-admin-settings-view__heading-10">
            ...
            <div class="views-admin-settings-view__panel-148">
              <div class="views-admin-settings-view__panel-38">
                <div>
                  <label
                    class="views-admin-settings-view__label-15"
                  >
          ...
          <div class="card">
            ...
            <div class="views-admin-settings-view__panel-149">
              <div class="views-admin-settings-view__panel-10">
                <label
                  class="views-admin-settings-view__label-15"
              ...
              <div v-if="form.balance_low_notify_enabled">
                ...
                <div class="views-admin-settings-view__panel-103">
                  <input
                    ...
                    min="0"
                    step="0.01"
                    class="views-admin-settings-view__field-29 input"
                  />
                  <span class="views-admin-settings-view__text-26">
                    {{ t("common.points") }}
                  </span>
                </div>
                <p class="views-admin-settings-view__description-16">
            ...
            <div class="views-admin-settings-view__panel-149">
              ...
              <div v-if="form.account_quota_notify_enabled">
                ...
                <div class="views-admin-settings-view__panel-62">
                  ...
                  >
                    <label
                      class="views-admin-settings-view__label-16"
                    >
                      <input
                        type="checkbox"
                        :checked="!entry.disabled"
                        @change="entry.disabled = !entry.disabled"
                        class="views-admin-settings-view__field-30"
                      />
                      <div
                        class="views-admin-settings-view__panel-150 has-pseudo-indicator"
                      ></div>
                    </label>
                    <input
                      v-model="entry.email"
                    ...
                    <button
                      ...
                      class="views-admin-settings-view__action-17 btn btn-secondary"
                      type="button"
                    >
                      <Icon name="x" size="xs" class="views-admin-settings-view__icon-3" />
                    </button>
                  </div>
                  <button
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/AsukaCC/EasySub2api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/AsukaCC/EasySub2api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/AsukaCC/EasySub2api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/AsukaCC/EasySub2api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
const settingsSectionTabs: Record<SettingsSection, SettingsTab[]> = {
  platform: ["general"],
  "feature-channel-monitor": ["features"],
  "feature-model-plaza": ["features"],
  "feature-affiliate": ["features"],
  compliance: ["agreement"],
  access: ["security", "users"],
  gateway: ["gateway"],
  payment: ["payment"],
  operations: ["email", "backup"],
};
const settingsSection = computed<SettingsSection>(() => {
  const raw = route.meta.settingsSection as string | undefined;
  return raw && raw in settingsSectionTabs
    ? (raw as SettingsSection)
    : "platform";
});
const visibleSettingsTabs = computed(
  () => settingsSectionTabs[settingsSection.value],
);
const hasSectionSave = computed(() =>
  visibleSettingsTabs.value.some((tab) => tab !== "backup"),
);

function isTabVisible(tab: SettingsTab): boolean {
  return visibleSettingsTabs.value.includes(tab);
}

function isFeatureSettingsCard(feature: "channel-monitor" | "available-channels" | "model-plaza" | "risk-control" | "affiliate"): boolean {
  return settingsSection.value === `feature-${feature}`;
}
...
const SETTINGS_SECTION_FIELDS: Record<SettingsSection, ReadonlySet<string>> = {
  ...
  compliance: new Set([
    "login_agreement_enabled", "login_agreement_mode",
    "login_agreement_updated_at", "login_agreement_documents",
  ]),
  access: new Set([
    "registration_enabled", "email_verify_enabled", "registration_email_suffix_whitelist",
    "registration_email_domain_quota_enabled", "promo_code_enabled", "invitation_code_enabled",
    ...
    "tencent_captcha_app_secret_key", "tencent_captcha_cloud_secret_id",
    "tencent_captcha_cloud_secret_key", "tencent_captcha_region", "aliyun_captcha_enabled",
    "aliyun_captcha_prefix", "aliyun_captcha_scene_id", "aliyun_captcha_access_key_id",
    "aliyun_captcha_access_key_secret", "aliyun_captcha_region",
    "dingtalk_connect_enabled", "dingtalk_connect_client_id",
    "dingtalk_connect_client_secret", "dingtalk_connect_redirect_url",
    "dingtalk_connect_corp_restriction_policy", "dingtalk_connect_internal_corp_id",
    ...
    "dingtalk_connect_sync_corp_email_attr_key", "dingtalk_connect_sync_display_name_attr_key",
    "dingtalk_connect_sync_dept_attr_key", "dingtalk_connect_sync_corp_email_attr_name",
    "dingtalk_connect_sync_display_name_attr_name", "dingtalk_connect_sync_dept_attr_name",
    "dingtalk_connect_scopes", "github_oauth_enabled",
    ...
    "google_oauth_scopes", "github_oauth_redirect_url", "github_oauth_frontend_redirect_url",
    "google_oauth_redirect_url", "google_oauth_frontend_redirect_url",
    "wechat_connect_enabled", "wechat_connect_mode",
    "wechat_connect_open_enabled", "wechat_connect_open_app_id", "wechat_connect_open_app_secret",
    "wechat_connect_mp_enabled", "wechat_connect_mp_app_id", "wechat_connect_mp_app_secret",
    "wechat_connect_mobile_enabled", "wechat_connect_mobile_app_id", "wechat_connect_mobile_app_secret",
    "wechat_connect_scopes", "wechat_connect_redirect_url", "wechat_connect_frontend_redirect_url",
    "oidc_connect_enabled", "oidc_connect_provider_name", "oidc_connect_issuer_url",
    "oidc_connect_discovery_url", "oidc_connect_authorize_url", "oidc_connect_token_url",
    "oidc_connect_userinfo_url", "oidc_connect_jwks_url", "oidc_connect_client_id",
    "oidc_connect_client_secret", "oidc_connect_scopes", "oidc_connect_redirect_url",
    "oidc_connect_frontend_redirect_url", "oidc_connect_token_auth_method", "oidc_connect_use_pkce",
    "oidc_connect_validate_id_token", "oidc_connect_allowed_signing_algs",
    "oidc_connect_clock_skew_seconds", "oidc_connect_require_email_verified",
  ...
  gateway: new Set([
    ...
    "openai_oauth_scheduling_rate_multiplier", "openai_advanced_scheduler_enabled",
    "openai_advanced_scheduler_rpm_limit", "openai_advanced_scheduler_tpm_limit",
    "openai_advanced_scheduler_window_seconds",
    "openai_fast_policy_settings", "web_search_emulation_enabled", "web_search_emulation_domains",
  ]),
  payment: new Set([
    ...
    "payment_cancel_rate_limit_unit", "payment_cancel_rate_limit_window_mode",
  ...
  operations: new Set([
    ...
    "smtp_from_name", "smtp_use_tls", "balance_low_notify_enabled",
...
function pickSectionPayload(
  payload: UpdateSettingsRequest,
  section: SettingsSection,
): UpdateSettingsRequest {
  const allowed = SETTINGS_SECTION_FIELDS[section];
  return Object.fromEntries(
    Object.entries(payload).filter(([key]) =>
      allowed.has(key) ||
      (section === "access" && key.startsWith("auth_source_default_")),
    ),
...
const lastSavedSection = ref<SettingsSection | null>(null);
...
> & {
  ...
  payment_recharge_bonus_tiers: EditableRechargeBonusTier[];
...
function canonicalDecimalText(value: unknown, maxScale: number): string | null {
  const raw = String(value ?? "").trim();
  const match = /^(\d*)(?:\.(\d*))?$/.exec(raw);
  if (!match || (!match[1] && !match[2]) || (match[2]?.length ?? 0) > maxScale) {
    return null;
  }
...
function editableRechargeBonusTiers(value: unknown): EditableRechargeBonusTier[] {
...
const duplicateRechargeBonusTierThreshold = computed<string | null>(() => {
  const seen = new Set<string>();
  for (const tier of form.payment_recharge_bonus_tiers) {
    const threshold = canonicalDecimalText(tier.threshold_cny, 2);
    if (threshold == null) continue;
    if (seen.has(threshold)) return threshold;
    seen.add(threshold);
  }
  return null;
});
...
function addRechargeBonusTier(): void {
  const thresholds = form.payment_recharge_bonus_tiers
    .map((tier) => canonicalDecimalText(tier.threshold_cny, 2))
    .filter((threshold): threshold is string => threshold != null)
...
async function loadSettings() {
  ...
  try {
    ...
    form.payment_recharge_bonus_tiers = editableRechargeBonusTiers(
...
async function saveSettings(section?: SettingsSection) {
  saving.value = true;
  try {
    const saveAllSections = !section;
    const savePlatform = saveAllSections || section === "platform";
    const saveCompliance = saveAllSections || section === "compliance";
    const saveAccess = saveAllSections || section === "access";
    const savePayment = saveAllSections || section === "payment";
    if (savePayment && invalidRechargeBonusTierRow.value != null) {
      appStore.showError(
        t("admin.settings.payment.invalidBonusTier", {
          row: invalidRechargeBonusTierRow.value,
        }),
      );
      return;
    }
    if (savePayment && duplicateRechargeBonusTierThreshold.value != null) {
      appStore.showError(
        t("admin.settings.payment.duplicateBonusThreshold", {
          amount: duplicateRechargeBonusTierThreshold.value,
        }),
      );
      return;
    }
    const normalizedRechargeBonusTiers = parseRechargeBonusTiers(
    ...
    if (savePlatform && !normalizedTablePageSizeOptions) {
      appStore.showError(
    ...
    if (saveCompliance && form.login_agreement_enabled && normalizedLoginAgreementDocuments.length === 0) {
      appStore.showError(
        localText(
    ...
    if (saveCompliance && emptyTitleDocument) {
      appStore.showError(
        localText(
          "登录条款文档名称不能为空。",
    ...
    if (saveCompliance && duplicateLoginAgreementDocumentId) {
      appStore.showError(
        localText(
    ...
    if (saveAccess && duplicateDefaultSubscription) {
      appStore.showError(
    ...
    if (saveAccess && form.wechat_connect_mp_enabled && form.wechat_connect_mobile_enabled) {
      appStore.showError(
        localText(
          "公众号和移动应用不能同时启用。",
    ...
    const payload: UpdateSettingsRequest = {
	  ...
	  bonus_balance_default_validity_days: Math.max(1, Math.min(3650, Number(form.bonus_balance_default_validity_days) || 90)),
    ...
    const requestPayload = section
      ? pickSectionPayload(payload, section)
      : payload;
    const updated = await settingsStepUp.run(() =>
      adminAPI.settings.updateSettings(requestPayload),
    );
    ...
    const wsOk = !section || section === "gateway"
      ? await saveWebSearchConfig()
      : true;
    // Refresh cached settings so sidebar/header update immediately
    await appStore.fetchPublicSettings(true);
    await adminSettingsStore.fetch(true);
    lastSavedSection.value = section ?? null;
    if (wsOk) {
...
async function saveSection() {
  await saveSettings(settingsSection.value);
}
...
function toggleAffiliateSelect(userId: string) {
...
.settings-platform-card__header {
  display: flex;
...
.settings-platform-card__header > div {
  min-width: 0;
}

.settings-platform-card__header .views-admin-settings-view__heading {
...
.payment-bonus-tiers__header,
.payment-bonus-tiers__row {
  display: flex;
...
.payment-bonus-tiers__rows {
  display: grid;
  gap: 0.625rem;
  margin-top: 0.75rem;
}

.payment-bonus-tiers__row label {
  display: grid;
  flex: 1;
  gap: 0.25rem;
  min-width: 0;
