...
describe('PaymentResultView', () => {
  ...
  it('renders recharge money in CNY and credited value in points', async () => {
    routeState.query = {
    ...
    expect(wrapper.text()).toContain(formatCNY(103, 'en'))
    expect(wrapper.text()).toContain(formatPoints(120, 'en'))
