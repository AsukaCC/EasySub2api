<template>
  <AppLayout>
    <TablePageLayout>
      <template #filters>
        <div class="views-user-available-channels-view__panel">
          <div class="views-user-available-channels-view__panel-2">
            <div class="views-user-available-channels-view__panel-3">
              <Icon
                name="search"
                size="md"
                class="views-user-available-channels-view__icon"
              />
              <input
                v-model="searchQuery"
                type="text"
                :placeholder="t('availableChannels.searchPlaceholder')"
                class="views-user-available-channels-view__field input"
              />
            </div>
          </div>

          <div class="views-user-available-channels-view__panel-4">
            <button
              @click="loadChannels"
              :disabled="loading"
            ...
            >
              <Icon name="refresh" size="md" :class="loading ? 'views-user-available-channels-view__icon-2' : ''" />
            </button>
          </div>
        </div>
      </template>
