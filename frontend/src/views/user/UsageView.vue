  ...
  <AppLayout>
    <div class="views-user-usage-view__panel">
      ...
      <div class="views-user-usage-view__panel-2">
        <div class="views-user-usage-view__panel-3 card">
          <div class="views-user-usage-view__panel-4">
            <div class="views-user-usage-view__panel-5">
              <span class="views-user-usage-view__text">{{ t('admin.dashboard.timeRange') }}:</span>
              <DateRangePicker
            ...
            <div class="views-user-usage-view__panel-6">
              <span class="views-user-usage-view__text">{{ t('admin.dashboard.granularity') }}:</span>
              <div class="views-user-usage-view__panel-7">
        ...
        <div class="views-user-usage-view__panel-8">
      ...
      <div class="views-user-usage-view__panel-9 card">
        <div class="views-user-usage-view__panel-10">
          <div v-if="activeTab === 'errors'" class="views-user-usage-view__panel-11">
            <div class="views-user-usage-view__panel-12">
          ...
          <div v-else class="views-user-usage-view__panel-11">
            <div class="views-user-usage-view__panel-12">
          ...
          <div class="views-user-usage-view__panel-15">
            ...
            <div class="views-user-usage-view__panel-16" ref="columnDropdownRef">
              <button
                ...
                class="views-user-usage-view__action btn btn-secondary"
                :title="t('admin.users.columnSettings')"
              >
                <Icon name="grid" size="sm" />
                <span class="views-user-usage-view__text-2">{{ t('admin.users.columnSettings') }}</span>
              </button>
              <div
      ...
      <div v-if="errorViewEnabled" class="views-user-usage-view__panel-18">
        <button class="views-user-usage-view__action-3" :class="{ 'tab-active': activeTab === 'usage' }" @click="activeTab = 'usage'">
          {{ t('usage.tabs.usage') }}
        </button>
        <button class="views-user-usage-view__action-3" :class="{ 'tab-active': activeTab === 'errors' }" @click="switchToErrors">
          {{ t('usage.tabs.errors') }}
        </button>
      </div>
...
const errorFilter = ref<{ model: string | null; category: string; api_key_id: string | null; status_code: number | null }>({
  model: '',
  category: '',
  api_key_id: null,
  status_code: null,
