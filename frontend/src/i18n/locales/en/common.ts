export default {
  common: {
    ...
    groupRateComparison: 'Group rate {original}x multiplied by the level and current discount gives {lowest}x for recharge points; bonus points exclude timed discounts',
    groupRateActualComparison: 'Original rate {original}x; current billed rate {actual}x',
    ...
    resizeColumnHint: 'Drag to resize the {column} column; double-click or press Enter to reset',
    search: 'Search',
    filter: 'Filter',
    export: 'Export',
    import: 'Import',
    ...
    view: 'View',
    settings: 'Settings',
    settingsFeatures: 'Feature Management',
    settingsFeatureChannelMonitor: 'Channel Monitor Settings',
    settingsFeatureAvailableChannels: 'Available Channels Settings',
    settingsFeatureModelPlaza: 'Model Plaza Settings',
    settingsFeaturePayment: 'Payment Settings',
    settingsFeatureRiskControl: 'Risk Control Settings',
    settingsFeatureAffiliate: 'Affiliate Settings',
    settingsFeatureOpsMonitoring: 'Operations Monitoring Settings',
    settingsPlatform: 'Platform',
    settingsCompliance: 'Login & Compliance',
    settingsAccess: 'Access & Users',
    settingsGateway: 'Gateway & Scheduling',
    settingsOperations: 'Email & Operations',
  ...
  nav: {
    ...
    settingsAffiliate: 'Affiliate Settings',
    profile: 'Profile',
    users: 'Users',
    userList: 'User List',
    ...
    ops: 'Ops',
    opsDashboard: 'Monitoring Dashboard',
    adminOperations: 'Operations',
    adminMenu: 'Admin Menu',
    adminOverview: 'Overview',
    resourceManagement: 'Core Resources',
    userBusinessManagement: 'Users & Business',
    operationsSecurity: 'Operations & Security',
    systemManagement: 'System Configuration',
    customPages: 'Custom Pages',
    businessManagement: 'Business',
    promoCodes: 'Promo Codes',
    settings: 'Settings',
    settingsFeatures: 'Feature Management',
    settingsUpdates: 'System Updates',
    settingsChannelMonitor: 'Monitor Settings',
    settingsPayment: 'Payment Settings',
    settingsModelPlaza: 'Model Plaza Settings',
    settingsOpsMonitoring: 'Operations Monitoring Settings',
    settingsPlatform: 'Platform',
    settingsCompliance: 'Login & Compliance',
    settingsAccess: 'Access & Users',
    settingsGateway: 'Gateway & Scheduling',
    ...
    themeAccentReset: 'Use site default theme color',
    backgroundSaveFailed: 'Failed to save background image (image may be too large)',
    collapse: 'Collapse',
    expand: 'Expand',
    logout: 'Logout',
    github: 'GitHub',
    mySubscriptions: 'My Subscriptions',
    buySubscription: 'Recharge Points',
    recharge: 'Recharge',
    subscribe: 'Subscribe',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  tickets: {
    ...
    description: 'Submit account or refund issues and follow every update in one timeline.',
    adminTitle: 'Ticket Management',
    adminDescription: 'Handle user issues, refund reviews, and the complete conversation history.',
    create: 'New Ticket',
    created: 'Ticket created',
    replied: 'Reply sent',
    disabled: 'New tickets are currently disabled. Existing tickets remain available.',
    list: 'Ticket list',
    empty: 'No tickets match these filters',
    emptyTitle: 'No tickets',
    unreadBadge: '{n} unread',
    selectHint: 'Select a ticket to view its details',
    searchPlaceholder: 'Search user, order, or ticket',
    ...
    apiKey: 'API key',
    apiKeyOptional: 'Related API key (optional)',
    noApiKey: 'No API key',
    group: 'Group snapshot',
    order: 'Order',
    user: 'User',
    approvedAmount: 'Approved principal',
    createdAt: 'Created',
    replyPlaceholder: 'Enter a reply, up to 4000 characters',
    send: 'Send Reply',
    ...
    principalAmount: 'Refund principal (CNY)',
    approve: 'Approve Refund',
    reject: 'Reject Refund',
    retry: 'Retry Refund',
    systemEvent: 'System status update',
    categories: { account: 'Account Issue', refund: 'Refund Issue' },
    statuses: {
    ...
    authors: { user: 'User', admin: 'Admin', system: 'System' },
    events: {
      refund_auto_failed: 'Automatic refund could not complete and was sent for manual review',
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive {amount}',
    ...
    affiliateCodeLabel: 'Invitation code',
    affiliateCodePlaceholder: 'Enter invitation code',
    invitationCodeRequired: 'Invitation code is required',
    invitationCodeValid: 'Invitation code is valid',
    invitationCodeInvalid: 'Invalid, disabled, or expired invitation code',
