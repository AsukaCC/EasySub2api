export default {
    settings: {
      ...
      systemUpdates: {
        ...
        description: 'Check for new releases, review release notes, and manage updates, restarts, and rollbacks.',
        check: 'Check for updates',
        checking: 'Checking...',
        checkFailed: 'Failed to check for updates',
        releaseBuild: 'Release build',
        sourceBuild: 'Source build',
        loadRollback: 'Load rollback versions',
        rollbackPrompt: 'Click “Load rollback versions” to view recent releases.',
        rollbackDescription: 'Online rollback is available for release builds only; use git for source builds.',
      },
      featureManagement: {
        title: 'Feature Management',
        description: 'Control feature runtime and user release state in one place. Enable and configure a feature before publishing it.',
        running: 'Running',
        stopped: 'Disabled',
        published: 'Published',
        ...
        configure: 'Configure',
        loadFailed: 'Failed to load feature states',
        saveFailed: 'Failed to save the feature state; the previous state was restored',
        modules: {
          payment: 'Payment',
        ...
        moduleDescriptions: {
          ...
          supportTickets: 'Handle account issues and refund requests in one place. Switches only gate new tickets.',
        },
        opsSettings: {
          title: 'Operations Monitoring Settings',
          description: 'Configure monitoring collection and existing operations runtime parameters. Use Feature Management for the master switch.',
          openDashboard: 'Open monitoring dashboard',
          realtime: 'Real-time monitoring',
          realtimeHint: 'Collect real-time concurrency and traffic information.',
          queryMode: 'Default query mode',
          metricsInterval: 'Metrics collection interval (seconds)',
          advanced: 'Advanced operations settings',
          intervalError: 'Metrics collection interval must be an integer from 1 to 3600 seconds',
        },
        riskSettings: {
          ttlError: 'Block duration must be an integer from 1 to 604800 seconds',
        },
      },
      features: {
        channelMonitor: {
          title: 'Channel Monitor',
          description: 'Passively aggregate error rate, latency, cache rate, and throughput from real gateway traffic without sending upstream probes.',
          configureLink: 'Open passive monitoring settings',
          openDashboard: 'Open monitor dashboard',
          enabled: 'Enable Channel Monitor',
          enabledHint: 'Disabling stops passive aggregation and hides the user entry; existing config and history are kept.',
        ...
        affiliate: {
          ...
          description: 'Referral codes establish invitation relationships; completed recharges generate rebate points from credited points. Disabled by default.',
          ...
          recipientHint: 'Choose who receives newly accrued rebate points. Existing rebates keep the recipient recorded when they were created.',
          freezeHours: 'Fixed Rebate Freeze Period',
          hoursUnit: 'hours (7 days)',
      ...
      apiKeyAcl: {
        ...
        trustForwardedIpHint:
          'Disabled by default so the Gin trusted-proxy chain configured by server.trusted_proxies remains authoritative. When enabled, raw CF-Connecting-IP, X-Real-IP, or X-Forwarded-For values take over client-IP resolution. Only enable takeover mode when the origin cannot be reached directly and the proxy overwrites these headers. Changing this switch changes existing session IP fingerprints.',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for EasySub2api end-user login',
      ...
      defaults: {
        ...
        defaultBalance: 'Default Platform Points',
        defaultBalanceHint: 'Initial platform points for new users',
		bonusValidityDays: 'Default bonus point validity (days)',
		bonusValidityDaysHint: 'Used for registration, auth grants, promo codes, redeem codes, and rebates unless overridden',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, EasySub2api temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream EasySub2api sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        title: 'Site Settings',
        description: 'Configure platform runtime, branding, links, and presentation by module.',
        sections: {
          runtime: {
            title: 'Runtime Mode',
            description: 'Control whether the platform is restricted to administrators only.',
          },
          branding: {
            title: 'Site Branding',
            description: 'Configure the site name, identity, and contact information.',
          },
          links: {
            title: 'API & External Links',
            description: 'Set the API address and documentation entry points.',
          },
          home: {
            title: 'Homepage Presentation',
            description: 'Configure homepage content and user-facing presentation preferences.',
          },
          tables: {
            title: 'Tables & Custom Endpoints',
            description: 'Set pagination defaults and maintain copyable API endpoints for users.',
          },
          menu: {
            title: 'Custom Menu',
            description: 'Manage custom sidebar pages and their visible roles.',
          },
        },
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'EasySub2api',
        siteNameHint: 'Displayed in emails and page titles',
        themeAccent: 'Theme accent',
        themeAccentHint: 'Used for primary buttons, links, and focus rings. Does not change light/dark or glass fills.',
        themeAccentCustom: 'Custom',
      ...
      payment: {
        ...
        pointsConversion: 'Recharge Point Conversion',
        onePlatformPoint: '1 platform point',
        pointsConversionHint: 'The conversion is permanently 1:1 and does not alter usage multipliers. Payment fees remain separate on recharge orders.',
        bonusTiers: 'Recharge Bonus Tiers',
        bonusTiersHint: 'Match against RMB recharge principal. Only the highest qualifying point bonus is granted; tiers do not stack.',
        addBonusTier: 'Add tier',
        noBonusTiers: 'No recharge bonuses configured',
        bonusThreshold: 'Recharge threshold (RMB)',
        bonusPoints: 'Bonus points',
        invalidBonusTier: 'Tier {row} is invalid. The recharge threshold allows up to 2 decimals, bonus points allow up to 8 decimals, and neither value may be negative.',
        duplicateBonusThreshold: 'The {amount} RMB recharge threshold is duplicated. Adjust it before saving.',
        ...
        balancePaymentDisabled: 'Disable Point Top-Up',
        ...
        field_paymentCurrencyHint: 'Only CNY channels can be used for platform point top-ups. Other currency settings are retained for compatibility and do not participate in the top-up flow.',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on EasySub2api orders; the upstream type is sent as EasyPay type.',
      ...
      balanceNotify: {
        ...
        description: 'Send an email notification when a user’s platform points fall below the threshold',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'EasySub2api',
        useTls: 'Use TLS',
      ...
      authSourceDefaults: {
        ...
        description: 'Configure per-source default platform points, concurrency, subscriptions, and grant rules.',
        requireEmailLabel: 'Require email on third-party signup',
        requireEmailHint: 'When enabled, OIDC and WeChat signups must provide an email before account creation.',
		...
		bonusValidityOverrideHint: 'Use 0 to inherit the global bonus validity.',
        sources: {
          email: {
            title: 'Email signup',
