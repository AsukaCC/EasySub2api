export default {
    accounts: {
      ...
      bulkEdit: {
        ...
        mixedPlatformWarning: 'Selected accounts span multiple platforms ({platforms}). Other bulk fields remain available; model restriction updates require a single platform.',
        modelRestrictionSinglePlatform: 'Model restriction updates require accounts from a single platform. Narrow the targets to one platform first.'
      },
      ...
      upstreamRequestIdHeader: 'Upstream ID header',
      ...
      profit: {
        ...
        subscriptionCost: 'Subscription-cycle cost (points)',
        subscriptionCostUnset: 'Not set',
        setSubscriptionCost: 'Set subscription-cycle cost',
        subscriptionCostPlaceholder: 'Leave blank to unset',
        subscriptionCostHint: 'Pre-expiry profit = 30-day window revenue points - subscription-cycle cost; unset uses upstream-cost basis',
        subscriptionCostInvalid: 'Enter a valid number greater than or equal to 0',
        clearSubscriptionCost: 'Clear cost',
        expiryProfitFormula: 'Pre-expiry profit = window revenue points - subscription-cycle cost ({cost})',
        profit: 'Profit',
        profitShort: 'Net',
        requests: 'Requests',
        requestsShort: 'requests',
        tokens: 'Tokens',
        history: 'Daily profit history',
        historyHint: 'Revenue is in points; cost is USD; profit is the system numeric difference',
        dailyChart: 'Daily earnings chart',
        dailyChartHint: 'Hover a day to inspect revenue, cost, profit, tokens, and requests',
        moneyTrend: 'Points and upstream cost trend',
        usageTrend: 'Token and request trend',
        range7d: '7 days',
        range30d: '30 days',
        range90d: '90 days',
        ...
        unitHint: 'Revenue: points · Cost: USD · Profit: numeric points difference',
        date: 'Date',
        days: '{count} days',
        loadMore: 'Load more',
        noHistory: 'No profit history',
        listEmpty: 'No account profit data',
        loadFailed: 'Failed to load account profit'
      },
      stats: {
