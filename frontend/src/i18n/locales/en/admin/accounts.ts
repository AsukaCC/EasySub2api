export default {
    accounts: {
      ...
      modelRules: {
        title: 'Model Rules',
        description: 'Save reusable account model whitelists and mappings per platform. Importing copies both into an account; later rule changes do not affect it.',
        createRule: 'New Rule',
        editRule: 'Edit Rule',
        platform: 'Platform',
        name: 'Rule Name',
        ...
        deleteConfirm: 'Delete rule “{name}”? Accounts that already imported it will not change.',
