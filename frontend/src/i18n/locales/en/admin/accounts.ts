export default {
    accounts: {
      ...
      allExpiryStatuses: 'All Expiry Statuses',
      ...
      modelRules: {
        tierMismatchShort: 'Tier mismatch',
        unrecognizedTier: 'Unrecognized tier',
        unbound: 'No rule bound',
        title: 'Model Rules',
        description: 'Maintain unified model routes by platform and subscription tier. Bound accounts follow rule updates; empty routes allow raw model passthrough.',
        createRule: 'New Rule',
        editRule: 'Edit Rule',
        platform: 'Platform',
        name: 'Rule Name',
        namePlaceholder: 'e.g. Claude compatibility map',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'Optional note',
        mapping: 'Model Mapping',
        routeConfig: 'Model Routing',
        routeCount: '{count} routes',
        addRoute: 'Add route',
        removeRoute: 'Remove route',
        routeInvalid: 'Complete each route, keep request models unique, use wildcards only at the request-model suffix, and do not use wildcards upstream.',
        emptyRoutes: 'Empty: allow every model and preserve the requested model identifier.',
        emptyRoutesHint: 'When empty, routing does not block or apply provider defaults. Once configured, only exact or suffix-wildcard request models are allowed.',
        passthroughAll: 'Empty · raw passthrough',
        scope: 'Scope',
        subscriptionTier: 'Subscription tier',
        allTiers: 'All tiers',
        allTiersOnly: 'Generic rules only',
        boundAccounts: 'Bound accounts',
        deleteBoundHint: 'Unbind or rebind accounts before deleting this rule',
        syncSourceAccount: 'Sync source account',
        sourceAccountRequired: 'Select a source account before creating a rule',
        syncUpstreamModels: 'Sync upstream models',
        importSyncedModels: 'Import synced models',
        whitelist: 'Model Whitelist',
        whitelistPlaceholder: 'e.g. claude-3-5-sonnet-20241022',
        addWhitelist: 'Add whitelist model',
        removeWhitelist: 'Remove whitelist model',
        whitelistCount: '{count} whitelist models',
        ...
        importModelsEmpty: 'Select at least one model to import',
        importModelsSuccess: 'Imported {count} model mappings',
        importModelsNoChanges: 'All selected models already exist in the mappings',
        searchModels: 'Search supported models',
        selectAllModels: 'Select all models',
        clearModelSelection: 'Clear selection',
        loadingModels: 'Loading the latest supported models for this platform…',
        noModels: 'No models are available for this platform',
        loadModelsFailed: 'Failed to load the latest supported models. Try again.',
        selectedModelsCount: '{count} models selected',
        removeMapping: 'Remove mapping',
        mappingCount: '{count} mappings',
        noRules: 'No model rules',
        createFirst: 'Create reusable model mappings for different platforms.',
        actions: 'Actions',
        save: 'Save Rule',
        deleteRule: 'Delete Rule',
        deleteConfirm: 'Delete rule “{name}”? It must have no bound accounts.',
        loadFailed: 'Failed to load model rules',
        saveFailed: 'Failed to save model rule',
        deleteFailed: 'Failed to delete model rule',
        createSuccess: 'Model rule created',
        updateSuccess: 'Model rule updated',
        deleteSuccess: 'Model rule deleted',
        nameRequired: 'Enter a rule name',
        mappingRequired: 'Complete the model mapping',
        whitelistRequired: 'Whitelist entries must be exact model names and cannot contain *',
        restrictionRequired: 'Add at least one whitelist model or mapping',
        duplicateSource: 'Request models must be unique',
        importLabel: 'Import an existing model rule',
        bindingLabel: 'Bind model routing rule',
        currentBinding: 'Current rule:',
        selectPlaceholder: 'Select a rule for this platform',
        importAction: 'Import',
        bindAction: 'Bind',
        unbindAction: 'Unbind',
        loading: 'Loading…',
        noRulesForPlatform: 'No rules are available for this platform',
        loadImportFailed: 'Failed to load rules',
        overwriteTitle: 'Replace current model restriction',
        overwriteMessage: 'Importing “{name}” will replace the current model mappings or whitelist. Continue?',
        overwriteConfirm: 'Replace and import',
        bindConfirmMessage: 'Binding “{name}” clears legacy account mappings and keeps the account synchronized with rule updates. Continue?',
        bindConfirm: 'Bind rule',
        boundReadOnlyHint: 'This account is bound to a model routing rule. Edit the rule to change its routes.',
        unbindSaveHint: 'After unbinding, account routing stays empty. Save this change before configuring or binding another rule.',
        tierMismatchWarning: 'The account tier no longer matches its bound rule. The rule remains active; rebind to the current tier or a generic rule.',
        importSuccess: 'Imported model rule “{name}”'
      },
      cnProviders: {
        accountMode: {
          title: 'Account Type',
          ...
          zhipuTeam: {
            ...
            hint: 'Only required for a team GLM Coding Plan. Leave both fields empty for a personal plan.',
          },
          balance: 'Balance --',
      ...
      columns: {
        modelRouting: 'Tier / Model Routing',
        name: 'Name',
        id: 'Account ID',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by EasySub2api, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within EasySub2api.',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. EasySub2api cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      accountExpiresAt: 'Account expiry {time}',
      ...
      bulkEdit: {
        ...
        modelRuleSinglePlatformHint: 'Bulk import of saved model rules requires accounts from a single platform. Narrow the targets to one platform first.'
      },
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from EasySub2api connectivity test.',
        ttsTextDefault: 'Hello from EasySub2api account connectivity test.',
      ...
      syncUpstreamModelsMetadataIncomplete:
        'Model IDs were synced, but capability metadata is incomplete and was not saved.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another EasySub2api instance.',
      ...
      upstream: {
        ...
        baseUrlHint: 'The address of the upstream service',
      ...
      oauth: {
        ...
        gemini: {
          ...
          failedToGenerateUrl: 'Failed to generate Gemini authorization URL',
          missingExchangeParams: 'Missing authorization code, state, or OAuth session',
          failedToExchangeCode: 'Failed to exchange Gemini authorization code',
          missingProjectId: 'Gemini authorization did not return a Project ID; select a project and authorize again',
          aiStudioNotConfigured: 'The AI Studio OAuth client is not configured'
        },
        antigravity: {
          title: 'Antigravity Account Authorization',
          failedToGenerateUrl: 'Failed to generate Antigravity authorization URL',
          missingExchangeParams: 'Missing authorization code, state, or OAuth session',
          failedToExchangeCode: 'Failed to exchange Antigravity authorization code',
          pleaseEnterRefreshToken: 'Please enter a Refresh Token',
          failedToValidateRT: 'Failed to validate Antigravity Refresh Token'
        },
        grok: {
