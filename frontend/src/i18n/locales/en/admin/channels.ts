export default {
    ...
    channels: {
      ...
      form: {
        ...
        inheritReasoningEffortMultipliers: 'Inherit model defaults',
        reasoningEffortMultiplierLabel: '{effort} multiplier',
        reasoningEffortMultiplierDefault: '1',
        clearReasoningEffortMultipliers: 'Clear multipliers',
        reasoningEffortMultiplierPositive: '{effort} multiplier must be finite and greater than zero',
        reasoningEffortLevelInvalid: 'Unsupported reasoning effort: {effort}',
        multiplierPlaceholder: 'Optional positive multiplier',
        fable51DefaultMaxReasoningMultiplier: 'Default for Claude Fable 5.1: 3.0',
        multiplierPositive: 'Reasoning effort multiplier must be positive',
    ...
    subscriptions: {
      ...
      resetWeeklyTitle: 'Reset weekly quota',
      selectedCount: '{count} subscriptions selected',
      bulk: {
        extend: 'Adjust terms',
        reset_quota: 'Reset quotas',
        revoke: 'Revoke selected',
        restore: 'Restore selected',
        clearSelection: 'Clear selection',
        confirmTargets: 'This operation will apply to {count} subscriptions',
        groupFallback: 'Group #{id}',
        extendHint: 'Positive values extend and negative values shorten. Each subscription must remain unexpired.',
        resetWindows: 'Select quota windows to reset',
        resetHint: 'Usage in the selected windows will be cleared and restarted using the current window rules.',
        revokeHint: 'Selected subscriptions stop immediately and can be restored from the revoked list later.',
        restoreHint: 'Only revoked subscriptions without a platform conflict or pending entitlement can be restored.',
        selectionRequired: 'Select at least one eligible subscription.',
        selectionLimit: 'A batch can contain at most 100 subscriptions.',
        invalidDays: 'Adjustment must be a non-zero integer between -36500 and 36500.',
        selectWindow: 'Select at least one quota window.',
        retryHint: 'Some changes may already be committed. Retry with the same operation to obtain the final result.',
        result: '{success} succeeded, {failed} failed',
        itemFailed: 'Operation failed',
        retry: 'Retry same request',
        confirm: 'Confirm operation',
        requestFailed: 'Bulk subscription operation failed'
      },
      batchAssign: {
        enable: 'Assign to multiple users',
        hint: 'Select up to 100 users. Each user returns an independent success, queued, or failed result.',
        selected: '{count} users selected',
        removeUser: 'Remove {email}',
        result: '{success} assigned or queued, {failed} failed',
        retryHint: 'Failed users remain selected so you can fix the issue and submit again.'
      },
      issueResetCards: 'Issue reset cards',
      issueResetCardsSelected: 'Issue reset cards to {count} selected subscriptions',
      resetCardQuantity: 'Quantity per subscription',
      resetCardValidityDays: 'Validity (days)',
      issueResetCardsTotal: 'Estimated total: {count}',
      resetCardQuantityInvalid: 'Quantity must be an integer from 1 to 1000.',
      resetCardValidityInvalid: 'Validity must be between 1 and 3650 days.',
      issueResetCardsPartial: 'Issued cards for {success} subscriptions; {failed} failed',
      issueResetCardsSuccess: 'Issued {count} reset cards',
      issueResetCardsFailed: 'Failed to issue reset cards',
      resetCardsAvailable: '{count} available',
      resetCardsExpired: '{count} expired',
      resetCardsNextExpiry: 'Next expiry: {time}',
      resetWeekly: 'Reset weekly quota',
      resetWeeklyConfirm: 'Reset the weekly quota for {count} selected subscriptions? Weekly usage will be cleared and a new 7-day window starts now. Reset cards, daily/monthly usage, and subscription expiry are unchanged. Subscriptions without a weekly limit will fail.',
      resetWeeklyConfirmSingle: "Reset the weekly quota for '{user}'? A new 7-day window starts now and no reset card is consumed.",
      resetWeeklyPartial: 'Reset {success} subscriptions; {failed} failed',
      resetWeeklySuccess: 'Reset weekly quota for {count} subscriptions',
      operationResultTitle: 'Batch operation result',
      operationResultIssueTitle: 'Reset card issuance result',
      operationResultWeeklyTitle: 'Weekly quota reset result',
      operationResultSummary: '{success} succeeded, {failed} failed',
      operationResultTotalIssued: '{count} card(s) issued in total',
      operationResultSuccess: 'Success',
      operationResultFailed: 'Failed',
      operationResultIssuedDetail: 'Issued {count} reset card(s)',
      operationResultResetDetail: 'Reset at {resetAt}; new window ends at {endAt}',
      operationResultError: 'Reason: {reason}',
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      failedToResetWeekly: 'Failed to reset weekly quota',
      ...
      guide: {
        ...
        actions: {
          ...
          resetWeekly: 'Reset weekly quota',
          resetWeeklyDesc: 'Clear weekly usage and restart the 7-day window now; no reset card is consumed',
          resetQuota: 'Reset Quota',
