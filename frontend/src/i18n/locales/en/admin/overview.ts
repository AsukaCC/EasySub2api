export default {
    ...
    users: {
      ...
      levels: {
        createdPendingBinding: 'The account was created with the default rule. Retry to finish assigning the selected rule.',
        defaultRule: 'Default rule',
        setDefault: 'Set as default',
        defaultProtected: 'The default rule cannot be deleted or disabled',
        inUseProtected: 'Default rules and rules with members cannot be disabled',
        memberSearch: 'Search username or email',
        noMembers: 'No matching users',
        addMember: 'Add member',
        transfer: 'Reassign',
        targetRule: 'Target level rule',
        applyMembers: 'Apply to selected users ({count})',
        resetDefault: 'Reset to default',
        confirmTransfer: 'Reassign {count} users to "{name}"? Their existing level binding will be replaced.',
        ...
        empty: 'No level rules',
        baseTier: 'Base tier',
        tier: 'Tier',
        tierName: 'Tier name',
        minSpend: 'Spend threshold (points)',
        multiplier: 'Level multiplier',
        tierHint: 'The base tier threshold is fixed at 0; later thresholds must increase. An unset multiplier means 1.',
        addTier: 'Add tier',
        invalidThresholds: 'Tier spend thresholds must be strictly increasing',
        loadFailed: 'Failed to load user level rules',
        saveFailed: 'Failed to save user level rules',
        deleteFailed: 'Failed to delete user level rule',
        deleteReferenced: 'This rule is assigned or referenced and cannot be deleted',
        confirmDelete: 'Delete rule "{name}"?',
        assignedRules: 'Assigned level rules',
        assignmentHint: 'Each user belongs to exactly one level rule.',
        enableBulk: 'Update level rules in bulk',
        addOperation: 'Add rules',
        removeOperation: 'Reset to default rule',
        replaceOperation: 'Reassign level rule',
      ...
      archive: {
        ...
        hint: 'This list contains users archived by older versions. Restoring recreates email sign-in only; old API keys are not restored. New user deletions are permanent.',
      ...
      userDeleted: 'User and related data permanently deleted',
      ...
      userDeletedSuccess: 'User and related data permanently deleted',
      ...
      deleteConfirm: "Permanently delete '{email}'? The user and related API keys, usage, wallet, orders, refunds, and tickets will be physically deleted and cannot be restored.",
