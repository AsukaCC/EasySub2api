export default {
    ...
    groups: {
      ...
      levelRates: {
        ...
        hint: 'The shared quota is consumed by all site users matching this rule; the personal quota is independent for each user. Both accumulate account 7-day usage USD.',
        ...
        activationSpend: 'Activation spend (7-day points)', sharedQuotaAmount: 'Site-wide shared quota USD (0 = unlimited)', personalQuotaAmount: 'Per-user quota USD (0 = unlimited)',
        sharedUsage: 'Site-wide used (account 7-day USD)', unlimited: 'Unlimited', enabled: 'Enabled', levels: 'Levels', allLevels: 'All levels',
