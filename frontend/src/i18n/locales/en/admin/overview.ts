export default {
    ...
    users: {
      ...
      levels: {
        ...
        multiplier: 'User multiplier (optional)',
        tierHint: 'The base tier threshold is fixed at 0; later thresholds must increase. An empty multiplier is not a candidate.',
        addTier: 'Add tier',
        ...
        assignmentHint: 'Select multiple rules; no selection means the user has no configured level.',
        enableBulk: 'Update level rules in bulk',
        addOperation: 'Add rules',
        removeOperation: 'Remove rules',
        replaceOperation: 'Replace all rules',
