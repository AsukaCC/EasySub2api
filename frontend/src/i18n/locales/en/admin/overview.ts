export default {
    ...
    dashboard: {
      ...
      accountQuotaHint: 'Estimated weekly capacity from account-cost points in enabled groups; the dashboard never probes upstream providers.',
      ...
      quotaEstimatedTotal: 'Estimated weekly total',
      quotaKnownEstimatedTotal: 'Known-account weekly estimate',
