export default {
    ...
    dashboard: {
      ...
      wsPoolConnections: 'WS pool connections',
      users: 'Users',
      ...
      accountQuotaHint: 'Weekly quota estimated from account-cost USD in enabled groups. Unknown accounts are excluded from amounts and percentages, and the dashboard never probes upstream providers.',
      quotaAccounts: 'accounts',
      quotaEnabledAccounts: 'enabled accounts',
      quotaUnknownAccounts: 'accounts with unknown quota',
      quotaRateLimited: '429-limited remainder',
      quotaUsed: 'Account cost used',
      quotaAvailable: 'Available quota',
      quotaAvailablePercent: '{percent}% available',
      quotaUnknown: 'Unknown',
      quotaNoAccounts: 'No account quota data',
      quotaNoGroups: 'No enabled groups',
      quotaEmptyGroup: '0 enabled accounts / no quota',
      quotaEstimatedTotal: 'Estimated weekly account cost',
      quotaKnownEstimatedTotal: 'Known-account weekly cost estimate',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. easysub2api-backups), choose a region',
    ...
    affiliates: {
      ...
      transfersDescription: 'View rebate point transfers into platform points',
      errors: {
      ...
      records: {
        ...
        netRebatePoints: 'Net Rebate Points',
        reservedReversalPoints: '{amount} pending reversal',
        paymentType: 'Payment Method',
        orderStatus: 'Order Status',
        transferAmount: 'Transfer Amount',
        balanceAfter: 'Points After Transfer',
    ...
    users: {
      ...
      levels: {
        ...
        description: 'Levels are calculated from actual spend in the latest 7 days; groups can use them for pricing.',
        l2: 'Level 2 threshold (points)',
        l3: 'Level 3 threshold (points)',
        rangeBelow: 'Below {amount}',
        rangeBetween: '{from} to {to}',
        rangeAbove: '{amount} and above',
        windowNote: 'The level window is fixed at the latest 7×24 hours; level 1 starts at zero.',
        saved: 'Level thresholds saved',
        loadFailed: 'Failed to load level settings',
        saveFailed: 'Failed to save level settings',
        invalidRange: 'The level 3 threshold must be greater than level 2'
      },
      ...
      inactiveCleanup: {
        ...
        title: 'Filter and Permanently Delete Inactive Accounts',
        warning: 'This permanently deletes matched users and related API keys, usage, wallet, orders, refunds, and tickets. It cannot be undone. Administrator accounts are never matched.',
        maxBalance: 'Maximum Balance (points)',
        maxBalanceHint: 'Matches accounts whose balance is less than or equal to this value.',
        lastUsedBefore: 'Last Successful Use Before',
        lastUsedBeforeHint: 'Evaluated at 00:00 on the selected date in server timezone {timezone}. Never-successfully-used accounts must also have been created before that date.',
        maxUsage7d: 'Maximum 7-Day Usage (points)',
        maxUsage7dHint: 'Uses actual points deducted by successful requests and matches values less than or equal to this threshold.',
        invalidBalance: 'Maximum balance must be a non-negative number.',
        invalidUsage7d: 'Maximum 7-day usage must be a non-negative number.',
        invalidLastUsedBefore: 'Select a valid last-successful-use cutoff date.',
        futureLastUsedBefore: 'The cutoff cannot be later than the current date in the server timezone.',
        preview: 'Preview Matches',
        previewing: 'Previewing...',
        previewFailed: 'Failed to preview inactive accounts',
        generatedAt: 'Preview generated: {time}',
        matchedUsers: 'matched accounts',
        totalBalance: 'Combined matched balance',
        totalUsage7d: 'Combined matched 7-day usage',
        usage7d: '7-Day Usage',
        neverUsed: 'Never used',
        sampleLimit: 'Showing the first {count} of {total}; deletion still processes every matched account.',
        confirmHint: 'Enter {phrase} exactly to confirm permanent deletion. If account activity changes, the server rejects deletion and requires a new preview.',
        noMatches: 'No removable non-admin users match the current filters.',
        deleteAction: 'Permanently Delete Matches',
        deleting: 'Permanently deleting...',
        deletedSuccess: 'Permanently deleted {count} inactive accounts',
        deleteFailed: 'Failed to permanently delete inactive accounts; preview again and retry'
      },
      archive: {
        action: 'Archived Users',
        title: 'Archived User Management',
        hint: 'Deleted users with successful recharge records are retained here after their identities and API keys are removed. Restoring recreates email sign-in only; old API keys are not restored.',
        search: 'Search archived users by email, username, or notes',
        archivedAt: 'Archived At',
        empty: 'No archived users',
        restore: 'Restore User',
        restoring: 'Restoring...',
        archivedSuccess: 'The user has recharge records and was archived; all API keys were removed',
        permanentlyDeletedSuccess: 'The user has no recharge records and was permanently deleted with related data',
        restoredSuccess: 'Archived user restored; create new API keys for the user',
        loadFailed: 'Failed to load archived users',
        restoreFailed: 'Failed to restore archived user'
      },
      editUser: 'Edit User',
      ...
      columns: {
        ...
        notes: 'Notes',
        role: 'Role',
        userLevel: 'Level (7d spend)',
        groups: 'Groups',
        subscriptions: 'Subscriptions',
        balance: 'Platform Points',
        balancePlatformQuota: 'Platform Points (Platform Quota)',
        usage: 'Usage',
      ...
      balanceAdjustedSuccess: 'Points adjusted successfully',
      ...
      deleteConfirm: "Delete '{email}'? Users with successful recharge records are archived and lose all API keys. Users without recharge records are permanently deleted with their keys, usage, and related data.",
      ...
      newBalance: 'Points After Operation',
      ...
      useDepositWithdrawButtons: 'Please use the add/deduct actions to adjust points',
      // Balance History
      balanceHistory: 'Point History',
      balanceHistoryTip: 'Click to open point history',
      ...
      platformOther: 'Other',
      balanceHistoryTitle: 'User Point & Concurrency History',
      noBalanceHistory: 'No records found for this user',
      allTypes: 'All Types',
      typeBalance: 'Points (Redeem Code)',
      typeAffiliateBalance: 'Points (Rebate Transfer)',
      typeAdminBalance: 'Points (Admin)',
      typeConcurrency: 'Concurrency (Redeem)',
      typeAdminConcurrency: 'Concurrency (Admin)',
      typeSubscription: 'Subscription',
      failedToLoadBalanceHistory: 'Failed to load point history',
      createdAt: 'Created',
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily, weekly, and monthly point limits for each upstream platform for user {email}',
        columns: {
          platform: 'Platform',
          daily: 'Daily Point Limit',
          weekly: 'Weekly Point Limit',
          monthly: 'Monthly Point Limit (30-day rolling)',
          usage: 'Current Usage',
        },
        ...
        subscriptionWarning: 'This user has an active subscription. Platform quotas only apply to point-based standard requests; subscription requests are not subject to these limits.',
    ...
    groups: {
      ...
      openaiFast: {
        ...
        hint: 'Forces the priority service tier for OpenAI requests in this group; the global Fast/Flex policy can still filter or block it.',
        free: 'Free Fast',
        freeHint: 'Requests still use the priority tier, while customers are charged the equivalent Standard price.'
      },
      ...
      levelRates: {
        ...
        hint: 'Level overrides take precedence over the group default; dynamic rules use absolute windows and two quota layers.',
        levelOverrides: 'User level overrides', dynamicRules: 'Time-window dynamic rates', addRule: 'Add rule', noRules: 'No dynamic rules',
        ...
        activationSpend: 'Activation spend (7-day points)', sharedQuotaAmount: 'Shared interval quota (0 = unlimited)', personalQuotaAmount: 'Personal interval quota (0 = unlimited)',
        sharedUsage: 'Shared quota usage', unlimited: 'Unlimited', enabled: 'Enabled', levels: 'Levels', allLevels: 'All levels',
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit OpenAI reasoning effort requests only. For Composite groups, it applies only to requests resolved to OpenAI. Omitted effort stays omitted, and the ceiling takes precedence over mappings.',
        ...
        reasoningEffortMappingsHint: 'Leave type and model empty to match every model; a model without a type defaults to exact. Multiple request values can share a scope. Exact matches beat affixes, and longer affixes beat shorter ones.',
        addReasoningEffortMapping: 'Add mapping',
        removeReasoningEffortMapping: 'Remove mapping',
        reasoningEffortMappingCount: '{count} / {max} rules',
        mappingLimit: 'Reasoning mappings are limited to {max} rules',
        modelRequired: 'Enter a model when a match type is selected',
        modelTooLong: 'Model match text must be 200 characters or fewer',
        ...
        reasoningEffortModelPlaceholder: 'Empty matches all, for example gpt-5',
        ...
        duplicateFrom: 'Request value must be unique within the same model scope',
      ...
      subscription: {
        ...
        type: 'Billing Type',
        typeHint:
          'Standard billing deducts platform points. Subscription mode uses point quota limits instead.',
        typeNotEditable: 'Billing type cannot be changed after group creation.',
        standard: 'Standard (Platform Points)',
        subscription: 'Subscription (Quota)',
        dailyLimit: 'Daily Point Limit',
        weeklyLimit: 'Weekly Point Limit',
        monthlyLimit: 'Monthly Point Limit',
      ...
      openaiLive: {
        ...
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The EasySub2api server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
