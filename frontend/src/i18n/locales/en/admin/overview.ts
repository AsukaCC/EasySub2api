export default {
    ...
    groups: {
      ...
      levelRates: {
        ...
        hint: 'Level overrides take precedence over the group default; dynamic rules use time and personal quota.',
        levelOverrides: 'User level overrides', dynamicRules: 'Time-window dynamic rates', addRule: 'Add rule', noRules: 'No dynamic rules',
        level: 'Level {level}', inherit: 'Inherit group default', name: 'Rule name', start: 'Start', end: 'End', multiplier: 'Multiplier',
        activationSpend: 'Activation spend (7-day points)', quotaAmount: 'Personal point quota (per day, 0 = unlimited)', enabled: 'Enabled', levels: 'Levels', allLevels: 'All levels', saveFailed: 'Failed to save level and dynamic rates'
      },
      accountFilters: {
