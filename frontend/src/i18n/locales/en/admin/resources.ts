export default {
    ...
    redeem: {
      ...
      invitationHint: 'Invitation codes restrict registration and can be reused by multiple users while valid.',
      unused: 'Unused',
      used: 'Used',
      columns: {
        code: 'Code',
	  ...
	  bonusValidityDays: 'Bonus validity after redemption (days)',
      ...
      form: {
        ...
        balanceHint: 'Platform point amount',
      ...
      noCodesDescription: 'Generate redeem codes to distribute platform points or concurrency to users.',
    ...
    announcements: {
      ...
      form: {
        ...
        status: 'Status',
        notifyMode: 'Notify Mode',
        notifyModeHint: 'Silent announcements appear on the dashboard; popup and top scrolling announcements support schedules and targeting',
        startsAt: 'Starts At',
        endsAt: 'Ends At',
        ...
        conditionBalance: 'Platform Points',
        conditionUser: 'Specific users',
        conditionLevel: 'Spend level',
        operator: 'Operator',
        balanceValue: 'Point threshold',
        selectPackages: 'Select packages',
        selectUsers: 'Select users',
        userSearchPlaceholder: 'Search email or user ID...',
      ...
      timeNever: 'Never',
      timeNotApplicable: 'Not applicable to dashboard announcements',
    ...
    usage: {
      ...
      billingTypeBalance: 'Platform Points',
      ...
      ipAddress: 'IP',
      clickToViewBalance: 'Click to view point history',
