export default {
  dashboard: {
    ...
    dynamicRateOffer: {
      ...
      startsAt: 'Starts',
      endsAt: 'Expires',
      spendProgress: '7-day spend: {used} / {amount} credits',
      personalQuota: 'Discount quota: {used} / {amount} U',
      status: {
      ...
      requirement: {
        group_unavailable: 'Group access required',
        subscription_required: 'Active subscription required',
        level_required: 'Spending level required',
      },
    },
    apiKeyUsage: {
      title: 'API Key Usage',
