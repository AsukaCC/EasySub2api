export default {
  ...
  featureUnavailable: {
    ...
    description: 'This feature is disabled or has not been published to users.',
    back: 'Back to home',
  },
  ...
  purchase: {
    title: 'Platform Points Top-Up',
    description: 'Top up platform points for your account',
  ...
  userSubscriptions: {
    ...
    noActiveSubscriptionsDesc:
      "You don't have any active subscriptions. Choose a plan below to subscribe.",
    ...
    fullValidity: 'Full {days}-day validity starts on activation',
    source: 'Source',
    sources: {
      payment_order: 'Purchase order',
      redeem_code: 'Redeem code',
      admin: 'Admin assignment',
      admin_assignment: 'Admin assignment',
      admin_bulk_assignment: 'Admin bulk assignment',
      registration_default: 'Registration default',
      oauth_default: 'Registration default',
      auth_default: 'Registration default',
      default_subscription: 'Default subscription',
      auth_first_bind: 'First-bind default',
      manual: 'Manual assignment',
    },
    activateNow: 'Activate Now',
    activateNowTitle: 'Activate Pending Subscription',
    confirmActivateNow: 'Forfeit Remaining Time and Activate',
    currentPlatformSubscription: 'current platform subscription',
    activateNowWarning: 'This immediately ends the current subscription(s) on this platform ({subscriptions}). Remaining time is not transferred, refunded, or restored. The new subscription starts its full {days}-day term after confirmation.',
    activateNowSuccess: 'The new subscription is now active',
    activateNowFailed: 'Activation failed; the current subscription was not changed',
    usage: 'Usage',
    expires: 'Expires',
    ...
    resetCards: {
      title: 'Weekly reset cards',
      summary: '{available} available, {expired} expired',
      use: 'Use reset card',
      nextExpiry: 'Next expiry: {time}',
      batch: '{count} card(s) expire: {time}',
      confirmTitle: 'Use a reset card?',
      confirmMessage: 'This consumes the earliest-expiring card for “{group}” and restarts its 7-day weekly window now. Available cards remaining: {available}.',
      confirm: 'Use card',
      success: 'Reset card used; the weekly quota window has restarted',
      failed: 'Failed to use reset card. Please try again later.',
    },
  },
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to EasySub2api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">EasySub2api is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of EasySub2api, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
      ...
      groupMultiplier: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Charge platform points 1:1 against standard cost</li><li><b>1.5</b> - Standard cost $1, charge 1.5 platform points</li><li><b>2.0</b> - Standard cost $1, charge 2 platform points</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to EasySub2api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the EasySub2api AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    creditedPoints: 'Total credited points',
	...
	wallet: {
	  useBalance: 'Use points',
	  available: 'Available points',
	  availablePoints: 'Available points',
	  rechargePoints: 'Purchased points',
	  bonusPoints: 'Bonus points',
	  planPrice: 'Plan price',
	  planPricePoints: 'Plan price in points',
	  bonusOffset: 'Bonus points offset',
	  rechargeOffset: 'Purchased points offset',
	  externalBase: 'External payment amount',
	  expiresAt: 'Your next bonus points expire on {date}; the earliest expiry is used first',
	  payWithBalance: 'Pay with points',
	  payWithPoints: 'Pay',
	  insufficientPoints: 'Not enough points. Top up before purchasing this plan.',
	  paymentSuccess: 'Subscription purchased successfully',
	},
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
    ...
    refundQuote: {
      loading: 'Calculating the refundable amount...',
      loadFailed: 'Unable to load the refund quote. Please retry.',
      retry: 'Recalculate',
      principalInput: 'Principal to refund',
      maximum: 'Currently refundable up to {amount}',
      clamped: 'Available principal or recoverable points limit this refund to {amount}',
      principal: 'Principal refund',
      fee: 'Fee refund',
      gatewayAmount: 'Total returned by payment provider',
      basePoints: 'Base points reversed',
      bonusPoints: 'Bonus points reversed',
      expiredBonusOffset: 'Expired bonus offset',
      pointsToHold: 'Total points held/reversed',
      affiliatePoints: 'Related affiliate points',
      deadline: 'Self-service refund deadline: {date}',
      ticketRequired: 'Manual review is required',
      ticketRequiredHint: 'The self-service window has closed. Add a comment and submit a refund ticket.',
      confirm: 'Confirm refund request',
      submitted: 'Refund submitted. Points remain held while it is processed.',
    },
    refundTickets: {
      title: 'Refund Tickets',
      description: 'Track manual review requests submitted after the self-service window.',
      empty: 'No refund tickets',
      comment: 'Request comment',
      commentPlaceholder: 'Explain the refund reason and why manual handling is needed',
      approvedPrincipal: 'Approved principal',
      reviewNote: 'Review note',
      cancel: 'Cancel ticket',
      submit: 'Submit refund ticket',
      submitted: 'Refund ticket submitted',
      cancelled: 'Refund ticket cancelled',
      status: {
    ...
    balanceDetails: 'Point details',
    overdraftAmount: 'Overdraft points',
    rechargeNow: 'Top up',
    rechargeDialogTitle: 'Top up points',
    ...
    confirmDeleteOrder: 'The order will be removed from the order list. Continue?',
    ...
    rechargeRatePreview: 'Exchange rate: 1 {currency} = 1 platform point',
    ...
    errors: {
      PLAN_SOLD_OUT: 'This plan is sold out. Refresh and choose another plan.',
      PLAN_STOCK_BELOW_FROZEN: 'Stock cannot be lower than the currently reserved quantity.',
      SUBSCRIPTION_PLATFORM_PENDING_EXISTS: 'A pending subscription already exists for this platform.',
      CONFIRMATION_REQUIRED: 'Confirm that you forfeit the current subscription’s remaining time.',
      ...
      BALANCE_PAYMENT_DISABLED: 'Platform point top-up has been disabled.',
      ...
      INVALID_ORDER_TYPE: 'Only point top-up orders can request a refund.',
      INVALID_STATUS: 'The current order status does not allow this operation.',
      ORDER_CANCELLATION_INCOMPLETE: 'Order resources are still being released. Refresh and try again shortly.',
      BALANCE_NOT_ENOUGH: 'There are not enough recoverable points for this refund amount.',
      REFUND_AMOUNT_EXCEEDED: 'Refund amount exceeds the recharge amount.',
      REFUND_FAILED: 'Refund failed.',
      USER_REFUND_DISABLED: 'Self-service refunds are disabled for this payment method.',
      REFUND_DISABLED: 'Refunds are disabled for this payment method.',
      REFUND_TICKET_REQUIRED: 'The self-service window has closed. Submit a refund ticket.',
      NO_REFUNDABLE_AMOUNT: 'No principal can be refunded with the currently recoverable points.',
      REFUND_SNAPSHOT_MISSING: 'This order is missing its refund snapshot. Contact an administrator.',
      ALREADY_REFUNDED: 'This order has no refundable principal remaining.',
      ACTIVE_REFUND_TICKET_EXISTS: 'This order already has an active refund ticket.',
      INVALID_IDEMPOTENCY_KEY: 'The refund request identifier is invalid. Close the dialog and retry.',
      IDEMPOTENCY_CONFLICT: 'The refund parameters changed. Close the dialog and start again.',
    },
    ...
    planCard: {
      ...
      resetCards: 'Weekly reset cards',
      resetCardsValue: '{count} included, valid for {days} days',
      quota: 'Quota',
      unlimited: 'Unlimited',
      models: 'Models',
      stock: 'Stock',
      ...
      soldOut: 'Sold Out',
      pendingExists: 'Pending subscription exists',
    },
    subscriptionWillQueue: 'You already have an active subscription on this platform. This purchase will remain pending and receive its full term after the current subscription expires.',
    subscriptionQueued: 'Purchase successful; subscription queued for activation',
    days: 'days',
    weeks: 'weeks',
    months: 'months',
    years: 'years',
    ...
    admin: {
      ...
      refundAmount: 'Refund principal (RMB)',
      gatewayRefundAmount: 'Gateway refund',
      reversedPoints: 'Reversed points',
      maxRefundable: 'Maximum refundable principal',
      refundReason: 'Refund Reason',
      ...
      deductBalance: 'Reverse points',
      deductBalanceHint: 'Reverse points from the user account in proportion to the refund',
      userBalance: 'User points',
      orderAmount: 'Order Amount',
      pointsToReverse: 'Estimated points to reverse',
      pointsReverseAutomaticHint: 'Submitting automatically holds and reverses recharge and bonus points in proportion to this refund.',
      insufficientBalance: 'The user does not have enough points; force the refund or adjust their points first',
      noDeduction: 'User points will not be reversed',
      forceRefund: 'Force refund (ignore point availability check)',
      ...
      workspaceLabel: 'Orders and refunds workspace',
      ordersWorkspace: 'Orders',
      refundTickets: {
        title: 'Refund Tickets',
        description: 'Review requests outside the self-service window and track gateway processing.',
        empty: 'No refund tickets match this filter',
        ticketId: 'Ticket ID',
        user: 'User',
        comment: 'Request comment',
        reviewNote: 'Review note',
        allStatuses: 'All statuses',
        review: 'Review',
        reviewTitle: 'Review Refund Ticket',
        decision: 'Decision',
        approve: 'Approve',
        reject: 'Reject',
        approvedPrincipal: 'Approved principal',
        approvedPrincipalHint: 'Amount is in RMB. Remaining principal is capped at {amount}; recoverable points may further reduce the actual refund.',
        loadingOrder: 'Loading the order refund snapshot...',
        orderLoadFailed: 'Unable to load the order refund snapshot',
        retryOrder: 'Reload',
        originalPrincipal: 'Original recharge principal',
        refundedPrincipal: 'Principal already refunded',
        remainingPrincipal: 'Remaining principal',
        basePoints: 'Base points',
        bonusPoints: 'Bonus points',
        affiliatePoints: 'Actual affiliate points',
        reviewNotePlaceholder: 'Record the review basis and handling notes',
        affiliateManual: 'Affiliate rebates require manual handling. Check related rebate records before approval.',
        submitReview: 'Submit review',
        reviewed: 'Refund ticket review submitted',
      },
      ...
      originalPrice: 'Original price (platform points)',
      price: 'Price (platform points)',
      planPointsHint: 'Plan purchases deduct platform points only and never create a payment-provider order.',
      stockControl: 'Limited stock',
      stockQuantity: 'Stock quantity',
      stockHint: '{frozen} units are currently reserved; stock cannot be lower than this value.',
      stockInvalid: 'Enter an integer stock quantity from {frozen} to 2147483647.',
      resetCardCount: 'Included reset cards',
      resetCardCountHint: 'Issued when the subscription becomes active; historical subscriptions are not backfilled.',
      resetCardValidityDays: 'Reset card validity (days)',
      resetCardCountInvalid: 'Reset card count must be an integer from 0 to 1000.',
      resetCardValidityInvalid: 'Reset card validity must be between 1 and 3650 days.',
      stockSummary: '{available} available / {frozen} reserved / {total} stock',
      ...
      priceRequired: 'Plan point price must be greater than 0',
