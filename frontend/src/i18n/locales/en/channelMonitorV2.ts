...
export default {
  channelMonitorV2: {
    ...
    compact: {
      ...
      timelineAria: '{group} availability over the last 90 minutes',
      noTrafficAt: '{time} no requests',
      bucketAt: '{time} {value}% uptime',
      ...
      pageDescription: 'Availability of channel groups over the last 90 minutes',
