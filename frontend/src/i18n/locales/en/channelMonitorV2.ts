...
export default {
  channelMonitorV2: {
    ...
    bootstrap: {
      ...
      description:
        'On first enable, passive aggregation silently fills the 90m, 24h, 7d, 14d, and 30d windows in the background. All ranges become complete once this finishes.',
    ...
    compact: {
      availability: '{value}% uptime',
      errorRate: 'Error rate {value}%',
      noData: 'No data',
      unnamedGroup: 'Unnamed group',
      timelineAria: '{group} error rate over the last 14 days, 2-hour cells',
      noTrafficAt: '{time} no requests',
      noTraffic: 'No requests',
      bucketAt: '{time} error rate {value}%',
      tooltipErrorRate: 'Error rate {value}%',
      requestCount: 'Requests {value}',
      errorRequests: 'Error requests {value}',
      emptyTitle: 'No monitored groups',
      emptyDescription: 'Ask an administrator to select groups in Channel Monitor settings.',
      loadFailed: 'Failed to load channel status',
      pageTitle: 'Channel Status',
      pageDescription: 'Error rates for channel groups over the last 14 days, in 2-hour cells',
      autoRefresh: 'Refreshes every minute',
      timeAxisNow: 'now',
      legendAria: 'Error rate legend',
      legendLowError: 'Low',
      legendHighError: 'High',
      legendHealthy: 'Healthy',
      legendWarning: 'Degraded',
      legendCritical: 'Down',
      legendUnknown: 'No traffic',
    },
    ranges: { '90m': '90m', '24h': '24h', '7d': '7d', '14d': '14d', '30d': '30d' },
    filters: {
    ...
    matrix: {
      title: 'Availability trend', description: 'Each row is a channel dimension and each block is an aggregate interval; hover for details', wheelZoom: 'Scroll over blocks to zoom in (narrower range, wider blocks)', wheelZoomX: 'Scroll over blocks to zoom in (narrower range, wider blocks)', dimension: 'Channel dimension', emptyTitle: 'No matrix data for the selected window', legendAria: 'Error rate legend', bad: 'High error rate', good: 'Low error rate', healthyLegend: 'Low error rate', warningLegend: 'Moderate error rate', criticalLegend: 'High error rate', unknownLegend: 'No traffic / insufficient samples', noTraffic: 'No traffic in this interval', noTrafficAt: '{time} · no traffic', scoreLine: 'Health score {score}', resetZoom: 'Reset zoom'
    },
    chart: {
    ...
    settings: {
      title: 'Passive monitoring settings',
      description:
        'Configure aggregation dimensions, refresh cadence, and health thresholds from real gateway traffic.',
      save: 'Save',
      loading: 'Loading…',
      loadFailed: 'Failed to load passive monitoring settings',
      saveSuccess: 'Passive monitoring settings saved',
      saveFailed: 'Failed to save passive monitoring settings',
      modeBanner:
      ...
      refreshHint: 'Controls trend granularity and page refresh cadence',
      ...
      healthHint:
        'Controls summary and detail health states. Defaults are tolerant so small error rates or low cache do not immediately show as unhealthy.',
      fields: {
