export default {
  ...
  userSubscriptions: {
    ...
    availableSubscriptions: '可购买订阅',
    noActiveSubscriptions: '暂无有效订阅',
    noActiveSubscriptionsDesc: '您当前没有有效订阅，可在下方选择订阅套餐。',
    failedToLoad: '加载订阅失败',
    status: {
      active: '有效',
      expired: '已过期',
    ...
    expectedActivation: '预计生效时间',
    fullValidity: '生效后享有完整 {days} 天有效期',
    source: '来源',
    sources: {
      payment_order: '购买订单',
      redeem_code: '兑换码',
      admin: '管理员分配',
      admin_assignment: '管理员分配',
      admin_bulk_assignment: '管理员批量分配',
      registration_default: '注册默认订阅',
      oauth_default: '注册默认订阅',
      auth_default: '注册默认订阅',
      default_subscription: '默认订阅',
      auth_first_bind: '首次绑定默认订阅',
      manual: '手动分配',
    },
    activateNow: '立即生效',
    activateNowTitle: '立即启用待生效订阅',
    confirmActivateNow: '确认放弃并立即生效',
    currentPlatformSubscription: '当前平台订阅',
    activateNowWarning: '将立即结束同平台的当前订阅（{subscriptions}），其剩余时间不会转移、退款或恢复。新订阅会从确认成功时开始计算完整 {days} 天有效期。',
    activateNowSuccess: '新订阅已立即生效',
    activateNowFailed: '立即生效失败，当前订阅未被更改',
    usage: '用量',
    expires: '到期时间',
    noExpiration: '无到期时间',
    unlimited: '无限制',
    ...
    resetCards: {
      title: '周限额重置卡',
      summary: '可用 {available} 次，已过期 {expired} 次',
      use: '使用重置卡',
      nextExpiry: '最近到期：{time}',
      batch: '{count} 次卡到期：{time}',
      confirmTitle: '确认使用重置卡',
      confirmMessage: '将消耗该订阅最早到期的一张重置卡，并把“{group}”的 7 天周周期从现在重新开始。当前剩余可用卡：{available} 次。',
      confirm: '确认使用',
      success: '重置卡已使用，周限额周期已重新开始',
      failed: '使用重置卡失败，请稍后重试',
    },
  },
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 EasySub2api',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">EasySub2api 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 EasySub2api 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
      ...
      groupMultiplier: {
        title: '💰 3. 费率倍数',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">设置该分组的计费倍率，控制用户的实际扣费。</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ 计费规则：</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - 标准成本按 1:1 扣除平台积分</li><li><b>1.5</b> - 标准成本 $1，扣除 1.5 平台积分</li><li><b>2.0</b> - 标准成本 $1，扣除 2 平台积分</li><li><b>0.8</b> - 补贴模式（亏本运营）</li></ul></div><p style="font-size: 13px; color: #6b7280;">建议测试分组设置为 1.0</p></div>',
        nextBtn: '下一步'
      },
      groupExclusive: {
        title: '🔒 4. 专属分组（可选）',
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 EasySub2api',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 EasySub2api AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
	...
	wallet: {
	  ...
	  bonusPoints: '赠送积分',
	  planPrice: '套餐价格',
	  planPricePoints: '套餐积分价格',
	  bonusOffset: '赠送积分抵扣',
	  rechargeOffset: '充值积分抵扣',
	  externalBase: '外部支付金额',
	  expiresAt: '赠送积分最近于 {date} 到期，将优先使用临期积分',
	  payWithBalance: '积分支付',
	  payWithPoints: '支付',
	  insufficientPoints: '可用积分不足，请先充值',
	  paymentSuccess: '订阅购买成功',
	},
    methods: {
      easypay: '易支付',
      alipay: '支付宝',
    ...
    refundQuote: {
      loading: '正在计算可退款金额...',
      loadFailed: '退款报价加载失败，请重试',
      retry: '重新计算',
      principalInput: '申请退还本金',
      maximum: '当前最多可退 {amount}',
      clamped: '因剩余本金或可扣回积分不足，实际最多按 {amount} 处理',
      principal: '退还本金',
      fee: '退还手续费',
      gatewayAmount: '原支付渠道退款总额',
      basePoints: '扣回基础积分',
      bonusPoints: '扣回赠送积分',
      expiredBonusOffset: '已过期赠送积分抵扣',
      pointsToHold: '合计冻结/扣回积分',
      affiliatePoints: '关联邀请返利积分',
      deadline: '自助退款截止时间：{date}',
      ticketRequired: '该订单需要人工审核',
      ticketRequiredHint: '自助退款期限已过，请填写说明并提交退款工单。',
      confirm: '确认申请退款',
      submitted: '退款已提交，积分将在退款处理期间冻结',
    },
    refundTickets: {
      title: '退款工单',
      description: '查看超过自助退款期限后提交的人工审核申请。',
      empty: '暂无退款工单',
      comment: '申请说明',
      commentPlaceholder: '请说明退款原因及需要人工处理的情况',
      approvedPrincipal: '批准本金',
      reviewNote: '审核备注',
      cancel: '取消工单',
      submit: '提交退款工单',
      submitted: '退款工单已提交',
    ...
    result: {
      ...
      failed: '支付失败',
      backToRecharge: '返回充值',
      backToSubscriptions: '返回我的订阅',
      viewOrders: '查看订单',
    },
    currentBalance: '当前积分',
    balanceDetails: '积分详情',
    overdraftAmount: '透支积分',
    rechargeNow: '充值',
    rechargeDialogTitle: '积分充值',
    groupFallback: '分组 #{id}',
    ...
    billingUnavailable: '当前站点未开放充值或订阅购买。',
    confirmSubscription: '确认订阅',
    confirmCancel: '确定要取消此订单吗？',
    deleteOrder: '删除已取消订单',
    confirmDeleteOrder: '删除后订单将从列表中移除。确定继续吗？',
    orderDeleted: '订单已删除',
    amountTooLow: '最低金额为 {min}',
    amountTooHigh: '最高金额为 {max}',
    amountNoMethod: '该金额没有可用的支付方式',
    rechargeRatePreview: '兑换比例：1 {currency} = 1 平台积分',
    refundReason: '退款原因',
    ...
    errors: {
      PLAN_SOLD_OUT: '该套餐已售罄，请刷新后选择其他套餐',
      PLAN_STOCK_BELOW_FROZEN: '库存不能低于当前冻结数量',
      SUBSCRIPTION_PLATFORM_PENDING_EXISTS: '该平台已有一份待生效订阅，请先等待或将其立即生效',
      CONFIRMATION_REQUIRED: '立即生效前必须确认放弃当前订阅剩余时间',
      ...
      BALANCE_PAYMENT_DISABLED: '平台积分充值功能已关闭',
      INVALID_AMOUNT: '金额无效',
      INVALID_INPUT: '参数有误',
      ...
      DAILY_LIMIT_EXCEEDED: '今日充值已达上限，剩余可充值金额 {remaining}',
      ...
      INVALID_ORDER_TYPE: '仅积分充值订单可申请退款',
      INVALID_STATUS: '当前订单状态不允许此操作',
      ORDER_CANCELLATION_INCOMPLETE: '订单取消资源仍在释放中，请稍后刷新后重试',
      BALANCE_NOT_ENOUGH: '可追回积分不足，无法按该金额退款',
      REFUND_AMOUNT_EXCEEDED: '退款金额超过充值金额',
      REFUND_FAILED: '退款失败',
      USER_REFUND_DISABLED: '该支付方式未开放用户自助退款',
      REFUND_DISABLED: '该支付方式未开放退款',
      REFUND_TICKET_REQUIRED: '自助退款期限已过，请提交退款工单',
      NO_REFUNDABLE_AMOUNT: '当前积分不足以支持退款，或已无可退本金',
      REFUND_SNAPSHOT_MISSING: '订单缺少退款快照，请联系管理员',
      ALREADY_REFUNDED: '该订单已无剩余可退本金',
      ACTIVE_REFUND_TICKET_EXISTS: '该订单已有进行中的退款工单',
      INVALID_IDEMPOTENCY_KEY: '退款请求标识无效，请关闭对话框后重试',
      IDEMPOTENCY_CONFLICT: '退款请求参数已变化，请关闭对话框后重新申请',
    },
    ...
    renewTitle: '续费订阅',
    confirmRenew: '确认续费',
    confirmSubscribe: '确认购买',
    noPlansForGroup: '该订阅分组暂无可用套餐',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      rate: '倍率',
      ...
      monthlyLimit: '月限额',
      resetCards: '周限额重置卡',
      resetCardsValue: '赠送 {count} 次，有效期 {days} 天',
      quota: '配额',
      unlimited: '无限制',
      models: '模型',
      stock: '库存',
      ...
      soldOut: '已售罄',
      pendingExists: '已有待生效订阅',
    },
    subscriptionWillQueue: '当前平台已有生效中的订阅，购买成功后将加入待生效队列，并在当前订阅到期后开始计算完整有效期。',
    subscriptionQueued: '购买成功，订阅已加入待生效队列',
    days: '天',
    weeks: '周',
    months: '个月',
    years: '年',
    ...
    admin: {
      ...
      refund: '退款',
      refundOrder: '退款订单',
      refundAmount: '退款本金（RMB）',
      gatewayRefundAmount: '网关退款',
      reversedPoints: '撤回积分',
      maxRefundable: '最大可退本金',
      refundReason: '退款原因',
      ...
      alreadyRefunded: '已退款',
      deductBalance: '扣回积分',
      deductBalanceHint: '按退款比例从用户账户扣回本次充值积分',
      userBalance: '用户积分',
      orderAmount: '订单金额',
      pointsToReverse: '预计扣回积分',
      pointsReverseAutomaticHint: '提交后系统会按本次退款比例自动冻结并扣回充值积分与赠送积分。',
      insufficientBalance: '用户积分不足，需要强制退款或先处理账户积分',
      noDeduction: '将不扣回用户积分',
      ...
      workspaceLabel: '订单与退款工作区',
      ordersWorkspace: '订单',
      refundTickets: {
        title: '退款工单',
        description: '审核超过自助期限的退款申请，并跟踪网关处理状态。',
        empty: '当前筛选条件下没有退款工单',
        ticketId: '工单 ID',
        user: '用户',
        comment: '申请说明',
        ...
        approve: '批准',
        reject: '拒绝',
        approvedPrincipal: '批准退还本金',
        approvedPrincipalHint: '金额单位为 RMB，当前剩余本金上限为 {amount}。实际退款仍会受可扣回积分约束。',
        loadingOrder: '正在加载订单退款快照...',
        orderLoadFailed: '订单退款快照加载失败',
        retryOrder: '重新加载',
        originalPrincipal: '原始充值本金',
        refundedPrincipal: '累计已退本金',
        remainingPrincipal: '剩余本金',
        basePoints: '基础积分',
        bonusPoints: '赠送积分',
        affiliatePoints: '实际邀请返利积分',
        reviewNotePlaceholder: '填写审核依据和处理说明',
        affiliateManual: '邀请返利按人工流程处理，请在审核前核对关联返利记录。',
        submitReview: '提交审核',
        reviewed: '退款工单审核已提交',
      },
      auditLogs: '操作日志',
      ...
      originalPrice: '原价（平台积分）',
      price: '价格（平台积分）',
      planPointsHint: '套餐购买仅扣除平台积分，不会创建支付网关订单。',
      stockControl: '限量库存',
      stockQuantity: '库存数量',
      stockHint: '已冻结 {frozen} 份；库存不能低于冻结数量。',
      stockInvalid: '请输入 {frozen} 到 2147483647 之间的整数库存',
      resetCardCount: '赠送重置卡数量',
      resetCardCountHint: '订阅实际生效时发放，历史订阅不会自动补发。',
      resetCardValidityDays: '重置卡有效期（天）',
      resetCardCountInvalid: '重置卡数量必须是 0 到 1000 的整数',
      resetCardValidityInvalid: '重置卡有效期必须是 1 到 3650 天',
      stockSummary: '可售 {available} / 冻结 {frozen} / 库存 {total}',
      unlimitedStock: '不限库存',
      validity: '有效期',
      validityUnit: '有效期单位',
      sortOrder: '排序',
