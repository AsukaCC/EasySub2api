export default {
  common: {
    ...
    groupRateComparison: '分组倍率 {original}x，充值积分乘以等级及当前优惠系数后为 {lowest}x；赠送积分不享分时优惠',
    ...
    resizeColumnHint: '拖动调整“{column}”列宽；双击或按 Enter 恢复默认宽度',
    search: '搜索',
    filter: '筛选',
    export: '导出',
    import: '导入',
  ...
  nav: {
    ...
    ops: '运维监控',
    opsDashboard: '监控面板',
    adminOperations: '运营管理',
    adminMenu: '管理员菜单',
    adminOverview: '概览',
    resourceManagement: '核心资源',
    userBusinessManagement: '用户与业务',
    operationsSecurity: '监控与审计',
    systemManagement: '系统配置',
    customPages: '自定义页面',
    businessManagement: '业务管理',
    promoCodes: '优惠码',
    settings: '系统设置',
    settingsFeatures: '功能管理',
    settingsUpdates: '系统更新',
    settingsChannelMonitor: '监控设置',
    settingsPayment: '支付设置',
    settingsModelPlaza: '模型广场设置',
    settingsOpsMonitoring: '运维监控设置',
    settingsFeatureChannelMonitor: '渠道监控设置',
    settingsFeatureAvailableChannels: '可用渠道设置',
    settingsFeatureModelPlaza: '模型广场设置',
    settingsFeaturePayment: '支付设置',
    settingsFeatureRiskControl: '风控设置',
    settingsFeatureAffiliate: '分销设置',
    settingsFeatureOpsMonitoring: '运维监控设置',
    settingsPlatform: '平台设置',
    settingsCompliance: '登录与合规',
    settingsAccess: '访问与用户',
    settingsGateway: '网关与调度',
    settingsOperations: '邮件与运维',
    myAccount: '我的账户',
    lightMode: '浅色模式',
    darkMode: '深色模式',
    ...
    themeAccent: '主题色',
    themeAccentReset: '恢复站点默认主题色',
    backgroundSaveFailed: '背景图保存失败(图片可能过大)',
    collapse: '收起',
    expand: '展开',
    logout: '退出登录',
    github: 'GitHub',
  ...
  tickets: {
    title: '工单中心',
    description: '提交账号或退款问题，并在同一时间线中查看处理进度。',
    adminTitle: '工单管理',
    adminDescription: '处理用户问题、退款审核与完整沟通记录。',
    create: '新建工单',
    created: '工单已创建',
    replied: '回复已发送',
    disabled: '工单功能当前已关闭，已有工单仍可查看和回复。',
    list: '工单列表',
    empty: '暂无符合条件的工单',
    emptyTitle: '暂无工单',
    unreadBadge: '{n} 条未读',
    selectHint: '选择一条工单查看详情',
    searchPlaceholder: '搜索用户、订单或工单',
    unreadOnly: '仅未读',
    unread: '未读更新',
    category: '问题类型',
    subject: '标题',
    ...
    refundReason: '退款原因',
    apiKey: 'API 密钥',
    apiKeyOptional: '关联 API 密钥（可选）',
    noApiKey: '不关联密钥',
    group: '分组快照',
    order: '订单',
    user: '用户',
    approvedAmount: '批准退款本金',
    createdAt: '创建时间',
    replyPlaceholder: '输入回复，最多 4000 字符',
    send: '发送回复',
    submit: '提交工单',
    cancel: '取消工单',
    close: '关闭工单',
    ...
    refundReview: '退款审核',
    principalAmount: '退款本金（人民币）',
    approve: '批准退款',
    reject: '拒绝退款',
    retry: '重试退款',
    systemEvent: '系统状态更新',
    categories: { account: '账号问题', refund: '退款问题' },
    statuses: {
    ...
    authors: { user: '用户', admin: '管理员', system: '系统' },
    events: {
      refund_auto_failed: '自动退款未完成，已转为人工处理',
  ...
  auth: {
    ...
    promoCodeValid: '有效！注册后将获得 {amount}',
    ...
    invitationCodeInvalid: '邀请码无效、已停用或已过期',
