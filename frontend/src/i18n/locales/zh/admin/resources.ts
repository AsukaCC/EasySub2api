export default {
    ...
    redeem: {
      ...
      noCodes: '暂无兑换码',
      noCodesDescription: '生成兑换码以向用户分发平台积分或并发数。',
    ...
    announcements: {
      ...
      form: {
        ...
        status: '状态',
        notifyMode: '通知方式',
        notifyModeHint: '静默公告显示在仪表盘；弹窗和顶部滚动公告可设置时间段及投放条件',
        startsAt: '开始时间',
        endsAt: '结束时间',
        ...
        selectPackages: '选择套餐',
        selectUsers: '选择用户',
        userSearchPlaceholder: '搜索邮箱或用户 ID...',
        selectLevels: '选择等级',
        level1: 'L1',
        level2: 'L2',
        level3: 'L3'
