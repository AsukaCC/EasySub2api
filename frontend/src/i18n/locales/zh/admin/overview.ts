export default {
    ...
    groups: {
      ...
      levelRates: {
        ...
        hint: '区间共享额度由命中本规则的全站用户共同消耗；个人区间额度为每个用户独立额度。两者都按账号 7d 用量 U 累计。',
        ...
        activationSpend: '触发消费（近 7 天积分）', sharedQuotaAmount: '全站共享额度 U（0=不限）', personalQuotaAmount: '每用户额度 U（0=不限）',
        sharedUsage: '全站共享已用（账号 7d U）', unlimited: '不限', enabled: '启用', levels: '适用等级', allLevels: '全部等级',
