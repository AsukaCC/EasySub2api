export default {
    ...
    groups: {
      ...
      levelRates: {
        ...
        hint: '等级覆盖优先于分组默认倍率；动态规则按当前时间和个人额度生效。',
        levelOverrides: '用户等级倍率覆盖', dynamicRules: '分时动态倍率', addRule: '新增规则', noRules: '暂无动态规则',
        level: '等级 {level}', inherit: '继承分组默认', name: '规则名称', start: '开始', end: '结束', multiplier: '倍率',
        activationSpend: '触发消费（近 7 天积分）', quotaAmount: '个人积分额度（每日，0=不限）', enabled: '启用', levels: '适用等级', allLevels: '全部等级', saveFailed: '保存等级与动态倍率失败'
      },
      accountFilters: {
        title: '账号过滤控制',
