export default {
    ...
    users: {
      ...
      inactiveCleanup: {
        ...
        lastUsedBefore: '最后使用时间早于',
        lastUsedBeforeHint: '按浏览器本地时间输入；从未使用的账户还必须创建时间早于该时间，避免误删新账户。',
        ...
        invalidLastUsedBefore: '请选择有效的最后使用截止时间。',
        futureLastUsedBefore: '最后使用截止时间不能晚于当前时间。',
        preview: '预览筛选结果',
        previewing: '预览中...',
