export default {
    ...
    users: {
      ...
      levels: {
        createdPendingBinding: '账号已创建并绑定默认规则，重试将完成所选规则的换绑。',
        defaultRule: '默认规则',
        setDefault: '设为默认规则',
        defaultProtected: '默认规则不能删除或停用',
        inUseProtected: '默认规则或有绑定用户的规则不能停用',
        memberSearch: '搜索用户名或邮箱',
        noMembers: '暂无匹配用户',
        addMember: '添加成员',
        transfer: '换绑',
        targetRule: '目标等级规则',
        applyMembers: '应用到已选用户（{count}）',
        resetDefault: '转回默认规则',
        confirmTransfer: '将 {count} 个用户换绑到“{name}”？原有等级绑定将被替换。',
        title: '用户等级规则',
        create: '新建规则',
        edit: '编辑规则',
        name: '规则名称',
        ...
        minSpend: '消费门槛（积分）',
        multiplier: '等级倍率',
        tierHint: '基础等级门槛固定为 0；后续等级门槛必须递增。未设置倍率按 1 计算。',
        addTier: '添加等级',
        invalidThresholds: '等级消费门槛必须严格递增',
        loadFailed: '加载用户等级规则失败',
        saveFailed: '保存用户等级规则失败',
        deleteFailed: '删除用户等级规则失败',
        deleteReferenced: '规则仍有用户分配或配置引用，无法删除',
        confirmDelete: '确定删除规则“{name}”吗？',
        assignedRules: '已分配等级规则',
        assignmentHint: '每个用户绑定一条等级规则。',
        enableBulk: '批量修改等级规则',
        addOperation: '添加规则',
        removeOperation: '转回默认规则',
        replaceOperation: '换绑等级规则',
      ...
      archive: {
        action: '归档用户',
        title: '归档用户管理',
        hint: '这里保留旧版本归档的用户。恢复账号只恢复邮箱登录，不会恢复原 API Key。新执行的用户删除将直接物理删除。',
      ...
      deleteConfirm: "确定要彻底删除用户 '{email}' 吗？用户及其 API Key、用量、钱包、订单、退款、工单等关联数据都会被物理删除，无法恢复。",
      roles: {
        admin: '管理员',
        user: '用户'
      },
      ...
      userDeletedSuccess: '用户及关联数据已彻底删除',
    ...
    groups: {
      ...
      codexModelsManifest: {
        ...
        disabledHint: '未启用：manifest 请求经由调度器选账号。',
        accounts: '选定账号',
