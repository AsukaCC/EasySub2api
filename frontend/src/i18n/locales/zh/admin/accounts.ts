export default {
    accounts: {
      ...
      allTypes: '全部类型',
      allStatus: '全部状态',
      allExpiryStatuses: '全部到期状态',
      expiringWithin7Days: '7 天内到期',
      expiredAccounts: '已过期账号',
      allGroups: '全部分组',
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 EasySub2api 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 EasySub2api 端解除该限制。',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: '此倍率由上游站点针对当前 API Key 自行声明。EasySub2api 无法验证该值是否与实际扣费一致；上游站点或中间代理可能返回伪造、过期或被篡改的数据。请结合账单、余额变化和实际用量自行核验。',
      ...
      modelRules: {
        title: '模型规则',
        description: '按平台和订阅档位维护统一模型路由。账号绑定后持续跟随规则更新；空路由不拦截且原样透传模型名。',
        createRule: '新建规则',
        editRule: '编辑规则',
        platform: '平台',
        name: '规则名称',
        namePlaceholder: '例如：Claude 兼容映射',
        descriptionLabel: '描述',
        ...
        addRoute: '添加路由',
        removeRoute: '删除路由',
        routeInvalid: '请补全路由，确保请求模型不重复、通配符仅位于请求模型末尾，且上游模型不含通配符。',
        emptyRoutes: '当前为空：允许所有模型并原样透传模型标识。',
        emptyRoutesHint: '留空时不拦截、不执行默认模型映射；配置后仅允许精确或尾部通配符命中的请求模型。',
        passthroughAll: '空配置 · 全部原样透传',
        scope: '作用域',
        subscriptionTier: '订阅档位',
        allTiers: '全部档位',
        allTiersOnly: '仅全部档位规则',
        boundAccounts: '绑定账号',
        deleteBoundHint: '仍有账号绑定，需先解绑或改绑',
        syncSourceAccount: '同步源账号',
        sourceAccountRequired: '新建规则必须选择一个同步源账号',
        syncUpstreamModels: '同步上游模型',
        importSyncedModels: '导入同步模型',
        whitelist: '模型白名单',
        whitelistPlaceholder: '例如：claude-3-5-sonnet-20241022',
        addWhitelist: '添加白名单',
        removeWhitelist: '删除白名单',
        whitelistCount: '{count} 个白名单',
        ...
        importModelsEmpty: '请选择要导入的模型',
        importModelsSuccess: '已导入 {count} 个模型映射',
        importModelsNoChanges: '选中的模型已存在于映射中',
        searchModels: '搜索支持的模型',
        selectAllModels: '全选模型',
        clearModelSelection: '清空选择',
        loadingModels: '正在拉取当前平台最新支持模型…',
        noModels: '当前平台没有可用模型',
        loadModelsFailed: '最新支持模型拉取失败，请重试',
        selectedModelsCount: '已选择 {count} 个模型',
        removeMapping: '删除映射',
        mappingCount: '{count} 条映射',
        noRules: '暂无模型规则',
        createFirst: '为不同平台创建可复用的模型映射规则。',
        actions: '操作',
        save: '保存规则',
        deleteRule: '删除规则',
        deleteConfirm: '确定删除规则“{name}”吗？删除前必须确保没有账号绑定。',
        loadFailed: '模型规则加载失败',
        saveFailed: '模型规则保存失败',
        deleteFailed: '模型规则删除失败',
        createSuccess: '模型规则创建成功',
        updateSuccess: '模型规则更新成功',
        deleteSuccess: '模型规则已删除',
        nameRequired: '请输入规则名称',
        mappingRequired: '请补全模型映射',
        whitelistRequired: '白名单仅支持精确模型名，不能包含 *',
        restrictionRequired: '白名单和模型映射至少填写一项',
        duplicateSource: '请求模型不能重复',
        importLabel: '导入已有模型规则',
        bindingLabel: '绑定模型路由规则',
        currentBinding: '当前规则：',
        selectPlaceholder: '选择当前平台的规则',
        importAction: '导入',
        bindAction: '绑定',
        unbindAction: '解绑',
        loading: '加载中…',
        noRulesForPlatform: '当前平台暂无可用规则',
        loadImportFailed: '规则加载失败',
        overwriteTitle: '替换当前模型限制',
        overwriteMessage: '导入“{name}”将替换当前模型映射或白名单，是否继续？',
        overwriteConfirm: '替换并导入',
        bindConfirmMessage: '绑定“{name}”后将清除账号旧模型映射，并持续跟随规则更新，是否继续？',
        bindConfirm: '确认绑定',
        boundReadOnlyHint: '账号已绑定模型路由规则。当前路由由规则统一控制，如需调整请编辑对应规则。',
        unbindSaveHint: '解绑后账号路由将保持为空。请先保存本次解绑，再按需重新配置或绑定其他规则。',
        tierMismatchWarning: '当前账号订阅档位与已绑定规则不一致；规则仍继续生效，改绑时请选当前档位或全部档位规则。',
        tierMismatchShort: '档位不匹配',
        unrecognizedTier: '未识别档位',
        unbound: '未绑定规则',
        importSuccess: '已导入模型规则“{name}”'
      },
      cnProviders: {
        accountMode: {
          title: '账号类型',
          ...
          zhipuTeam: {
            ...
            hint: '仅团队版 GLM Coding Plan 需要填写；个人版请将两项都留空。',
          },
          balance: '余额 --',
        window5h: '5 小时窗口',
        windowWeekly: '每周窗口',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokFreeQuota24hHint: '按 EasySub2api 近 24 小时本地 Token 用量估算（上限 {limit}）',
      ...
      bulkEdit: {
        ...
        modelRuleSinglePlatformHint: '批量导入已定义的模型规则仅支持同一平台账号，请先将目标限定为单一平台。'
      },
      ...
      grok: {
        ...
        ttsTextLabel: 'TTS 文本',
        ttsTextPlaceholder: '例如：Hello from EasySub2api connectivity test.',
      ...
      syncUpstreamModelsMetadataIncomplete: '模型 ID 已同步，但能力元数据不完整，因此未保存能力快照。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 EasySub2api 实例的场景。',
      ...
      oauth: {
        ...
        gemini: {
          ...
          missingProjectId: 'Gemini 授权结果缺少 Project ID，请选择项目后重新授权',
          aiStudioNotConfigured: '管理员尚未配置 AI Studio OAuth 客户端'
        },
        antigravity: {
          ...
          pleaseEnterRefreshToken: '请输入 Refresh Token',
          failedToValidateRT: '验证 Antigravity Refresh Token 失败'
        },
        grok: {
          title: 'Grok 账号授权',
