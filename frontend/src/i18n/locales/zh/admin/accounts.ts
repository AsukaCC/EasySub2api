export default {
    accounts: {
      ...
      subscriptionTierUnrecognized: '未识别档位',
      ...
      bulkEdit: {
        ...
        mixedPlatformWarning: '所选账号跨越多个平台（{platforms}）。其他批量字段仍可修改；模型限制配置必须限定为单一平台。',
        modelRestrictionSinglePlatform: '模型限制配置必须使用同一平台账号，请先将目标限定为单一平台。'
      },
      ...
      openai: {
        ...
        wsMode: 'WS mode',
        wsModeDesc:
          '仅对当前 OpenAI 账号类型生效。off 会关闭 WebSocket 路由；gateway.openai_ws.mode_router_v2_enabled=true 时按所选模式转发，否则保持旧版上下文池行为。',
        wsModeOff: '关闭（off）',
        ...
        wsModeOffHint: '当前账号类型已关闭 WebSocket 路由。',
        wsModeConcurrencyHint: '账号并发数限制同时执行的请求数；上下文池连接上限由网关连接池配置决定。',
        wsModePassthroughHint: '每个客户端会话使用独立上游 WebSocket 连接，不进入共享上下文池。',
        wsModeHttpBridgeHint: '客户端 WebSocket 请求会转换为上游 HTTP/SSE，再通过客户端连接回传。',
      ...
      profit: {
        ...
        pageTitle: '账号收益',
        period7d: '最近 7 天收益',
        expiry30d: '到期前 30 天收益',
        lifetime: '累计收益',
        quota7d: '7d 额度',
        quotaUnavailable: '暂无快照',
        quotaResetAt: '重置时间',
        quotaObservedAt: '采样时间',
        viewColumns: '显示列',
        noTier: '未设置档位',
        noExpiry: '未设置到期日',
        accountCreated: '添加时间',
        ...
        cost: '成本',
        upstreamCost: '上游计费',
        subscriptionCost: '订阅周期成本（积分）',
        subscriptionCostUnset: '未设置',
        setSubscriptionCost: '设置订阅周期成本',
        subscriptionCostPlaceholder: '留空表示未设置',
        subscriptionCostHint: '到期前30天毛利 = 该窗口积分收益 - 订阅周期成本；未设置时沿用上游成本口径',
        subscriptionCostInvalid: '请输入大于或等于 0 的有效数字',
        clearSubscriptionCost: '清除成本',
        expiryProfitFormula: '到期前30天毛利 = 窗口积分收益 - 订阅周期成本（{cost}）',
        profit: '毛利',
        profitShort: '利',
        requests: '请求数',
        requestsShort: '请求',
        tokens: 'Token',
        history: '每日收益记录',
        historyHint: '收入单位为积分，成本为 USD，毛利为当前系统数值差额',
        dailyChart: '每日收益图表',
        dailyChartHint: '悬浮到数据点可查看当天完整收入、成本、毛利和 Token 明细',
        moneyTrend: '积分与上游计费趋势',
        usageTrend: 'Token 与请求趋势',
        range7d: '7 天',
        range30d: '30 天',
        range90d: '90 天',
        rangeAll: '全部历史',
        ...
        rangeFrom: '开始日期',
        rangeTo: '结束日期',
        rangeInvalid: '开始日期必须早于或等于结束日期',
        unitHint: '收入：积分 · 成本：USD · 毛利：积分数值差额',
        date: '日期',
        days: '{count} 天',
        loadMore: '加载更多',
        noHistory: '暂无收益记录',
