...
export function getBillingModeBadgeClass(mode: string | null | undefined): string {
  switch (mode) {
    case BILLING_MODE_PER_REQUEST: return 'utils-billing-mode__state'
    case BILLING_MODE_IMAGE: return 'utils-billing-mode__state-2'
    case BILLING_MODE_VIDEO: return 'utils-billing-mode__state-3'
    default: return 'utils-billing-mode__state-4'
  }
}
