...
export async function regenerateAffiliateCode(): Promise<AffiliateCodeRegenerationResponse> {
  const { data } = await apiClient.post<AffiliateCodeRegenerationResponse>('/user/aff/code/regenerate')
  return data
}
