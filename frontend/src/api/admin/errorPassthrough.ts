 ...
 */
export async function getById(id: string): Promise<ErrorPassthroughRule> {
 ...
 */
export async function update(id: string, updates: UpdateRuleRequest): Promise<ErrorPassthroughRule> {
 ...
 * @returns Updated rule
 */
export async function toggleEnabled(id: string, enabled: boolean): Promise<ErrorPassthroughRule> {
