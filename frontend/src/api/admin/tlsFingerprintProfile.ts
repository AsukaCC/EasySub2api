...
export async function getById(id: string): Promise<TLSFingerprintProfile> {
...
export async function update(id: string, updates: UpdateProfileRequest): Promise<TLSFingerprintProfile> {
