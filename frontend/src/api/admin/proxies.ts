 ...
 */
export async function getById(id: string): Promise<Proxy> {
 ...
 * @returns Updated proxy
 */
export async function toggleStatus(id: string, status: 'active' | 'inactive'): Promise<Proxy> {
 ...
 */
export async function checkProxyQuality(id: string): Promise<ProxyQualityCheckResult> {
 ...
 */
export async function getProxyAccounts(id: string): Promise<ProxyAccountSummary[]> {
