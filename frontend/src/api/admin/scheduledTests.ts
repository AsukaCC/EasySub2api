 ...
 */
export async function listByAccount(accountId: string): Promise<ScheduledTestPlan[]> {
 ...
 */
export async function update(id: string, req: UpdateScheduledTestPlanRequest): Promise<ScheduledTestPlan> {
 ...
 */
export async function listResults(planId: string, limit?: number): Promise<ScheduledTestResult[]> {
