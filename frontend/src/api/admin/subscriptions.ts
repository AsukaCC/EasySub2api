 ...
 */
export async function getById(id: string): Promise<UserSubscription> {
 ...
 */
export async function getProgress(id: string): Promise<SubscriptionProgress> {
 ...
 */
export async function revoke(id: string): Promise<{ message: string }> {
 ...
 */
export async function restore(id: string): Promise<UserSubscription> {
