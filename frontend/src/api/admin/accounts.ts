...
function duplicateOperationStorageKey(id: string): string {
  return `easysub2api:admin:account-duplicate:${id}`
}

function getStoredDuplicateOperationKey(id: string): string | null {
  try {
...
function storeDuplicateOperationKey(id: string, key: string | null): void {
  try {
...
export async function duplicate(id: string): Promise<Account> {
 ...
 * @returns Updated account
 */
export async function toggleStatus(id: string, status: 'active' | 'inactive'): Promise<Account> {
 ...
 * @returns Test result
 */
export async function testAccount(id: string): Promise<{
  success: boolean
  message: string
  latency_ms?: number
}> {
 ...
 * @returns Updated account
 */
export async function refreshCredentials(id: string): Promise<Account> {
 ...
 */
export async function getStats(id: string, days: number = 30): Promise<AccountUsageStatsResponse> {
 ...
 * @returns Updated account
 */
export async function clearError(id: string): Promise<Account> {
 ...
 */
export async function getUsage(id: string, source?: 'passive' | 'active', force?: boolean): Promise<AccountUsageInfo> {
...
export async function getBatchUsage(accountIds: string[], force?: boolean): Promise<BatchAccountUsageResponse> {
 ...
 * @returns Updated account
 */
export async function clearRateLimit(id: string): Promise<Account> {
  const { data } = await apiClient.post<Account>(
 ...
 * @returns Updated account
 */
export async function recoverState(id: string): Promise<Account> {
 ...
 * @returns Updated account
 */
export async function resetAccountQuota(id: string): Promise<Account> {
  const { data } = await apiClient.post<Account>(
 ...
 */
export async function getTempUnschedulableStatus(id: string): Promise<TempUnschedulableStatus> {
 ...
 * @returns Success confirmation
 */
export async function resetTempUnschedulable(id: string): Promise<{ message: string }> {
...
export async function exchangeCode(
  endpoint: string,
  exchangeData: { session_id: string; code: string; state?: string; proxy_id?: string }
...
export async function bulkUpdate(
  accountIdsOrPayload: string[] | Record<string, unknown>,
 ...
 */
export async function getTodayStats(id: string): Promise<WindowStats> {
 ...
 */
export async function getBatchTodayStats(accountIds: string[]): Promise<BatchTodayStatsResponse> {
 ...
 * @returns Updated account
 */
export async function setSchedulable(id: string, schedulable: boolean): Promise<Account> {
 ...
 */
export async function syncUpstreamModels(id: string): Promise<SyncUpstreamModelsResult> {
...
export async function refreshOpenAIToken(
  ...
  const payload: { refresh_token: string; proxy_id?: string; client_id?: string } = {
...
export interface BatchOperationResult {
  ...
  warnings?: Array<{ account_id: string; warning: string }>
}
 ...
 * @returns Success confirmation
 */
export async function revertProxyFallback(id: string): Promise<{ message: string }> {
 ...
 */
export async function batchDelete(accountIds: string[]): Promise<BatchOperationResult> {
 ...
 */
export async function batchClearError(accountIds: string[]): Promise<BatchOperationResult> {
 ...
 * @returns Batch operation result
 */
export async function batchRefresh(accountIds: string[]): Promise<BatchOperationResult> {
...
export async function setPrivacy(id: string): Promise<Account> {
 ...
 * client binding here.
 */
export async function refreshOpenAIQuota(id: string): Promise<OpenAIQuotaRefreshResult> {
 ...
 */
export async function resetOpenAIQuota(id: string): Promise<OpenAIQuotaResetResult> {
...
export async function createSparkShadow(parentId: string, payload: SparkShadowCreatePayload): Promise<Account> {
...
export async function setUpstreamBillingProbeEnabled(id: string, enabled: boolean): Promise<void> {
  await apiClient.put(`/admin/accounts/${id}/upstream-billing-probe`, { enabled })
}

export async function probeUpstreamBilling(id: string): Promise<UpstreamBillingProbeResult> {
  const { data } = await apiClient.post<UpstreamBillingProbeResult>(`/admin/accounts/${id}/upstream-billing-probe`)
  return data
}

export async function probeUpstreamBillingBatch(accountIds: string[]): Promise<UpstreamBillingProbeResult[]> {
...
export async function getOllamaCloudUsage(id: string): Promise<OllamaCloudUsageState> {
  const { data } = await apiClient.get<OllamaCloudUsageState>(`/admin/accounts/${id}/ollama-cloud-usage`)
  return data
}

export async function saveOllamaCloudUsageSession(id: string, session: string): Promise<OllamaCloudUsageState> {
...
export async function deleteOllamaCloudUsageSession(id: string): Promise<OllamaCloudUsageState> {
  const { data } = await apiClient.delete<OllamaCloudUsageState>(`/admin/accounts/${id}/ollama-cloud-usage/session`)
  return data
}

export async function setOllamaCloudUsageAutoRefresh(id: string, enabled: boolean): Promise<OllamaCloudUsageState> {
...
export async function refreshOllamaCloudUsage(id: string): Promise<OllamaCloudUsageState> {
...
export async function refreshGeminiTier(id: string): Promise<Record<string, unknown>> {
  const { data } = await apiClient.post<Record<string, unknown>>(`/admin/accounts/${id}/refresh-tier`)
  return data
}

export async function batchRefreshGeminiTier(accountIds: string[] = []): Promise<{
  total: number
  success: number
  failed: number
  errors: Array<{ account_id: string; error: string }>
}> {
  const { data } = await apiClient.post('/admin/accounts/batch-refresh-tier', { account_ids: accountIds })
  return data
}
