...
export async function get(id: string): Promise<ChannelMonitorTemplate> {
...
export async function update(id: string, params: UpdateParams): Promise<ChannelMonitorTemplate> {
 ...
 */
export async function apply(id: string, monitorIds: string[]): Promise<ApplyResponse> {
 ...
 */
export async function listAssociatedMonitors(id: string): Promise<AssociatedMonitorsResponse> {
