...
export async function queryQuota(id: string): Promise<CNProviderQuotaProbeResult> {
...
/** 查询 payg 账号余额。 */
export async function queryBalance(id: string): Promise<CNProviderBalanceResult> {
