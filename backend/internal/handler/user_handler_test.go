...
func TestUserHandlerGetProfileReturnsIdentitySummaries(t *testing.T) {
	...
	_, hasLinuxDoIdentity := rawResp.Data.Identities["linuxdo"]
	require.False(t, hasLinuxDoIdentity)
}
...
func TestUserHandlerGetProfileReturnsLegacyCompatibilityFields(t *testing.T) {
	...
	_, hasLinuxDoBound := resp.Data["linuxdo_bound"]
	require.False(t, hasLinuxDoBound)
	...
	require.True(t, ok)
	_, hasLinuxDoBinding := authBindings["linuxdo"]
	require.False(t, hasLinuxDoBinding)
	...
	_, hasLinuxDoIdentity := identityBindings["linuxdo"]
	require.False(t, hasLinuxDoIdentity)
