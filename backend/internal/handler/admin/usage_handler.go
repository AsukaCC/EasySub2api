...
// ListAdmin lists only usage generated by administrator users. It is exposed
// under account management so it cannot be confused with account profit data.
func (h *UsageHandler) ListAdmin(c *gin.Context) {
	h.list(c, usageRoleScopeAdmin)
}

func (h *UsageHandler) list(c *gin.Context, forcedScope string) {
...
// StatsAdmin returns aggregate usage for all administrator users.
func (h *UsageHandler) StatsAdmin(c *gin.Context) {
	h.stats(c, usageRoleScopeAdmin)
}

func (h *UsageHandler) stats(c *gin.Context, forcedScope string) {
	roleScope, err := parseUsageRoleScope(c, usageRoleScopeRegular, forcedScope)
	if err != nil {
		response.BadRequest(c, err.Error())
		return
...
func (h *UsageHandler) SearchUsersAdmin(c *gin.Context) {
	h.searchUsers(c, usageRoleScopeAdmin)
}

func (h *UsageHandler) searchUsers(c *gin.Context, forcedScope string) {
	keyword := c.Query("q")
	if keyword == "" {
	...
	if forcedScope == usageRoleScopeAdmin {
		filters.Role = service.RoleAdmin
	}
...
func (h *UsageHandler) SearchAPIKeysAdmin(c *gin.Context) {
	h.searchAPIKeys(c, usageRoleScopeAdmin)
}

func (h *UsageHandler) searchAPIKeys(c *gin.Context, forcedScope string) {
