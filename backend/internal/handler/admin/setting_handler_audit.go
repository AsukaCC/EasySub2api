...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.AffiliateRebateRecipient != after.AffiliateRebateRecipient {
		changed = append(changed, "affiliate_rebate_recipient")
	}
	if before.AffiliateRebateFreezeHours != after.AffiliateRebateFreezeHours {
		changed = append(changed, "affiliate_rebate_freeze_hours")
	}
	if before.AffiliateTransferValidityDays != after.AffiliateTransferValidityDays {
		changed = append(changed, "affiliate_transfer_validity_days")
	}
	...
	if before.AvailableChannelsUserVisible != after.AvailableChannelsUserVisible {
		changed = append(changed, "available_channels_user_visible")
	}
	if before.ModelPlazaEnabled != after.ModelPlazaEnabled {
		changed = append(changed, "model_plaza_enabled")
	}
	if before.ModelPlazaUserVisible != after.ModelPlazaUserVisible {
		changed = append(changed, "model_plaza_user_visible")
	}
	...
	if before.AffiliateUserVisible != after.AffiliateUserVisible {
		changed = append(changed, "affiliate_user_visible")
	}
	if before.PaymentUserVisible != after.PaymentUserVisible {
		changed = append(changed, "payment_user_visible")
	}
