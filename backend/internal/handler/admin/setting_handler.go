...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		BonusBalanceDefaultValidityDays:                        settings.BonusBalanceDefaultValidityDays,
		RiskControlEnabled:                                     settings.RiskControlEnabled,
		SupportTicketsEnabled:                                  settings.SupportTicketsEnabled,
		SupportTicketsUserVisible:                              settings.SupportTicketsUserVisible,
		...
		AffiliateRebateRecipient:                               settings.AffiliateRebateRecipient,
		AffiliateRebateFreezeHours:                             settings.AffiliateRebateFreezeHours,
		AffiliateTransferValidityDays:                          settings.AffiliateTransferValidityDays,
		AffiliateRebateDurationDays:                            settings.AffiliateRebateDurationDays,
		AffiliateRebatePerInviteeCap:                           settings.AffiliateRebatePerInviteeCap,
		AdminRechargeRebateEnabled:                             settings.AdminRechargeRebateEnabled,
		AffiliateInviterBindingRewardPoints:                    settings.AffiliateInviterBindingRewardPoints,
		AffiliateInviterBindingRewardValidityDays:              settings.AffiliateInviterBindingRewardValidityDays,
		AffiliateInviteeBindingRewardPoints:                    settings.AffiliateInviteeBindingRewardPoints,
		...
		SiteBillingMode:                                        settings.SiteBillingMode,
		PaymentUserVisible:                                     settings.PaymentUserVisible,
		...
		AvailableChannelsUserVisible: settings.AvailableChannelsUserVisible,
...
func systemSettingsResponseData(settings dto.SystemSettings, authSourceDefaults *service.AuthSourceDefaultSettings) map[string]any {
	...
	data["auth_source_default_email_bonus_validity_days"] = authSourceDefaults.Email.BonusValidityDays
	...
	data["auth_source_default_dingtalk_bonus_validity_days"] = authSourceDefaults.DingTalk.BonusValidityDays
	...
	data["auth_source_default_oidc_bonus_validity_days"] = authSourceDefaults.OIDC.BonusValidityDays
	...
	data["auth_source_default_wechat_bonus_validity_days"] = authSourceDefaults.WeChat.BonusValidityDays
	...
	data["auth_source_default_github_bonus_validity_days"] = authSourceDefaults.GitHub.BonusValidityDays
	...
	data["auth_source_default_google_bonus_validity_days"] = authSourceDefaults.Google.BonusValidityDays
