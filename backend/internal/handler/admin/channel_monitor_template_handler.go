...
type channelMonitorTemplateCreateRequest struct {
	...
	Provider         string            `json:"provider" binding:"required,oneof=openai anthropic grok"`
...
func parseTemplateID(c *gin.Context) (string, bool) {
...
type channelMonitorTemplateApplyRequest struct {
	...
	MonitorIDs []string `json:"monitor_ids" binding:"required,min=1"`
}
