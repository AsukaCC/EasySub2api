...
type User struct {
	...
	NextExpiringBonusAmount float64    `json:"next_expiring_bonus_amount"`
...
type APIKey struct {
	...
	Quota       float64    `json:"quota"`      // Platform point quota (0 = unlimited)
	QuotaUsed   float64    `json:"quota_used"` // Used platform points
...
type Group struct {
	...
	WeeklyLimitUSD            *float64 `json:"weekly_limit_usd"` // Legacy alias; value is platform points.
	WeeklyLimitPoints         *float64 `json:"weekly_limit_points"`
	MonthlyLimitUSD           *float64 `json:"monthly_limit_usd"` // Legacy alias; value is platform points.
	...
	// ReasoningEffortMappings OpenAI/Codex 推理强度映射。
...
type Account struct {
	...
	ProtectionPolicyVersion int     `json:"protection_policy_version"`
	ID                      string  `json:"id"`
	Name                    string  `json:"name"`
	Notes                   *string `json:"notes"`
	Platform                string  `json:"platform"`
	...
	TLSFingerprintProfileID *string `json:"tls_fingerprint_profile_id,omitempty"`
...
type Proxy struct {
	...
	BackupProxyID  *string    `json:"backup_proxy_id"`
...
type BatchUpdateRedeemCodeFields struct {
	...
	Notes     *string             `json:"notes,omitempty"`
	GroupID   NullableStringField `json:"group_id,omitempty"`
...
type UsageLog struct {
	...
	// AccountBilledPoints is the legacy JSON field name for the upstream account
	// billing amount in USD. It does not expose account pricing details.
	AccountBilledPoints       float64 `json:"account_billed_points"`
	RateMultiplier            float64 `json:"rate_multiplier"`
...
type UserSubscription struct {
	...
	DailyUsagePoints   float64 `json:"daily_usage_points"`
	WeeklyUsageUSD     float64 `json:"weekly_usage_usd"`
	WeeklyUsagePoints  float64 `json:"weekly_usage_points"`
	MonthlyUsageUSD    float64 `json:"monthly_usage_usd"`
	MonthlyUsagePoints float64 `json:"monthly_usage_points"`
