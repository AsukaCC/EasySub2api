...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		NextBonusExpiresAt:         wallet.NextBonusExpiresAt,
		NextExpiringBonusAmount:    wallet.NextExpiringBonus,
...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		Name:               k.Name,
		GroupID:            k.GroupID,
		GroupIDs:           append([]string(nil), k.GroupIDs...),
		Status:             k.Status,
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		DailyLimitPoints:                g.DailyLimitUSD,
		WeeklyLimitUSD:                  g.WeeklyLimitUSD,
		WeeklyLimitPoints:               g.WeeklyLimitUSD,
		MonthlyLimitUSD:                 g.MonthlyLimitUSD,
		MonthlyLimitPoints:              g.MonthlyLimitUSD,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		ModelRuleID:               a.ModelRuleID,
		ModelRuleName:             a.ModelRuleName,
		ModelRuleSubscriptionTier: a.ModelRuleSubscriptionTier,
		ModelRuleTierMismatch:     a.HasModelRuleTierMismatch(),
	...
	if a.IsAnthropicOAuthOrSetupToken() {
		...
		// TLS指纹模板ID
		if profileID := a.GetTLSFingerprintProfileID(); profileID != "" {
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		BonusValidityDays: rc.BonusValidityDays,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	// 普通用户 DTO：仅暴露汇总后的上游账号计费金额，不包含账号倍率、定价基数、账号或上游详情。
...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	return UserSubscription{
		...
		DailyUsagePoints:   sub.DailyUsageUSD,
		WeeklyUsageUSD:     sub.WeeklyUsageUSD,
		WeeklyUsagePoints:  sub.WeeklyUsageUSD,
		MonthlyUsageUSD:    sub.MonthlyUsageUSD,
		MonthlyUsagePoints: sub.MonthlyUsageUSD,
...
func PromoCodeFromService(pc *service.PromoCode) *PromoCode {
	...
	return &PromoCode{
		...
		BonusValidityDays: pc.BonusValidityDays,
		MaxUses:           pc.MaxUses,
