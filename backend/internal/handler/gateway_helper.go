...
func (h *ConcurrencyHelper) IncrementWaitCount(ctx context.Context, userID string, maxWait int) (bool, error) {
	return h.concurrencyService.IncrementWaitCount(ctx, userID, maxWait)
}

// DecrementWaitCount decrements the wait count for a user
func (h *ConcurrencyHelper) DecrementWaitCount(ctx context.Context, userID string) {
	h.concurrencyService.DecrementWaitCount(ctx, userID)
}

// IncrementAccountWaitCount increments the wait count for an account
func (h *ConcurrencyHelper) IncrementAccountWaitCount(ctx context.Context, accountID string, maxWait int) (bool, error) {
...
func (h *ConcurrencyHelper) DecrementAccountWaitCount(ctx context.Context, accountID string) {
	h.concurrencyService.DecrementAccountWaitCount(ctx, accountID)
}

// TryAcquireUserSlot 尝试立即获取用户并发槽位。
// 返回值: (releaseFunc, acquired, error)
func (h *ConcurrencyHelper) TryAcquireUserSlot(ctx context.Context, userID string, maxConcurrency int) (func(), bool, error) {
...
func (h *ConcurrencyHelper) TryAcquireUserSlotForAPIKey(ctx context.Context, userID string, maxConcurrency int, apiKeyID string) (func(), bool, error) {
...
func (h *ConcurrencyHelper) AcquireOpenAIWSIngressLease(ctx context.Context, apiKeyID string, maxConnections int) (*service.OpenAIWSIngressLease, bool, error) {
...
// 返回值: (releaseFunc, acquired, error)
func (h *ConcurrencyHelper) TryAcquireAccountSlot(ctx context.Context, accountID string, maxConcurrency int) (func(), bool, error) {
...
func (h *ConcurrencyHelper) AcquireUserSlotWithWait(c *gin.Context, userID string, maxConcurrency int, isStream bool, streamStarted *bool) (func(), error) {
	return h.acquireUserSlotWithWaitTimeout(c, userID, maxConcurrency, maxConcurrencyWait, isStream, streamStarted)
}

func (h *ConcurrencyHelper) acquireUserSlotWithWaitTimeout(c *gin.Context, userID string, maxConcurrency int, timeout time.Duration, isStream bool, streamStarted *bool) (func(), error) {
...
func (h *ConcurrencyHelper) withAPIKeySlot(ctx context.Context, apiKeyID string, releaseFunc func()) func() {
	if h == nil || h.concurrencyService == nil || apiKeyID == "" {
		return releaseFunc
	}
...
// For streaming requests, sends ping events during the wait.
// streamStarted is updated if streaming response has begun.
func (h *ConcurrencyHelper) AcquireAccountSlotWithWait(c *gin.Context, accountID string, maxConcurrency int, isStream bool, streamStarted *bool) (func(), error) {
	ctx := c.Request.Context()
...
func (h *ConcurrencyHelper) waitForSlotWithPing(c *gin.Context, slotType string, id string, maxConcurrency int, isStream bool, streamStarted *bool) (func(), error) {
...
func (h *ConcurrencyHelper) waitForSlotWithPingTimeout(c *gin.Context, slotType string, id string, maxConcurrency int, timeout time.Duration, isStream bool, streamStarted *bool, tryImmediate bool) (func(), error) {
...
func (h *ConcurrencyHelper) AcquireAccountSlotWithWaitTimeout(c *gin.Context, accountID string, maxConcurrency int, timeout time.Duration, isStream bool, streamStarted *bool) (func(), error) {
