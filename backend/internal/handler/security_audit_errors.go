...
func googleSecurityAuditError(c *gin.Context, decision *securityaudit.Decision) {
	...
	c.JSON(status, gin.H{"error": gin.H{
		...
		"details": []gin.H{{
			"@type": "type.googleapis.com/google.rpc.ErrorInfo", "reason": securityAuditErrorCode(decision),
			"domain": "easysub2api.securityaudit", "metadata": gin.H{"request_id": requestID},
		}},
	}})
}
