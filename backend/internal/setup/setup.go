...
import (
	...
	"github.com/AsukaCC/EasySub2api/internal/repository"
...
func AutoSetupFromEnv() error {
	...
	cfg := &SetupConfig{
		Database: DatabaseConfig{
			...
			DBName:   getEnvOrDefault("DATABASE_DBNAME", "easysub2api"),
		...
		Admin: AdminConfig{
			Email:    getEnvOrDefault("ADMIN_EMAIL", "admin@easysub2api.local"),
