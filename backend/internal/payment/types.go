...
type RefundRequest struct {
	TradeNo   string
	OrderID   string
	RequestID string // Stable ID for one logical refund, reused across retries
...
type RefundQueryRequest struct {
	...
	OrderID   string
	RefundID  string
	RequestID string // Stable provider request identity used when the response ID was lost
	Amount    string
}
