...
func (r *proxyRepository) sweepOneExpiredProxy(ctx context.Context, proxyID string, target *string, change bool) ([]string, error) {
...
func (r *proxyRepository) sweepOneExpiredProxyOnExec(ctx context.Context, exec sqlExecutor, proxyID string, target *string, change bool) ([]string, error) {
