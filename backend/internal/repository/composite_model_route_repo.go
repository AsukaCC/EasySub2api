...
import (
	...
	"github.com/AsukaCC/EasySub2api/ent/compositemodelroute"
...
func (r *compositeModelRouteRepository) ListByGroup(ctx context.Context, groupID string, includeDisabled bool) ([]service.CompositeModelRoute, error) {
...
func (r *compositeModelRouteRepository) Delete(ctx context.Context, id string) error {
...
func (r *compositeModelRouteRepository) DeleteByGroup(ctx context.Context, groupID string) error {
