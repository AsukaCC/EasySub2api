...
import (
	...
	"github.com/AsukaCC/EasySub2api/ent/userattributedefinition"
	"github.com/AsukaCC/EasySub2api/ent/userattributevalue"
...
func (r *userAttributeDefinitionRepository) GetByID(ctx context.Context, id string) (*service.UserAttributeDefinition, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userAttributeDefinitionRepository) Delete(ctx context.Context, id string) error {
	client := clientFromContext(ctx, r.client)
...
func (r *userAttributeDefinitionRepository) UpdateDisplayOrders(ctx context.Context, orders map[string]int) error {
...
func (r *userAttributeValueRepository) GetByUserID(ctx context.Context, userID string) ([]service.UserAttributeValue, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userAttributeValueRepository) GetByUserIDs(ctx context.Context, userIDs []string) ([]service.UserAttributeValue, error) {
	if len(userIDs) == 0 {
...
func (r *userAttributeValueRepository) UpsertBatch(ctx context.Context, userID string, inputs []service.UpdateUserAttributeInput) error {
	if len(inputs) == 0 {
		return nil
	}
...
func (r *userAttributeValueRepository) DeleteByAttributeID(ctx context.Context, attributeID string) error {
	client := clientFromContext(ctx, r.client)
...
func (r *userAttributeValueRepository) DeleteByUserID(ctx context.Context, userID string) error {
	client := clientFromContext(ctx, r.client)
