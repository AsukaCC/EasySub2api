...
import (
	...
	dbusagecleanuptask "github.com/AsukaCC/EasySub2api/ent/usagecleanuptask"
...
func (r *usageCleanupRepository) GetTaskStatus(ctx context.Context, taskID string) (string, error) {
	if r.client != nil {
...
func (r *usageCleanupRepository) UpdateTaskProgress(ctx context.Context, taskID string, deletedRows int64) error {
	if r.client != nil {
...
func (r *usageCleanupRepository) CancelTask(ctx context.Context, taskID string, canceledBy string) (bool, error) {
	if r.client != nil {
...
func (r *usageCleanupRepository) MarkTaskSucceeded(ctx context.Context, taskID string, deletedRows int64) error {
	if r.client != nil {
...
func (r *usageCleanupRepository) MarkTaskFailed(ctx context.Context, taskID string, deletedRows int64, errorMsg string) error {
	if r.client != nil {
...
func (r *usageCleanupRepository) getTaskStatusWithEnt(ctx context.Context, taskID string) (string, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *usageCleanupRepository) updateTaskProgressWithEnt(ctx context.Context, taskID string, deletedRows int64) error {
	client := clientFromContext(ctx, r.client)
	now := time.Now()
...
func (r *usageCleanupRepository) cancelTaskWithEnt(ctx context.Context, taskID string, canceledBy string) (bool, error) {
	client := clientFromContext(ctx, r.client)
	now := time.Now()
...
func (r *usageCleanupRepository) markTaskSucceededWithEnt(ctx context.Context, taskID string, deletedRows int64) error {
	client := clientFromContext(ctx, r.client)
	now := time.Now()
	_, err := client.UsageCleanupTask.Update().
		Where(dbusagecleanuptask.IDEQ(taskID)).
...
func (r *usageCleanupRepository) markTaskFailedWithEnt(ctx context.Context, taskID string, deletedRows int64, errorMsg string) error {
	client := clientFromContext(ctx, r.client)
	now := time.Now()
	_, err := client.UsageCleanupTask.Update().
		Where(dbusagecleanuptask.IDEQ(taskID)).
