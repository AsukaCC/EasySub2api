...
func userRefreshTokensKey(userID string) string {
	return fmt.Sprintf("%s%s", userRefreshTokensPrefix, userID)
}
...
func (c *refreshTokenCache) DeleteUserRefreshTokens(ctx context.Context, userID string) error {
...
func (c *refreshTokenCache) AddToUserTokenSet(ctx context.Context, userID string, tokenHash string, ttl time.Duration) error {
...
func (c *refreshTokenCache) GetUserTokenHashes(ctx context.Context, userID string) ([]string, error) {
	key := userRefreshTokensKey(userID)
