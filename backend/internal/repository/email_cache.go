...
func notifyCodeUserRateKey(userID string) string {
	return notifyCodeUserRateKeyPrefix + userID
}

func (c *emailCache) IncrNotifyCodeUserRate(ctx context.Context, userID string, window time.Duration) (int64, error) {
...
func (c *emailCache) GetNotifyCodeUserRate(ctx context.Context, userID string) (int64, error) {
	key := notifyCodeUserRateKey(userID)
