...
func buildSessionKey(groupID string, sessionHash string) string {
	return fmt.Sprintf("%s%s:%s", stickySessionPrefix, groupID, sessionHash)
}

func (c *gatewayCache) GetSessionAccountID(ctx context.Context, groupID string, sessionHash string) (string, error) {
...
func (c *gatewayCache) SetSessionAccountID(ctx context.Context, groupID string, sessionHash string, accountID string, ttl time.Duration) error {
	key := buildSessionKey(groupID, sessionHash)
	return c.rdb.Set(ctx, key, accountID, ttl).Err()
}

func (c *gatewayCache) RefreshSessionTTL(ctx context.Context, groupID string, sessionHash string, ttl time.Duration) error {
	key := buildSessionKey(groupID, sessionHash)
...
func (c *gatewayCache) DeleteSessionAccountID(ctx context.Context, groupID string, sessionHash string) error {
	key := buildSessionKey(groupID, sessionHash)
