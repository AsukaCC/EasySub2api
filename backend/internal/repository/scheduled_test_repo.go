...
func (r *scheduledTestPlanRepository) GetByID(ctx context.Context, id string) (*service.ScheduledTestPlan, error) {
	row := r.db.QueryRowContext(ctx, `
...
func (r *scheduledTestPlanRepository) ListByAccountID(ctx context.Context, accountID string) ([]*service.ScheduledTestPlan, error) {
...
func (r *scheduledTestPlanRepository) Delete(ctx context.Context, id string) error {
	_, err := r.db.ExecContext(ctx, `DELETE FROM scheduled_test_plans WHERE id = $1`, id)
	return err
}

func (r *scheduledTestPlanRepository) UpdateAfterRun(ctx context.Context, id string, lastRunAt time.Time, nextRunAt time.Time) error {
...
func (r *scheduledTestResultRepository) ListByPlanID(ctx context.Context, planID string, limit int) ([]*service.ScheduledTestResult, error) {
	rows, err := r.db.QueryContext(ctx, `
...
func (r *scheduledTestResultRepository) PruneOldResults(ctx context.Context, planID string, keepCount int) error {
	_, err := r.db.ExecContext(ctx, `
