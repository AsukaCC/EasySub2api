...
import (
	...
	"github.com/AsukaCC/EasySub2api/ent/errorpassthroughrule"
...
// GetByID 根据 ID 获取规则
func (r *errorPassthroughRepository) GetByID(ctx context.Context, id string) (*model.ErrorPassthroughRule, error) {
...
// Delete 删除规则
func (r *errorPassthroughRepository) Delete(ctx context.Context, id string) error {
