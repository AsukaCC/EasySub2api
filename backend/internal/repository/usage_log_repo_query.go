...
import (
	...
	dbapikey "github.com/AsukaCC/EasySub2api/ent/apikey"
	...
	dbusersub "github.com/AsukaCC/EasySub2api/ent/usersubscription"
...
func (r *usageLogRepository) GetByID(ctx context.Context, id string) (log *service.UsageLog, err error) {
...
func (r *usageLogRepository) ListByUser(ctx context.Context, userID string, params pagination.PaginationParams) ([]service.UsageLog, *pagination.PaginationResult, error) {
	return r.listUsageLogsWithPagination(ctx, "WHERE user_id = $1", []any{userID}, params)
}

func (r *usageLogRepository) ListByAPIKey(ctx context.Context, apiKeyID string, params pagination.PaginationParams) ([]service.UsageLog, *pagination.PaginationResult, error) {
	return r.listUsageLogsWithPagination(ctx, "WHERE api_key_id = $1", []any{apiKeyID}, params)
}

func (r *usageLogRepository) ListByAccount(ctx context.Context, accountID string, params pagination.PaginationParams) ([]service.UsageLog, *pagination.PaginationResult, error) {
	return r.listUsageLogsWithPagination(ctx, "WHERE account_id = $1", []any{accountID}, params)
}

func (r *usageLogRepository) ListByUserAndTimeRange(ctx context.Context, userID string, startTime, endTime time.Time) ([]service.UsageLog, *pagination.PaginationResult, error) {
...
func (r *usageLogRepository) ListByAPIKeyAndTimeRange(ctx context.Context, apiKeyID string, startTime, endTime time.Time) ([]service.UsageLog, *pagination.PaginationResult, error) {
...
func (r *usageLogRepository) ListByAccountAndTimeRange(ctx context.Context, accountID string, startTime, endTime time.Time) ([]service.UsageLog, *pagination.PaginationResult, error) {
...
func (r *usageLogRepository) Delete(ctx context.Context, id string) error {
...
func shouldUseFastUsageLogTotal(filters UsageLogFilters) bool {
	...
	return filters.UserID == "" && filters.APIKeyID == "" && filters.AccountID == ""
}
...
func collectUsageLogIDs(logs []service.UsageLog) usageLogIDs {
	idSet := func() map[string]struct{} { return make(map[string]struct{}) }
...
func (r *usageLogRepository) loadUsers(ctx context.Context, ids []string) (map[string]*service.User, error) {
	out := make(map[string]*service.User)
	if len(ids) == 0 {
		return out, nil
	}
...
func (r *usageLogRepository) loadAPIKeys(ctx context.Context, ids []string) (map[string]*service.APIKey, error) {
	out := make(map[string]*service.APIKey)
	if len(ids) == 0 {
		return out, nil
	}
...
func (r *usageLogRepository) loadAccounts(ctx context.Context, ids []string) (map[string]*service.Account, error) {
	out := make(map[string]*service.Account)
	if len(ids) == 0 {
		return out, nil
	}
...
func (r *usageLogRepository) loadGroups(ctx context.Context, ids []string) (map[string]*service.Group, error) {
	out := make(map[string]*service.Group)
	if len(ids) == 0 {
		return out, nil
	}
...
func (r *usageLogRepository) loadSubscriptions(ctx context.Context, ids []string) (map[string]*service.UserSubscription, error) {
	out := make(map[string]*service.UserSubscription)
	if len(ids) == 0 {
		return out, nil
	}
...
func nullID(v *string) sql.NullString {
	if v == nil || *v == "" {
