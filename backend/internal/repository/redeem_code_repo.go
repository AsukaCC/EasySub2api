...
func (r *redeemCodeRepository) Create(ctx context.Context, code *service.RedeemCode) error {
	created, err := r.client.RedeemCode.Create().
		...
		SetBonusValidityDays(code.BonusValidityDays).
...
func (r *redeemCodeRepository) CreateBatch(ctx context.Context, codes []service.RedeemCode) error {
	...
	for i := range codes {
		...
		b := r.client.RedeemCode.Create().
			...
			SetBonusValidityDays(c.BonusValidityDays).
...
func (r *redeemCodeRepository) GetByID(ctx context.Context, id string) (*service.RedeemCode, error) {
...
func (r *redeemCodeRepository) Delete(ctx context.Context, id string) error {
...
func (r *redeemCodeRepository) BatchUpdate(ctx context.Context, ids []string, fields service.RedeemCodeBatchUpdateFields) (int64, error) {
...
func (r *redeemCodeRepository) batchUpdate(ctx context.Context, client *dbent.Client, ids []string, fields service.RedeemCodeBatchUpdateFields) (int64, error) {
...
func (r *redeemCodeRepository) Use(ctx context.Context, id, userID string) error {
	now := time.Now()
...
func (r *redeemCodeRepository) ListByUser(ctx context.Context, userID string, limit int) ([]service.RedeemCode, error) {
	if limit <= 0 {
		limit = 10
	}
...
func (r *redeemCodeRepository) ListByUserPaginated(ctx context.Context, userID string, params pagination.PaginationParams, codeType string) ([]service.RedeemCode, *pagination.PaginationResult, error) {
	q := r.client.RedeemCode.Query().
		Where(redeemcode.UsedByEQ(userID))
...
func (r *redeemCodeRepository) SumPositiveBalanceByUser(ctx context.Context, userID string) (float64, error) {
	var result []struct {
...
func redeemCodeEntityToService(m *dbent.RedeemCode) *service.RedeemCode {
	...
	out := &service.RedeemCode{
		...
		BonusValidityDays: m.BonusValidityDays,
	}
	if m.Edges.User != nil {
