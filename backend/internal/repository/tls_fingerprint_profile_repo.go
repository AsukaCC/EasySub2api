...
// GetByID 根据 ID 获取模板
func (r *tlsFingerprintProfileRepository) GetByID(ctx context.Context, id string) (*model.TLSFingerprintProfile, error) {
...
// Delete 删除模板
func (r *tlsFingerprintProfileRepository) Delete(ctx context.Context, id string) error {
