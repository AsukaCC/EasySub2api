...
combined AS (
  ...
  FULL OUTER JOIN error_agg e
   ...
   AND COALESCE(u.group_id, '00000000-0000-0000-0000-000000000000'::uuid) = COALESCE(e.group_id, '00000000-0000-0000-0000-000000000000'::uuid)
)
...
ON CONFLICT (bucket_start, COALESCE(platform, ''), COALESCE(group_id, '00000000-0000-0000-0000-000000000000'::uuid)) DO UPDATE SET
...
GROUP BY 1, 2, 3
ON CONFLICT (bucket_date, COALESCE(platform, ''), COALESCE(group_id, '00000000-0000-0000-0000-000000000000'::uuid)) DO UPDATE SET
  success_count = EXCLUDED.success_count,
  ttft_sample_count = EXCLUDED.ttft_sample_count,
  error_count_total = EXCLUDED.error_count_total,
  business_limited_count = EXCLUDED.business_limited_count,
