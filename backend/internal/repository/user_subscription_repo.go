...
func (r *userSubscriptionRepository) GetByID(ctx context.Context, id string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) GetByIDForUpdate(ctx context.Context, id string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
	m, err := client.UserSubscription.Query().
		Where(usersubscription.IDEQ(id)).
		ForUpdate().
...
func (r *userSubscriptionRepository) GetByIDIncludeDeleted(ctx context.Context, id string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) GetByUserIDAndGroupID(ctx context.Context, userID, groupID string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
	m, err := client.UserSubscription.Query().
...
func (r *userSubscriptionRepository) GetActiveByUserIDAndGroupID(ctx context.Context, userID, groupID string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
	m, err := client.UserSubscription.Query().
		Where(
...
func (r *userSubscriptionRepository) Restore(ctx context.Context, subscriptionID string, restoredStatus string) (*service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
	queryCtx := mixins.SkipSoftDelete(ctx)
...
func (r *userSubscriptionRepository) ListByUserID(ctx context.Context, userID string) ([]service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ListActiveByUserID(ctx context.Context, userID string) ([]service.UserSubscription, error) {
	client := clientFromContext(ctx, r.client)
	subs, err := client.UserSubscription.Query().
		Where(
			usersubscription.UserIDEQ(userID),
...
func (r *userSubscriptionRepository) ListByGroupID(ctx context.Context, groupID string, params pagination.PaginationParams) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) List(ctx context.Context, params pagination.PaginationParams, userID, groupID *string, status, platform, sortBy, sortOrder string) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ExistsByUserIDAndGroupID(ctx context.Context, userID, groupID string) (bool, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ExistsActiveByUserIDAndGroupID(ctx context.Context, userID, groupID string) (bool, error) {
	return r.ExistsByUserIDAndGroupID(ctx, userID, groupID)
}

func (r *userSubscriptionRepository) ExtendExpiry(ctx context.Context, subscriptionID string, newExpiresAt time.Time) error {
	client := clientFromContext(ctx, r.client)
	_, err := client.UserSubscription.UpdateOneID(subscriptionID).
...
func (r *userSubscriptionRepository) UpdateStatus(ctx context.Context, subscriptionID string, status string) error {
	client := clientFromContext(ctx, r.client)
	_, err := client.UserSubscription.UpdateOneID(subscriptionID).
		SetStatus(status).
		Save(ctx)
...
func (r *userSubscriptionRepository) UpdateNotes(ctx context.Context, subscriptionID string, notes string) error {
	client := clientFromContext(ctx, r.client)
	_, err := client.UserSubscription.UpdateOneID(subscriptionID).
		SetNotes(notes).
		Save(ctx)
...
func (r *userSubscriptionRepository) ActivateWindows(ctx context.Context, id string, dailyStart, periodicStart time.Time) error {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ResetUsageWindows(ctx context.Context, id string, resetDaily, resetWeekly, resetMonthly bool, dailyStart, periodicStart time.Time) error {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ResetDailyUsage(ctx context.Context, id string, expectedWindowStart *time.Time, newWindowStart time.Time) error {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) ResetWeeklyUsage(ctx context.Context, id string, expectedWindowStart *time.Time, newWindowStart time.Time) error {
	client := clientFromContext(ctx, r.client)
	query := client.UserSubscription.Update().Where(usersubscription.IDEQ(id))
	if expectedWindowStart == nil {
...
func (r *userSubscriptionRepository) ResetMonthlyUsage(ctx context.Context, id string, expectedWindowStart *time.Time, newWindowStart time.Time) error {
	client := clientFromContext(ctx, r.client)
	query := client.UserSubscription.Update().Where(usersubscription.IDEQ(id))
	if expectedWindowStart == nil {
...
func (r *userSubscriptionRepository) translateConditionalWindowReset(ctx context.Context, client *dbent.Client, id string, affected int, err error) error {
	if err != nil {
		return translatePersistenceError(err, service.ErrSubscriptionNotFound, nil)
	}
	if affected > 0 {
...
func (r *userSubscriptionRepository) IncrementUsage(ctx context.Context, id string, costUSD float64) error {
	const updateSQL = `
...
func (r *userSubscriptionRepository) CountByGroupID(ctx context.Context, groupID string) (int64, error) {
	client := clientFromContext(ctx, r.client)
	count, err := client.UserSubscription.Query().Where(usersubscription.GroupIDEQ(groupID)).Count(ctx)
	return int64(count), err
}

func (r *userSubscriptionRepository) CountActiveByGroupID(ctx context.Context, groupID string) (int64, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) DeleteByGroupID(ctx context.Context, groupID string) (int64, error) {
	client := clientFromContext(ctx, r.client)
...
func (r *userSubscriptionRepository) attachUserSubscriptionRelations(ctx context.Context, subs []service.UserSubscription) error {
	...
	groupIDs := make([]string, 0, len(subs))
	assignedByIDs := make([]string, 0, len(subs))
	for i := range subs {
	...
	client := clientFromContext(ctx, r.client)
	users, err := client.User.Query().Where(user.IDIn(uniqueStrings(userIDs)...)).All(ctx)
	if err != nil {
		return err
	}
	userByID := make(map[string]*service.User, len(users))
	for _, u := range users {
		userByID[u.ID] = userEntityToService(u)
	}

	groups, err := client.Group.Query().Where(group.IDIn(uniqueStrings(groupIDs)...)).All(ctx)
	if err != nil {
		return err
	}
	groupByID := make(map[string]*service.Group, len(groups))
	for _, g := range groups {
		groupByID[g.ID] = groupEntityToService(g)
	}

	assignedByID := map[string]*service.User{}
	if len(assignedByIDs) > 0 {
		assignedUsers, err := client.User.Query().Where(user.IDIn(uniqueStrings(assignedByIDs)...)).All(ctx)
		if err != nil {
			return err
		}
		assignedByID = make(map[string]*service.User, len(assignedUsers))
