...
func (r *promoCodeRepository) GetByID(ctx context.Context, id string) (*service.PromoCode, error) {
...
func (r *promoCodeRepository) Delete(ctx context.Context, id string) error {
	client := clientFromContext(ctx, r.client)
...
func (r *promoCodeRepository) GetUsageByPromoCodeAndUser(ctx context.Context, promoCodeID, userID string) (*service.PromoCodeUsage, error) {
...
func (r *promoCodeRepository) ListUsagesByPromoCode(ctx context.Context, promoCodeID string, params pagination.PaginationParams) ([]service.PromoCodeUsage, *pagination.PaginationResult, error) {
...
func (r *promoCodeRepository) IncrementUsedCount(ctx context.Context, id string) error {
	client := clientFromContext(ctx, r.client)
