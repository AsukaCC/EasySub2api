...
// normalizeLoweredFunctionItemID maps restored client-only call IDs back to
// the fc_ prefix expected by function-protocol upstreams. Output IDs have no
// function-protocol counterpart and are removed; unknown prefixes are kept.
