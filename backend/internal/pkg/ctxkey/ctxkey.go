...
const (
	...
	// ThinkingEnabled 标识当前请求是否开启 thinking。
	...
	// APIKeyGroupIDs contains all groups bound to the authenticated API key.
	// Group remains the primary group used for pricing and request settings.
	APIKeyGroupIDs Key = "ctx_api_key_group_ids"

	// UserID 认证后的 EasySub2api 用户 ID，由 API Key 认证中间件设置。
