...
func (s *OpenAIQuotaService) referralAccount(ctx context.Context, id string, sending bool) (*Account, error) {
...
func (s *OpenAIQuotaService) referralCall(ctx context.Context, id string, program string) (OpenAIReferralCall, error) {
...
func (s *OpenAIQuotaService) QueryReferralEligibility(ctx context.Context, id string) (*OpenAIReferralEligibility, error) {
...
func (s *OpenAIQuotaService) CacheReferralSnapshot(ctx context.Context, id string, eligibility *OpenAIReferralEligibility) error {
...
func (s *OpenAIQuotaService) SendReferralInvite(ctx context.Context, id string, input OpenAIReferralSendRequest) (*OpenAIReferralSendResult, error) {
