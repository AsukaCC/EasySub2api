...
func (s *OAuthService) GenerateAuthURL(ctx context.Context, proxyID *string) (*GenerateAuthURLResult, error) {
...
func (s *OAuthService) GenerateSetupTokenURL(ctx context.Context, proxyID *string) (*GenerateAuthURLResult, error) {
	scope := oauth.ScopeInference
	return s.generateAuthURLWithScope(ctx, scope, proxyID)
}

func (s *OAuthService) generateAuthURLWithScope(ctx context.Context, scope string, proxyID *string) (*GenerateAuthURLResult, error) {
