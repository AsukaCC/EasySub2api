...
func (s *OpsService) UpdateRuntimeLogConfig(ctx context.Context, req *OpsRuntimeLogConfig, operatorID string) (*OpsRuntimeLogConfig, error) {
	if s == nil || s.settingRepo == nil {
...
func (s *OpsService) ResetRuntimeLogConfig(ctx context.Context, operatorID string) (*OpsRuntimeLogConfig, error) {
	if s == nil || s.settingRepo == nil {
		return nil, errors.New("setting repository not initialized")
	}
	if ctx == nil {
...
func (s *OpsService) auditRuntimeLogConfigChange(operatorID string, oldCfg *OpsRuntimeLogConfig, newCfg *OpsRuntimeLogConfig, action string) {
...
func (s *OpsService) auditRuntimeLogConfigFailure(operatorID string, oldCfg *OpsRuntimeLogConfig, newCfg *OpsRuntimeLogConfig, reason string) {
	oldRaw, _ := json.Marshal(oldCfg)
	newRaw, _ := json.Marshal(newCfg)
	logger.With(
		zap.String("component", "audit.log_config_change"),
