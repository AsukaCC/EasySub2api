...
func appendRawJSON(existing json.RawMessage, fragment string) json.RawMessage {
	// Anthropic starts tool_use with input: {}, then sends the real value in
	// input_json_delta fragments. The empty object is a placeholder, not a JSON
	// prefix; retaining it would produce invalid "{}{...}" arguments.
