...
type PromoCodeRepository interface {
	...
	GetUsageByPromoCodeAndUser(ctx context.Context, promoCodeID, userID string) (*PromoCodeUsage, error)
	ListUsagesByPromoCode(ctx context.Context, promoCodeID string, params pagination.PaginationParams) ([]PromoCodeUsage, *pagination.PaginationResult, error)
