...
type OpsRepository interface {
	InsertErrorLog(ctx context.Context, input *OpsInsertErrorLogInput) (string, error)
	BatchInsertErrorLogs(ctx context.Context, inputs []*OpsInsertErrorLogInput) (int64, error)
	ListErrorLogs(ctx context.Context, filter *OpsErrorLogFilter) (*OpsErrorLogList, error)
	GetErrorLogByID(ctx context.Context, id string) (*OpsErrorLogDetail, error)
	...
	UpdateErrorResolution(ctx context.Context, errorID string, resolved bool, resolvedByUserID *string, resolvedAt *time.Time) error
	...
	GetAlertEventByID(ctx context.Context, eventID string) (*OpsAlertEvent, error)
	GetActiveAlertEvent(ctx context.Context, ruleID string) (*OpsAlertEvent, error)
	GetLatestAlertEvent(ctx context.Context, ruleID string) (*OpsAlertEvent, error)
	CreateAlertEvent(ctx context.Context, event *OpsAlertEvent) (*OpsAlertEvent, error)
	UpdateAlertEventStatus(ctx context.Context, eventID string, status string, resolvedAt *time.Time) error
	UpdateAlertEventEmailSent(ctx context.Context, eventID string, emailSent bool) error

	// Alert silences
	CreateAlertSilence(ctx context.Context, input *OpsAlertSilence) (*OpsAlertSilence, error)
	IsAlertSilenced(ctx context.Context, ruleID string, platform string, groupID *string, region *string, now time.Time) (bool, error)
