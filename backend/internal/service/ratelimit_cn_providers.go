...
// Kimi reports its per-account concurrency limit as a 403 rather than a 429.
// Treat this exact response as a recoverable cooldown so it can fail over
// without incrementing the account's permanent 403 counter.
