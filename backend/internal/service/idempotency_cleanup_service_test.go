...
func (r *idempotencyCleanupRepoStub) TryReclaim(context.Context, string, string, time.Time, time.Time, time.Time) (bool, error) {
	return false, nil
}
func (r *idempotencyCleanupRepoStub) ExtendProcessingLock(context.Context, string, string, time.Time, time.Time) (bool, error) {
	return false, nil
}
func (r *idempotencyCleanupRepoStub) MarkSucceeded(context.Context, string, int, string, time.Time) error {
	return nil
}
func (r *idempotencyCleanupRepoStub) MarkFailedRetryable(context.Context, string, string, time.Time, time.Time) error {
	return nil
}
