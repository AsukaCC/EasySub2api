...
func (s *AntiDegradeService) Preview(ctx context.Context, id string) (AntiDegradePreview, error) {
	return s.PreviewMode(ctx, id, DefaultAntiDegradeMode)
}

func (s *AntiDegradeService) PreviewMode(ctx context.Context, id string, mode AntiDegradeMode) (AntiDegradePreview, error) {
	...
	preview.Runtime = ResolveProtectionRuntime(account, s.cfg)
	return preview, nil
}

// Apply handler 适配：应用一键防降智。
func (s *AntiDegradeService) Apply(ctx context.Context, id string) (*Account, error) {
	return s.ApplyAntiDegradeMode(ctx, id, DefaultAntiDegradeMode)
}

// Revert handler 适配：一键还原。
func (s *AntiDegradeService) Revert(ctx context.Context, id string) (*Account, error) {
	return s.RevertAntiDegrade(ctx, id)
}

// ApplyAntiDegrade 应用一键防降智并快照旧值。
func (s *AntiDegradeService) ApplyAntiDegrade(ctx context.Context, id string) (*Account, error) {
	return s.ApplyAntiDegradeMode(ctx, id, DefaultAntiDegradeMode)
}

// ApplyAntiDegradeMode 应用指定方案并快照旧值。
func (s *AntiDegradeService) ApplyAntiDegradeMode(ctx context.Context, id string, mode AntiDegradeMode) (*Account, error) {
...
func (s *AntiDegradeService) RevertAntiDegrade(ctx context.Context, id string) (*Account, error) {
	return s.transition(ctx, id, func(planner *AntiDegradeService) error {
