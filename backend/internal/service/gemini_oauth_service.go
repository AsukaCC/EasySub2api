...
func (s *GeminiOAuthService) GenerateAuthURL(ctx context.Context, proxyID *string, redirectURI, projectID, oauthType, tierID string) (*GeminiAuthURLResult, error) {
...
func (s *GeminiOAuthService) ExchangeCode(ctx context.Context, input *GeminiExchangeCodeInput) (*GeminiTokenInfo, error) {
	...
	logger.LegacyPrintf("service.gemini_oauth", "[GeminiOAuth] ProxyURL: %s", proxyurl.Redact(proxyURL))
