...
type ErrorPassthroughRepository interface {
	...
	// GetByID 根据 ID 获取规则
	GetByID(ctx context.Context, id string) (*model.ErrorPassthroughRule, error)
	// Create 创建规则
...
// GetByID 根据 ID 获取规则
func (s *ErrorPassthroughService) GetByID(ctx context.Context, id string) (*model.ErrorPassthroughRule, error) {
...
// Delete 删除规则
func (s *ErrorPassthroughService) Delete(ctx context.Context, id string) error {
