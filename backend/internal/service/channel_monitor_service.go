...
type ChannelMonitorRepository interface {
	...
	GetByID(ctx context.Context, id string) (*ChannelMonitor, error)
	...
	MarkChecked(ctx context.Context, id string, checkedAt time.Time) error
	...
	// 历史记录
	ListHistory(ctx context.Context, monitorID string, model string, limit int) ([]*ChannelMonitorHistoryEntry, error)

	// 用户视图聚合
	ListLatestPerModel(ctx context.Context, monitorID string) ([]*ChannelMonitorLatest, error)
	ComputeAvailability(ctx context.Context, monitorID string, windowDays int) ([]*ChannelMonitorAvailability, error)

	// 批量聚合（admin/user list 用，避免 N+1）
	ListLatestForMonitorIDs(ctx context.Context, ids []string) (map[string][]*ChannelMonitorLatest, error)
	ComputeAvailabilityForMonitors(ctx context.Context, ids []string, windowDays int) (map[string][]*ChannelMonitorAvailability, error)
	...
	ListRecentHistoryForMonitors(ctx context.Context, ids []string, primaryModels map[string]string, perMonitorLimit int) (map[string][]*ChannelMonitorHistoryEntry, error)
...
const ChannelMonitorDuplicateOperationIDMetadataKey = "easysub2api:duplicate_operation_id"
...
func (s *ChannelMonitorService) Get(ctx context.Context, id string) (*ChannelMonitor, error) {
...
func (s *ChannelMonitorService) Create(ctx context.Context, p ChannelMonitorCreateParams) (*ChannelMonitor, error) {
	...
	m := &ChannelMonitor{
		...
		CheckMode:        checkMode,
		AccountID:        cloneStringPointer(p.AccountID),
	}
...
func (s *ChannelMonitorService) Duplicate(
	...
	duplicate := &ChannelMonitor{
		...
		CreatedBy:            createdBy,
		TemplateID:           cloneStringPointer(source.TemplateID),
		...
		AccountID:            cloneStringPointer(source.AccountID),
...
func duplicateChannelMonitorOperationID(sourceID string, actorScope, operationKey string) string {
	...
	payload := "admin.channel_monitors.duplicate\x00" + actorScope + "\x00" + sourceID + "\x00" + operationKey
...
func validateCreateParams(p ChannelMonitorCreateParams) error {
	...
	if usesQuota && (p.AccountID == nil || *p.AccountID == "") {
...
func (s *ChannelMonitorService) validateLinkedAccount(ctx context.Context, provider string, accountID *string) error {
...
func (s *ChannelMonitorService) Update(ctx context.Context, id string, p ChannelMonitorUpdateParams) (*ChannelMonitor, error) {
...
func (s *ChannelMonitorService) Delete(ctx context.Context, id string) error {
...
func (s *ChannelMonitorService) ListHistory(ctx context.Context, id string, model string, limit int) ([]*ChannelMonitorHistoryEntry, error) {
...
func (s *ChannelMonitorService) RunCheck(ctx context.Context, id string) ([]*CheckResult, error) {
