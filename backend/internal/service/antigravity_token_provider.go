...
func (p *AntigravityTokenProvider) shouldAttemptBackfill(accountID string) bool {
...
func (p *AntigravityTokenProvider) markBackfillAttempted(accountID string) {
