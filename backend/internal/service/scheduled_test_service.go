...
func (s *ScheduledTestService) GetPlan(ctx context.Context, id string) (*ScheduledTestPlan, error) {
	return s.planRepo.GetByID(ctx, id)
}

// ListPlansByAccount returns all plans for a given account.
func (s *ScheduledTestService) ListPlansByAccount(ctx context.Context, accountID string) ([]*ScheduledTestPlan, error) {
...
func (s *ScheduledTestService) DeletePlan(ctx context.Context, id string) error {
	return s.planRepo.Delete(ctx, id)
}

// ListResults returns the most recent results for a plan.
func (s *ScheduledTestService) ListResults(ctx context.Context, planID string, limit int) ([]*ScheduledTestResult, error) {
	if limit <= 0 {
		limit = 50
	}
...
func (s *ScheduledTestService) SaveResult(ctx context.Context, planID string, maxResults int, result *ScheduledTestResult) error {
