...
func (s *UsageService) invalidateUsageCaches(ctx context.Context, userID string, balanceUpdated bool) {
...
// GetByID 根据ID获取使用日志
func (s *UsageService) GetByID(ctx context.Context, id string) (*UsageLog, error) {
...
func (s *UsageService) ListByUser(ctx context.Context, userID string, params pagination.PaginationParams) ([]UsageLog, *pagination.PaginationResult, error) {
...
func (s *UsageService) ListByAPIKey(ctx context.Context, apiKeyID string, params pagination.PaginationParams) ([]UsageLog, *pagination.PaginationResult, error) {
...
func (s *UsageService) ListByAccount(ctx context.Context, accountID string, params pagination.PaginationParams) ([]UsageLog, *pagination.PaginationResult, error) {
...
func (s *UsageService) GetStatsByUser(ctx context.Context, userID string, startTime, endTime time.Time) (*UsageStats, error) {
...
func (s *UsageService) GetStatsByAPIKey(ctx context.Context, apiKeyID string, startTime, endTime time.Time) (*UsageStats, error) {
...
func (s *UsageService) GetStatsByAccount(ctx context.Context, accountID string, startTime, endTime time.Time) (*UsageStats, error) {
...
func (s *UsageService) GetDailyStats(ctx context.Context, userID string, days int) ([]map[string]any, error) {
	endTime := time.Now()
...
func (s *UsageService) GetUserDashboardStats(ctx context.Context, userID string) (*usagestats.UserDashboardStats, error) {
...
func (s *UsageService) GetAPIKeyDashboardStats(ctx context.Context, apiKeyID string) (*usagestats.UserDashboardStats, error) {
...
func (s *UsageService) GetUserUsageTrendByUserID(ctx context.Context, userID string, startTime, endTime time.Time, granularity string) ([]usagestats.TrendDataPoint, error) {
...
func (s *UsageService) GetUserModelStats(ctx context.Context, userID string, startTime, endTime time.Time) ([]usagestats.ModelStat, error) {
...
func (s *UsageService) GetModelStatsWithFiltersBySource(ctx context.Context, startTime, endTime time.Time, filters usagestats.UsageLogFilters, modelSource string) ([]usagestats.ModelStat, error) {
	...
	type modelStatsBySourceRepo interface {
		GetModelStatsWithFiltersBySource(ctx context.Context, startTime, endTime time.Time, userID, apiKeyID, accountID, groupID string, requestType *int16, stream *bool, billingType *int8, source string) ([]usagestats.ModelStat, error)
	}
...
func (s *UsageService) GetAPIKeyModelStats(ctx context.Context, apiKeyID string, startTime, endTime time.Time) ([]usagestats.ModelStat, error) {
	stats, err := s.usageRepo.GetModelStatsWithFilters(ctx, startTime, endTime, "", apiKeyID, "", "", nil, nil, nil)
	if err != nil {
...
func (s *UsageService) GetAPIKeyDailyUsage(ctx context.Context, userID, apiKeyID string, startTime, endTime time.Time) ([]usagestats.APIKeyDailyUsagePoint, error) {
	trend, err := s.usageRepo.GetUsageTrendWithFilters(ctx, startTime, endTime, "day", userID, apiKeyID, "", "", "", nil, nil, nil)
	if err != nil {
...
func (s *UsageService) GetBatchAPIKeyUsageStats(ctx context.Context, apiKeyIDs []string, startTime, endTime time.Time) (map[string]*usagestats.BatchAPIKeyUsageStats, error) {
