...
func TestGetModelPricing_OpenAICompactAliasesFallback(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt5.6-sol", inputPrice: 5e-6, outputPrice: 30e-6, cacheRead: 0.5e-6, longContext: 0},
		{model: "openai/gpt5.6-terra", inputPrice: 2e-6, outputPrice: 12e-6, cacheRead: 0.2e-6, longContext: 0},
