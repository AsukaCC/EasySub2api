...
func (s *OpsService) GetAccountAvailabilityStats(ctx context.Context, platformFilter string, groupIDFilter *string) (
	map[string]*PlatformAvailability,
	map[string]*GroupAvailability,
	map[string]*AccountAvailability,
	*time.Time,
	error,
) {
	...
	group := make(map[string]*GroupAvailability)
	account := make(map[string]*AccountAvailability)
...
func (s *OpsService) GetAccountAvailability(ctx context.Context, platformFilter string, groupIDFilter *string) (*OpsAccountAvailability, error) {
	if s == nil {
	...
	if accountStats == nil {
		accountStats = map[string]*AccountAvailability{}
	}
