...
func (s *DashboardService) GetModelStatsWithFilters(ctx context.Context, startTime, endTime time.Time, userID, apiKeyID, accountID, groupID string, requestType *int16, stream *bool, billingType *int8) ([]usagestats.ModelStat, error) {
...
func (s *DashboardService) GetModelStatsWithFiltersBySource(ctx context.Context, startTime, endTime time.Time, userID, apiKeyID, accountID, groupID string, requestType *int16, stream *bool, billingType *int8, modelSource string) ([]usagestats.ModelStat, error) {
...
func (s *DashboardService) GetGroupStatsWithFilters(ctx context.Context, startTime, endTime time.Time, userID, apiKeyID, accountID, groupID string, requestType *int16, stream *bool, billingType *int8) ([]usagestats.GroupStat, error) {
...
func (s *DashboardService) GetBatchUserUsageStats(ctx context.Context, userIDs []string, startTime, endTime time.Time) (map[string]*usagestats.BatchUserUsageStats, error) {
...
func (s *DashboardService) GetBatchAPIKeyUsageStats(ctx context.Context, apiKeyIDs []string, startTime, endTime time.Time) (map[string]*usagestats.BatchAPIKeyUsageStats, error) {
