...
func subCacheKey(userID, groupID string) string {
	return "sub:" + userID + ":" + groupID
}
...
func (s *SubscriptionService) InvalidateSubCache(userID, groupID string) {
	if s.subCacheL1 == nil {
		return
	}
...
func (s *SubscriptionService) InvalidateSubCacheSync(userID, groupID string) {
...
func (s *SubscriptionService) invalidateSubscriptionCaches(userID, groupID string) error {
...
func (s *SubscriptionService) maybeInvalidateAssignmentCaches(userID, groupID string, deferred bool) {
...
func (s *SubscriptionService) BulkAssignSubscription(ctx context.Context, input *BulkAssignSubscriptionInput) (*BulkAssignResult, error) {
	...
	for _, userID := range input.UserIDs {
		...
		if err != nil {
			result.FailedCount++
			result.Errors = append(result.Errors, fmt.Sprintf("user %v: %v", userID, err))
...
func (s *SubscriptionService) RevokeSubscription(ctx context.Context, subscriptionID string) error {
	// 先获取订阅信息用于失效缓存
...
func (s *SubscriptionService) RestoreSubscription(ctx context.Context, subscriptionID string) (*UserSubscription, error) {
...
func (s *SubscriptionService) ExtendSubscription(ctx context.Context, subscriptionID string, days int) (*UserSubscription, error) {
	sub, err := s.userSubRepo.GetByID(ctx, subscriptionID)
	if err != nil {
...
func (s *SubscriptionService) GetActiveSubscription(ctx context.Context, userID, groupID string) (*UserSubscription, error) {
...
func (s *SubscriptionService) ListUserSubscriptions(ctx context.Context, userID string) ([]UserSubscription, error) {
...
func (s *SubscriptionService) ListActiveUserSubscriptions(ctx context.Context, userID string) ([]UserSubscription, error) {
...
func (s *SubscriptionService) ListGroupSubscriptions(ctx context.Context, groupID string, page, pageSize int) ([]UserSubscription, *pagination.PaginationResult, error) {
...
func (s *SubscriptionService) List(ctx context.Context, page, pageSize int, userID, groupID *string, status, platform, sortBy, sortOrder string) ([]UserSubscription, *pagination.PaginationResult, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *SubscriptionService) AdminResetQuota(ctx context.Context, subscriptionID string, resetDaily, resetWeekly, resetMonthly bool) (*UserSubscription, error) {
...
func (s *SubscriptionService) RecordUsage(ctx context.Context, subscriptionID string, costUSD float64) error {
...
func (s *SubscriptionService) GetSubscriptionProgress(ctx context.Context, subscriptionID string) (*SubscriptionProgress, error) {
	sub, err := s.userSubRepo.GetByID(ctx, subscriptionID)
	if err != nil {
		return nil, ErrSubscriptionNotFound
	}
...
func (s *SubscriptionService) calculateProgress(sub *UserSubscription, group *Group) *SubscriptionProgress {
	...
	if group.HasDailyLimit() && sub.DailyWindowStart != nil {
		...
		progress.Daily = &UsageWindowProgress{
			...
			LimitPoints:     limit,
			UsedPoints:      sub.DailyUsageUSD,
			RemainingPoints: limit - sub.DailyUsageUSD,
		...
		if progress.Daily.RemainingUSD < 0 {
			...
			progress.Daily.RemainingPoints = 0
		}
	...
	if group.HasWeeklyLimit() && sub.WeeklyWindowStart != nil {
		...
		progress.Weekly = &UsageWindowProgress{
			...
			LimitPoints:     limit,
			UsedPoints:      sub.WeeklyUsageUSD,
			RemainingPoints: limit - sub.WeeklyUsageUSD,
		...
		if progress.Weekly.RemainingUSD < 0 {
			...
			progress.Weekly.RemainingPoints = 0
		}
	...
	if group.HasMonthlyLimit() && sub.MonthlyWindowStart != nil {
		...
		progress.Monthly = &UsageWindowProgress{
			...
			LimitPoints:     limit,
			UsedPoints:      sub.MonthlyUsageUSD,
			RemainingPoints: limit - sub.MonthlyUsageUSD,
		...
		if progress.Monthly.RemainingUSD < 0 {
			...
			progress.Monthly.RemainingPoints = 0
		}
...
func (s *SubscriptionService) GetUserSubscriptionsWithProgress(ctx context.Context, userID string) ([]SubscriptionProgress, error) {
