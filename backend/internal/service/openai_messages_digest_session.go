...
func openAICompatAnthropicDigestNamespace(account *Account, cAPIKeyID string) string {
	if account == nil || account.ID == "" {
		return ""
	}
	return fmt.Sprintf("%v|%v|", account.ID, cAPIKeyID)
}

func (s *OpenAIGatewayService) findOpenAICompatAnthropicDigestPromptCacheKey(account *Account, cAPIKeyID string, digestChain string) (promptCacheKey string, matchedChain string) {
...
func (s *OpenAIGatewayService) bindOpenAICompatAnthropicDigestPromptCacheKey(account *Account, cAPIKeyID string, digestChain, promptCacheKey, oldDigestChain string) {
