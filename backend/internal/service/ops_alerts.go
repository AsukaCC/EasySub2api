...
func (s *OpsService) DeleteAlertRule(ctx context.Context, id string) error {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) GetAlertEventByID(ctx context.Context, eventID string) (*OpsAlertEvent, error) {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return nil, err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) GetActiveAlertEvent(ctx context.Context, ruleID string) (*OpsAlertEvent, error) {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return nil, err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) IsAlertSilenced(ctx context.Context, ruleID string, platform string, groupID *string, region *string, now time.Time) (bool, error) {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return false, err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) GetLatestAlertEvent(ctx context.Context, ruleID string) (*OpsAlertEvent, error) {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return nil, err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) UpdateAlertEventStatus(ctx context.Context, eventID string, status string, resolvedAt *time.Time) error {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) UpdateAlertEventEmailSent(ctx context.Context, eventID string, emailSent bool) error {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return err
	}
	if s.opsRepo == nil {
