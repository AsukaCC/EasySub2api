...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/AsukaCC/EasySub2api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/AsukaCC/EasySub2api/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 EasySub2api 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the EasySub2api Deployment and Operation Compliance Commitment"
...
func adminComplianceAcknowledgementKey(adminUserID string) string {
	if adminUserID == "" {
		return settingKeyAdminComplianceAcknowledgement
	}
	return settingKeyAdminComplianceAcknowledgement + ":" + adminUserID
}

func (s *SettingService) GetAdminComplianceStatus(ctx context.Context, adminUserID string) (*AdminComplianceStatus, error) {
...
func (s *SettingService) IsAdminComplianceAcknowledged(ctx context.Context, adminUserID string) (bool, error) {
