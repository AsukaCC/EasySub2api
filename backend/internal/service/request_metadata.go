...
type RequestMetadata struct {
	...
	PrefetchedStickyAccountID  *string
	PrefetchedStickyGroupID    *string
...
func WithPrefetchedStickySession(ctx context.Context, accountID, groupID string, bridgeOldKeys bool) context.Context {
	return updateRequestMetadata(ctx, bridgeOldKeys, func(md *RequestMetadata) {
		account := accountID
		group := groupID
...
func PrefetchedStickyAccountIDFromContext(ctx context.Context) (string, bool) {
