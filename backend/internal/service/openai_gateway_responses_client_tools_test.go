...
func TestOpenAIPassthroughAPIKeyRestoresClientToolsNonStreaming(t *testing.T) {
	...
	account := &Account{ID: "account-5659", Platform: PlatformOpenAI, Type: AccountTypeAPIKey, Credentials: map[string]any{"api_key": "test-key"}}
...
func TestOpenAIPassthroughAPIKeyRestoresClientToolsStreaming(t *testing.T) {
	...
	svc := openAIClientToolsTestService(upstream)
	account := &Account{ID: "account-5660", Platform: PlatformOpenAI, Type: AccountTypeAPIKey, Credentials: map[string]any{"api_key": "test-key"}}
