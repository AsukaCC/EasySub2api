...
// isOpenAIGPT6AstraModel reports GPT-6 Astra and its dated/provider-prefixed
// aliases. Unrelated GPT-6 families must remain distinct instead of inheriting
// Astra's reasoning and modality capabilities.
