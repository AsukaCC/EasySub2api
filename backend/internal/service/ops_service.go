...
type OpsService struct {
	...
	getAccountAvailability func(ctx context.Context, platformFilter string, groupIDFilter *string) (*OpsAccountAvailability, error)
...
func (s *OpsService) ListUserErrorRequests(ctx context.Context, userID string, filter *OpsErrorLogFilter) (*UserErrorRequestList, error) {
	if filter == nil {
...
func (s *OpsService) GetErrorLogByID(ctx context.Context, id string) (*OpsErrorLogDetail, error) {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return nil, err
	}
	if s.opsRepo == nil {
...
func (s *OpsService) GetUserErrorRequestDetail(ctx context.Context, userID, id string) (*UserErrorRequestDetail, error) {
	if s.opsRepo == nil {
		return nil, infraerrors.NotFound("OPS_ERROR_NOT_FOUND", "ops error log not found")
	}
	if id == "" {
...
func (s *OpsService) UpdateErrorResolution(ctx context.Context, errorID string, resolved bool, resolvedByUserID *string) error {
	if err := s.RequireMonitoringEnabled(ctx); err != nil {
		return err
	}
	if s.opsRepo == nil {
...
func trimConversationArrays(root map[string]any, maxBytes int) (map[string]any, bool) {
	// Supported request payloads use messages.
