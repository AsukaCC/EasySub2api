...
type LiveConcurrencyCache interface {
	...
	RefreshLiveLease(ctx context.Context, accountID, userID, apiKeyID string, leaseID string) (bool, error)
	ReleaseLiveLease(ctx context.Context, accountID, userID, apiKeyID string, leaseID string) error
}
