...
const (
	...
	AffiliateRebateFreezeHoursDefault     = 168   // 兼容字段固定为 7 天
...
const (
	...
	SettingKeyAffiliateInviterBindingRewardPoints       = "affiliate_inviter_binding_reward_points"
	...
	SettingKeySupportTicketAccountEnabled               = "support_ticket_account_enabled"
	SettingKeySupportTicketRefundEnabled                = "support_ticket_refund_enabled"
	...
	SettingKeyThemeAccent                 = "theme_accent"                  // 站点主题强调色
	...
	SettingKeyAuthSourceDefaultEmailBonusValidityDays    = "auth_source_default_email_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultLinuxDoBonusValidityDays  = "auth_source_default_linuxdo_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultOIDCBonusValidityDays     = "auth_source_default_oidc_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultWeChatBonusValidityDays   = "auth_source_default_wechat_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultGitHubBonusValidityDays   = "auth_source_default_github_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultGoogleBonusValidityDays   = "auth_source_default_google_bonus_validity_days"
	...
	SettingKeyAuthSourceDefaultDingTalkBonusValidityDays = "auth_source_default_dingtalk_bonus_validity_days"
	...
	SettingKeyAvailableChannelsUserVisible = "available_channels_user_visible"
	...
	SettingKeyModelPlazaUserVisible = "model_plaza_user_visible"
	...
	// SettingKeyUsageGuideEnabled controls the authenticated user usage guide.
	...
	// SettingKeyOpenAITTFTMode controls the first_token_ms measurement boundary.
	...
	SettingKeyBalanceLowNotifyThreshold   = "balance_low_notify_threshold"    // 默认阈值（平台积分）
...
// SettingKeyDefaultPlatformQuotas —— 系统全局：每用户 × 平台日/周/月积分上限（JSON）。
// 值为 map[platform]{daily,weekly,monthly}，null/缺省 = 不限制；0 = 禁用；>0 = 积分上限。
