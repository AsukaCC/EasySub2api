...
func addGeminiModerationImage(images *[]string, part gjson.Result) {
	if inlineData := part.Get("inline_data"); inlineData.IsObject() {
		addModerationImageData(images, inlineData.Get("mime_type").String(), inlineData.Get("data").String())
	}
	if inlineData := part.Get("inlineData"); inlineData.IsObject() {
		addModerationImageData(images, inlineData.Get("mimeType").String(), inlineData.Get("data").String())
	}
