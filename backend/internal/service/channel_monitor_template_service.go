...
type ChannelMonitorRequestTemplateRepository interface {
	...
	GetByID(ctx context.Context, id string) (*ChannelMonitorRequestTemplate, error)
	...
	// 返回被覆盖的监控数量。
	ApplyToMonitors(ctx context.Context, id string, monitorIDs []string) (int64, error)
	// CountAssociatedMonitors 统计 template_id = id 的监控数（用于 UI 展示「应用到 N 个配置」）。
	CountAssociatedMonitors(ctx context.Context, id string) (int64, error)
	...
	ListAssociatedMonitors(ctx context.Context, id string) ([]*AssociatedMonitorBrief, error)
}
...
// Get 返回单个模板。
func (s *ChannelMonitorRequestTemplateService) Get(ctx context.Context, id string) (*ChannelMonitorRequestTemplate, error) {
...
func (s *ChannelMonitorRequestTemplateService) Update(ctx context.Context, id string, p ChannelMonitorRequestTemplateUpdateParams) (*ChannelMonitorRequestTemplate, error) {
...
func (s *ChannelMonitorRequestTemplateService) Delete(ctx context.Context, id string) error {
...
// 返回实际被覆盖的监控数。
func (s *ChannelMonitorRequestTemplateService) ApplyToMonitors(ctx context.Context, id string, monitorIDs []string) (int64, error) {
...
func (s *ChannelMonitorRequestTemplateService) CountAssociatedMonitors(ctx context.Context, id string) (int64, error) {
...
func (s *ChannelMonitorRequestTemplateService) ListAssociatedMonitors(ctx context.Context, id string) ([]*AssociatedMonitorBrief, error) {
	if _, err := s.repo.GetByID(ctx, id); err != nil {
		return nil, err
	}
