...
type WeChatPaymentResumeClaims struct {
	...
	PlanID      string `json:"pid,omitempty"`
...
func (lb *visibleMethodLoadBalancer) GetInstanceConfig(ctx context.Context, instanceID string) (map[string]string, error) {
...
func buildPaymentReturnURL(base string, orderID string, outTradeNo string, resumeToken string) (string, error) {
