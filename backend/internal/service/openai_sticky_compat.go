...
func (s *OpenAIGatewayService) getStickySessionAccountID(ctx context.Context, groupID *string, sessionHash string) (string, error) {
	...
	if legacyErr == nil && legacyAccountID != "" {
...
func (s *OpenAIGatewayService) setStickySessionAccountID(ctx context.Context, groupID *string, sessionHash string, accountID string, ttl time.Duration) error {
...
func (s *OpenAIGatewayService) refreshStickySessionTTL(ctx context.Context, groupID *string, sessionHash string, ttl time.Duration) error {
	if s == nil || s.cache == nil {
		return nil
	}
	primaryKey := s.openAISessionCacheKey(sessionHash)
...
func (s *OpenAIGatewayService) deleteStickySessionAccountID(ctx context.Context, groupID *string, sessionHash string) error {
	if s == nil || s.cache == nil {
		return nil
	}
	primaryKey := s.openAISessionCacheKey(sessionHash)
