...
func (s *CNProviderBalanceService) QueryBalance(ctx context.Context, accountID string) (*CNProviderBalanceResult, error) {
...
func (s *CNProviderBalanceService) loadPayGAccount(ctx context.Context, accountID string) (*Account, error) {
