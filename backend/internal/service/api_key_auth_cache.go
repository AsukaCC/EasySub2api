...
type APIKeyAuthGroupSnapshot struct {
	...
	DynamicRateRules                []GroupDynamicRateRule        `json:"dynamic_rate_rules,omitempty"`
	...
	FallbackGroupIDOnInvalidRequest *string                       `json:"fallback_group_id_on_invalid_request,omitempty"`
