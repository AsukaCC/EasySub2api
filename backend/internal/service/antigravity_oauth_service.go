...
func (s *AntigravityOAuthService) GenerateAuthURL(ctx context.Context, proxyID *string) (*AntigravityAuthURLResult, error) {
...
func (s *AntigravityOAuthService) ValidateRefreshToken(ctx context.Context, refreshToken string, proxyID *string) (*AntigravityTokenInfo, error) {
	var proxyURL string
	if proxyID != nil {
		proxy, err := s.proxyRepo.GetByID(ctx, *proxyID)
		if err == nil && proxy != nil {
