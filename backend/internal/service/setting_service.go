...
type WebSearchManagerBuilder func(cfg *WebSearchEmulationConfig, proxyURLs map[string]string)
...
type AuthSourceDefaultSettings struct {
	...
	LinuxDo                      ProviderDefaultGrantSettings // Legacy settings retained for upgrade compatibility.
...
var (
	emailAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultEmailBonusValidityDays,
	...
	linuxDoAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultLinuxDoBonusValidityDays,
	...
	oidcAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultOIDCBonusValidityDays,
	...
	weChatAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultWeChatBonusValidityDays,
	...
	gitHubAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultGitHubBonusValidityDays,
	...
	googleAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultGoogleBonusValidityDays,
	...
	dingTalkAuthSourceDefaultKeys = authSourceDefaultKeySet{
		...
		bonusValidityDays: SettingKeyAuthSourceDefaultDingTalkBonusValidityDays,
