...
func (s *GrokOAuthService) GenerateAuthURL(ctx context.Context, proxyID *string, redirectURI string) (*GrokAuthURLResult, error) {
...
func (s *GrokOAuthService) ValidateRefreshToken(ctx context.Context, refreshToken string, proxyID *string) (*GrokTokenInfo, error) {
	proxyURL, err := s.proxyURL(ctx, proxyID)
	if err != nil {
		return nil, err
	}
...
func (s *GrokOAuthService) ValidateSSOToken(ctx context.Context, ssoToken string, proxyID *string) (*GrokTokenInfo, error) {
...
func (s *GrokOAuthService) ConvertFromSSO(ctx context.Context, ssoToken string, proxyID *string) (*GrokTokenInfo, error) {
...
func (s *GrokOAuthService) AuthorizePassword(ctx context.Context, email, password string, proxyID *string) (*GrokTokenInfo, error) {
...
func (s *GrokOAuthService) proxyURL(ctx context.Context, proxyID *string) (string, error) {
	if proxyID == nil {
		return "", nil
	}
	if s.proxyRepo == nil {
