...
type EmailCache interface {
	...
	IncrNotifyCodeUserRate(ctx context.Context, userID string, window time.Duration) (int64, error)
	GetNotifyCodeUserRate(ctx context.Context, userID string) (int64, error)
}
