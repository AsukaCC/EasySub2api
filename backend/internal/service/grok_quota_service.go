...
func (s *GrokQuotaService) QueryQuota(ctx context.Context, accountID string) (*GrokQuotaProbeResult, error) {
...
func (s *GrokQuotaService) ProbeUsage(ctx context.Context, accountID string) (*GrokQuotaProbeResult, error) {
	return s.runProbeFlight(ctx, "active:"+accountID, func(sharedCtx context.Context) (*GrokQuotaProbeResult, error) {
...
func (s *GrokQuotaService) probeUsage(ctx context.Context, accountID string) (*GrokQuotaProbeResult, error) {
	...
	if resp.StatusCode >= 400 {
		...
		return nil, infraerrors.Newf(
			...
			reason,
			"upstream returned %v for probe model %q",
			resp.StatusCode,
			probeModel,
		)
	}
...
func (s *GrokQuotaService) ProbeBilling(ctx context.Context, accountID string) (*GrokQuotaProbeResult, error) {
	return s.runProbeFlight(ctx, "billing:"+accountID, func(sharedCtx context.Context) (*GrokQuotaProbeResult, error) {
...
func (s *GrokQuotaService) ProbeMediaEligibility(ctx context.Context, accountID string) (bool, string, error) {
...
func (s *GrokQuotaService) fetchBilling(
	...
	for attempt := 0; attempt < grokBillingMaxAttempts; attempt++ {
		...
		if statusCode >= 400 {
			...
			return nil, statusCode, infraerrors.Newf(mapUpstreamStatus(statusCode), "GROK_QUOTA_PROBE_UPSTREAM_ERROR", "billing returned %v: %s", statusCode, bodyText)
		}
...
func (s *GrokQuotaService) ResetQuota(ctx context.Context, accountID string) (*GrokQuotaResetResult, error) {
...
func (s *GrokQuotaService) prepareProbe(ctx context.Context, accountID string) (*Account, string, string, error) {
...
func (s *GrokQuotaService) loadGrokOAuthAccount(ctx context.Context, accountID string) (*Account, error) {
