...
func (a *Account) ProtectionPolicyVersion() int { return mode1Int(mode1Marker(a)["policy_version"]) }
...
func BoundAccountProtectionConcurrency(a *Account) {
	...
	if a.Concurrency <= 0 {
		a.Concurrency = a.Mode1EffectiveConcurrency()
	}
...
func (s *AntiDegradeService) SetProtection(ctx context.Context, id string, enabled, confirmDisable bool) (*Account, error) {
