...
func TestValidatePlanRequired_EmptyGroupID(t *testing.T) {
	err := validatePlanRequired("Pro", "", 9.99, 30, "days", nil)
	require.Error(t, err)
	require.Contains(t, err.Error(), "group")
}

func TestValidatePlanRequired_StringGroupID(t *testing.T) {
	err := validatePlanRequired("Pro", "group-id", 9.99, 30, "days", nil)
	require.NoError(t, err)
}
...
func TestValidatePlanPatch_EmptyGroupID(t *testing.T) {
	err := validatePlanPatch(UpdatePlanRequest{GroupID: ptrStr("")})
	require.Error(t, err)
	require.Contains(t, err.Error(), "group")
}
