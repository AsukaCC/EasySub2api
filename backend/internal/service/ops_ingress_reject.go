...
func (a *OpsIngressRejectAggregator) RecordIngressReject(reason, routeFamily, protocol, clientIP string, userID, apiKeyID string) {
...
func ingressRejectHash(k ingressRejectKey) int {
	...
	for _, value := range []string{k.reason, k.routeFamily, k.protocol, k.clientIP, k.userID, k.apiKeyID} {
...
func (s *OpsService) RecordIngressReject(reason, routeFamily, protocol, clientIP string, userID, apiKeyID string) {
