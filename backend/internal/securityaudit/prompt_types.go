...
const (
	...
	ConfigInvalidationChannel       = "easysub2api:prompt_guard:config:invalidate"
	LegacyConfigInvalidationChannel = "sub2api:prompt_guard:config:invalidate"
	PayloadKeyPrefix                = "easysub2api:prompt_audit:payload:"
	LegacyPayloadKeyPrefix          = "sub2api:prompt_audit:payload:"
