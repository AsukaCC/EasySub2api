...
func (s *PromptService) SaveConfig(ctx context.Context, req UpdateConfigRequest, actorID string) (PublicConfig, error) {
...
func (s *PromptService) GetEvent(ctx context.Context, id string) (*Event, error) {
	return s.repo.GetEvent(ctx, id)
}

func (s *PromptService) DeleteEvent(ctx context.Context, id string) (*DeleteResult, error) {
...
func (s *PromptService) DeleteEventsByIDs(ctx context.Context, ids []string) (*DeleteResult, error) {
...
func (s *PromptService) PreviewDelete(ctx context.Context, filter EventFilter, adminID string) (*DeletePreview, error) {
...
func (s *PromptService) DeleteByFilter(ctx context.Context, request DeleteByFilterRequest, adminID string) (*DeleteResult, error) {
	if !request.Confirm {
...
func (s *PromptService) deletePayloads(ctx context.Context, jobIDs []string) {
