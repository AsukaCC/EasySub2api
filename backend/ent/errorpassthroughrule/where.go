...
func ID(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldEQ(FieldID, id))
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldEQ(FieldID, id))
}

// IDNEQ applies the NEQ predicate on the ID field.
func IDNEQ(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldLTE(FieldID, id))
}

// IDEqualFold applies the EqualFold predicate on the ID field.
func IDEqualFold(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldEqualFold(FieldID, id))
}

// IDContainsFold applies the ContainsFold predicate on the ID field.
func IDContainsFold(id string) predicate.ErrorPassthroughRule {
	return predicate.ErrorPassthroughRule(sql.FieldContainsFold(FieldID, id))
}
