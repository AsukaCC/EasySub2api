...
func (_q *IdentityAdoptionDecisionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *IdentityAdoptionDecisionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *IdentityAdoptionDecisionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *IdentityAdoptionDecisionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *IdentityAdoptionDecisionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *IdentityAdoptionDecisionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *IdentityAdoptionDecisionQuery) loadPendingAuthSession(ctx context.Context, query *PendingAuthSessionQuery, nodes []*IdentityAdoptionDecision, init func(*IdentityAdoptionDecision), assign func(*IdentityAdoptionDecision, *PendingAuthSession)) error {
	...
	nodeids := make(map[string][]*IdentityAdoptionDecision)
	for i := range nodes {
...
func (_q *IdentityAdoptionDecisionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(identityadoptiondecision.Table, identityadoptiondecision.Columns, sqlgraph.NewFieldSpec(identityadoptiondecision.FieldID, field.TypeString))
	_spec.From = _q.sql
