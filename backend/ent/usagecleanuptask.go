...
func (*UsageCleanupTask) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagecleanuptask.FieldID, usagecleanuptask.FieldStatus, usagecleanuptask.FieldCreatedBy, usagecleanuptask.FieldErrorMessage, usagecleanuptask.FieldCanceledBy:
