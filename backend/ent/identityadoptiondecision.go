...
type IdentityAdoptionDecision struct {
	...
	PendingAuthSessionID string `json:"pending_auth_session_id,omitempty"`
...
func (_m *IdentityAdoptionDecision) String() string {
	...
	builder.WriteString(_m.PendingAuthSessionID)
	builder.WriteString(", ")
