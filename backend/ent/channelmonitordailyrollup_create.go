...
func (_c *ChannelMonitorDailyRollupCreate) SetMonitorID(v string) *ChannelMonitorDailyRollupCreate {
...
func (_c *ChannelMonitorDailyRollupCreate) SetID(v string) *ChannelMonitorDailyRollupCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ChannelMonitorDailyRollupCreate) SetNillableID(v *string) *ChannelMonitorDailyRollupCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ChannelMonitorDailyRollupCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := channelmonitordailyrollup.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *ChannelMonitorDailyRollupCreate) sqlSave(ctx context.Context) (*ChannelMonitorDailyRollup, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected ChannelMonitorDailyRollup.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ChannelMonitorDailyRollupCreate) createSpec() (*ChannelMonitorDailyRollup, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(channelmonitordailyrollup.Table, sqlgraph.NewFieldSpec(channelmonitordailyrollup.FieldID, field.TypeString))
	)
	...
	if nodes := _c.mutation.MonitorIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(channelmonitor.FieldID, field.TypeString),
			},
		}
		for _, k := range nodes {
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorDailyRollupUpsert) SetMonitorID(v string) *ChannelMonitorDailyRollupUpsert {
...
//				u.SetIgnore(channelmonitordailyrollup.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *ChannelMonitorDailyRollupUpsertOne) UpdateNewValues() *ChannelMonitorDailyRollupUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(channelmonitordailyrollup.FieldID)
		}
	}))
	return u
}
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorDailyRollupUpsertOne) SetMonitorID(v string) *ChannelMonitorDailyRollupUpsertOne {
...
func (u *ChannelMonitorDailyRollupUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: ChannelMonitorDailyRollupUpsertOne.ID is not supported by MySQL driver. Use ChannelMonitorDailyRollupUpsertOne.Exec instead")
	}
...
func (u *ChannelMonitorDailyRollupUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorDailyRollupUpsertBulk) SetMonitorID(v string) *ChannelMonitorDailyRollupUpsertBulk {
	return u.Update(func(s *ChannelMonitorDailyRollupUpsert) {
		s.SetMonitorID(v)
	})
}
