...
func (_c *UsageCleanupTaskCreate) SetCreatedBy(v string) *UsageCleanupTaskCreate {
...
func (_c *UsageCleanupTaskCreate) SetCanceledBy(v string) *UsageCleanupTaskCreate {
	_c.mutation.SetCanceledBy(v)
	return _c
}

// SetNillableCanceledBy sets the "canceled_by" field if the given value is not nil.
func (_c *UsageCleanupTaskCreate) SetNillableCanceledBy(v *string) *UsageCleanupTaskCreate {
	if v != nil {
		_c.SetCanceledBy(*v)
	}
	return _c
...
func (_c *UsageCleanupTaskCreate) SetID(v string) *UsageCleanupTaskCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *UsageCleanupTaskCreate) SetNillableID(v *string) *UsageCleanupTaskCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *UsageCleanupTaskCreate) sqlSave(ctx context.Context) (*UsageCleanupTask, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected UsageCleanupTask.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *UsageCleanupTaskCreate) createSpec() (*UsageCleanupTask, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(usagecleanuptask.Table, sqlgraph.NewFieldSpec(usagecleanuptask.FieldID, field.TypeString))
	)
	...
	if value, ok := _c.mutation.CreatedBy(); ok {
		_spec.SetField(usagecleanuptask.FieldCreatedBy, field.TypeString, value)
	...
	if value, ok := _c.mutation.CanceledBy(); ok {
		_spec.SetField(usagecleanuptask.FieldCanceledBy, field.TypeString, value)
...
// SetCreatedBy sets the "created_by" field.
func (u *UsageCleanupTaskUpsert) SetCreatedBy(v string) *UsageCleanupTaskUpsert {
...
// SetCanceledBy sets the "canceled_by" field.
func (u *UsageCleanupTaskUpsert) SetCanceledBy(v string) *UsageCleanupTaskUpsert {
...
//				u.SetIgnore(usagecleanuptask.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *UsageCleanupTaskUpsertOne) UpdateNewValues() *UsageCleanupTaskUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(usagecleanuptask.FieldID)
		}
...
// SetCreatedBy sets the "created_by" field.
func (u *UsageCleanupTaskUpsertOne) SetCreatedBy(v string) *UsageCleanupTaskUpsertOne {
	return u.Update(func(s *UsageCleanupTaskUpsert) {
		s.SetCreatedBy(v)
	})
}
...
// SetCanceledBy sets the "canceled_by" field.
func (u *UsageCleanupTaskUpsertOne) SetCanceledBy(v string) *UsageCleanupTaskUpsertOne {
	return u.Update(func(s *UsageCleanupTaskUpsert) {
		s.SetCanceledBy(v)
	})
}
...
func (u *UsageCleanupTaskUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: UsageCleanupTaskUpsertOne.ID is not supported by MySQL driver. Use UsageCleanupTaskUpsertOne.Exec instead")
	}
...
func (u *UsageCleanupTaskUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetCreatedBy sets the "created_by" field.
func (u *UsageCleanupTaskUpsertBulk) SetCreatedBy(v string) *UsageCleanupTaskUpsertBulk {
	return u.Update(func(s *UsageCleanupTaskUpsert) {
		s.SetCreatedBy(v)
	})
}
...
// SetCanceledBy sets the "canceled_by" field.
func (u *UsageCleanupTaskUpsertBulk) SetCanceledBy(v string) *UsageCleanupTaskUpsertBulk {
	return u.Update(func(s *UsageCleanupTaskUpsert) {
		s.SetCanceledBy(v)
	})
}
