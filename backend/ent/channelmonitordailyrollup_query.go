...
func (_q *ChannelMonitorDailyRollupQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorDailyRollupQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorDailyRollupQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorDailyRollupQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorDailyRollupQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ChannelMonitorDailyRollupQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChannelMonitorDailyRollupQuery) loadMonitor(ctx context.Context, query *ChannelMonitorQuery, nodes []*ChannelMonitorDailyRollup, init func(*ChannelMonitorDailyRollup), assign func(*ChannelMonitorDailyRollup, *ChannelMonitor)) error {
	...
	nodeids := make(map[string][]*ChannelMonitorDailyRollup)
	for i := range nodes {
...
func (_q *ChannelMonitorDailyRollupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(channelmonitordailyrollup.Table, channelmonitordailyrollup.Columns, sqlgraph.NewFieldSpec(channelmonitordailyrollup.FieldID, field.TypeString))
	_spec.From = _q.sql
