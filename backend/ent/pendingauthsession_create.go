...
func (_c *PendingAuthSessionCreate) SetTargetUserID(v string) *PendingAuthSessionCreate {
	_c.mutation.SetTargetUserID(v)
	return _c
}

// SetNillableTargetUserID sets the "target_user_id" field if the given value is not nil.
func (_c *PendingAuthSessionCreate) SetNillableTargetUserID(v *string) *PendingAuthSessionCreate {
	if v != nil {
...
func (_c *PendingAuthSessionCreate) SetID(v string) *PendingAuthSessionCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *PendingAuthSessionCreate) SetNillableID(v *string) *PendingAuthSessionCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *PendingAuthSessionCreate) SetAdoptionDecisionID(id string) *PendingAuthSessionCreate {
...
func (_c *PendingAuthSessionCreate) SetNillableAdoptionDecisionID(id *string) *PendingAuthSessionCreate {
	if id != nil {
...
func (_c *PendingAuthSessionCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := pendingauthsession.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *PendingAuthSessionCreate) sqlSave(ctx context.Context) (*PendingAuthSession, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected PendingAuthSession.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *PendingAuthSessionCreate) createSpec() (*PendingAuthSession, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(pendingauthsession.Table, sqlgraph.NewFieldSpec(pendingauthsession.FieldID, field.TypeString))
	)
	...
	if nodes := _c.mutation.AdoptionDecisionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(identityadoptiondecision.FieldID, field.TypeString),
			},
		}
		for _, k := range nodes {
			edge.Target.Nodes = append(edge.Target.Nodes, k)
...
// SetTargetUserID sets the "target_user_id" field.
func (u *PendingAuthSessionUpsert) SetTargetUserID(v string) *PendingAuthSessionUpsert {
...
//				u.SetIgnore(pendingauthsession.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *PendingAuthSessionUpsertOne) UpdateNewValues() *PendingAuthSessionUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(pendingauthsession.FieldID)
		}
...
// SetTargetUserID sets the "target_user_id" field.
func (u *PendingAuthSessionUpsertOne) SetTargetUserID(v string) *PendingAuthSessionUpsertOne {
	return u.Update(func(s *PendingAuthSessionUpsert) {
		s.SetTargetUserID(v)
	})
}
...
func (u *PendingAuthSessionUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: PendingAuthSessionUpsertOne.ID is not supported by MySQL driver. Use PendingAuthSessionUpsertOne.Exec instead")
	}
...
func (u *PendingAuthSessionUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetTargetUserID sets the "target_user_id" field.
func (u *PendingAuthSessionUpsertBulk) SetTargetUserID(v string) *PendingAuthSessionUpsertBulk {
	return u.Update(func(s *PendingAuthSessionUpsert) {
		s.SetTargetUserID(v)
	})
}
