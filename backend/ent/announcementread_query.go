...
func (_q *AnnouncementReadQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AnnouncementReadQuery) FirstIDX(ctx context.Context) string {
...
func (_q *AnnouncementReadQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AnnouncementReadQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *AnnouncementReadQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *AnnouncementReadQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AnnouncementReadQuery) loadAnnouncement(ctx context.Context, query *AnnouncementQuery, nodes []*AnnouncementRead, init func(*AnnouncementRead), assign func(*AnnouncementRead, *Announcement)) error {
	...
	nodeids := make(map[string][]*AnnouncementRead)
	for i := range nodes {
