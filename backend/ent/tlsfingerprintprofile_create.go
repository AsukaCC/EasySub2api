...
func (_c *TLSFingerprintProfileCreate) SetID(v string) *TLSFingerprintProfileCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *TLSFingerprintProfileCreate) SetNillableID(v *string) *TLSFingerprintProfileCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *TLSFingerprintProfileCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := tlsfingerprintprofile.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *TLSFingerprintProfileCreate) sqlSave(ctx context.Context) (*TLSFingerprintProfile, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected TLSFingerprintProfile.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *TLSFingerprintProfileCreate) createSpec() (*TLSFingerprintProfile, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(tlsfingerprintprofile.Table, sqlgraph.NewFieldSpec(tlsfingerprintprofile.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(tlsfingerprintprofile.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *TLSFingerprintProfileUpsertOne) UpdateNewValues() *TLSFingerprintProfileUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(tlsfingerprintprofile.FieldID)
		}
...
func (u *TLSFingerprintProfileUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: TLSFingerprintProfileUpsertOne.ID is not supported by MySQL driver. Use TLSFingerprintProfileUpsertOne.Exec instead")
	}
...
func (u *TLSFingerprintProfileUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
