...
func (_q *UserAttributeDefinitionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserAttributeDefinitionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UserAttributeDefinitionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserAttributeDefinitionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UserAttributeDefinitionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UserAttributeDefinitionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserAttributeDefinitionQuery) loadValues(ctx context.Context, query *UserAttributeValueQuery, nodes []*UserAttributeDefinition, init func(*UserAttributeDefinition), assign func(*UserAttributeDefinition, *UserAttributeValue)) error {
	...
	nodeids := make(map[string]*UserAttributeDefinition)
	for i := range nodes {
...
func (_q *UserAttributeDefinitionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userattributedefinition.Table, userattributedefinition.Columns, sqlgraph.NewFieldSpec(userattributedefinition.FieldID, field.TypeString))
	_spec.From = _q.sql
