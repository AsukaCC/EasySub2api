...
func (*AuthIdentity) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case authidentity.FieldMetadata:
			values[i] = new([]byte)
		case authidentity.FieldID, authidentity.FieldUserID, authidentity.FieldProviderType, authidentity.FieldProviderKey, authidentity.FieldProviderSubject, authidentity.FieldIssuer:
