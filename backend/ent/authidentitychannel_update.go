...
func (_u *AuthIdentityChannelUpdate) SetIdentityID(v string) *AuthIdentityChannelUpdate {
	_u.mutation.SetIdentityID(v)
	return _u
}

// SetNillableIdentityID sets the "identity_id" field if the given value is not nil.
func (_u *AuthIdentityChannelUpdate) SetNillableIdentityID(v *string) *AuthIdentityChannelUpdate {
	if v != nil {
		_u.SetIdentityID(*v)
	}
	return _u
...
func (_u *AuthIdentityChannelUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(authidentitychannel.Table, authidentitychannel.Columns, sqlgraph.NewFieldSpec(authidentitychannel.FieldID, field.TypeString))
...
// SetIdentityID sets the "identity_id" field.
func (_u *AuthIdentityChannelUpdateOne) SetIdentityID(v string) *AuthIdentityChannelUpdateOne {
	_u.mutation.SetIdentityID(v)
	return _u
}

// SetNillableIdentityID sets the "identity_id" field if the given value is not nil.
func (_u *AuthIdentityChannelUpdateOne) SetNillableIdentityID(v *string) *AuthIdentityChannelUpdateOne {
	if v != nil {
		_u.SetIdentityID(*v)
	}
	return _u
