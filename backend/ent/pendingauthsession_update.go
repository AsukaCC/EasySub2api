...
func (_u *PendingAuthSessionUpdate) SetTargetUserID(v string) *PendingAuthSessionUpdate {
	_u.mutation.SetTargetUserID(v)
	return _u
}

// SetNillableTargetUserID sets the "target_user_id" field if the given value is not nil.
func (_u *PendingAuthSessionUpdate) SetNillableTargetUserID(v *string) *PendingAuthSessionUpdate {
	if v != nil {
...
func (_u *PendingAuthSessionUpdate) SetAdoptionDecisionID(id string) *PendingAuthSessionUpdate {
...
func (_u *PendingAuthSessionUpdate) SetNillableAdoptionDecisionID(id *string) *PendingAuthSessionUpdate {
	if id != nil {
...
func (_u *PendingAuthSessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(pendingauthsession.Table, pendingauthsession.Columns, sqlgraph.NewFieldSpec(pendingauthsession.FieldID, field.TypeString))
...
// SetTargetUserID sets the "target_user_id" field.
func (_u *PendingAuthSessionUpdateOne) SetTargetUserID(v string) *PendingAuthSessionUpdateOne {
	_u.mutation.SetTargetUserID(v)
	return _u
}

// SetNillableTargetUserID sets the "target_user_id" field if the given value is not nil.
func (_u *PendingAuthSessionUpdateOne) SetNillableTargetUserID(v *string) *PendingAuthSessionUpdateOne {
	if v != nil {
		_u.SetTargetUserID(*v)
	}
	return _u
...
// SetAdoptionDecisionID sets the "adoption_decision" edge to the IdentityAdoptionDecision entity by ID.
func (_u *PendingAuthSessionUpdateOne) SetAdoptionDecisionID(id string) *PendingAuthSessionUpdateOne {
	_u.mutation.SetAdoptionDecisionID(id)
	return _u
}

// SetNillableAdoptionDecisionID sets the "adoption_decision" edge to the IdentityAdoptionDecision entity by ID if the given value is not nil.
func (_u *PendingAuthSessionUpdateOne) SetNillableAdoptionDecisionID(id *string) *PendingAuthSessionUpdateOne {
	if id != nil {
		_u = _u.SetAdoptionDecisionID(*id)
	}
	return _u
