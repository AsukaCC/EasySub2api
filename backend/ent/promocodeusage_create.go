...
func (_c *PromoCodeUsageCreate) SetUserID(v string) *PromoCodeUsageCreate {
...
func (_c *PromoCodeUsageCreate) SetNillableID(v *string) *PromoCodeUsageCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
// SetPromoCodeID sets the "promo_code_id" field.
func (u *PromoCodeUsageUpsert) SetPromoCodeID(v string) *PromoCodeUsageUpsert {
...
// SetUserID sets the "user_id" field.
func (u *PromoCodeUsageUpsert) SetUserID(v string) *PromoCodeUsageUpsert {
...
//				u.SetIgnore(promocodeusage.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *PromoCodeUsageUpsertOne) UpdateNewValues() *PromoCodeUsageUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(promocodeusage.FieldID)
		}
	}))
	return u
}
...
// SetPromoCodeID sets the "promo_code_id" field.
func (u *PromoCodeUsageUpsertOne) SetPromoCodeID(v string) *PromoCodeUsageUpsertOne {
...
// SetUserID sets the "user_id" field.
func (u *PromoCodeUsageUpsertOne) SetUserID(v string) *PromoCodeUsageUpsertOne {
	return u.Update(func(s *PromoCodeUsageUpsert) {
		s.SetUserID(v)
	})
}
...
func (u *PromoCodeUsageUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: PromoCodeUsageUpsertOne.ID is not supported by MySQL driver. Use PromoCodeUsageUpsertOne.Exec instead")
	}
...
func (u *PromoCodeUsageUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetPromoCodeID sets the "promo_code_id" field.
func (u *PromoCodeUsageUpsertBulk) SetPromoCodeID(v string) *PromoCodeUsageUpsertBulk {
	return u.Update(func(s *PromoCodeUsageUpsert) {
		s.SetPromoCodeID(v)
	})
}
...
// SetUserID sets the "user_id" field.
func (u *PromoCodeUsageUpsertBulk) SetUserID(v string) *PromoCodeUsageUpsertBulk {
	return u.Update(func(s *PromoCodeUsageUpsert) {
		s.SetUserID(v)
	})
}
