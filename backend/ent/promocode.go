...
func (*PromoCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case promocode.FieldBonusValidityDays, promocode.FieldMaxUses, promocode.FieldUsedCount:
			values[i] = new(sql.NullInt64)
		case promocode.FieldID, promocode.FieldCode, promocode.FieldStatus, promocode.FieldNotes:
...
func (_m *PromoCode) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case promocode.FieldBonusValidityDays:
