...
func (_c *ErrorPassthroughRuleCreate) SetID(v string) *ErrorPassthroughRuleCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ErrorPassthroughRuleCreate) SetNillableID(v *string) *ErrorPassthroughRuleCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ErrorPassthroughRuleCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := errorpassthroughrule.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *ErrorPassthroughRuleCreate) sqlSave(ctx context.Context) (*ErrorPassthroughRule, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected ErrorPassthroughRule.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ErrorPassthroughRuleCreate) createSpec() (*ErrorPassthroughRule, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(errorpassthroughrule.Table, sqlgraph.NewFieldSpec(errorpassthroughrule.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(errorpassthroughrule.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *ErrorPassthroughRuleUpsertOne) UpdateNewValues() *ErrorPassthroughRuleUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(errorpassthroughrule.FieldID)
		}
...
func (u *ErrorPassthroughRuleUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: ErrorPassthroughRuleUpsertOne.ID is not supported by MySQL driver. Use ErrorPassthroughRuleUpsertOne.Exec instead")
	}
...
func (u *ErrorPassthroughRuleUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
