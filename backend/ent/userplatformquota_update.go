...
func (_u *UserPlatformQuotaUpdate) SetUserID(v string) *UserPlatformQuotaUpdate {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *UserPlatformQuotaUpdate) SetNillableUserID(v *string) *UserPlatformQuotaUpdate {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
...
func (_u *UserPlatformQuotaUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(userplatformquota.Table, userplatformquota.Columns, sqlgraph.NewFieldSpec(userplatformquota.FieldID, field.TypeString))
...
// SetUserID sets the "user_id" field.
func (_u *UserPlatformQuotaUpdateOne) SetUserID(v string) *UserPlatformQuotaUpdateOne {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *UserPlatformQuotaUpdateOne) SetNillableUserID(v *string) *UserPlatformQuotaUpdateOne {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
