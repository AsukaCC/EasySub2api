...
func (_c *RedeemCodeCreate) SetUsedBy(v string) *RedeemCodeCreate {
	_c.mutation.SetUsedBy(v)
	return _c
}

// SetNillableUsedBy sets the "used_by" field if the given value is not nil.
func (_c *RedeemCodeCreate) SetNillableUsedBy(v *string) *RedeemCodeCreate {
	if v != nil {
		_c.SetUsedBy(*v)
	}
	return _c
...
func (_c *RedeemCodeCreate) SetGroupID(v string) *RedeemCodeCreate {
	_c.mutation.SetGroupID(v)
	return _c
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_c *RedeemCodeCreate) SetNillableGroupID(v *string) *RedeemCodeCreate {
	if v != nil {
		_c.SetGroupID(*v)
	}
	return _c
...
func (_c *RedeemCodeCreate) SetBonusValidityDays(v int) *RedeemCodeCreate {
...
func (_c *RedeemCodeCreate) SetNillableBonusValidityDays(v *int) *RedeemCodeCreate {
	if v != nil {
...
func (_c *RedeemCodeCreate) SetID(v string) *RedeemCodeCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *RedeemCodeCreate) SetNillableID(v *string) *RedeemCodeCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *RedeemCodeCreate) SetUserID(id string) *RedeemCodeCreate {
	_c.mutation.SetUserID(id)
	return _c
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (_c *RedeemCodeCreate) SetNillableUserID(id *string) *RedeemCodeCreate {
	if id != nil {
		_c = _c.SetUserID(*id)
	}
	return _c
...
func (_c *RedeemCodeCreate) defaults() {
	...
	if _, ok := _c.mutation.BonusValidityDays(); !ok {
		v := redeemcode.DefaultBonusValidityDays
		_c.mutation.SetBonusValidityDays(v)
	}
	if _, ok := _c.mutation.ID(); !ok {
		v := redeemcode.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *RedeemCodeCreate) check() error {
	...
	if _, ok := _c.mutation.BonusValidityDays(); !ok {
		return &ValidationError{Name: "bonus_validity_days", err: errors.New(`ent: missing required field "RedeemCode.bonus_validity_days"`)}
	}
	return nil
}
...
func (_c *RedeemCodeCreate) sqlSave(ctx context.Context) (*RedeemCode, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected RedeemCode.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *RedeemCodeCreate) createSpec() (*RedeemCode, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(redeemcode.Table, sqlgraph.NewFieldSpec(redeemcode.FieldID, field.TypeString))
	)
	...
	if value, ok := _c.mutation.BonusValidityDays(); ok {
		_spec.SetField(redeemcode.FieldBonusValidityDays, field.TypeInt, value)
...
// SetUsedBy sets the "used_by" field.
func (u *RedeemCodeUpsert) SetUsedBy(v string) *RedeemCodeUpsert {
...
// SetGroupID sets the "group_id" field.
func (u *RedeemCodeUpsert) SetGroupID(v string) *RedeemCodeUpsert {
...
// SetBonusValidityDays sets the "bonus_validity_days" field.
func (u *RedeemCodeUpsert) SetBonusValidityDays(v int) *RedeemCodeUpsert {
	u.Set(redeemcode.FieldBonusValidityDays, v)
	return u
}

// UpdateBonusValidityDays sets the "bonus_validity_days" field to the value that was provided on create.
func (u *RedeemCodeUpsert) UpdateBonusValidityDays() *RedeemCodeUpsert {
	u.SetExcluded(redeemcode.FieldBonusValidityDays)
	return u
}

// AddBonusValidityDays adds v to the "bonus_validity_days" field.
func (u *RedeemCodeUpsert) AddBonusValidityDays(v int) *RedeemCodeUpsert {
	u.Add(redeemcode.FieldBonusValidityDays, v)
	return u
}
...
//				u.SetIgnore(redeemcode.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *RedeemCodeUpsertOne) UpdateNewValues() *RedeemCodeUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(redeemcode.FieldID)
		}
...
// SetUsedBy sets the "used_by" field.
func (u *RedeemCodeUpsertOne) SetUsedBy(v string) *RedeemCodeUpsertOne {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.SetUsedBy(v)
	})
}
...
// SetGroupID sets the "group_id" field.
func (u *RedeemCodeUpsertOne) SetGroupID(v string) *RedeemCodeUpsertOne {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.SetGroupID(v)
	})
}
...
// SetBonusValidityDays sets the "bonus_validity_days" field.
func (u *RedeemCodeUpsertOne) SetBonusValidityDays(v int) *RedeemCodeUpsertOne {
	return u.Update(func(s *RedeemCodeUpsert) {
...
// AddBonusValidityDays adds v to the "bonus_validity_days" field.
func (u *RedeemCodeUpsertOne) AddBonusValidityDays(v int) *RedeemCodeUpsertOne {
	return u.Update(func(s *RedeemCodeUpsert) {
...
// UpdateBonusValidityDays sets the "bonus_validity_days" field to the value that was provided on create.
func (u *RedeemCodeUpsertOne) UpdateBonusValidityDays() *RedeemCodeUpsertOne {
	return u.Update(func(s *RedeemCodeUpsert) {
...
func (u *RedeemCodeUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: RedeemCodeUpsertOne.ID is not supported by MySQL driver. Use RedeemCodeUpsertOne.Exec instead")
	}
...
func (u *RedeemCodeUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetUsedBy sets the "used_by" field.
func (u *RedeemCodeUpsertBulk) SetUsedBy(v string) *RedeemCodeUpsertBulk {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.SetUsedBy(v)
	})
}
...
// SetGroupID sets the "group_id" field.
func (u *RedeemCodeUpsertBulk) SetGroupID(v string) *RedeemCodeUpsertBulk {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.SetGroupID(v)
	})
}
...
// SetBonusValidityDays sets the "bonus_validity_days" field.
func (u *RedeemCodeUpsertBulk) SetBonusValidityDays(v int) *RedeemCodeUpsertBulk {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.SetBonusValidityDays(v)
	})
}
...
// AddBonusValidityDays adds v to the "bonus_validity_days" field.
func (u *RedeemCodeUpsertBulk) AddBonusValidityDays(v int) *RedeemCodeUpsertBulk {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.AddBonusValidityDays(v)
	})
}
...
// UpdateBonusValidityDays sets the "bonus_validity_days" field to the value that was provided on create.
func (u *RedeemCodeUpsertBulk) UpdateBonusValidityDays() *RedeemCodeUpsertBulk {
	return u.Update(func(s *RedeemCodeUpsert) {
		s.UpdateBonusValidityDays()
	})
}
