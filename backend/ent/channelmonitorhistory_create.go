...
func (_c *ChannelMonitorHistoryCreate) SetMonitorID(v string) *ChannelMonitorHistoryCreate {
...
func (_c *ChannelMonitorHistoryCreate) SetID(v string) *ChannelMonitorHistoryCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ChannelMonitorHistoryCreate) SetNillableID(v *string) *ChannelMonitorHistoryCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ChannelMonitorHistoryCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := channelmonitorhistory.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *ChannelMonitorHistoryCreate) sqlSave(ctx context.Context) (*ChannelMonitorHistory, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected ChannelMonitorHistory.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ChannelMonitorHistoryCreate) createSpec() (*ChannelMonitorHistory, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(channelmonitorhistory.Table, sqlgraph.NewFieldSpec(channelmonitorhistory.FieldID, field.TypeString))
	)
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorHistoryUpsert) SetMonitorID(v string) *ChannelMonitorHistoryUpsert {
...
//				u.SetIgnore(channelmonitorhistory.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *ChannelMonitorHistoryUpsertOne) UpdateNewValues() *ChannelMonitorHistoryUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(channelmonitorhistory.FieldID)
		}
	}))
	return u
}
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorHistoryUpsertOne) SetMonitorID(v string) *ChannelMonitorHistoryUpsertOne {
...
func (u *ChannelMonitorHistoryUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: ChannelMonitorHistoryUpsertOne.ID is not supported by MySQL driver. Use ChannelMonitorHistoryUpsertOne.Exec instead")
	}
...
func (u *ChannelMonitorHistoryUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetMonitorID sets the "monitor_id" field.
func (u *ChannelMonitorHistoryUpsertBulk) SetMonitorID(v string) *ChannelMonitorHistoryUpsertBulk {
	return u.Update(func(s *ChannelMonitorHistoryUpsert) {
		s.SetMonitorID(v)
	})
}
