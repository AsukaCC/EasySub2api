...
func (*UserSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersubscription.FieldID, usersubscription.FieldUserID, usersubscription.FieldGroupID, usersubscription.FieldStatus, usersubscription.FieldAssignedBy, usersubscription.FieldNotes:
