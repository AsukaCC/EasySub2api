...
func (_q *PaymentAuditLogQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PaymentAuditLogQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PaymentAuditLogQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PaymentAuditLogQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PaymentAuditLogQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PaymentAuditLogQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentAuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentauditlog.Table, paymentauditlog.Columns, sqlgraph.NewFieldSpec(paymentauditlog.FieldID, field.TypeString))
	_spec.From = _q.sql
