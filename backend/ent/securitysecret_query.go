...
func (_q *SecuritySecretQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SecuritySecretQuery) FirstIDX(ctx context.Context) string {
...
func (_q *SecuritySecretQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SecuritySecretQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *SecuritySecretQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *SecuritySecretQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SecuritySecretQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(securitysecret.Table, securitysecret.Columns, sqlgraph.NewFieldSpec(securitysecret.FieldID, field.TypeString))
	_spec.From = _q.sql
