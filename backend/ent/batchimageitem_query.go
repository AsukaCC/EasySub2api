...
func (_q *BatchImageItemQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageItemQuery) FirstIDX(ctx context.Context) string {
...
func (_q *BatchImageItemQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageItemQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *BatchImageItemQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *BatchImageItemQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BatchImageItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(batchimageitem.Table, batchimageitem.Columns, sqlgraph.NewFieldSpec(batchimageitem.FieldID, field.TypeString))
	_spec.From = _q.sql
