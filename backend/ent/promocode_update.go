...
func (_u *PromoCodeUpdate) SetBonusValidityDays(v int) *PromoCodeUpdate {
...
func (_u *PromoCodeUpdate) SetNillableBonusValidityDays(v *int) *PromoCodeUpdate {
	if v != nil {
...
func (_u *PromoCodeUpdate) AddBonusValidityDays(v int) *PromoCodeUpdate {
...
func (_u *PromoCodeUpdate) AddUsageRecordIDs(ids ...string) *PromoCodeUpdate {
...
func (_u *PromoCodeUpdate) RemoveUsageRecordIDs(ids ...string) *PromoCodeUpdate {
...
func (_u *PromoCodeUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedBonusValidityDays(); ok {
		_spec.AddField(promocode.FieldBonusValidityDays, field.TypeInt, value)
	}
...
// SetBonusValidityDays sets the "bonus_validity_days" field.
func (_u *PromoCodeUpdateOne) SetBonusValidityDays(v int) *PromoCodeUpdateOne {
	_u.mutation.ResetBonusValidityDays()
	_u.mutation.SetBonusValidityDays(v)
	return _u
}
...
// SetNillableBonusValidityDays sets the "bonus_validity_days" field if the given value is not nil.
func (_u *PromoCodeUpdateOne) SetNillableBonusValidityDays(v *int) *PromoCodeUpdateOne {
	if v != nil {
		_u.SetBonusValidityDays(*v)
	}
	return _u
...
// AddBonusValidityDays adds value to the "bonus_validity_days" field.
func (_u *PromoCodeUpdateOne) AddBonusValidityDays(v int) *PromoCodeUpdateOne {
	_u.mutation.AddBonusValidityDays(v)
	return _u
}
...
// AddUsageRecordIDs adds the "usage_records" edge to the PromoCodeUsage entity by IDs.
func (_u *PromoCodeUpdateOne) AddUsageRecordIDs(ids ...string) *PromoCodeUpdateOne {
	_u.mutation.AddUsageRecordIDs(ids...)
	return _u
}
...
// RemoveUsageRecordIDs removes the "usage_records" edge to PromoCodeUsage entities by IDs.
func (_u *PromoCodeUpdateOne) RemoveUsageRecordIDs(ids ...string) *PromoCodeUpdateOne {
	_u.mutation.RemoveUsageRecordIDs(ids...)
	return _u
}
