...
func (*ErrorPassthroughRule) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case errorpassthroughrule.FieldPriority, errorpassthroughrule.FieldResponseCode:
			values[i] = new(sql.NullInt64)
		case errorpassthroughrule.FieldID, errorpassthroughrule.FieldName, errorpassthroughrule.FieldMatchMode, errorpassthroughrule.FieldCustomMessage, errorpassthroughrule.FieldDescription:
