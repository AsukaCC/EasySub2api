...
func (_q *ProxyQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ProxyQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ProxyQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ProxyQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ProxyQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ProxyQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ProxyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(proxy.Table, proxy.Columns, sqlgraph.NewFieldSpec(proxy.FieldID, field.TypeString))
	_spec.From = _q.sql
