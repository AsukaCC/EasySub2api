...
func (_c *SubscriptionPlanCreate) SetGroupID(v string) *SubscriptionPlanCreate {
...
func (_c *SubscriptionPlanCreate) createSpec() (*SubscriptionPlan, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.GroupID(); ok {
		_spec.SetField(subscriptionplan.FieldGroupID, field.TypeString, value)
		_node.GroupID = value
	}
...
// SetGroupID sets the "group_id" field.
func (u *SubscriptionPlanUpsert) SetGroupID(v string) *SubscriptionPlanUpsert {
...
// SetGroupID sets the "group_id" field.
func (u *SubscriptionPlanUpsertOne) SetGroupID(v string) *SubscriptionPlanUpsertOne {
...
func (u *SubscriptionPlanUpsertOne) ID(ctx context.Context) (id string, err error) {
...
func (u *SubscriptionPlanUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetGroupID sets the "group_id" field.
func (u *SubscriptionPlanUpsertBulk) SetGroupID(v string) *SubscriptionPlanUpsertBulk {
	return u.Update(func(s *SubscriptionPlanUpsert) {
		s.SetGroupID(v)
	})
}
