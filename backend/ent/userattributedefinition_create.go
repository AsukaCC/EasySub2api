...
func (_c *UserAttributeDefinitionCreate) SetID(v string) *UserAttributeDefinitionCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *UserAttributeDefinitionCreate) SetNillableID(v *string) *UserAttributeDefinitionCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *UserAttributeDefinitionCreate) AddValueIDs(ids ...string) *UserAttributeDefinitionCreate {
...
func (_c *UserAttributeDefinitionCreate) sqlSave(ctx context.Context) (*UserAttributeDefinition, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected UserAttributeDefinition.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *UserAttributeDefinitionCreate) createSpec() (*UserAttributeDefinition, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userattributedefinition.Table, sqlgraph.NewFieldSpec(userattributedefinition.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(userattributedefinition.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *UserAttributeDefinitionUpsertOne) UpdateNewValues() *UserAttributeDefinitionUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(userattributedefinition.FieldID)
		}
...
func (u *UserAttributeDefinitionUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: UserAttributeDefinitionUpsertOne.ID is not supported by MySQL driver. Use UserAttributeDefinitionUpsertOne.Exec instead")
	}
...
func (u *UserAttributeDefinitionUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
