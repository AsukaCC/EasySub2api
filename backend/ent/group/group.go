...
const (
	...
	// FieldLevelRateMultipliers holds the string denoting the level_rate_multipliers field in the database.
	FieldLevelRateMultipliers = "level_rate_multipliers"
	// FieldDynamicRateRules holds the string denoting the dynamic_rate_rules field in the database.
	FieldDynamicRateRules = "dynamic_rate_rules"
...
var Columns = []string{
	...
	FieldDescription,
	FieldRateMultiplier,
	FieldLevelRateMultipliers,
	FieldDynamicRateRules,
...
//
//	import _ "github.com/AsukaCC/EasySub2api/ent/runtime"
var (
	Hooks        [1]ent.Hook
	...
	// DefaultLevelRateMultipliers holds the default value on creation for the "level_rate_multipliers" field.
	DefaultLevelRateMultipliers map[string]float64
	// DefaultDynamicRateRules holds the default value on creation for the "dynamic_rate_rules" field.
	DefaultDynamicRateRules []domain.GroupDynamicRateRule
