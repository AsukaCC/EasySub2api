...
func (_q *UsageCleanupTaskQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UsageCleanupTaskQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UsageCleanupTaskQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UsageCleanupTaskQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UsageCleanupTaskQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UsageCleanupTaskQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UsageCleanupTaskQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usagecleanuptask.Table, usagecleanuptask.Columns, sqlgraph.NewFieldSpec(usagecleanuptask.FieldID, field.TypeString))
	_spec.From = _q.sql
