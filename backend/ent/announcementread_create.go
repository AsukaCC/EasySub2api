...
func (_c *AnnouncementReadCreate) SetAnnouncementID(v string) *AnnouncementReadCreate {
	_c.mutation.SetAnnouncementID(v)
	return _c
}

// SetUserID sets the "user_id" field.
func (_c *AnnouncementReadCreate) SetUserID(v string) *AnnouncementReadCreate {
...
func (_c *AnnouncementReadCreate) SetID(v string) *AnnouncementReadCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *AnnouncementReadCreate) SetNillableID(v *string) *AnnouncementReadCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
// SetAnnouncementID sets the "announcement_id" field.
func (u *AnnouncementReadUpsert) SetAnnouncementID(v string) *AnnouncementReadUpsert {
...
// SetUserID sets the "user_id" field.
func (u *AnnouncementReadUpsert) SetUserID(v string) *AnnouncementReadUpsert {
...
//				u.SetIgnore(announcementread.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *AnnouncementReadUpsertOne) UpdateNewValues() *AnnouncementReadUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(announcementread.FieldID)
		}
...
// SetAnnouncementID sets the "announcement_id" field.
func (u *AnnouncementReadUpsertOne) SetAnnouncementID(v string) *AnnouncementReadUpsertOne {
...
// SetUserID sets the "user_id" field.
func (u *AnnouncementReadUpsertOne) SetUserID(v string) *AnnouncementReadUpsertOne {
	return u.Update(func(s *AnnouncementReadUpsert) {
		s.SetUserID(v)
	})
}
...
func (u *AnnouncementReadUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: AnnouncementReadUpsertOne.ID is not supported by MySQL driver. Use AnnouncementReadUpsertOne.Exec instead")
	}
...
func (u *AnnouncementReadUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetAnnouncementID sets the "announcement_id" field.
func (u *AnnouncementReadUpsertBulk) SetAnnouncementID(v string) *AnnouncementReadUpsertBulk {
	return u.Update(func(s *AnnouncementReadUpsert) {
		s.SetAnnouncementID(v)
	})
}
...
// SetUserID sets the "user_id" field.
func (u *AnnouncementReadUpsertBulk) SetUserID(v string) *AnnouncementReadUpsertBulk {
	return u.Update(func(s *AnnouncementReadUpsert) {
		s.SetUserID(v)
	})
}
