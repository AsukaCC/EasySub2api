...
func (_q *UserPlatformQuotaQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserPlatformQuotaQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UserPlatformQuotaQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserPlatformQuotaQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UserPlatformQuotaQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UserPlatformQuotaQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserPlatformQuotaQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserPlatformQuota, init func(*UserPlatformQuota), assign func(*UserPlatformQuota, *User)) error {
	...
	nodeids := make(map[string][]*UserPlatformQuota)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserPlatformQuotaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userplatformquota.Table, userplatformquota.Columns, sqlgraph.NewFieldSpec(userplatformquota.FieldID, field.TypeString))
	_spec.From = _q.sql
