...
func (_q *ChannelMonitorRequestTemplateQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorRequestTemplateQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorRequestTemplateQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorRequestTemplateQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorRequestTemplateQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ChannelMonitorRequestTemplateQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChannelMonitorRequestTemplateQuery) loadMonitors(ctx context.Context, query *ChannelMonitorQuery, nodes []*ChannelMonitorRequestTemplate, init func(*ChannelMonitorRequestTemplate), assign func(*ChannelMonitorRequestTemplate, *ChannelMonitor)) error {
	...
	nodeids := make(map[string]*ChannelMonitorRequestTemplate)
	for i := range nodes {
...
func (_q *ChannelMonitorRequestTemplateQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(channelmonitorrequesttemplate.Table, channelmonitorrequesttemplate.Columns, sqlgraph.NewFieldSpec(channelmonitorrequesttemplate.FieldID, field.TypeString))
	_spec.From = _q.sql
