...
func (_c *APIKeyCreate) AddUsageLogIDs(ids ...string) *APIKeyCreate {
...
// SetGroupID sets the "group_id" field.
func (u *APIKeyUpsert) SetGroupID(v string) *APIKeyUpsert {
...
// SetGroupID sets the "group_id" field.
func (u *APIKeyUpsertOne) SetGroupID(v string) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetGroupID(v)
	})
}
...
// SetGroupID sets the "group_id" field.
func (u *APIKeyUpsertBulk) SetGroupID(v string) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetGroupID(v)
	})
}
