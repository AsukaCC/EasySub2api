...
func (_q *AuthIdentityQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AuthIdentityQuery) FirstIDX(ctx context.Context) string {
...
func (_q *AuthIdentityQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AuthIdentityQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *AuthIdentityQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *AuthIdentityQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AuthIdentityQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*AuthIdentity, init func(*AuthIdentity), assign func(*AuthIdentity, *User)) error {
	...
	nodeids := make(map[string][]*AuthIdentity)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *AuthIdentityQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authidentity.Table, authidentity.Columns, sqlgraph.NewFieldSpec(authidentity.FieldID, field.TypeString))
	_spec.From = _q.sql
