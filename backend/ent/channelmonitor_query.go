...
func (_q *ChannelMonitorQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ChannelMonitorQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChannelMonitorQuery) loadHistory(ctx context.Context, query *ChannelMonitorHistoryQuery, nodes []*ChannelMonitor, init func(*ChannelMonitor), assign func(*ChannelMonitor, *ChannelMonitorHistory)) error {
	...
	nodeids := make(map[string]*ChannelMonitor)
	for i := range nodes {
...
func (_q *ChannelMonitorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(channelmonitor.Table, channelmonitor.Columns, sqlgraph.NewFieldSpec(channelmonitor.FieldID, field.TypeString))
	_spec.From = _q.sql
