...
func (*ChannelMonitor) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitor.FieldIntervalSeconds, channelmonitor.FieldJitterSeconds:
			values[i] = new(sql.NullInt64)
		case channelmonitor.FieldID, channelmonitor.FieldName, channelmonitor.FieldProvider, channelmonitor.FieldCheckMode, channelmonitor.FieldAccountID, channelmonitor.FieldAPIMode, channelmonitor.FieldEndpoint, channelmonitor.FieldAPIKeyEncrypted, channelmonitor.FieldPrimaryModel, channelmonitor.FieldGroupName, channelmonitor.FieldCreatedBy, channelmonitor.FieldTemplateID, channelmonitor.FieldBodyOverrideMode:
