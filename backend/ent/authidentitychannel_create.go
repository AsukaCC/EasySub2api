...
func (_c *AuthIdentityChannelCreate) SetIdentityID(v string) *AuthIdentityChannelCreate {
...
func (_c *AuthIdentityChannelCreate) SetID(v string) *AuthIdentityChannelCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *AuthIdentityChannelCreate) SetNillableID(v *string) *AuthIdentityChannelCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *AuthIdentityChannelCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := authidentitychannel.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *AuthIdentityChannelCreate) sqlSave(ctx context.Context) (*AuthIdentityChannel, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected AuthIdentityChannel.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *AuthIdentityChannelCreate) createSpec() (*AuthIdentityChannel, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(authidentitychannel.Table, sqlgraph.NewFieldSpec(authidentitychannel.FieldID, field.TypeString))
	)
...
// SetIdentityID sets the "identity_id" field.
func (u *AuthIdentityChannelUpsert) SetIdentityID(v string) *AuthIdentityChannelUpsert {
...
//				u.SetIgnore(authidentitychannel.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *AuthIdentityChannelUpsertOne) UpdateNewValues() *AuthIdentityChannelUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(authidentitychannel.FieldID)
		}
...
// SetIdentityID sets the "identity_id" field.
func (u *AuthIdentityChannelUpsertOne) SetIdentityID(v string) *AuthIdentityChannelUpsertOne {
	return u.Update(func(s *AuthIdentityChannelUpsert) {
		s.SetIdentityID(v)
	})
}
...
func (u *AuthIdentityChannelUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: AuthIdentityChannelUpsertOne.ID is not supported by MySQL driver. Use AuthIdentityChannelUpsertOne.Exec instead")
	}
...
func (u *AuthIdentityChannelUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetIdentityID sets the "identity_id" field.
func (u *AuthIdentityChannelUpsertBulk) SetIdentityID(v string) *AuthIdentityChannelUpsertBulk {
	return u.Update(func(s *AuthIdentityChannelUpsert) {
		s.SetIdentityID(v)
	})
}
