...
func (*IdempotencyRecord) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case idempotencyrecord.FieldID, idempotencyrecord.FieldScope, idempotencyrecord.FieldIdempotencyKeyHash, idempotencyrecord.FieldRequestFingerprint, idempotencyrecord.FieldStatus, idempotencyrecord.FieldResponseBody, idempotencyrecord.FieldErrorReason:
