...
func (*PaymentProviderInstance) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentproviderinstance.FieldID, paymentproviderinstance.FieldProviderKey, paymentproviderinstance.FieldName, paymentproviderinstance.FieldConfig, paymentproviderinstance.FieldSupportedTypes, paymentproviderinstance.FieldPaymentMode, paymentproviderinstance.FieldLimits:
