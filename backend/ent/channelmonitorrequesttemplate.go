...
func (*ChannelMonitorRequestTemplate) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitorrequesttemplate.FieldExtraHeaders, channelmonitorrequesttemplate.FieldBodyOverride:
			values[i] = new([]byte)
		case channelmonitorrequesttemplate.FieldID, channelmonitorrequesttemplate.FieldName, channelmonitorrequesttemplate.FieldProvider, channelmonitorrequesttemplate.FieldAPIMode, channelmonitorrequesttemplate.FieldDescription, channelmonitorrequesttemplate.FieldBodyOverrideMode:
