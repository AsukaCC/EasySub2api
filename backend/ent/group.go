...
type Group struct {
	...
	// Daily platform point limit; column name is retained for compatibility
	DailyLimitUsd *float64 `json:"daily_limit_usd,omitempty"`
	// Weekly platform point limit; column name is retained for compatibility
	WeeklyLimitUsd *float64 `json:"weekly_limit_usd,omitempty"`
	// Monthly platform point limit; column name is retained for compatibility
	...
	// CC-Switch 导出此 OpenAI/Codex 分组时是否启用 Responses WebSocket
	CcsCodexWsEnabled bool `json:"ccs_codex_ws_enabled,omitempty"`
	// 是否强制此 OpenAI/Composite 分组请求使用 service_tier=priority
	ForceOpenaiFast bool `json:"force_openai_fast,omitempty"`
	// 是否让此 OpenAI/Composite 分组的 Fast 请求按 Standard 价格向用户计费
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldLevelRateMultipliers, group.FieldDynamicRateRules, group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldLongContextPricingEnabled, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldCcsCodexWsEnabled, group.FieldForceOpenaiFast, group.FieldFreeOpenaiFast, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldProfitControlEnabled:
		...
		case group.FieldDefaultValidityDays, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldID, group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldLevelRateMultipliers:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field level_rate_multipliers", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &_m.LevelRateMultipliers); err != nil {
					return fmt.Errorf("unmarshal field level_rate_multipliers: %w", err)
				}
			}
		case group.FieldDynamicRateRules:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field dynamic_rate_rules", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &_m.DynamicRateRules); err != nil {
					return fmt.Errorf("unmarshal field dynamic_rate_rules: %w", err)
				}
			}
		...
		case group.FieldFallbackGroupID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.FallbackGroupID = new(string)
				*_m.FallbackGroupID = value.String
			}
		case group.FieldFallbackGroupIDOnInvalidRequest:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field fallback_group_id_on_invalid_request", values[i])
			} else if value.Valid {
				_m.FallbackGroupIDOnInvalidRequest = new(string)
				*_m.FallbackGroupIDOnInvalidRequest = value.String
			}
		...
		case group.FieldCcsCodexWsEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field ccs_codex_ws_enabled", values[i])
			} else if value.Valid {
				_m.CcsCodexWsEnabled = value.Bool
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("level_rate_multipliers=")
	builder.WriteString(fmt.Sprintf("%v", _m.LevelRateMultipliers))
	builder.WriteString(", ")
	builder.WriteString("dynamic_rate_rules=")
	builder.WriteString(fmt.Sprintf("%v", _m.DynamicRateRules))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("ccs_codex_ws_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.CcsCodexWsEnabled))
	builder.WriteString(", ")
