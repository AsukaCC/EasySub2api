...
func (_q *UserAttributeValueQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserAttributeValueQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UserAttributeValueQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserAttributeValueQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UserAttributeValueQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UserAttributeValueQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserAttributeValueQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserAttributeValue, init func(*UserAttributeValue), assign func(*UserAttributeValue, *User)) error {
	...
	nodeids := make(map[string][]*UserAttributeValue)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserAttributeValueQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userattributevalue.Table, userattributevalue.Columns, sqlgraph.NewFieldSpec(userattributevalue.FieldID, field.TypeString))
	_spec.From = _q.sql
