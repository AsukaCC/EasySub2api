...
func BonusBalance(v float64) predicate.User {
...
func FrozenBonusBalance(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldFrozenBonusBalance, v))
}
...
func BonusBalanceEQ(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldBonusBalance, v))
}

// BonusBalanceNEQ applies the NEQ predicate on the "bonus_balance" field.
func BonusBalanceNEQ(v float64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldBonusBalance, v))
}

// BonusBalanceIn applies the In predicate on the "bonus_balance" field.
func BonusBalanceIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldIn(FieldBonusBalance, vs...))
}

// BonusBalanceNotIn applies the NotIn predicate on the "bonus_balance" field.
func BonusBalanceNotIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldBonusBalance, vs...))
}

// BonusBalanceGT applies the GT predicate on the "bonus_balance" field.
func BonusBalanceGT(v float64) predicate.User {
	return predicate.User(sql.FieldGT(FieldBonusBalance, v))
}

// BonusBalanceGTE applies the GTE predicate on the "bonus_balance" field.
func BonusBalanceGTE(v float64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldBonusBalance, v))
}

// BonusBalanceLT applies the LT predicate on the "bonus_balance" field.
func BonusBalanceLT(v float64) predicate.User {
	return predicate.User(sql.FieldLT(FieldBonusBalance, v))
}

// BonusBalanceLTE applies the LTE predicate on the "bonus_balance" field.
func BonusBalanceLTE(v float64) predicate.User {
...
func FrozenBonusBalanceEQ(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldFrozenBonusBalance, v))
}

// FrozenBonusBalanceNEQ applies the NEQ predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceNEQ(v float64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldFrozenBonusBalance, v))
}

// FrozenBonusBalanceIn applies the In predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldIn(FieldFrozenBonusBalance, vs...))
}

// FrozenBonusBalanceNotIn applies the NotIn predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceNotIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldFrozenBonusBalance, vs...))
}

// FrozenBonusBalanceGT applies the GT predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceGT(v float64) predicate.User {
	return predicate.User(sql.FieldGT(FieldFrozenBonusBalance, v))
}

// FrozenBonusBalanceGTE applies the GTE predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceGTE(v float64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldFrozenBonusBalance, v))
}

// FrozenBonusBalanceLT applies the LT predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceLT(v float64) predicate.User {
	return predicate.User(sql.FieldLT(FieldFrozenBonusBalance, v))
}

// FrozenBonusBalanceLTE applies the LTE predicate on the "frozen_bonus_balance" field.
func FrozenBonusBalanceLTE(v float64) predicate.User {
	return predicate.User(sql.FieldLTE(FieldFrozenBonusBalance, v))
}
