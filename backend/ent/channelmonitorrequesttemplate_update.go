...
func (_u *ChannelMonitorRequestTemplateUpdate) AddMonitorIDs(ids ...string) *ChannelMonitorRequestTemplateUpdate {
...
func (_u *ChannelMonitorRequestTemplateUpdate) RemoveMonitorIDs(ids ...string) *ChannelMonitorRequestTemplateUpdate {
...
func (_u *ChannelMonitorRequestTemplateUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(channelmonitorrequesttemplate.Table, channelmonitorrequesttemplate.Columns, sqlgraph.NewFieldSpec(channelmonitorrequesttemplate.FieldID, field.TypeString))
...
// AddMonitorIDs adds the "monitors" edge to the ChannelMonitor entity by IDs.
func (_u *ChannelMonitorRequestTemplateUpdateOne) AddMonitorIDs(ids ...string) *ChannelMonitorRequestTemplateUpdateOne {
	_u.mutation.AddMonitorIDs(ids...)
	return _u
}
...
// RemoveMonitorIDs removes the "monitors" edge to ChannelMonitor entities by IDs.
func (_u *ChannelMonitorRequestTemplateUpdateOne) RemoveMonitorIDs(ids ...string) *ChannelMonitorRequestTemplateUpdateOne {
	_u.mutation.RemoveMonitorIDs(ids...)
	return _u
}
