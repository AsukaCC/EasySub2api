...
func (_q *RedeemCodeQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RedeemCodeQuery) FirstIDX(ctx context.Context) string {
...
func (_q *RedeemCodeQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RedeemCodeQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *RedeemCodeQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *RedeemCodeQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RedeemCodeQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*RedeemCode, init func(*RedeemCode), assign func(*RedeemCode, *User)) error {
	...
	nodeids := make(map[string][]*RedeemCode)
	for i := range nodes {
...
func (_q *RedeemCodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(redeemcode.Table, redeemcode.Columns, sqlgraph.NewFieldSpec(redeemcode.FieldID, field.TypeString))
	_spec.From = _q.sql
