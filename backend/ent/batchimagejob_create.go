...
func (_c *BatchImageJobCreate) SetUserID(v string) *BatchImageJobCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetAPIKeyID sets the "api_key_id" field.
func (_c *BatchImageJobCreate) SetAPIKeyID(v string) *BatchImageJobCreate {
	_c.mutation.SetAPIKeyID(v)
	return _c
}

// SetNillableAPIKeyID sets the "api_key_id" field if the given value is not nil.
func (_c *BatchImageJobCreate) SetNillableAPIKeyID(v *string) *BatchImageJobCreate {
	if v != nil {
		_c.SetAPIKeyID(*v)
	}
	return _c
...
func (_c *BatchImageJobCreate) SetAccountID(v string) *BatchImageJobCreate {
	_c.mutation.SetAccountID(v)
	return _c
}

// SetNillableAccountID sets the "account_id" field if the given value is not nil.
func (_c *BatchImageJobCreate) SetNillableAccountID(v *string) *BatchImageJobCreate {
	if v != nil {
		_c.SetAccountID(*v)
	}
	return _c
...
func (_c *BatchImageJobCreate) SetID(v string) *BatchImageJobCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *BatchImageJobCreate) SetNillableID(v *string) *BatchImageJobCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *BatchImageJobCreate) sqlSave(ctx context.Context) (*BatchImageJob, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected BatchImageJob.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *BatchImageJobCreate) createSpec() (*BatchImageJob, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(batchimagejob.Table, sqlgraph.NewFieldSpec(batchimagejob.FieldID, field.TypeString))
	)
	...
	if value, ok := _c.mutation.UserID(); ok {
		_spec.SetField(batchimagejob.FieldUserID, field.TypeString, value)
		_node.UserID = value
	}
	if value, ok := _c.mutation.APIKeyID(); ok {
		_spec.SetField(batchimagejob.FieldAPIKeyID, field.TypeString, value)
		_node.APIKeyID = &value
	}
	if value, ok := _c.mutation.AccountID(); ok {
		_spec.SetField(batchimagejob.FieldAccountID, field.TypeString, value)
...
// SetUserID sets the "user_id" field.
func (u *BatchImageJobUpsert) SetUserID(v string) *BatchImageJobUpsert {
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *BatchImageJobUpsert) SetAPIKeyID(v string) *BatchImageJobUpsert {
...
// SetAccountID sets the "account_id" field.
func (u *BatchImageJobUpsert) SetAccountID(v string) *BatchImageJobUpsert {
...
//				u.SetIgnore(batchimagejob.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *BatchImageJobUpsertOne) UpdateNewValues() *BatchImageJobUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(batchimagejob.FieldID)
		}
...
// SetUserID sets the "user_id" field.
func (u *BatchImageJobUpsertOne) SetUserID(v string) *BatchImageJobUpsertOne {
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *BatchImageJobUpsertOne) SetAPIKeyID(v string) *BatchImageJobUpsertOne {
	return u.Update(func(s *BatchImageJobUpsert) {
		s.SetAPIKeyID(v)
	})
}
...
// SetAccountID sets the "account_id" field.
func (u *BatchImageJobUpsertOne) SetAccountID(v string) *BatchImageJobUpsertOne {
	return u.Update(func(s *BatchImageJobUpsert) {
		s.SetAccountID(v)
	})
}
...
func (u *BatchImageJobUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: BatchImageJobUpsertOne.ID is not supported by MySQL driver. Use BatchImageJobUpsertOne.Exec instead")
	}
...
func (u *BatchImageJobUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetUserID sets the "user_id" field.
func (u *BatchImageJobUpsertBulk) SetUserID(v string) *BatchImageJobUpsertBulk {
	return u.Update(func(s *BatchImageJobUpsert) {
		s.SetUserID(v)
	})
}
...
// SetAPIKeyID sets the "api_key_id" field.
func (u *BatchImageJobUpsertBulk) SetAPIKeyID(v string) *BatchImageJobUpsertBulk {
	return u.Update(func(s *BatchImageJobUpsert) {
		s.SetAPIKeyID(v)
	})
}
...
// SetAccountID sets the "account_id" field.
func (u *BatchImageJobUpsertBulk) SetAccountID(v string) *BatchImageJobUpsertBulk {
	return u.Update(func(s *BatchImageJobUpsert) {
		s.SetAccountID(v)
	})
}
