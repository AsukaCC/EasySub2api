...
func (_c *UserPlatformQuotaCreate) SetUserID(v string) *UserPlatformQuotaCreate {
...
func (_c *UserPlatformQuotaCreate) SetID(v string) *UserPlatformQuotaCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *UserPlatformQuotaCreate) SetNillableID(v *string) *UserPlatformQuotaCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *UserPlatformQuotaCreate) sqlSave(ctx context.Context) (*UserPlatformQuota, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected UserPlatformQuota.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *UserPlatformQuotaCreate) createSpec() (*UserPlatformQuota, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userplatformquota.Table, sqlgraph.NewFieldSpec(userplatformquota.FieldID, field.TypeString))
	)
...
// SetUserID sets the "user_id" field.
func (u *UserPlatformQuotaUpsert) SetUserID(v string) *UserPlatformQuotaUpsert {
...
//				u.SetIgnore(userplatformquota.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *UserPlatformQuotaUpsertOne) UpdateNewValues() *UserPlatformQuotaUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(userplatformquota.FieldID)
		}
...
// SetUserID sets the "user_id" field.
func (u *UserPlatformQuotaUpsertOne) SetUserID(v string) *UserPlatformQuotaUpsertOne {
	return u.Update(func(s *UserPlatformQuotaUpsert) {
		s.SetUserID(v)
	})
}
...
func (u *UserPlatformQuotaUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: UserPlatformQuotaUpsertOne.ID is not supported by MySQL driver. Use UserPlatformQuotaUpsertOne.Exec instead")
	}
...
func (u *UserPlatformQuotaUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetUserID sets the "user_id" field.
func (u *UserPlatformQuotaUpsertBulk) SetUserID(v string) *UserPlatformQuotaUpsertBulk {
	return u.Update(func(s *UserPlatformQuotaUpsert) {
		s.SetUserID(v)
	})
}
