...
type APIKey struct {
	...
	// Quota limit in platform points for this API key (0 = unlimited)
	Quota float64 `json:"quota,omitempty"`
	// Used quota amount in platform points
	QuotaUsed float64 `json:"quota_used,omitempty"`
	// Expiration time for this API key (null = never expires)
	ExpiresAt *time.Time `json:"expires_at,omitempty"`
	// Rate limit in platform points per 5 hours (0 = unlimited)
	RateLimit5h float64 `json:"rate_limit_5h,omitempty"`
	// Rate limit in platform points per day (0 = unlimited)
	RateLimit1d float64 `json:"rate_limit_1d,omitempty"`
	// Rate limit in platform points per 7 days (0 = unlimited)
	RateLimit7d float64 `json:"rate_limit_7d,omitempty"`
	// Used platform points for the current 5h window
	Usage5h float64 `json:"usage_5h,omitempty"`
	// Used platform points for the current 1d window
	Usage1d float64 `json:"usage_1d,omitempty"`
	// Used platform points for the current 7d window
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldKey, apikey.FieldName, apikey.FieldGroupID, apikey.FieldStatus:
