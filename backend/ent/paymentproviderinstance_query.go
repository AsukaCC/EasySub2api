...
func (_q *PaymentProviderInstanceQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PaymentProviderInstanceQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PaymentProviderInstanceQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PaymentProviderInstanceQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PaymentProviderInstanceQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PaymentProviderInstanceQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentProviderInstanceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentproviderinstance.Table, paymentproviderinstance.Columns, sqlgraph.NewFieldSpec(paymentproviderinstance.FieldID, field.TypeString))
	_spec.From = _q.sql
