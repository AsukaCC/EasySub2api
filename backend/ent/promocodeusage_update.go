...
func (_u *PromoCodeUsageUpdate) SetUserID(v string) *PromoCodeUsageUpdate {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *PromoCodeUsageUpdate) SetNillableUserID(v *string) *PromoCodeUsageUpdate {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
...
// SetUserID sets the "user_id" field.
func (_u *PromoCodeUsageUpdateOne) SetUserID(v string) *PromoCodeUsageUpdateOne {
	_u.mutation.SetUserID(v)
	return _u
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (_u *PromoCodeUsageUpdateOne) SetNillableUserID(v *string) *PromoCodeUsageUpdateOne {
	if v != nil {
		_u.SetUserID(*v)
	}
	return _u
