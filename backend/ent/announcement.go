...
type Announcement struct {
	...
	// 通知模式: silent(仪表盘), popup(弹窗提醒), banner(顶部滚动)
...
func (*Announcement) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case announcement.FieldTargeting:
			values[i] = new([]byte)
		case announcement.FieldID, announcement.FieldTitle, announcement.FieldContent, announcement.FieldStatus, announcement.FieldNotifyMode, announcement.FieldCreatedBy, announcement.FieldUpdatedBy:
