...
func (_c *BatchImageItemCreate) SetID(v string) *BatchImageItemCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *BatchImageItemCreate) SetNillableID(v *string) *BatchImageItemCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *BatchImageItemCreate) sqlSave(ctx context.Context) (*BatchImageItem, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected BatchImageItem.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *BatchImageItemCreate) createSpec() (*BatchImageItem, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(batchimageitem.Table, sqlgraph.NewFieldSpec(batchimageitem.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(batchimageitem.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *BatchImageItemUpsertOne) UpdateNewValues() *BatchImageItemUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(batchimageitem.FieldID)
		}
...
func (u *BatchImageItemUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: BatchImageItemUpsertOne.ID is not supported by MySQL driver. Use BatchImageItemUpsertOne.Exec instead")
	}
...
func (u *BatchImageItemUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
