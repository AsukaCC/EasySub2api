...
func (_u *UserUpdate) SetBonusBalance(v float64) *UserUpdate {
...
func (_u *UserUpdate) SetNillableBonusBalance(v *float64) *UserUpdate {
	if v != nil {
...
func (_u *UserUpdate) AddBonusBalance(v float64) *UserUpdate {
...
func (_u *UserUpdate) SetFrozenBonusBalance(v float64) *UserUpdate {
	_u.mutation.ResetFrozenBonusBalance()
	_u.mutation.SetFrozenBonusBalance(v)
	return _u
}

// SetNillableFrozenBonusBalance sets the "frozen_bonus_balance" field if the given value is not nil.
func (_u *UserUpdate) SetNillableFrozenBonusBalance(v *float64) *UserUpdate {
	if v != nil {
		_u.SetFrozenBonusBalance(*v)
	}
	return _u
}

// AddFrozenBonusBalance adds value to the "frozen_bonus_balance" field.
func (_u *UserUpdate) AddFrozenBonusBalance(v float64) *UserUpdate {
	_u.mutation.AddFrozenBonusBalance(v)
	return _u
}
...
func (_u *UserUpdate) AddRedeemCodeIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddAssignedSubscriptionIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddAnnouncementReadIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddAllowedGroupIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddUsageLogIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddAttributeValueIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddPromoCodeUsageIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddAuthIdentityIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddPendingAuthSessionIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) AddPlatformQuotaIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveRedeemCodeIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveAssignedSubscriptionIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveAnnouncementReadIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveAllowedGroupIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveUsageLogIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveAttributeValueIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemovePromoCodeUsageIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveAuthIdentityIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemovePendingAuthSessionIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemovePlatformQuotaIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedFrozenBonusBalance(); ok {
		_spec.AddField(user.FieldFrozenBonusBalance, field.TypeFloat64, value)
	}
	...
	if _u.mutation.RedeemCodesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(redeemcode.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.AnnouncementReadsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(announcementread.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.UsageLogsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(usagelog.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.AttributeValuesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(userattributevalue.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.AuthIdentitiesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(authidentity.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.PendingAuthSessionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(pendingauthsession.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if _u.mutation.PlatformQuotasCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(userplatformquota.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// SetBonusBalance sets the "bonus_balance" field.
func (_u *UserUpdateOne) SetBonusBalance(v float64) *UserUpdateOne {
	_u.mutation.ResetBonusBalance()
	_u.mutation.SetBonusBalance(v)
	return _u
}
...
// SetNillableBonusBalance sets the "bonus_balance" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableBonusBalance(v *float64) *UserUpdateOne {
	if v != nil {
		_u.SetBonusBalance(*v)
	}
	return _u
...
// AddBonusBalance adds value to the "bonus_balance" field.
func (_u *UserUpdateOne) AddBonusBalance(v float64) *UserUpdateOne {
	_u.mutation.AddBonusBalance(v)
	return _u
}
...
// SetFrozenBonusBalance sets the "frozen_bonus_balance" field.
func (_u *UserUpdateOne) SetFrozenBonusBalance(v float64) *UserUpdateOne {
	_u.mutation.ResetFrozenBonusBalance()
	_u.mutation.SetFrozenBonusBalance(v)
	return _u
}
...
// SetNillableFrozenBonusBalance sets the "frozen_bonus_balance" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableFrozenBonusBalance(v *float64) *UserUpdateOne {
	if v != nil {
		_u.SetFrozenBonusBalance(*v)
	}
	return _u
...
// AddFrozenBonusBalance adds value to the "frozen_bonus_balance" field.
func (_u *UserUpdateOne) AddFrozenBonusBalance(v float64) *UserUpdateOne {
	_u.mutation.AddFrozenBonusBalance(v)
	return _u
}
...
// AddRedeemCodeIDs adds the "redeem_codes" edge to the RedeemCode entity by IDs.
func (_u *UserUpdateOne) AddRedeemCodeIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddRedeemCodeIDs(ids...)
	return _u
}
...
// AddAssignedSubscriptionIDs adds the "assigned_subscriptions" edge to the UserSubscription entity by IDs.
func (_u *UserUpdateOne) AddAssignedSubscriptionIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddAssignedSubscriptionIDs(ids...)
	return _u
}
...
// AddAnnouncementReadIDs adds the "announcement_reads" edge to the AnnouncementRead entity by IDs.
func (_u *UserUpdateOne) AddAnnouncementReadIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddAnnouncementReadIDs(ids...)
	return _u
}
...
// AddAllowedGroupIDs adds the "allowed_groups" edge to the Group entity by IDs.
func (_u *UserUpdateOne) AddAllowedGroupIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddAllowedGroupIDs(ids...)
	return _u
}
...
// AddUsageLogIDs adds the "usage_logs" edge to the UsageLog entity by IDs.
func (_u *UserUpdateOne) AddUsageLogIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddUsageLogIDs(ids...)
	return _u
}
...
// AddAttributeValueIDs adds the "attribute_values" edge to the UserAttributeValue entity by IDs.
func (_u *UserUpdateOne) AddAttributeValueIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddAttributeValueIDs(ids...)
	return _u
}
...
// AddPromoCodeUsageIDs adds the "promo_code_usages" edge to the PromoCodeUsage entity by IDs.
func (_u *UserUpdateOne) AddPromoCodeUsageIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddPromoCodeUsageIDs(ids...)
	return _u
}
...
// AddAuthIdentityIDs adds the "auth_identities" edge to the AuthIdentity entity by IDs.
func (_u *UserUpdateOne) AddAuthIdentityIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddAuthIdentityIDs(ids...)
	return _u
}
...
// AddPendingAuthSessionIDs adds the "pending_auth_sessions" edge to the PendingAuthSession entity by IDs.
func (_u *UserUpdateOne) AddPendingAuthSessionIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddPendingAuthSessionIDs(ids...)
	return _u
}
...
// AddPlatformQuotaIDs adds the "platform_quotas" edge to the UserPlatformQuota entity by IDs.
func (_u *UserUpdateOne) AddPlatformQuotaIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddPlatformQuotaIDs(ids...)
	return _u
}
...
// RemoveRedeemCodeIDs removes the "redeem_codes" edge to RedeemCode entities by IDs.
func (_u *UserUpdateOne) RemoveRedeemCodeIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveRedeemCodeIDs(ids...)
	return _u
}
...
// RemoveAssignedSubscriptionIDs removes the "assigned_subscriptions" edge to UserSubscription entities by IDs.
func (_u *UserUpdateOne) RemoveAssignedSubscriptionIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveAssignedSubscriptionIDs(ids...)
	return _u
}
...
// RemoveAnnouncementReadIDs removes the "announcement_reads" edge to AnnouncementRead entities by IDs.
func (_u *UserUpdateOne) RemoveAnnouncementReadIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveAnnouncementReadIDs(ids...)
	return _u
}
...
// RemoveAllowedGroupIDs removes the "allowed_groups" edge to Group entities by IDs.
func (_u *UserUpdateOne) RemoveAllowedGroupIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveAllowedGroupIDs(ids...)
	return _u
}
...
// RemoveUsageLogIDs removes the "usage_logs" edge to UsageLog entities by IDs.
func (_u *UserUpdateOne) RemoveUsageLogIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveUsageLogIDs(ids...)
	return _u
}
...
// RemoveAttributeValueIDs removes the "attribute_values" edge to UserAttributeValue entities by IDs.
func (_u *UserUpdateOne) RemoveAttributeValueIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveAttributeValueIDs(ids...)
	return _u
}
...
// RemovePromoCodeUsageIDs removes the "promo_code_usages" edge to PromoCodeUsage entities by IDs.
func (_u *UserUpdateOne) RemovePromoCodeUsageIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemovePromoCodeUsageIDs(ids...)
	return _u
}
...
// RemoveAuthIdentityIDs removes the "auth_identities" edge to AuthIdentity entities by IDs.
func (_u *UserUpdateOne) RemoveAuthIdentityIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveAuthIdentityIDs(ids...)
	return _u
}
...
// RemovePendingAuthSessionIDs removes the "pending_auth_sessions" edge to PendingAuthSession entities by IDs.
func (_u *UserUpdateOne) RemovePendingAuthSessionIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemovePendingAuthSessionIDs(ids...)
	return _u
}
...
// RemovePlatformQuotaIDs removes the "platform_quotas" edge to UserPlatformQuota entities by IDs.
func (_u *UserUpdateOne) RemovePlatformQuotaIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemovePlatformQuotaIDs(ids...)
	return _u
}
