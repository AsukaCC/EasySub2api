...
func (_c *PaymentProviderInstanceCreate) SetID(v string) *PaymentProviderInstanceCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *PaymentProviderInstanceCreate) SetNillableID(v *string) *PaymentProviderInstanceCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *PaymentProviderInstanceCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := paymentproviderinstance.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *PaymentProviderInstanceCreate) sqlSave(ctx context.Context) (*PaymentProviderInstance, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected PaymentProviderInstance.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *PaymentProviderInstanceCreate) createSpec() (*PaymentProviderInstance, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(paymentproviderinstance.Table, sqlgraph.NewFieldSpec(paymentproviderinstance.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(paymentproviderinstance.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *PaymentProviderInstanceUpsertOne) UpdateNewValues() *PaymentProviderInstanceUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(paymentproviderinstance.FieldID)
		}
...
func (u *PaymentProviderInstanceUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: PaymentProviderInstanceUpsertOne.ID is not supported by MySQL driver. Use PaymentProviderInstanceUpsertOne.Exec instead")
	}
...
func (u *PaymentProviderInstanceUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
