...
func (_q *ChannelMonitorHistoryQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorHistoryQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorHistoryQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChannelMonitorHistoryQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ChannelMonitorHistoryQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ChannelMonitorHistoryQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChannelMonitorHistoryQuery) loadMonitor(ctx context.Context, query *ChannelMonitorQuery, nodes []*ChannelMonitorHistory, init func(*ChannelMonitorHistory), assign func(*ChannelMonitorHistory, *ChannelMonitor)) error {
	...
	nodeids := make(map[string][]*ChannelMonitorHistory)
	for i := range nodes {
...
func (_q *ChannelMonitorHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(channelmonitorhistory.Table, channelmonitorhistory.Columns, sqlgraph.NewFieldSpec(channelmonitorhistory.FieldID, field.TypeString))
	_spec.From = _q.sql
