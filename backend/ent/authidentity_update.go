...
func (_u *AuthIdentityUpdate) AddChannelIDs(ids ...string) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) AddAdoptionDecisionIDs(ids ...string) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) RemoveChannelIDs(ids ...string) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) RemoveAdoptionDecisionIDs(ids ...string) *AuthIdentityUpdate {
...
func (_u *AuthIdentityUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ChannelsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(authidentitychannel.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// AddChannelIDs adds the "channels" edge to the AuthIdentityChannel entity by IDs.
func (_u *AuthIdentityUpdateOne) AddChannelIDs(ids ...string) *AuthIdentityUpdateOne {
	_u.mutation.AddChannelIDs(ids...)
	return _u
}
...
// AddAdoptionDecisionIDs adds the "adoption_decisions" edge to the IdentityAdoptionDecision entity by IDs.
func (_u *AuthIdentityUpdateOne) AddAdoptionDecisionIDs(ids ...string) *AuthIdentityUpdateOne {
	_u.mutation.AddAdoptionDecisionIDs(ids...)
	return _u
}
...
// RemoveChannelIDs removes the "channels" edge to AuthIdentityChannel entities by IDs.
func (_u *AuthIdentityUpdateOne) RemoveChannelIDs(ids ...string) *AuthIdentityUpdateOne {
	_u.mutation.RemoveChannelIDs(ids...)
	return _u
}
...
// RemoveAdoptionDecisionIDs removes the "adoption_decisions" edge to IdentityAdoptionDecision entities by IDs.
func (_u *AuthIdentityUpdateOne) RemoveAdoptionDecisionIDs(ids ...string) *AuthIdentityUpdateOne {
	_u.mutation.RemoveAdoptionDecisionIDs(ids...)
	return _u
}
