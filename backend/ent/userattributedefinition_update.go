...
func (_u *UserAttributeDefinitionUpdate) AddValueIDs(ids ...string) *UserAttributeDefinitionUpdate {
...
func (_u *UserAttributeDefinitionUpdate) RemoveValueIDs(ids ...string) *UserAttributeDefinitionUpdate {
...
func (_u *UserAttributeDefinitionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(userattributedefinition.Table, userattributedefinition.Columns, sqlgraph.NewFieldSpec(userattributedefinition.FieldID, field.TypeString))
...
// AddValueIDs adds the "values" edge to the UserAttributeValue entity by IDs.
func (_u *UserAttributeDefinitionUpdateOne) AddValueIDs(ids ...string) *UserAttributeDefinitionUpdateOne {
	_u.mutation.AddValueIDs(ids...)
	return _u
}
...
// RemoveValueIDs removes the "values" edge to UserAttributeValue entities by IDs.
func (_u *UserAttributeDefinitionUpdateOne) RemoveValueIDs(ids ...string) *UserAttributeDefinitionUpdateOne {
	_u.mutation.RemoveValueIDs(ids...)
	return _u
}
