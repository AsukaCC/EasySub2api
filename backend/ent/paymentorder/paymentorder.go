...
const (
	...
	// FieldWalletBonusAmount holds the string denoting the wallet_bonus_amount field in the database.
	FieldWalletBonusAmount = "wallet_bonus_amount"
	// FieldWalletRechargeAmount holds the string denoting the wallet_recharge_amount field in the database.
	FieldWalletRechargeAmount = "wallet_recharge_amount"
	// FieldWalletHoldID holds the string denoting the wallet_hold_id field in the database.
	FieldWalletHoldID = "wallet_hold_id"
	// FieldWalletOnly holds the string denoting the wallet_only field in the database.
	FieldWalletOnly = "wallet_only"
	...
	// FieldCreditedPoints holds the string denoting the credited_points field in the database.
	FieldCreditedPoints = "credited_points"
	// FieldBonusTierSnapshot holds the string denoting the bonus_tier_snapshot field in the database.
	FieldBonusTierSnapshot = "bonus_tier_snapshot"
	...
	// FieldBonusGrantID holds the string denoting the bonus_grant_id field in the database.
	FieldBonusGrantID = "bonus_grant_id"
	...
	// FieldRefundDeadline holds the string denoting the refund_deadline field in the database.
	FieldRefundDeadline = "refund_deadline"
	...
	// FieldRefundedFeeAmount holds the string denoting the refunded_fee_amount field in the database.
	FieldRefundedFeeAmount = "refunded_fee_amount"
	...
	// FieldReversedBasePoints holds the string denoting the reversed_base_points field in the database.
	FieldReversedBasePoints = "reversed_base_points"
	// FieldReversedBonusPoints holds the string denoting the reversed_bonus_points field in the database.
	FieldReversedBonusPoints = "reversed_bonus_points"
	// FieldReversedAffiliatePoints holds the string denoting the reversed_affiliate_points field in the database.
	FieldReversedAffiliatePoints = "reversed_affiliate_points"
...
var Columns = []string{
	...
	FieldFeeRate,
	FieldWalletAmount,
	FieldWalletBonusAmount,
	FieldWalletRechargeAmount,
	FieldWalletHoldID,
	FieldWalletOnly,
	...
	FieldBonusPoints,
	FieldCreditedPoints,
	FieldBonusTierSnapshot,
	FieldBonusExpiresAt,
	FieldBonusGrantID,
	FieldAffiliateRebatePoints,
	FieldRefundDeadline,
	FieldRefundedPrincipalAmount,
	FieldRefundedFeeAmount,
	FieldRefundedGatewayAmount,
	FieldReversedBasePoints,
	FieldReversedBonusPoints,
	FieldReversedAffiliatePoints,
	FieldRechargeCode,
	FieldOutTradeNo,
	FieldPaymentType,
	FieldPaymentTradeNo,
...
var (
	...
	// DefaultWalletAmount holds the default value on creation for the "wallet_amount" field.
	DefaultWalletAmount float64
	// DefaultWalletBonusAmount holds the default value on creation for the "wallet_bonus_amount" field.
	DefaultWalletBonusAmount float64
	// DefaultWalletRechargeAmount holds the default value on creation for the "wallet_recharge_amount" field.
	DefaultWalletRechargeAmount float64
	// DefaultWalletOnly holds the default value on creation for the "wallet_only" field.
	DefaultWalletOnly bool
	...
	// DefaultCreditedPoints holds the default value on creation for the "credited_points" field.
	DefaultCreditedPoints float64
	...
	// DefaultRefundedFeeAmount holds the default value on creation for the "refunded_fee_amount" field.
	DefaultRefundedFeeAmount float64
	...
	// DefaultReversedBasePoints holds the default value on creation for the "reversed_base_points" field.
	DefaultReversedBasePoints float64
	// DefaultReversedBonusPoints holds the default value on creation for the "reversed_bonus_points" field.
	DefaultReversedBonusPoints float64
	// DefaultReversedAffiliatePoints holds the default value on creation for the "reversed_affiliate_points" field.
	DefaultReversedAffiliatePoints float64
...
// ByWalletBonusAmount orders the results by the wallet_bonus_amount field.
func ByWalletBonusAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWalletBonusAmount, opts...).ToFunc()
}

// ByWalletRechargeAmount orders the results by the wallet_recharge_amount field.
func ByWalletRechargeAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWalletRechargeAmount, opts...).ToFunc()
}
...
// ByWalletOnly orders the results by the wallet_only field.
func ByWalletOnly(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWalletOnly, opts...).ToFunc()
}
...
// ByCreditedPoints orders the results by the credited_points field.
func ByCreditedPoints(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCreditedPoints, opts...).ToFunc()
}
...
// ByBonusGrantID orders the results by the bonus_grant_id field.
func ByBonusGrantID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBonusGrantID, opts...).ToFunc()
}
...
// ByRefundDeadline orders the results by the refund_deadline field.
func ByRefundDeadline(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRefundDeadline, opts...).ToFunc()
}
...
// ByRefundedFeeAmount orders the results by the refunded_fee_amount field.
func ByRefundedFeeAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRefundedFeeAmount, opts...).ToFunc()
}
...
// ByReversedBasePoints orders the results by the reversed_base_points field.
func ByReversedBasePoints(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReversedBasePoints, opts...).ToFunc()
}

// ByReversedBonusPoints orders the results by the reversed_bonus_points field.
func ByReversedBonusPoints(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReversedBonusPoints, opts...).ToFunc()
}

// ByReversedAffiliatePoints orders the results by the reversed_affiliate_points field.
func ByReversedAffiliatePoints(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReversedAffiliatePoints, opts...).ToFunc()
}
