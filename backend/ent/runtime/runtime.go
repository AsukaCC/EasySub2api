...
import (
	...
	"github.com/AsukaCC/EasySub2api/ent/batchimageevent"
	"github.com/AsukaCC/EasySub2api/ent/batchimageitem"
	"github.com/AsukaCC/EasySub2api/ent/batchimagejob"
	"github.com/AsukaCC/EasySub2api/ent/channelmonitor"
	"github.com/AsukaCC/EasySub2api/ent/channelmonitordailyrollup"
	...
	"github.com/AsukaCC/EasySub2api/ent/idempotencyrecord"
...
func init() {
	...
	announcementreadDescID := announcementreadMixinFields0[0].Descriptor()
	// announcementread.DefaultID holds the default value on creation for the id field.
	announcementread.DefaultID = announcementreadDescID.Default.(func() string)
	...
	authidentityDescID := authidentityMixinFields0[0].Descriptor()
	...
	// authidentitychannelDescID is the schema descriptor for id field.
	authidentitychannelDescID := authidentitychannelMixinFields0[0].Descriptor()
	// authidentitychannel.DefaultID holds the default value on creation for the id field.
	authidentitychannel.DefaultID = authidentitychannelDescID.Default.(func() string)
	...
	// batchimageeventDescID is the schema descriptor for id field.
	batchimageeventDescID := batchimageeventMixinFields0[0].Descriptor()
	// batchimageevent.DefaultID holds the default value on creation for the id field.
	batchimageevent.DefaultID = batchimageeventDescID.Default.(func() string)
	...
	// batchimageitemDescID is the schema descriptor for id field.
	batchimageitemDescID := batchimageitemMixinFields0[0].Descriptor()
	// batchimageitem.DefaultID holds the default value on creation for the id field.
	batchimageitem.DefaultID = batchimageitemDescID.Default.(func() string)
	...
	// batchimagejobDescID is the schema descriptor for id field.
	batchimagejobDescID := batchimagejobMixinFields0[0].Descriptor()
	// batchimagejob.DefaultID holds the default value on creation for the id field.
	batchimagejob.DefaultID = batchimagejobDescID.Default.(func() string)
	...
	channelmonitorMixinFields1 := channelmonitorMixin[1].Fields()
	_ = channelmonitorMixinFields1
	...
	channelmonitorDescCreatedAt := channelmonitorMixinFields1[0].Descriptor()
	...
	channelmonitorDescUpdatedAt := channelmonitorMixinFields1[1].Descriptor()
	...
	// channelmonitorDescID is the schema descriptor for id field.
	channelmonitorDescID := channelmonitorMixinFields0[0].Descriptor()
	// channelmonitor.DefaultID holds the default value on creation for the id field.
	channelmonitor.DefaultID = channelmonitorDescID.Default.(func() string)
	channelmonitordailyrollupMixin := schema.ChannelMonitorDailyRollup{}.Mixin()
	channelmonitordailyrollupMixinFields0 := channelmonitordailyrollupMixin[0].Fields()
	_ = channelmonitordailyrollupMixinFields0
	...
	// channelmonitordailyrollupDescID is the schema descriptor for id field.
	channelmonitordailyrollupDescID := channelmonitordailyrollupMixinFields0[0].Descriptor()
	// channelmonitordailyrollup.DefaultID holds the default value on creation for the id field.
	channelmonitordailyrollup.DefaultID = channelmonitordailyrollupDescID.Default.(func() string)
	channelmonitorhistoryMixin := schema.ChannelMonitorHistory{}.Mixin()
	channelmonitorhistoryMixinFields0 := channelmonitorhistoryMixin[0].Fields()
	_ = channelmonitorhistoryMixinFields0
	...
	// channelmonitorhistoryDescID is the schema descriptor for id field.
	channelmonitorhistoryDescID := channelmonitorhistoryMixinFields0[0].Descriptor()
	// channelmonitorhistory.DefaultID holds the default value on creation for the id field.
	channelmonitorhistory.DefaultID = channelmonitorhistoryDescID.Default.(func() string)
	...
	channelmonitorrequesttemplateMixinFields1 := channelmonitorrequesttemplateMixin[1].Fields()
	_ = channelmonitorrequesttemplateMixinFields1
	...
	channelmonitorrequesttemplateDescCreatedAt := channelmonitorrequesttemplateMixinFields1[0].Descriptor()
	...
	channelmonitorrequesttemplateDescUpdatedAt := channelmonitorrequesttemplateMixinFields1[1].Descriptor()
	...
	// channelmonitorrequesttemplateDescID is the schema descriptor for id field.
	channelmonitorrequesttemplateDescID := channelmonitorrequesttemplateMixinFields0[0].Descriptor()
	// channelmonitorrequesttemplate.DefaultID holds the default value on creation for the id field.
	channelmonitorrequesttemplate.DefaultID = channelmonitorrequesttemplateDescID.Default.(func() string)
	compositemodelrouteMixin := schema.CompositeModelRoute{}.Mixin()
	compositemodelrouteMixinHooks2 := compositemodelrouteMixin[2].Hooks()
	compositemodelroute.Hooks[0] = compositemodelrouteMixinHooks2[0]
	compositemodelrouteMixinInters2 := compositemodelrouteMixin[2].Interceptors()
	compositemodelroute.Interceptors[0] = compositemodelrouteMixinInters2[0]
	...
	// compositemodelrouteDescID is the schema descriptor for id field.
	compositemodelrouteDescID := compositemodelrouteMixinFields0[0].Descriptor()
	// compositemodelroute.DefaultID holds the default value on creation for the id field.
	compositemodelroute.DefaultID = compositemodelrouteDescID.Default.(func() string)
	errorpassthroughruleMixin := schema.ErrorPassthroughRule{}.Mixin()
	errorpassthroughruleMixinFields0 := errorpassthroughruleMixin[0].Fields()
	_ = errorpassthroughruleMixinFields0
	errorpassthroughruleMixinFields1 := errorpassthroughruleMixin[1].Fields()
	_ = errorpassthroughruleMixinFields1
	...
	errorpassthroughruleDescCreatedAt := errorpassthroughruleMixinFields1[0].Descriptor()
	...
	errorpassthroughruleDescUpdatedAt := errorpassthroughruleMixinFields1[1].Descriptor()
	...
	// errorpassthroughruleDescID is the schema descriptor for id field.
	errorpassthroughruleDescID := errorpassthroughruleMixinFields0[0].Descriptor()
	// errorpassthroughrule.DefaultID holds the default value on creation for the id field.
	errorpassthroughrule.DefaultID = errorpassthroughruleDescID.Default.(func() string)
	...
	// groupDescLevelRateMultipliers is the schema descriptor for level_rate_multipliers field.
	groupDescLevelRateMultipliers := groupFields[3].Descriptor()
	// group.DefaultLevelRateMultipliers holds the default value on creation for the level_rate_multipliers field.
	group.DefaultLevelRateMultipliers = groupDescLevelRateMultipliers.Default.(map[string]float64)
	// groupDescDynamicRateRules is the schema descriptor for dynamic_rate_rules field.
	groupDescDynamicRateRules := groupFields[4].Descriptor()
	// group.DefaultDynamicRateRules holds the default value on creation for the dynamic_rate_rules field.
	group.DefaultDynamicRateRules = groupDescDynamicRateRules.Default.([]domain.GroupDynamicRateRule)
	...
	idempotencyrecordDescID := idempotencyrecordMixinFields0[0].Descriptor()
	...
	// identityadoptiondecisionDescID is the schema descriptor for id field.
	identityadoptiondecisionDescID := identityadoptiondecisionMixinFields0[0].Descriptor()
	// identityadoptiondecision.DefaultID holds the default value on creation for the id field.
	identityadoptiondecision.DefaultID = identityadoptiondecisionDescID.Default.(func() string)
	...
	// paymentauditlogDescID is the schema descriptor for id field.
	paymentauditlogDescID := paymentauditlogMixinFields0[0].Descriptor()
	// paymentauditlog.DefaultID holds the default value on creation for the id field.
	paymentauditlog.DefaultID = paymentauditlogDescID.Default.(func() string)
	...
	// paymentorderDescWalletAmount is the schema descriptor for wallet_amount field.
	paymentorderDescWalletAmount := paymentorderFields[7].Descriptor()
	// paymentorder.DefaultWalletAmount holds the default value on creation for the wallet_amount field.
	paymentorder.DefaultWalletAmount = paymentorderDescWalletAmount.Default.(float64)
	// paymentorderDescWalletBonusAmount is the schema descriptor for wallet_bonus_amount field.
	paymentorderDescWalletBonusAmount := paymentorderFields[8].Descriptor()
	// paymentorder.DefaultWalletBonusAmount holds the default value on creation for the wallet_bonus_amount field.
	paymentorder.DefaultWalletBonusAmount = paymentorderDescWalletBonusAmount.Default.(float64)
	// paymentorderDescWalletRechargeAmount is the schema descriptor for wallet_recharge_amount field.
	paymentorderDescWalletRechargeAmount := paymentorderFields[9].Descriptor()
	// paymentorder.DefaultWalletRechargeAmount holds the default value on creation for the wallet_recharge_amount field.
	paymentorder.DefaultWalletRechargeAmount = paymentorderDescWalletRechargeAmount.Default.(float64)
	// paymentorderDescWalletOnly is the schema descriptor for wallet_only field.
	paymentorderDescWalletOnly := paymentorderFields[11].Descriptor()
	// paymentorder.DefaultWalletOnly holds the default value on creation for the wallet_only field.
	paymentorder.DefaultWalletOnly = paymentorderDescWalletOnly.Default.(bool)
	// paymentorderDescGatewayBaseAmount is the schema descriptor for gateway_base_amount field.
	paymentorderDescGatewayBaseAmount := paymentorderFields[12].Descriptor()
	// paymentorder.DefaultGatewayBaseAmount holds the default value on creation for the gateway_base_amount field.
	paymentorder.DefaultGatewayBaseAmount = paymentorderDescGatewayBaseAmount.Default.(float64)
	// paymentorderDescPrincipalAmount is the schema descriptor for principal_amount field.
	paymentorderDescPrincipalAmount := paymentorderFields[13].Descriptor()
	// paymentorder.DefaultPrincipalAmount holds the default value on creation for the principal_amount field.
	paymentorder.DefaultPrincipalAmount = paymentorderDescPrincipalAmount.Default.(float64)
	// paymentorderDescFeeAmount is the schema descriptor for fee_amount field.
	paymentorderDescFeeAmount := paymentorderFields[14].Descriptor()
	...
	paymentorderDescCurrency := paymentorderFields[15].Descriptor()
	...
	// paymentorderDescBasePoints is the schema descriptor for base_points field.
	paymentorderDescBasePoints := paymentorderFields[16].Descriptor()
	// paymentorder.DefaultBasePoints holds the default value on creation for the base_points field.
	paymentorder.DefaultBasePoints = paymentorderDescBasePoints.Default.(float64)
	// paymentorderDescBonusPoints is the schema descriptor for bonus_points field.
	paymentorderDescBonusPoints := paymentorderFields[17].Descriptor()
	// paymentorder.DefaultBonusPoints holds the default value on creation for the bonus_points field.
	paymentorder.DefaultBonusPoints = paymentorderDescBonusPoints.Default.(float64)
	// paymentorderDescCreditedPoints is the schema descriptor for credited_points field.
	paymentorderDescCreditedPoints := paymentorderFields[18].Descriptor()
	// paymentorder.DefaultCreditedPoints holds the default value on creation for the credited_points field.
	paymentorder.DefaultCreditedPoints = paymentorderDescCreditedPoints.Default.(float64)
	// paymentorderDescAffiliateRebatePoints is the schema descriptor for affiliate_rebate_points field.
	paymentorderDescAffiliateRebatePoints := paymentorderFields[22].Descriptor()
	// paymentorder.DefaultAffiliateRebatePoints holds the default value on creation for the affiliate_rebate_points field.
	paymentorder.DefaultAffiliateRebatePoints = paymentorderDescAffiliateRebatePoints.Default.(float64)
	// paymentorderDescRefundedPrincipalAmount is the schema descriptor for refunded_principal_amount field.
	paymentorderDescRefundedPrincipalAmount := paymentorderFields[24].Descriptor()
	// paymentorder.DefaultRefundedPrincipalAmount holds the default value on creation for the refunded_principal_amount field.
	paymentorder.DefaultRefundedPrincipalAmount = paymentorderDescRefundedPrincipalAmount.Default.(float64)
	// paymentorderDescRefundedFeeAmount is the schema descriptor for refunded_fee_amount field.
	paymentorderDescRefundedFeeAmount := paymentorderFields[25].Descriptor()
	// paymentorder.DefaultRefundedFeeAmount holds the default value on creation for the refunded_fee_amount field.
	paymentorder.DefaultRefundedFeeAmount = paymentorderDescRefundedFeeAmount.Default.(float64)
	// paymentorderDescRefundedGatewayAmount is the schema descriptor for refunded_gateway_amount field.
	paymentorderDescRefundedGatewayAmount := paymentorderFields[26].Descriptor()
	// paymentorder.DefaultRefundedGatewayAmount holds the default value on creation for the refunded_gateway_amount field.
	paymentorder.DefaultRefundedGatewayAmount = paymentorderDescRefundedGatewayAmount.Default.(float64)
	// paymentorderDescReversedBasePoints is the schema descriptor for reversed_base_points field.
	paymentorderDescReversedBasePoints := paymentorderFields[27].Descriptor()
	// paymentorder.DefaultReversedBasePoints holds the default value on creation for the reversed_base_points field.
	paymentorder.DefaultReversedBasePoints = paymentorderDescReversedBasePoints.Default.(float64)
	// paymentorderDescReversedBonusPoints is the schema descriptor for reversed_bonus_points field.
	paymentorderDescReversedBonusPoints := paymentorderFields[28].Descriptor()
	// paymentorder.DefaultReversedBonusPoints holds the default value on creation for the reversed_bonus_points field.
	paymentorder.DefaultReversedBonusPoints = paymentorderDescReversedBonusPoints.Default.(float64)
	// paymentorderDescReversedAffiliatePoints is the schema descriptor for reversed_affiliate_points field.
	paymentorderDescReversedAffiliatePoints := paymentorderFields[29].Descriptor()
	// paymentorder.DefaultReversedAffiliatePoints holds the default value on creation for the reversed_affiliate_points field.
	paymentorder.DefaultReversedAffiliatePoints = paymentorderDescReversedAffiliatePoints.Default.(float64)
	// paymentorderDescRechargeCode is the schema descriptor for recharge_code field.
	paymentorderDescRechargeCode := paymentorderFields[30].Descriptor()
	...
	paymentorderDescOutTradeNo := paymentorderFields[31].Descriptor()
	...
	paymentorderDescPaymentType := paymentorderFields[32].Descriptor()
	...
	paymentorderDescPaymentTradeNo := paymentorderFields[33].Descriptor()
	...
	paymentorderDescOrderType := paymentorderFields[37].Descriptor()
	...
	// paymentproviderinstanceDescID is the schema descriptor for id field.
	paymentproviderinstanceDescID := paymentproviderinstanceMixinFields0[0].Descriptor()
	// paymentproviderinstance.DefaultID holds the default value on creation for the id field.
	paymentproviderinstance.DefaultID = paymentproviderinstanceDescID.Default.(func() string)
	...
	// paymentrefundDescSource is the schema descriptor for source field.
	paymentrefundDescSource := paymentrefundFields[3].Descriptor()
	// paymentrefund.DefaultSource holds the default value on creation for the source field.
	paymentrefund.DefaultSource = paymentrefundDescSource.Default.(string)
	// paymentrefund.SourceValidator is a validator for the "source" field. It is called by the builders before save.
	paymentrefund.SourceValidator = paymentrefundDescSource.Validators[0].(func(string) error)
	// paymentrefundDescStatus is the schema descriptor for status field.
	paymentrefundDescStatus := paymentrefundFields[4].Descriptor()
	...
	// paymentrefundDescIdempotencyKey is the schema descriptor for idempotency_key field.
	paymentrefundDescIdempotencyKey := paymentrefundFields[5].Descriptor()
	// paymentrefund.IdempotencyKeyValidator is a validator for the "idempotency_key" field. It is called by the builders before save.
	paymentrefund.IdempotencyKeyValidator = paymentrefundDescIdempotencyKey.Validators[0].(func(string) error)
	// paymentrefundDescRequestFingerprint is the schema descriptor for request_fingerprint field.
	paymentrefundDescRequestFingerprint := paymentrefundFields[6].Descriptor()
	// paymentrefund.DefaultRequestFingerprint holds the default value on creation for the request_fingerprint field.
	paymentrefund.DefaultRequestFingerprint = paymentrefundDescRequestFingerprint.Default.(string)
	// paymentrefund.RequestFingerprintValidator is a validator for the "request_fingerprint" field. It is called by the builders before save.
	paymentrefund.RequestFingerprintValidator = paymentrefundDescRequestFingerprint.Validators[0].(func(string) error)
	// paymentrefundDescProviderRequestID is the schema descriptor for provider_request_id field.
	paymentrefundDescProviderRequestID := paymentrefundFields[7].Descriptor()
	// paymentrefund.ProviderRequestIDValidator is a validator for the "provider_request_id" field. It is called by the builders before save.
	paymentrefund.ProviderRequestIDValidator = paymentrefundDescProviderRequestID.Validators[0].(func(string) error)
	// paymentrefundDescProviderRefundID is the schema descriptor for provider_refund_id field.
	paymentrefundDescProviderRefundID := paymentrefundFields[8].Descriptor()
	...
	paymentrefundDescCurrency := paymentrefundFields[9].Descriptor()
	...
	// paymentrefundDescRequestedPrincipalAmount is the schema descriptor for requested_principal_amount field.
	paymentrefundDescRequestedPrincipalAmount := paymentrefundFields[10].Descriptor()
	// paymentrefund.DefaultRequestedPrincipalAmount holds the default value on creation for the requested_principal_amount field.
	paymentrefund.DefaultRequestedPrincipalAmount = paymentrefundDescRequestedPrincipalAmount.Default.(float64)
	// paymentrefundDescPrincipalAmount is the schema descriptor for principal_amount field.
	paymentrefundDescPrincipalAmount := paymentrefundFields[11].Descriptor()
	// paymentrefund.DefaultPrincipalAmount holds the default value on creation for the principal_amount field.
	paymentrefund.DefaultPrincipalAmount = paymentrefundDescPrincipalAmount.Default.(float64)
	// paymentrefundDescFeeAmount is the schema descriptor for fee_amount field.
	paymentrefundDescFeeAmount := paymentrefundFields[12].Descriptor()
	// paymentrefund.DefaultFeeAmount holds the default value on creation for the fee_amount field.
	paymentrefund.DefaultFeeAmount = paymentrefundDescFeeAmount.Default.(float64)
	// paymentrefundDescRefundFeeRate is the schema descriptor for refund_fee_rate field.
	paymentrefundDescRefundFeeRate := paymentrefundFields[13].Descriptor()
	// paymentrefund.DefaultRefundFeeRate holds the default value on creation for the refund_fee_rate field.
	paymentrefund.DefaultRefundFeeRate = paymentrefundDescRefundFeeRate.Default.(float64)
	// paymentrefundDescRefundFeeAmount is the schema descriptor for refund_fee_amount field.
	paymentrefundDescRefundFeeAmount := paymentrefundFields[14].Descriptor()
	// paymentrefund.DefaultRefundFeeAmount holds the default value on creation for the refund_fee_amount field.
	paymentrefund.DefaultRefundFeeAmount = paymentrefundDescRefundFeeAmount.Default.(float64)
	// paymentrefundDescGatewayAmount is the schema descriptor for gateway_amount field.
	paymentrefundDescGatewayAmount := paymentrefundFields[15].Descriptor()
	...
	// paymentrefundDescBasePoints is the schema descriptor for base_points field.
	paymentrefundDescBasePoints := paymentrefundFields[16].Descriptor()
	// paymentrefund.DefaultBasePoints holds the default value on creation for the base_points field.
	paymentrefund.DefaultBasePoints = paymentrefundDescBasePoints.Default.(float64)
	// paymentrefundDescBonusPoints is the schema descriptor for bonus_points field.
	paymentrefundDescBonusPoints := paymentrefundFields[17].Descriptor()
	// paymentrefund.DefaultBonusPoints holds the default value on creation for the bonus_points field.
	paymentrefund.DefaultBonusPoints = paymentrefundDescBonusPoints.Default.(float64)
	// paymentrefundDescAffiliateRebatePoints is the schema descriptor for affiliate_rebate_points field.
	paymentrefundDescAffiliateRebatePoints := paymentrefundFields[18].Descriptor()
	// paymentrefund.DefaultAffiliateRebatePoints holds the default value on creation for the affiliate_rebate_points field.
	paymentrefund.DefaultAffiliateRebatePoints = paymentrefundDescAffiliateRebatePoints.Default.(float64)
	// paymentrefundDescBonusExpiredOffset is the schema descriptor for bonus_expired_offset field.
	paymentrefundDescBonusExpiredOffset := paymentrefundFields[19].Descriptor()
	// paymentrefund.DefaultBonusExpiredOffset holds the default value on creation for the bonus_expired_offset field.
	paymentrefund.DefaultBonusExpiredOffset = paymentrefundDescBonusExpiredOffset.Default.(float64)
	// paymentrefundDescTargetPrincipalAmount is the schema descriptor for target_principal_amount field.
	paymentrefundDescTargetPrincipalAmount := paymentrefundFields[20].Descriptor()
	// paymentrefund.DefaultTargetPrincipalAmount holds the default value on creation for the target_principal_amount field.
	paymentrefund.DefaultTargetPrincipalAmount = paymentrefundDescTargetPrincipalAmount.Default.(float64)
	// paymentrefundDescTargetFeeAmount is the schema descriptor for target_fee_amount field.
	paymentrefundDescTargetFeeAmount := paymentrefundFields[21].Descriptor()
	// paymentrefund.DefaultTargetFeeAmount holds the default value on creation for the target_fee_amount field.
	paymentrefund.DefaultTargetFeeAmount = paymentrefundDescTargetFeeAmount.Default.(float64)
	// paymentrefundDescTargetRefundFeeAmount is the schema descriptor for target_refund_fee_amount field.
	paymentrefundDescTargetRefundFeeAmount := paymentrefundFields[22].Descriptor()
	// paymentrefund.DefaultTargetRefundFeeAmount holds the default value on creation for the target_refund_fee_amount field.
	paymentrefund.DefaultTargetRefundFeeAmount = paymentrefundDescTargetRefundFeeAmount.Default.(float64)
	// paymentrefundDescTargetBasePoints is the schema descriptor for target_base_points field.
	paymentrefundDescTargetBasePoints := paymentrefundFields[23].Descriptor()
	// paymentrefund.DefaultTargetBasePoints holds the default value on creation for the target_base_points field.
	paymentrefund.DefaultTargetBasePoints = paymentrefundDescTargetBasePoints.Default.(float64)
	// paymentrefundDescTargetBonusPoints is the schema descriptor for target_bonus_points field.
	paymentrefundDescTargetBonusPoints := paymentrefundFields[24].Descriptor()
	// paymentrefund.DefaultTargetBonusPoints holds the default value on creation for the target_bonus_points field.
	paymentrefund.DefaultTargetBonusPoints = paymentrefundDescTargetBonusPoints.Default.(float64)
	// paymentrefundDescTargetAffiliatePoints is the schema descriptor for target_affiliate_points field.
	paymentrefundDescTargetAffiliatePoints := paymentrefundFields[25].Descriptor()
	// paymentrefund.DefaultTargetAffiliatePoints holds the default value on creation for the target_affiliate_points field.
	paymentrefund.DefaultTargetAffiliatePoints = paymentrefundDescTargetAffiliatePoints.Default.(float64)
	// paymentrefundDescReason is the schema descriptor for reason field.
	paymentrefundDescReason := paymentrefundFields[28].Descriptor()
	// paymentrefund.DefaultReason holds the default value on creation for the reason field.
	paymentrefund.DefaultReason = paymentrefundDescReason.Default.(string)
	// paymentrefundDescErrorCode is the schema descriptor for error_code field.
	paymentrefundDescErrorCode := paymentrefundFields[29].Descriptor()
	// paymentrefund.DefaultErrorCode holds the default value on creation for the error_code field.
	paymentrefund.DefaultErrorCode = paymentrefundDescErrorCode.Default.(string)
	// paymentrefund.ErrorCodeValidator is a validator for the "error_code" field. It is called by the builders before save.
	paymentrefund.ErrorCodeValidator = paymentrefundDescErrorCode.Validators[0].(func(string) error)
	// paymentrefundDescErrorMessage is the schema descriptor for error_message field.
	paymentrefundDescErrorMessage := paymentrefundFields[30].Descriptor()
	// paymentrefund.DefaultErrorMessage holds the default value on creation for the error_message field.
	paymentrefund.DefaultErrorMessage = paymentrefundDescErrorMessage.Default.(string)
	// paymentrefundDescCreatedAt is the schema descriptor for created_at field.
	paymentrefundDescCreatedAt := paymentrefundFields[33].Descriptor()
	...
	paymentrefundDescUpdatedAt := paymentrefundFields[34].Descriptor()
	...
	// paymentrefund.DefaultID holds the default value on creation for the id field.
	paymentrefund.DefaultID = paymentrefundDescID.Default.(func() string)
	...
	// pendingauthsessionDescID is the schema descriptor for id field.
	...
	// promocodeDescBonusValidityDays is the schema descriptor for bonus_validity_days field.
	promocodeDescBonusValidityDays := promocodeFields[2].Descriptor()
	// promocode.DefaultBonusValidityDays holds the default value on creation for the bonus_validity_days field.
	promocode.DefaultBonusValidityDays = promocodeDescBonusValidityDays.Default.(int)
	...
	promocodeDescID := promocodeMixinFields0[0].Descriptor()
	// promocode.DefaultID holds the default value on creation for the id field.
	promocode.DefaultID = promocodeDescID.Default.(func() string)
	...
	// promocodeusageDescID is the schema descriptor for id field.
	promocodeusageDescID := promocodeusageMixinFields0[0].Descriptor()
	// promocodeusage.DefaultID holds the default value on creation for the id field.
	promocodeusage.DefaultID = promocodeusageDescID.Default.(func() string)
	proxyMixin := schema.Proxy{}.Mixin()
	proxyMixinHooks2 := proxyMixin[2].Hooks()
	proxy.Hooks[0] = proxyMixinHooks2[0]
	proxyMixinInters2 := proxyMixin[2].Interceptors()
	proxy.Interceptors[0] = proxyMixinInters2[0]
	proxyMixinFields0 := proxyMixin[0].Fields()
	_ = proxyMixinFields0
	proxyMixinFields1 := proxyMixin[1].Fields()
	_ = proxyMixinFields1
	proxyFields := schema.Proxy{}.Fields()
	_ = proxyFields
	// proxyDescCreatedAt is the schema descriptor for created_at field.
	proxyDescCreatedAt := proxyMixinFields1[0].Descriptor()
	...
	proxyDescUpdatedAt := proxyMixinFields1[1].Descriptor()
	...
	proxyDescID := proxyMixinFields0[0].Descriptor()
	// proxy.DefaultID holds the default value on creation for the id field.
	proxy.DefaultID = proxyDescID.Default.(func() string)
	...
	// redeemcodeDescBonusValidityDays is the schema descriptor for bonus_validity_days field.
	redeemcodeDescBonusValidityDays := redeemcodeFields[11].Descriptor()
	// redeemcode.DefaultBonusValidityDays holds the default value on creation for the bonus_validity_days field.
	redeemcode.DefaultBonusValidityDays = redeemcodeDescBonusValidityDays.Default.(int)
	// redeemcodeDescID is the schema descriptor for id field.
	...
	securitysecretMixinFields1 := securitysecretMixin[1].Fields()
	_ = securitysecretMixinFields1
	...
	securitysecretDescCreatedAt := securitysecretMixinFields1[0].Descriptor()
	...
	securitysecretDescUpdatedAt := securitysecretMixinFields1[1].Descriptor()
	...
	// securitysecretDescID is the schema descriptor for id field.
	securitysecretDescID := securitysecretMixinFields0[0].Descriptor()
	// securitysecret.DefaultID holds the default value on creation for the id field.
	securitysecret.DefaultID = securitysecretDescID.Default.(func() string)
	...
	tlsfingerprintprofileMixinFields1 := tlsfingerprintprofileMixin[1].Fields()
	_ = tlsfingerprintprofileMixinFields1
	...
	tlsfingerprintprofileDescCreatedAt := tlsfingerprintprofileMixinFields1[0].Descriptor()
	...
	tlsfingerprintprofileDescUpdatedAt := tlsfingerprintprofileMixinFields1[1].Descriptor()
	...
	// tlsfingerprintprofileDescID is the schema descriptor for id field.
	tlsfingerprintprofileDescID := tlsfingerprintprofileMixinFields0[0].Descriptor()
	// tlsfingerprintprofile.DefaultID holds the default value on creation for the id field.
	tlsfingerprintprofile.DefaultID = tlsfingerprintprofileDescID.Default.(func() string)
	...
	// usagecleanuptaskDescID is the schema descriptor for id field.
	usagecleanuptaskDescID := usagecleanuptaskMixinFields0[0].Descriptor()
	// usagecleanuptask.DefaultID holds the default value on creation for the id field.
	usagecleanuptask.DefaultID = usagecleanuptaskDescID.Default.(func() string)
	...
	usagelogDescRequestedReasoningEffort := usagelogFields[31].Descriptor()
	...
	usagelogDescNativeCompactionV2 := usagelogFields[33].Descriptor()
	...
	usagelog.DefaultID = usagelogDescID.Default.(func() string)
	...
	user.DefaultFrozenBonusBalance = userDescFrozenBonusBalance.Default.(float64)
	...
	userattributedefinition.Hooks[0] = userattributedefinitionMixinHooks2[0]
	userattributedefinitionMixinInters2 := userattributedefinitionMixin[2].Interceptors()
	userattributedefinition.Interceptors[0] = userattributedefinitionMixinInters2[0]
	...
	// userattributedefinitionDescID is the schema descriptor for id field.
	userattributedefinitionDescID := userattributedefinitionMixinFields0[0].Descriptor()
	// userattributedefinition.DefaultID holds the default value on creation for the id field.
	userattributedefinition.DefaultID = userattributedefinitionDescID.Default.(func() string)
	...
	// userattributevalueDescID is the schema descriptor for id field.
	userattributevalueDescID := userattributevalueMixinFields0[0].Descriptor()
	// userattributevalue.DefaultID holds the default value on creation for the id field.
	userattributevalue.DefaultID = userattributevalueDescID.Default.(func() string)
	userplatformquotaMixin := schema.UserPlatformQuota{}.Mixin()
	userplatformquotaMixinHooks2 := userplatformquotaMixin[2].Hooks()
	userplatformquota.Hooks[0] = userplatformquotaMixinHooks2[0]
	userplatformquotaMixinInters2 := userplatformquotaMixin[2].Interceptors()
	userplatformquota.Interceptors[0] = userplatformquotaMixinInters2[0]
	...
	// userplatformquotaDescID is the schema descriptor for id field.
	userplatformquotaDescID := userplatformquotaMixinFields0[0].Descriptor()
	// userplatformquota.DefaultID holds the default value on creation for the id field.
	userplatformquota.DefaultID = userplatformquotaDescID.Default.(func() string)
	...
	usersubscriptionDescID := usersubscriptionMixinFields0[0].Descriptor()
