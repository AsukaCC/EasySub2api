...
func (_q *AuthIdentityChannelQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AuthIdentityChannelQuery) FirstIDX(ctx context.Context) string {
...
func (_q *AuthIdentityChannelQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AuthIdentityChannelQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *AuthIdentityChannelQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *AuthIdentityChannelQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AuthIdentityChannelQuery) loadIdentity(ctx context.Context, query *AuthIdentityQuery, nodes []*AuthIdentityChannel, init func(*AuthIdentityChannel), assign func(*AuthIdentityChannel, *AuthIdentity)) error {
	...
	nodeids := make(map[string][]*AuthIdentityChannel)
	for i := range nodes {
...
func (_q *AuthIdentityChannelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authidentitychannel.Table, authidentitychannel.Columns, sqlgraph.NewFieldSpec(authidentitychannel.FieldID, field.TypeString))
	_spec.From = _q.sql
