...
func (_c *IdentityAdoptionDecisionCreate) SetPendingAuthSessionID(v string) *IdentityAdoptionDecisionCreate {
	_c.mutation.SetPendingAuthSessionID(v)
	return _c
}

// SetIdentityID sets the "identity_id" field.
func (_c *IdentityAdoptionDecisionCreate) SetIdentityID(v string) *IdentityAdoptionDecisionCreate {
	_c.mutation.SetIdentityID(v)
	return _c
}

// SetNillableIdentityID sets the "identity_id" field if the given value is not nil.
func (_c *IdentityAdoptionDecisionCreate) SetNillableIdentityID(v *string) *IdentityAdoptionDecisionCreate {
	if v != nil {
		_c.SetIdentityID(*v)
	}
	return _c
...
func (_c *IdentityAdoptionDecisionCreate) SetID(v string) *IdentityAdoptionDecisionCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *IdentityAdoptionDecisionCreate) SetNillableID(v *string) *IdentityAdoptionDecisionCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *IdentityAdoptionDecisionCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := identityadoptiondecision.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *IdentityAdoptionDecisionCreate) sqlSave(ctx context.Context) (*IdentityAdoptionDecision, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected IdentityAdoptionDecision.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *IdentityAdoptionDecisionCreate) createSpec() (*IdentityAdoptionDecision, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(identityadoptiondecision.Table, sqlgraph.NewFieldSpec(identityadoptiondecision.FieldID, field.TypeString))
	)
...
// SetPendingAuthSessionID sets the "pending_auth_session_id" field.
func (u *IdentityAdoptionDecisionUpsert) SetPendingAuthSessionID(v string) *IdentityAdoptionDecisionUpsert {
...
// SetIdentityID sets the "identity_id" field.
func (u *IdentityAdoptionDecisionUpsert) SetIdentityID(v string) *IdentityAdoptionDecisionUpsert {
...
//				u.SetIgnore(identityadoptiondecision.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *IdentityAdoptionDecisionUpsertOne) UpdateNewValues() *IdentityAdoptionDecisionUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(identityadoptiondecision.FieldID)
		}
...
// SetPendingAuthSessionID sets the "pending_auth_session_id" field.
func (u *IdentityAdoptionDecisionUpsertOne) SetPendingAuthSessionID(v string) *IdentityAdoptionDecisionUpsertOne {
	return u.Update(func(s *IdentityAdoptionDecisionUpsert) {
...
// SetIdentityID sets the "identity_id" field.
func (u *IdentityAdoptionDecisionUpsertOne) SetIdentityID(v string) *IdentityAdoptionDecisionUpsertOne {
	return u.Update(func(s *IdentityAdoptionDecisionUpsert) {
		s.SetIdentityID(v)
	})
}
...
func (u *IdentityAdoptionDecisionUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: IdentityAdoptionDecisionUpsertOne.ID is not supported by MySQL driver. Use IdentityAdoptionDecisionUpsertOne.Exec instead")
	}
...
func (u *IdentityAdoptionDecisionUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetPendingAuthSessionID sets the "pending_auth_session_id" field.
func (u *IdentityAdoptionDecisionUpsertBulk) SetPendingAuthSessionID(v string) *IdentityAdoptionDecisionUpsertBulk {
	return u.Update(func(s *IdentityAdoptionDecisionUpsert) {
		s.SetPendingAuthSessionID(v)
	})
}
...
// SetIdentityID sets the "identity_id" field.
func (u *IdentityAdoptionDecisionUpsertBulk) SetIdentityID(v string) *IdentityAdoptionDecisionUpsertBulk {
	return u.Update(func(s *IdentityAdoptionDecisionUpsert) {
		s.SetIdentityID(v)
	})
}
