...
func (_q *ErrorPassthroughRuleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ErrorPassthroughRuleQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ErrorPassthroughRuleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ErrorPassthroughRuleQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ErrorPassthroughRuleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ErrorPassthroughRuleQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ErrorPassthroughRuleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(errorpassthroughrule.Table, errorpassthroughrule.Columns, sqlgraph.NewFieldSpec(errorpassthroughrule.FieldID, field.TypeString))
	_spec.From = _q.sql
