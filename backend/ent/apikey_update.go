...
func (_u *APIKeyUpdate) AddUsageLogIDs(ids ...string) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveUsageLogIDs(ids ...string) *APIKeyUpdate {
...
// AddUsageLogIDs adds the "usage_logs" edge to the UsageLog entity by IDs.
func (_u *APIKeyUpdateOne) AddUsageLogIDs(ids ...string) *APIKeyUpdateOne {
	_u.mutation.AddUsageLogIDs(ids...)
	return _u
}
...
// RemoveUsageLogIDs removes the "usage_logs" edge to UsageLog entities by IDs.
func (_u *APIKeyUpdateOne) RemoveUsageLogIDs(ids ...string) *APIKeyUpdateOne {
	_u.mutation.RemoveUsageLogIDs(ids...)
	return _u
}
