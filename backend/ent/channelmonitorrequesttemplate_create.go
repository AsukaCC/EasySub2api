...
func (_c *ChannelMonitorRequestTemplateCreate) SetID(v string) *ChannelMonitorRequestTemplateCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ChannelMonitorRequestTemplateCreate) SetNillableID(v *string) *ChannelMonitorRequestTemplateCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ChannelMonitorRequestTemplateCreate) AddMonitorIDs(ids ...string) *ChannelMonitorRequestTemplateCreate {
...
func (_c *ChannelMonitorRequestTemplateCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := channelmonitorrequesttemplate.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *ChannelMonitorRequestTemplateCreate) sqlSave(ctx context.Context) (*ChannelMonitorRequestTemplate, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected ChannelMonitorRequestTemplate.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ChannelMonitorRequestTemplateCreate) createSpec() (*ChannelMonitorRequestTemplate, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(channelmonitorrequesttemplate.Table, sqlgraph.NewFieldSpec(channelmonitorrequesttemplate.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(channelmonitorrequesttemplate.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *ChannelMonitorRequestTemplateUpsertOne) UpdateNewValues() *ChannelMonitorRequestTemplateUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(channelmonitorrequesttemplate.FieldID)
		}
...
func (u *ChannelMonitorRequestTemplateUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: ChannelMonitorRequestTemplateUpsertOne.ID is not supported by MySQL driver. Use ChannelMonitorRequestTemplateUpsertOne.Exec instead")
	}
...
func (u *ChannelMonitorRequestTemplateUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
