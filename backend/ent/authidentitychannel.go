...
func (*AuthIdentityChannel) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case authidentitychannel.FieldMetadata:
			values[i] = new([]byte)
		case authidentitychannel.FieldID, authidentitychannel.FieldIdentityID, authidentitychannel.FieldProviderType, authidentitychannel.FieldProviderKey, authidentitychannel.FieldChannel, authidentitychannel.FieldChannelAppID, authidentitychannel.FieldChannelSubject:
