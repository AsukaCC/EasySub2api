...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "proxy_fallback_origin_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	AnnouncementsColumns = []*schema.Column{
		...
		{Name: "created_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "updated_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	...
	AnnouncementReadsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "announcement_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "user_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	AuthIdentityChannelsColumns = []*schema.Column{
		...
		{Name: "metadata", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "identity_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "created_by", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		...
		{Name: "template_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	ChannelMonitorDailyRollupsColumns = []*schema.Column{
		...
		{Name: "monitor_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "level_rate_multipliers", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "dynamic_rate_rules", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "fallback_group_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "fallback_group_id_on_invalid_request", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	IdentityAdoptionDecisionsColumns = []*schema.Column{
		...
		{Name: "identity_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "pending_auth_session_id", Type: field.TypeString, Unique: true, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	PaymentAuditLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "order_id", Type: field.TypeString, Size: 64, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "wallet_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "wallet_bonus_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "wallet_recharge_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "wallet_hold_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "wallet_only", Type: field.TypeBool, Default: false},
		{Name: "gateway_base_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "base_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "credited_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_tier_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "bonus_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "bonus_grant_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "affiliate_rebate_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "refund_deadline", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "refunded_principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "refunded_fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "refunded_gateway_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "reversed_base_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "reversed_bonus_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "reversed_affiliate_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		{Name: "refund_requested_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	PaymentRefundsColumns = []*schema.Column{
		...
		{Name: "user_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "ticket_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "source", Type: field.TypeString, Size: 24, Default: "SELF_SERVICE"},
		{Name: "status", Type: field.TypeString, Size: 30, Default: "REQUESTED"},
		{Name: "idempotency_key", Type: field.TypeString, Size: 160},
		{Name: "request_fingerprint", Type: field.TypeString, Size: 160, Default: ""},
		{Name: "provider_request_id", Type: field.TypeString, Size: 128},
		...
		{Name: "requested_principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "refund_fee_rate", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(5,2)"}},
		{Name: "refund_fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "gateway_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "base_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "affiliate_rebate_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_expired_offset", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "target_principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "target_fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "target_refund_fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "target_base_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "target_bonus_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "target_affiliate_points", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "wallet_hold_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "requested_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	PaymentRefundsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "paymentrefund_order_id_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{PaymentRefundsColumns[1], PaymentRefundsColumns[6]},
			},
			{
			...
			{
				Name:    "idx_payment_refunds_one_active_order",
				Unique:  true,
				Columns: []*schema.Column{PaymentRefundsColumns[1]},
				Annotation: &entsql.IndexAnnotation{
			...
			{
				Name:    "paymentrefund_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{PaymentRefundsColumns[2], PaymentRefundsColumns[34]},
			},
			{
				Name:    "paymentrefund_status",
				Unique:  false,
				Columns: []*schema.Column{PaymentRefundsColumns[5]},
			},
		},
	}
	...
	PendingAuthSessionsColumns = []*schema.Column{
		...
		{Name: "target_user_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	PromoCodesColumns = []*schema.Column{
		...
		{Name: "bonus_validity_days", Type: field.TypeInt, Default: 90},
	...
	PromoCodeUsagesColumns = []*schema.Column{
		...
		{Name: "promo_code_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "user_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "bonus_validity_days", Type: field.TypeInt, Default: 90},
		{Name: "group_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "used_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	UsageCleanupTasksColumns = []*schema.Column{
		...
		{Name: "canceled_by", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "channel_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		...
		{Name: "group_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "user_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "subscription_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
	}
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "frozen_recharge_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "frozen_bonus_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	UserAttributeValuesColumns = []*schema.Column{
		...
		{Name: "user_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "attribute_id", Type: field.TypeString, SchemaType: map[string]string{"postgres": "uuid"}},
	}
...
func init() {
	...
	PaymentRefundsTable.Annotation.Checks = map[string]string{
