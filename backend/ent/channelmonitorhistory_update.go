...
func (_u *ChannelMonitorHistoryUpdate) SetMonitorID(v string) *ChannelMonitorHistoryUpdate {
	_u.mutation.SetMonitorID(v)
	return _u
}

// SetNillableMonitorID sets the "monitor_id" field if the given value is not nil.
func (_u *ChannelMonitorHistoryUpdate) SetNillableMonitorID(v *string) *ChannelMonitorHistoryUpdate {
	if v != nil {
		_u.SetMonitorID(*v)
	}
	return _u
...
func (_u *ChannelMonitorHistoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(channelmonitorhistory.Table, channelmonitorhistory.Columns, sqlgraph.NewFieldSpec(channelmonitorhistory.FieldID, field.TypeString))
...
// SetMonitorID sets the "monitor_id" field.
func (_u *ChannelMonitorHistoryUpdateOne) SetMonitorID(v string) *ChannelMonitorHistoryUpdateOne {
	_u.mutation.SetMonitorID(v)
	return _u
}

// SetNillableMonitorID sets the "monitor_id" field if the given value is not nil.
func (_u *ChannelMonitorHistoryUpdateOne) SetNillableMonitorID(v *string) *ChannelMonitorHistoryUpdateOne {
	if v != nil {
		_u.SetMonitorID(*v)
	}
	return _u
