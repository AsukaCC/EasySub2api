...
func (_q *BatchImageEventQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageEventQuery) FirstIDX(ctx context.Context) string {
...
func (_q *BatchImageEventQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageEventQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *BatchImageEventQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *BatchImageEventQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BatchImageEventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(batchimageevent.Table, batchimageevent.Columns, sqlgraph.NewFieldSpec(batchimageevent.FieldID, field.TypeString))
	_spec.From = _q.sql
