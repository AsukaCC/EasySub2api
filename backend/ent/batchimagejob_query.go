...
func (_q *BatchImageJobQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageJobQuery) FirstIDX(ctx context.Context) string {
...
func (_q *BatchImageJobQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BatchImageJobQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *BatchImageJobQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *BatchImageJobQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BatchImageJobQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(batchimagejob.Table, batchimagejob.Columns, sqlgraph.NewFieldSpec(batchimagejob.FieldID, field.TypeString))
	_spec.From = _q.sql
