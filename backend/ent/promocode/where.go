...
func BonusValidityDays(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldEQ(FieldBonusValidityDays, v))
}
...
func BonusValidityDaysEQ(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldEQ(FieldBonusValidityDays, v))
}

// BonusValidityDaysNEQ applies the NEQ predicate on the "bonus_validity_days" field.
func BonusValidityDaysNEQ(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldNEQ(FieldBonusValidityDays, v))
}

// BonusValidityDaysIn applies the In predicate on the "bonus_validity_days" field.
func BonusValidityDaysIn(vs ...int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldIn(FieldBonusValidityDays, vs...))
}

// BonusValidityDaysNotIn applies the NotIn predicate on the "bonus_validity_days" field.
func BonusValidityDaysNotIn(vs ...int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldNotIn(FieldBonusValidityDays, vs...))
}

// BonusValidityDaysGT applies the GT predicate on the "bonus_validity_days" field.
func BonusValidityDaysGT(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldGT(FieldBonusValidityDays, v))
}

// BonusValidityDaysGTE applies the GTE predicate on the "bonus_validity_days" field.
func BonusValidityDaysGTE(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldGTE(FieldBonusValidityDays, v))
}

// BonusValidityDaysLT applies the LT predicate on the "bonus_validity_days" field.
func BonusValidityDaysLT(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldLT(FieldBonusValidityDays, v))
}

// BonusValidityDaysLTE applies the LTE predicate on the "bonus_validity_days" field.
func BonusValidityDaysLTE(v int) predicate.PromoCode {
	return predicate.PromoCode(sql.FieldLTE(FieldBonusValidityDays, v))
}
