...
func (*CompositeModelRoute) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case compositemodelroute.FieldID, compositemodelroute.FieldGroupID, compositemodelroute.FieldPublicModel, compositemodelroute.FieldMatchType, compositemodelroute.FieldTargetPlatform, compositemodelroute.FieldUpstreamModel, compositemodelroute.FieldEndpoint, compositemodelroute.FieldNotes:
