...
func (_c *UserAttributeValueCreate) SetUserID(v string) *UserAttributeValueCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetAttributeID sets the "attribute_id" field.
func (_c *UserAttributeValueCreate) SetAttributeID(v string) *UserAttributeValueCreate {
...
func (_c *UserAttributeValueCreate) SetID(v string) *UserAttributeValueCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *UserAttributeValueCreate) SetNillableID(v *string) *UserAttributeValueCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *UserAttributeValueCreate) SetDefinitionID(id string) *UserAttributeValueCreate {
...
func (_c *UserAttributeValueCreate) defaults() {
	...
	if _, ok := _c.mutation.ID(); !ok {
		v := userattributevalue.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *UserAttributeValueCreate) sqlSave(ctx context.Context) (*UserAttributeValue, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected UserAttributeValue.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *UserAttributeValueCreate) createSpec() (*UserAttributeValue, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userattributevalue.Table, sqlgraph.NewFieldSpec(userattributevalue.FieldID, field.TypeString))
	)
	...
	if nodes := _c.mutation.DefinitionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(userattributedefinition.FieldID, field.TypeString),
			},
		}
		for _, k := range nodes {
			edge.Target.Nodes = append(edge.Target.Nodes, k)
...
// SetUserID sets the "user_id" field.
func (u *UserAttributeValueUpsert) SetUserID(v string) *UserAttributeValueUpsert {
...
// SetAttributeID sets the "attribute_id" field.
func (u *UserAttributeValueUpsert) SetAttributeID(v string) *UserAttributeValueUpsert {
...
//				u.SetIgnore(userattributevalue.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *UserAttributeValueUpsertOne) UpdateNewValues() *UserAttributeValueUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(userattributevalue.FieldID)
		}
...
// SetUserID sets the "user_id" field.
func (u *UserAttributeValueUpsertOne) SetUserID(v string) *UserAttributeValueUpsertOne {
	return u.Update(func(s *UserAttributeValueUpsert) {
		s.SetUserID(v)
	})
}
...
// SetAttributeID sets the "attribute_id" field.
func (u *UserAttributeValueUpsertOne) SetAttributeID(v string) *UserAttributeValueUpsertOne {
	return u.Update(func(s *UserAttributeValueUpsert) {
		s.SetAttributeID(v)
	})
}
...
func (u *UserAttributeValueUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: UserAttributeValueUpsertOne.ID is not supported by MySQL driver. Use UserAttributeValueUpsertOne.Exec instead")
	}
...
func (u *UserAttributeValueUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetUserID sets the "user_id" field.
func (u *UserAttributeValueUpsertBulk) SetUserID(v string) *UserAttributeValueUpsertBulk {
	return u.Update(func(s *UserAttributeValueUpsert) {
		s.SetUserID(v)
	})
}
...
// SetAttributeID sets the "attribute_id" field.
func (u *UserAttributeValueUpsertBulk) SetAttributeID(v string) *UserAttributeValueUpsertBulk {
	return u.Update(func(s *UserAttributeValueUpsert) {
		s.SetAttributeID(v)
	})
}
