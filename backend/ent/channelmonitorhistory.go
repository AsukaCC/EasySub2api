...
func (*ChannelMonitorHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitorhistory.FieldQuota:
			values[i] = new([]byte)
		case channelmonitorhistory.FieldLatencyMs, channelmonitorhistory.FieldPingLatencyMs:
			values[i] = new(sql.NullInt64)
		case channelmonitorhistory.FieldID, channelmonitorhistory.FieldMonitorID, channelmonitorhistory.FieldModel, channelmonitorhistory.FieldStatus, channelmonitorhistory.FieldMessage:
...
func (_m *ChannelMonitorHistory) String() string {
	...
	builder.WriteString(_m.MonitorID)
	builder.WriteString(", ")
