...
func (_c *BatchImageEventCreate) SetID(v string) *BatchImageEventCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *BatchImageEventCreate) SetNillableID(v *string) *BatchImageEventCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *BatchImageEventCreate) sqlSave(ctx context.Context) (*BatchImageEvent, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected BatchImageEvent.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *BatchImageEventCreate) createSpec() (*BatchImageEvent, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(batchimageevent.Table, sqlgraph.NewFieldSpec(batchimageevent.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(batchimageevent.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *BatchImageEventUpsertOne) UpdateNewValues() *BatchImageEventUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(batchimageevent.FieldID)
		}
...
func (u *BatchImageEventUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: BatchImageEventUpsertOne.ID is not supported by MySQL driver. Use BatchImageEventUpsertOne.Exec instead")
	}
...
func (u *BatchImageEventUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
