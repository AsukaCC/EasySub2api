...
func (_c *ProxyCreate) SetBackupProxyID(v string) *ProxyCreate {
	_c.mutation.SetBackupProxyID(v)
	return _c
}

// SetNillableBackupProxyID sets the "backup_proxy_id" field if the given value is not nil.
func (_c *ProxyCreate) SetNillableBackupProxyID(v *string) *ProxyCreate {
	if v != nil {
...
func (_c *ProxyCreate) SetID(v string) *ProxyCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ProxyCreate) SetNillableID(v *string) *ProxyCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ProxyCreate) AddAccountIDs(ids ...string) *ProxyCreate {
...
func (_c *ProxyCreate) AddPrimaryProxyIDs(ids ...string) *ProxyCreate {
...
func (_c *ProxyCreate) sqlSave(ctx context.Context) (*Proxy, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected Proxy.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ProxyCreate) createSpec() (*Proxy, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(proxy.Table, sqlgraph.NewFieldSpec(proxy.FieldID, field.TypeString))
	)
...
// SetBackupProxyID sets the "backup_proxy_id" field.
func (u *ProxyUpsert) SetBackupProxyID(v string) *ProxyUpsert {
...
// SetBackupProxyID sets the "backup_proxy_id" field.
func (u *ProxyUpsertOne) SetBackupProxyID(v string) *ProxyUpsertOne {
	return u.Update(func(s *ProxyUpsert) {
...
func (u *ProxyUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: ProxyUpsertOne.ID is not supported by MySQL driver. Use ProxyUpsertOne.Exec instead")
	}
...
func (u *ProxyUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetBackupProxyID sets the "backup_proxy_id" field.
func (u *ProxyUpsertBulk) SetBackupProxyID(v string) *ProxyUpsertBulk {
	return u.Update(func(s *ProxyUpsert) {
		s.SetBackupProxyID(v)
	})
}
