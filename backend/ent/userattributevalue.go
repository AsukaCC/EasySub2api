...
func (*UserAttributeValue) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case userattributevalue.FieldID, userattributevalue.FieldUserID, userattributevalue.FieldAttributeID, userattributevalue.FieldValue:
...
func (_m *UserAttributeValue) String() string {
	...
	builder.WriteString(_m.AttributeID)
	builder.WriteString(", ")
