...
const (
	// Label holds the string label denoting the accountmodelrule type in the database.
	Label = "account_model_rule"
...
// Columns holds all SQL columns for accountmodelrule fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AccountModelRule queries.
