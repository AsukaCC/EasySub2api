...
func (*RedeemCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case redeemcode.FieldValidityDays, redeemcode.FieldBonusValidityDays:
			values[i] = new(sql.NullInt64)
		case redeemcode.FieldID, redeemcode.FieldCode, redeemcode.FieldType, redeemcode.FieldStatus, redeemcode.FieldUsedBy, redeemcode.FieldNotes, redeemcode.FieldGroupID:
...
func (_m *RedeemCode) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case redeemcode.FieldBonusValidityDays:
			if value, ok := values[i].(*sql.NullInt64); !ok {
