...
func (_u *SubscriptionPlanUpdate) SetGroupID(v string) *SubscriptionPlanUpdate {
	_u.mutation.SetGroupID(v)
	return _u
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_u *SubscriptionPlanUpdate) SetNillableGroupID(v *string) *SubscriptionPlanUpdate {
	if v != nil {
		_u.SetGroupID(*v)
	}
	return _u
...
// SetGroupID sets the "group_id" field.
func (_u *SubscriptionPlanUpdateOne) SetGroupID(v string) *SubscriptionPlanUpdateOne {
	_u.mutation.SetGroupID(v)
	return _u
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_u *SubscriptionPlanUpdateOne) SetNillableGroupID(v *string) *SubscriptionPlanUpdateOne {
	if v != nil {
		_u.SetGroupID(*v)
	}
	return _u
