...
func (_u *ChannelMonitorDailyRollupUpdate) SetMonitorID(v string) *ChannelMonitorDailyRollupUpdate {
	_u.mutation.SetMonitorID(v)
	return _u
}

// SetNillableMonitorID sets the "monitor_id" field if the given value is not nil.
func (_u *ChannelMonitorDailyRollupUpdate) SetNillableMonitorID(v *string) *ChannelMonitorDailyRollupUpdate {
	if v != nil {
		_u.SetMonitorID(*v)
	}
	return _u
...
func (_u *ChannelMonitorDailyRollupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(channelmonitordailyrollup.Table, channelmonitordailyrollup.Columns, sqlgraph.NewFieldSpec(channelmonitordailyrollup.FieldID, field.TypeString))
...
// SetMonitorID sets the "monitor_id" field.
func (_u *ChannelMonitorDailyRollupUpdateOne) SetMonitorID(v string) *ChannelMonitorDailyRollupUpdateOne {
	_u.mutation.SetMonitorID(v)
	return _u
}

// SetNillableMonitorID sets the "monitor_id" field if the given value is not nil.
func (_u *ChannelMonitorDailyRollupUpdateOne) SetNillableMonitorID(v *string) *ChannelMonitorDailyRollupUpdateOne {
	if v != nil {
		_u.SetMonitorID(*v)
	}
	return _u
