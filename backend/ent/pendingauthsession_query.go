...
func (_q *PendingAuthSessionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PendingAuthSessionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PendingAuthSessionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PendingAuthSessionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PendingAuthSessionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PendingAuthSessionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PendingAuthSessionQuery) loadTargetUser(ctx context.Context, query *UserQuery, nodes []*PendingAuthSession, init func(*PendingAuthSession), assign func(*PendingAuthSession, *User)) error {
	...
	nodeids := make(map[string][]*PendingAuthSession)
	for i := range nodes {
...
func (_q *PendingAuthSessionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pendingauthsession.Table, pendingauthsession.Columns, sqlgraph.NewFieldSpec(pendingauthsession.FieldID, field.TypeString))
	_spec.From = _q.sql
