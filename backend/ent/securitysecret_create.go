...
func (_c *SecuritySecretCreate) SetID(v string) *SecuritySecretCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *SecuritySecretCreate) SetNillableID(v *string) *SecuritySecretCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *SecuritySecretCreate) sqlSave(ctx context.Context) (*SecuritySecret, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected SecuritySecret.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *SecuritySecretCreate) createSpec() (*SecuritySecret, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(securitysecret.Table, sqlgraph.NewFieldSpec(securitysecret.FieldID, field.TypeString))
	)
...
//				u.SetIgnore(securitysecret.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *SecuritySecretUpsertOne) UpdateNewValues() *SecuritySecretUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(securitysecret.FieldID)
		}
...
func (u *SecuritySecretUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: SecuritySecretUpsertOne.ID is not supported by MySQL driver. Use SecuritySecretUpsertOne.Exec instead")
	}
...
func (u *SecuritySecretUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
