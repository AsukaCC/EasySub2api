...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dashboardHandler := admin.NewDashboardHandler(dashboardService, dashboardAggregationService, service.ProvideAccountQuotaDashboardService(accountRepository, groupRepository, usageLogRepository))
