...
import (
	...
	"github.com/AsukaCC/EasySub2api/internal/setup"
	"github.com/AsukaCC/EasySub2api/internal/web"
...
func main() {
	...
	if *showVersion {
		log.Printf("EasySub2api %s (commit: %s, built: %s)\n", Version, Commit, Date)
		return
	}
...
func runSetupServer() {
	...
	log.Println("Complete the setup wizard to configure EasySub2api")
